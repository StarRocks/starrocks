...
+ 参考手册
  ...
  + 函数参考
    ...
    + JSON 函数
      ...
      + JSON 查询和处理函数
        + [箭头函数](/sql-reference/sql-functions/json-functions/json-query-processing-functions/arrow-function.md)
        + [cast](/sql-reference/sql-functions/json-functions/json-query-processing-functions/cast-from-or-to-json.md)
        + [get_json_double](/sql-reference/sql-functions/json-functions/json-query-processing-functions/get_json_double.md)
        + [get_json_int](/sql-reference/sql-functions/json-functions/json-query-processing-functions/get_json_int.md)
        + [get_json_string](/sql-reference/sql-functions/json-functions/json-query-processing-functions/get_json_string.md)
        + [json_each](/sql-reference/sql-functions/json-functions/json-query-processing-functions/json_each.md)
        + [json_exists](/sql-reference/sql-functions/json-functions/json-query-processing-functions/json_exist.md)
        + [json_query](/sql-reference/sql-functions/json-functions/json-query-processing-functions/json_query.md)
        + [json_string](/sql-reference/sql-functions/json-functions/json-query-processing-functions/json_string.md)
    + 模糊/正则匹配函数
    ...
    + 条件函数
      + [case](/sql-reference/sql-functions/condition-functions/case_when.mdmd)
