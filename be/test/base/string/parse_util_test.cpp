...
TEST(TestParseDataSize, Normal) {
    ...
    ASSERT_EQ(0, ParseUtil::parse_data_size(std::string(1, static_cast<char>(0xFF))));
    ASSERT_EQ(0, ParseUtil::parse_data_size(std::string("10") + static_cast<char>(0xFF)));
    ...
    ASSERT_EQ(0, ParseUtil::parse_data_size("9223372036854775808"));
