...
TEST_F(SchemaChangeTest, convert_int_to_bitmap) {
    ...
    ChunkPtr src_chunk = ChunkBuilder::new_chunk(ChunkHelper::convert_schema(src_tablet_schema), 4096);
    ChunkPtr dst_chunk = ChunkBuilder::new_chunk(ChunkHelper::convert_schema(dst_tablet_schema), 4096);
