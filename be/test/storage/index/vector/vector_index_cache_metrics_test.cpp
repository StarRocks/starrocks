...
TEST(VectorIndexCacheMetricsTest, InstallRegistersMetrics) {
    ...
    assert_metric_registered(&registry, "vector_index_cache_async_load_submitted");
    assert_metric_registered(&registry, "vector_index_cache_async_load_deduplicated");
    ...
    assert_metric_registered(&registry, "vector_index_cache_async_load_cancelled");
    assert_metric_registered(&registry, "vector_index_cache_async_load_ns");
    assert_metric_registered(&registry, "vector_index_cache_probe_count");
    assert_metric_registered(&registry, "vector_index_cache_probe_ns");
    assert_metric_registered(&registry, "vector_index_cache_entry_lock_wait_count");
    assert_metric_registered(&registry, "vector_index_cache_entry_lock_wait_ns");
    assert_metric_registered(&registry, "vector_index_cache_empty_entry_removed");
}
