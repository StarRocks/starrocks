...
TEST(ColumnAggregator, testIntSum) {
    FieldPtr field = std::make_shared<Field>(1, "test", LogicalType::OLAP_FIELD_TYPE_INT, false);
...
TEST(ColumnAggregator, testNullIntSum) {
    FieldPtr field = std::make_shared<Field>(1, "test", LogicalType::OLAP_FIELD_TYPE_INT, true);
    field->set_aggregate_method(FieldAggregationMethod::OLAP_FIELD_AGGREGATION_SUM);
...
TEST(ColumnAggregator, testStringMin) {
    FieldPtr field = std::make_shared<Field>(1, "test", LogicalType::OLAP_FIELD_TYPE_VARCHAR, false);
...
TEST(ColumnAggregator, testNullBooleanMin) {
    FieldPtr field = std::make_shared<Field>(1, "test_boolean", LogicalType::OLAP_FIELD_TYPE_BOOL, true);
    field->set_aggregate_method(FieldAggregationMethod::OLAP_FIELD_AGGREGATION_MIN);
...
TEST(ColumnAggregator, testArrayReplace) {
    auto array_type_info = get_array_type_info(get_type_info(LogicalType::OLAP_FIELD_TYPE_VARCHAR));
...
TEST(ColumnAggregator, testNullArrayReplaceIfNotNull2) {
    auto array_type_info = get_array_type_info(get_type_info(LogicalType::OLAP_FIELD_TYPE_INT));
    FieldPtr field =
