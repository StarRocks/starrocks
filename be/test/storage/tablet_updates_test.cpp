...
// Manual compaction of a primary-key tablet goes through CompactionAction::do_compaction's updates() branch,
...
// Same path but with an explicit rowset_ids list, exercising CompactionAction::do_compaction's
