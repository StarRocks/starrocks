...
TEST_F(SegmentRewriterTest, rewrite_owned_only_drops_the_unowned_rows) {
    ...
    ASSERT_OK(SegmentRewriter::rewrite_partial_update_owned_only(
            src_file_info, &dst_file_info, tablet_schema, /*flat_json_config=*/nullptr, resolved_column_ids,
            resolved_columns, owned, kEmittedBase, 0, partial_rowset_footer));
...
TEST_F(SegmentRewriterTest, rewrite_copy_only_copies_just_the_bundled_slice) {
    ...
    ASSERT_OK(SegmentRewriter::rewrite_partial_update(src, &dest, tablet_schema, /*flat_json_config=*/nullptr,
                                                      no_column_ids, no_columns, 0, FooterPointerPB()));
...
TEST_F(SegmentRewriterTest, rewrite_copy_only_keeps_the_source_encryption) {
    ...
    MutableColumns no_columns;
    ASSERT_OK(SegmentRewriter::rewrite_partial_update(src, &dest, tablet_schema, /*flat_json_config=*/nullptr,
                                                      no_column_ids, no_columns, 0, partial_rowset_footer));
