...
TEST_F(SegmentIteratorTest, TestGlobalDictNotSuperSet) {
    ...
    vec_schema.append(std::make_shared<VectorizedField>(0, "c1", LOGICAL_TYPE_INT, -1, -1, false));
    vec_schema.append(std::make_shared<VectorizedField>(1, "c2", LOGICAL_TYPE_VARCHAR, -1, -1, false));
