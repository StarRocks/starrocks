...
TEST_F(EncodingInfoTest, default_encoding) {
    std::map<LogicalType, EncodingTypePB> default_expected = {
            ...
            {LOGICAL_TYPE_BOOL, RLE},

            {LOGICAL_TYPE_DATE, BIT_SHUFFLE},
            {LOGICAL_TYPE_DATE_V2, BIT_SHUFFLE},
            {LOGICAL_TYPE_DATETIME, BIT_SHUFFLE},
            {LOGICAL_TYPE_TIMESTAMP, BIT_SHUFFLE},

            {LOGICAL_TYPE_DECIMAL, BIT_SHUFFLE},
            {LOGICAL_TYPE_DECIMAL_V2, BIT_SHUFFLE},
    ...
    std::map<LogicalType, EncodingTypePB> value_seek_expected = {
            ...
            {LOGICAL_TYPE_VARCHAR, PREFIX_ENCODING}, {LOGICAL_TYPE_BOOL, PLAIN_ENCODING},
            {LOGICAL_TYPE_DATE, FOR_ENCODING},       {LOGICAL_TYPE_DATE_V2, FOR_ENCODING},
            {LOGICAL_TYPE_DATETIME, FOR_ENCODING},   {LOGICAL_TYPE_TIMESTAMP, FOR_ENCODING},
            {LOGICAL_TYPE_DECIMAL_V2, BIT_SHUFFLE},  {LOGICAL_TYPE_DECIMAL, BIT_SHUFFLE},
    };
