...
>>>>>>> 2a972f7313 ([Enhancement] Add fast cancel for lake replication file copy (#70222))
        #ifdef USE_STAROS
...
#include "util/failpoint/fail_point.h"
    ...
    TEST_F(LakeReplicationRemoteStorageTest, test_fast_cancel_txn_aborted_before_copy) {
        ...
        std::string src_meta_dir = fmt::format("staros://{}/db{}/{}/{}/meta", _src_tablet_id, _src_db_id, _src_table_id,
                                               _src_partition_id);
    ...
    TEST_F(LakeReplicationRemoteStorageTest, test_no_fast_cancel_when_txn_active) {
        ...
        EXPECT_TRUE(before_copy_invoked)
                << "before_copy SyncPoint should have been reached (fast cancel did not trigger)";
