...
TEST_P(LakePrimaryKeyPublishTest, test_cloud_native_index_minor_compact_because_rows) {
    ...
    auto saved_rows_threshold = config::cloud_native_pk_index_rebuild_rows_threshold;
    config::cloud_native_pk_index_rebuild_rows_threshold = (int64_t)kChunkSize * 2;
    DeferOp restore_config([&] { config::cloud_native_pk_index_rebuild_rows_threshold = saved_rows_threshold; });
