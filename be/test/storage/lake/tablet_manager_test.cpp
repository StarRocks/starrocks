...
TEST_F(LakeTabletManagerTest, segment_cache_key_distinguishes_bundle_slices) {
    ...
    const auto plain_key = lake::TabletManager::segment_cache_key(plain);
    const auto slice0_key = lake::TabletManager::segment_cache_key(slice0);
    const auto slice1_key = lake::TabletManager::segment_cache_key(slice1);
...
TEST_F(LakeTabletManagerTest, load_segment_returns_distinct_slices_for_same_path) {
    ...
    const auto key_a = lake::TabletManager::segment_cache_key(info_a);
    const auto key_b = lake::TabletManager::segment_cache_key(info_b);
