...
class PersistentIndexRebuildExecutorTest : public ::testing::Test {
public:
...
TEST_F(PersistentIndexRebuildExecutorTest, test_submit_task) {
    ...
    auto latch_or = pindex_rebuild_executor->submit_task(_tablet);
