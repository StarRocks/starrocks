...
PARALLEL_TEST(ConvertHelperTest, testDecimalToDecimalV2Column) {
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DECIMAL, false);
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DECIMAL, true);
        c0->append_datum({values[0]});
        c0->append_datum({});
        c0->append_datum({values[1]});
        c0->append_datum({});
...
PARALLEL_TEST(ConvertHelperTest, testDecimalV2ToDecimalColumn) {
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DECIMALV2, false);
        c0->append_datum({values[0]});
        c0->append_datum({values[1]});
        c0->append_datum({values[2]});
        c0->append_datum({values[3]});
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DECIMALV2, true);
        c0->append_datum({values[0]});
        c0->append_datum({});
        c0->append_datum({values[1]});
        c0->append_datum({});
...
PARALLEL_TEST(ConvertHelperTest, testDateToDateV2Column) {
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DATE_V1, false);
        c0->append_datum({values[0]});
        c0->append_datum({values[1]});
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DATE_V1, true);
        c0->append_datum({values[0]});
        c0->append_datum({});
        c0->append_datum({values[1]});
        c0->append_datum({});
...
PARALLEL_TEST(ConvertHelperTest, testDateV2ToDateColumn) {
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DATE, false);
        c0->append_datum({values[0]});
        c0->append_datum({values[1]});
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DATE, true);
        c0->append_datum({values[0]});
        c0->append_datum({});
        c0->append_datum({values[1]});
        c0->append_datum({});
...
PARALLEL_TEST(ConvertHelperTest, testDatetimeToTimestampColumn) {
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DATETIME_V1, false);
        c0->append_datum({values[0]});
        c0->append_datum({values[1]});
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DATETIME_V1, true);
        c0->append_datum({values[0]});
        c0->append_datum({});
        c0->append_datum({values[1]});
        c0->append_datum({});
...
PARALLEL_TEST(ConvertHelperTest, testTimestampToDatetimeColumn) {
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DATETIME, false);
        c0->append_datum({values[0]});
        c0->append_datum({values[1]});
    ...
    {
        auto c0 = ChunkFactory::column_from_field_type(TYPE_DATETIME, true);
        c0->append_datum({values[0]});
        c0->append_datum({});
        c0->append_datum({values[1]});
        c0->append_datum({});
...
static void test_convert_same_numeric_types() {
    ...
    auto c0 = ChunkFactory::column_from_field_type(field_type, false);
    c0->append_datum({values[0]});
    c0->append_datum({values[1]});
    c0->append_datum({values[2]});
    c0->append_datum({values[3]});
...
PARALLEL_TEST(ConvertHelperTest, testSameTypeConvertColumn_VARCHAR) {
    ...
    auto c0 = ChunkFactory::column_from_field_type(TYPE_VARCHAR, false);
    c0->append_datum({values[0]});
    c0->append_datum({values[1]});
    c0->append_datum({values[2]});
    c0->append_datum({values[3]});
...
PARALLEL_TEST(ConvertHelperTest, testSameTypeConvertColumn_DOUBLE) {
    ...
    auto c0 = ChunkFactory::column_from_field_type(TYPE_DOUBLE, false);
    c0->append_datum({values[0]});
    c0->append_datum({values[1]});
    c0->append_datum({values[2]});
    c0->append_datum({values[3]});
