...
TEST_F(ChunkHelperTest, reject_if_over_capacity_accepts_an_ordinary_chunk) {
    ...
    // holding its elements. On this branch those offsets are uint32; constructing a genuinely
    // over-capacity chunk would require more than 4GB and is not suitable for a unit test.
