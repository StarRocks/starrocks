...
//   https://github.com/apache/incubator-doris/blob/master/be/test/olap/skiplist_test.cpp
...
public:
    ...
    explicit TestState(int s) : _seed(s), _quit_flag(NULL), _state(STARTING), _cv_state() {}
