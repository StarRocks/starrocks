...
PARALLEL_TEST(PrimaryIndexTest, test_composite_key) {
    ...
    PrimaryKeyEncoder::create_column(*schema, &pk_column, PrimaryKeyEncodingType::V1);
    PrimaryKeyEncoder::encode(*schema, *chunk, 0, chunk->num_rows(), pk_column.get(), PrimaryKeyEncodingType::V1);
