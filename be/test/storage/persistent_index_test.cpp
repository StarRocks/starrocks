...
PARALLEL_TEST(PersistentIndexTest, test_fixlen_mutable_index) {
    ...
    vector<IndexValue> erase_old_values(erase_keys.size(), IndexValue(NullIndexValue));
...
PARALLEL_TEST(PersistentIndexTest, test_keep_del_in_minor_compact) {
...
PARALLEL_TEST(PersistentIndexTest, test_keep_del_in_minor_compact2) {
    int64_t old_config = config::l0_max_mem_usage;
    config::l0_max_mem_usage = 100;
    FileSystem* fs = FileSystem::Default();
...
PARALLEL_TEST(PersistentIndexTest, test_snapshot_with_minor_compact) {
    int64_t old_config = config::l0_max_mem_usage;
