...
#include "schema_scanner/schema_events_scanner.h"
#include "schema_scanner/schema_statistics_scanner.h"
#include "schema_scanner/schema_triggers_scanner.h"
...
TEST(SchemaScannersTest, DummyScannerAlwaysReturnsEos) {
...
TEST(SchemaScannersTest, CharsetsScannerReturnsStaticCharsetRow) {
...
TEST(SchemaScannersTest, CollationsScannerReturnsStaticCollationRow) {
...
TEST(SchemaScannersTest, CollationCharacterSetApplicabilityScannerMirrorsCollations) {
...
TEST(SchemaScannersTest, DescriptorOnlyScannersExposeStableSchemas) {
    ObjectPool pool;
...
TEST(SchemaScannersTest, ColumnFillerHandlesNullableAndNonNullableColumns) {
