...
static void test_array_column_view_helper(bool nullable, bool append_default, std::vector<uint32_t> selection,
    ...
    auto opt_array_column_view = ColumnViewHelper::create_column_view(type_desc, nullable);
...
PARALLEL_TEST(ColumnViewTest, test_not_nullable_with_append_default) {
    ...
    test_array_column_view_helper(false, true, selection,
...
PARALLEL_TEST(ColumnViewTest, test_not_nullable_without_append_default) {
    ...
    test_array_column_view_helper(false, false, selection, "[[1,2,3,4], [8], [9,10], [12,13], [15,16]]");
}
...
PARALLEL_TEST(ColumnViewTest, test_create_struct_column_view) {
    ...
    for (auto nullable : {true, false}) {
        auto opt_struct_column_view = ColumnViewHelper::create_column_view(type_desc, nullable);
...
PARALLEL_TEST(ColumnViewTest, test_create_json_column_view) {
    ...
    for (auto nullable : {true, false}) {
        auto opt_json_column_view = ColumnViewHelper::create_column_view(type_desc, nullable);
...
PARALLEL_TEST(ColumnViewTest, test_create_binary_column_view) {
    for (auto ltype : {LogicalType::TYPE_VARBINARY, LogicalType::TYPE_VARCHAR, LogicalType::TYPE_CHAR}) {
        for (auto nullable : {true, false}) {
            ...
            auto opt_binary_column_view = ColumnViewHelper::create_column_view(type_desc, nullable);
...
PARALLEL_TEST(ColumnViewTest, test_create_map_column_view) {
    ...
    type_desc.children.push_back(field2_type_desc);
    for (auto nullable : {true, false}) {
        auto opt_map_column_view = ColumnViewHelper::create_column_view(type_desc, nullable);
