...
TEST(FieldTest, test_construct1) {
    FieldPtr field1 = std::make_shared<Field>(1, "c1", get_type_info(LOGICAL_TYPE_INT), OLAP_FIELD_AGGREGATION_MAX,
                                              10, true, false);
    ...
    FieldPtr field2 = std::make_shared<Field>(2, "c2", get_type_info(LOGICAL_TYPE_VARCHAR),
