...
PARALLEL_TEST(ArrayColumnTest, test_empty_null_array) {
    ...
    auto res = column->empty_null_complex_column(null_map->get_data(), column->offsets_column()->get_data());
    ASSERT_FALSE(res);
    ASSERT_EQ(2, column->size());
    ASSERT_EQ("[1,2,3]", column->debug_item(0));
    ASSERT_EQ("[4,5,6]", column->debug_item(1));
    ...
    res = column->empty_null_complex_column(null_map->get_data(), column->offsets_column()->get_data());
    ASSERT_TRUE(res);
    ASSERT_EQ(2, column->size());
