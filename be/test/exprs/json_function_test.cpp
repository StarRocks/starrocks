...
//   https://github.com/apache/incubator-doris/blob/master/be/test/exprs/json_function_test.cpp
...
TEST_F(JsonFunctionTest, string) {
    ...
    rapidjson::Value* res1 =
            JsonFunctions::get_json_object(nullptr, json_string, path_string, JSON_FUN_STRING, &document1);
    ...
    rapidjson::Value* res2 =
            JsonFunctions::get_json_object(nullptr, json_string2, path_string2, JSON_FUN_STRING, &document2);
    ...
    rapidjson::Value* res3 =
            JsonFunctions::get_json_object(nullptr, json_string3, path_string3, JSON_FUN_STRING, &document3);
    ...
    rapidjson::Value* res4 =
            JsonFunctions::get_json_object(nullptr, json_string4, path_string4, JSON_FUN_STRING, &document4);
    ...
    rapidjson::Value* res5_1 =
            JsonFunctions::get_json_object(nullptr, json_string5, path_string5_1, JSON_FUN_STRING, &document5_1);
    ...
    rapidjson::Value* res5_2 =
            JsonFunctions::get_json_object(nullptr, json_string5, path_string5_2, JSON_FUN_STRING, &document5_2);
    ...
    rapidjson::Value* res5_3 =
            JsonFunctions::get_json_object(nullptr, json_string5, path_string5_3, JSON_FUN_STRING, &document5_2);
...
TEST_F(JsonFunctionTest, int) {
    ...
    rapidjson::Value* res = JsonFunctions::get_json_object(nullptr, json_string, path_string, JSON_FUN_INT, &document);
    ...
    rapidjson::Document document1;
    rapidjson::Value* res1 =
            JsonFunctions::get_json_object(nullptr, json_string1, path_string1, JSON_FUN_INT, &document1);
    ...
    rapidjson::Document document2;
    rapidjson::Value* res2 =
            JsonFunctions::get_json_object(nullptr, json_string2, path_string2, JSON_FUN_INT, &document2);
    ...
    rapidjson::Value* res3_1 =
            JsonFunctions::get_json_object(nullptr, json_string3, path_string3_1, JSON_FUN_INT, &document3_1);
    ASSERT_TRUE(res3_1 == nullptr);

    std::string path_string3_2("$.couponFee");
    rapidjson::Document document3_2;
    rapidjson::Value* res3_2 =
            JsonFunctions::get_json_object(nullptr, json_string3, path_string3_2, JSON_FUN_INT, &document3_2);
...
TEST_F(JsonFunctionTest, double) {
    ...
    rapidjson::Document document;
    rapidjson::Value* res =
            JsonFunctions::get_json_object(nullptr, json_string, path_string, JSON_FUN_DOUBLE, &document);
    ASSERT_EQ(res->GetDouble(), 123000.789);

    std::string path_string2("$.age");
    rapidjson::Document document2;
    rapidjson::Value* res2 =
            JsonFunctions::get_json_object(nullptr, json_string, path_string2, JSON_FUN_DOUBLE, &document2);
...
TEST_F(JsonFunctionTest, special_char) {
    ...
    rapidjson::Document document2;
    rapidjson::Value* res2 =
            JsonFunctions::get_json_object(nullptr, json_string2, path_string2, JSON_FUN_DOUBLE, &document2);
    ...
    rapidjson::Document document3;
    rapidjson::Value* res3 =
            JsonFunctions::get_json_object(nullptr, json_string3, path_string3, JSON_FUN_DOUBLE, &document3);
...
TEST_F(JsonFunctionTest, json_path_get_nullobject) {
    ...
    rapidjson::Value* res3 =
            JsonFunctions::get_json_array_from_parsed_json("$.[*].b", &jsonDoc, jsonDoc.GetAllocator());
    ASSERT_TRUE(res3->IsArray());
...
TEST_F(JsonFunctionTest, json_path_test) {
    {
        ...
        rapidjson::Value* res3 =
                JsonFunctions::get_json_array_from_parsed_json("$.[*].a", &jsonDoc, jsonDoc.GetAllocator());
        ASSERT_TRUE(res3->IsArray());
