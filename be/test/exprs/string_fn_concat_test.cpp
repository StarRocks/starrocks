...
static inline void concat_not_const_test(const NullColumnPtr& null_col, const ColumnPtr& col0, const ColumnPtr& col1,
    ...
    concat_not_const_test(
            null_col, {NullableColumn::create(col0->assume_mutable(), null_col->assume_mutable()), col1, col2, col3}, 0,
            limit);
    /*
    concat_not_const_test(null_col, {col1, NullableColumn::create(col0->assume_mutable(), null_col->assume_mutable()), col2, col3}, 1,
                          limit);
    concat_not_const_test(null_col, {col1, col2, NullableColumn::create(col0->assume_mutable(), null_col->assume_mutable()), col3}, 2,
                          limit);
    concat_not_const_test(null_col, {col1, col2, col3, NullableColumn::create(col0->assume_mutable(), null_col->assume_mutable())}, 3,
                          limit);
    */
    concat_not_const_test(
            null_col, {col0, NullableColumn::create(col1->assume_mutable(), null_col->assume_mutable()), col2, col3}, 0,
            limit);
    /*
    concat_not_const_test(null_col, {col0, col1, NullableColumn::create(std::move(col2), null_col->assume_mutable()), col3}, 0,
                          limit);
    concat_not_const_test(null_col, {col0, col1, col2, NullableColumn::create(std::move(col3), null_col->assume_mutable())}, 0,
                          limit);
    */
    concat_not_const_test(
            null_col, {NullableColumn::create(col1->assume_mutable(), null_col->assume_mutable()), col0, col2, col3}, 1,
            limit);
    /*
    concat_not_const_test(null_col, {col1, NullableColumn::create(std::move(col2), null_col->assume_mutable()), col0, col3}, 2,
                          limit);
    concat_not_const_test(null_col, {col1, col2, NullableColumn::create(std::move(col3), null_col->assume_mutable()), col0}, 3,
                          limit);
    */
}
...
static inline void concat_ws_test(const NullColumnPtr& sep_null_col, const NullColumnPtr& null_col,
                                  ...
                                  const ColumnPtr& col2, const ColumnPtr& col3, const size_t limit) {
    ColumnPtr nullable_sep_col = NullableColumn::create(sep_col->assume_mutable(), sep_null_col->assume_mutable());
    concat_ws_test(sep_null_col, null_col, sep_col,
                   {nullable_sep_col, NullableColumn::create(col0->assume_mutable(), null_col->assume_mutable()), col1,
                    col2, col3},
                   1, limit);
    /*
    concat_ws_test(sep_null_col, null_col, sep_col,
                   {nullable_sep_col, col1, NullableColumn::create(col0->assume_mutable(), null_col->assume_mutable()), col2, col3}, 2,
                   limit);
    concat_ws_test(sep_null_col, null_col, sep_col,
                   {nullable_sep_col, col1, col2, NullableColumn::create(col0->assume_mutable(), null_col->assume_mutable()), col3}, 3,
                   limit);
    */
    concat_ws_test(sep_null_col, null_col, sep_col,
                   {nullable_sep_col, col1, col2, col3,
                    NullableColumn::create(col0->assume_mutable(), null_col->assume_mutable())},
                   4, limit);

    concat_ws_test(
            sep_null_col, null_col, sep_col,
            {nullable_sep_col, col0, NullableColumn::create(std::move(col1), null_col->assume_mutable()), col2, col3},
            1, limit);
    /*
    concat_ws_test(sep_null_col, null_col, sep_col,
                   {nullable_sep_col, col0, col1, NullableColumn::create(std::move(col2), null_col->assume_mutable()), col3}, 1,
                   limit);
    concat_ws_test(sep_null_col, null_col, sep_col,
                   {nullable_sep_col, col0, col1, col2, NullableColumn::create(std::move(col3), null_col->assume_mutable())}, 1,
                   limit);
    */
    concat_ws_test(
            sep_null_col, null_col, sep_col,
            {nullable_sep_col, NullableColumn::create(std::move(col1), null_col->assume_mutable()), col0, col2, col3},
            2, limit);
    /*
    concat_ws_test(sep_null_col, null_col, sep_col,
                   {nullable_sep_col, col1, NullableColumn::create(std::move(col2), null_col->assume_mutable()), col0, col3}, 3,
                   limit);
    concat_ws_test(sep_null_col, null_col, sep_col,
                   {nullable_sep_col, col1, col2, NullableColumn::create(std::move(col3), null_col->assume_mutable()), col0}, 4,
                   limit);
    */
}
