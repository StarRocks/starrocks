...
TEST_F(VectorizedCastExprTest, IntCastToDate) {
...

    {
        ...
        // error cast
        ASSERT_EQ(nullptr, ColumnHelper::as_column<Int64Column>(ptr));
    }
}
...
TEST_F(VectorizedCastExprTest, BigIntCastToTimestamp) {
...

    {
        ...
        auto v = ColumnHelper::as_column<TimestampColumn>(ptr);
        ASSERT_EQ(10, v->size());
...
TEST_F(VectorizedCastExprTest, BigIntCastToTimestampError) {
...

    {
        ...
        // error cast
        ASSERT_EQ(nullptr, ColumnHelper::as_column<TimestampColumn>(ptr));
    }
}
...
TEST_F(VectorizedCastExprTest, intToBigIntCastExpr) {
...

    {
        ...
        // right cast
        auto v = ColumnHelper::as_column<Int64Column>(ptr);
        ASSERT_EQ(10, v->size());
        ...
        // error cast
        ASSERT_EQ(nullptr, ColumnHelper::as_column<Int8Column>(ptr));
    }
}
...
TEST_F(VectorizedCastExprTest, NullableBooleanCastExpr) {
...

    {
        ...
        // right cast
        auto v = ColumnHelper::as_column<BooleanColumn>(ColumnHelper::as_column<NullableColumn>(ptr)->data_column());
        ASSERT_EQ(10, v->size());
...
TEST_F(VectorizedCastExprTest, dateCastToDecimalV2) {
...

    {
        ...
        // right cast
        auto v = ColumnHelper::as_column<DecimalColumn>(ptr);
        ASSERT_EQ(10, v->size());
...
TEST_F(VectorizedCastExprTest, decimalCastString) {
...

    {
        ...
        // right cast
        auto v = ColumnHelper::as_column<BinaryColumn>(ptr);
        ASSERT_EQ(10, v->size());
...
TEST_F(VectorizedCastExprTest, stringCastToTime) {
...

    {
        ...
        // right cast
        auto v = ColumnHelper::as_column<DoubleColumn>(ptr);
        ASSERT_EQ(10, v->size());
