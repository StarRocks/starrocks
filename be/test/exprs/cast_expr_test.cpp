...
TEST_F(VectorizedCastExprTest, json_to_struct) {
    ...
    EXPECT_EQ("{col1:1.1,col2:2.2,col3:3.3}",
              cast_json_to_struct(cast_expr,
    ...
    EXPECT_EQ("{star:'rocks',number:1}",
              cast_json_to_struct(cast_expr,
                                  {TYPE_VARCHAR, TYPE_INT},
                                  {"star", "number"},
                                  R"({"star": "rocks", "number": 1})"));
    EXPECT_EQ("{number:1,star:'rocks'}",
              cast_json_to_struct(cast_expr,
                                  {TYPE_INT, TYPE_VARCHAR},
                                  {"number", "star"},
                                  R"({"star": "rocks", "number": 1})"));
