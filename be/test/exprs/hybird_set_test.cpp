...
//   https://github.com/apache/incubator-doris/blob/master/be/test/exprs/hybird_set_test.cpp
...
TEST_F(HybirdSetTest, bool) {
    std::unique_ptr<HybirdSetBase> set(HybirdSetBase::create_set(TYPE_BOOLEAN));
    bool a = true;
    set->insert(&a);
    a = false;
    set->insert(&a);
...
TEST_F(HybirdSetTest, tinyint) {
    std::unique_ptr<HybirdSetBase> set(HybirdSetBase::create_set(TYPE_TINYINT));
    int8_t a = 0;
    set->insert(&a);
    a = 1;
    set->insert(&a);
...
TEST_F(HybirdSetTest, smallint) {
    std::unique_ptr<HybirdSetBase> set(HybirdSetBase::create_set(TYPE_SMALLINT));
    int16_t a = 0;
    set->insert(&a);
    a = 1;
    set->insert(&a);
...
TEST_F(HybirdSetTest, int) {
    std::unique_ptr<HybirdSetBase> set(HybirdSetBase::create_set(TYPE_INT));
    int32_t a = 0;
    set->insert(&a);
    a = 1;
    set->insert(&a);
...
TEST_F(HybirdSetTest, bigint) {
    std::unique_ptr<HybirdSetBase> set(HybirdSetBase::create_set(TYPE_BIGINT));
    int64_t a = 0;
    set->insert(&a);
    a = 1;
    set->insert(&a);
...
TEST_F(HybirdSetTest, float) {
    std::unique_ptr<HybirdSetBase> set(HybirdSetBase::create_set(TYPE_FLOAT));
    float a = 0;
    set->insert(&a);
    a = 1.1;
    set->insert(&a);
...
TEST_F(HybirdSetTest, double) {
    std::unique_ptr<HybirdSetBase> set(HybirdSetBase::create_set(TYPE_DOUBLE));
    double a = 0;
    set->insert(&a);
    a = 1.1;
    set->insert(&a);
...
TEST_F(HybirdSetTest, string) {
    std::unique_ptr<HybirdSetBase> set(HybirdSetBase::create_set(TYPE_VARCHAR));
    StringValue a;
...
TEST_F(HybirdSetTest, timestamp) {
    std::unique_ptr<HybirdSetBase> set(HybirdSetBase::create_set(TYPE_DATETIME));
