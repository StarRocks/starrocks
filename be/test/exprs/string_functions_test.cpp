...
//   https://github.com/apache/incubator-doris/blob/master/be/test/exprs/string_functions_test.cpp
...
TEST_F(StringFunctionsTest, money_format_bigint) {
    ...
    StringVal result = StringFunctions::money_format(context, starrocks_udf::BigIntVal(123456));
    StringVal expected = AnyValUtil::from_string_temp(context, std::string("123,456.00"));
    ASSERT_EQ(expected, result);

    result = StringFunctions::money_format(context, starrocks_udf::BigIntVal(-123456));
    expected = AnyValUtil::from_string_temp(context, std::string("-123,456.00"));
    ASSERT_EQ(expected, result);

    result = StringFunctions::money_format(context, starrocks_udf::BigIntVal(9223372036854775807));
...
TEST_F(StringFunctionsTest, money_format_large_int) {
    ...
    __int128 value;
    ss >> value;
    StringVal result = StringFunctions::money_format(context, starrocks_udf::LargeIntVal(value));
...
TEST_F(StringFunctionsTest, money_format_double) {
    ...
    StringVal result = StringFunctions::money_format(context, starrocks_udf::DoubleVal(1234.456));
    StringVal expected = AnyValUtil::from_string_temp(context, std::string("1,234.46"));
    ASSERT_EQ(expected, result);

    result = StringFunctions::money_format(context, starrocks_udf::DoubleVal(1234.45));
    expected = AnyValUtil::from_string_temp(context, std::string("1,234.45"));
    ASSERT_EQ(expected, result);

    result = StringFunctions::money_format(context, starrocks_udf::DoubleVal(1234.4));
    expected = AnyValUtil::from_string_temp(context, std::string("1,234.40"));
    ASSERT_EQ(expected, result);

    result = StringFunctions::money_format(context, starrocks_udf::DoubleVal(1234.454));
    expected = AnyValUtil::from_string_temp(context, std::string("1,234.45"));
    ASSERT_EQ(expected, result);
    delete context;
}
...
TEST_F(StringFunctionsTest, split_part) {
    ...
    ASSERT_EQ(StringVal::null(), StringFunctions::split_part(context, StringVal("hello word"), StringVal(" "), 3));
    ...
    ASSERT_EQ(AnyValUtil::from_string_temp(context, std::string("#234")),
...
TEST_F(StringFunctionsTest, ends_with) {
    starrocks_udf::FunctionContext* context = new starrocks_udf::FunctionContext();
    starrocks_udf::BooleanVal falseRet = starrocks_udf::BooleanVal(false);
    starrocks_udf::BooleanVal trueRet = starrocks_udf::BooleanVal(true);
    starrocks_udf::BooleanVal nullRet = starrocks_udf::BooleanVal::null();
    ...
    ASSERT_EQ(falseRet, StringFunctions::ends_with(context, StringVal("hello starrocks"), StringVal("hello")));

    ASSERT_EQ(trueRet, StringFunctions::ends_with(context, StringVal("hello starrocks"), StringVal("starrocks")));

    ASSERT_EQ(trueRet, StringFunctions::ends_with(context, StringVal("hello starrocks"), StringVal("hello starrocks")));
...
TEST_F(StringFunctionsTest, null_or_empty) {
    ...
    ASSERT_EQ(falseRet, StringFunctions::null_or_empty(context, StringVal("starrocks")));
...
TEST_F(StringFunctionsTest, substring) {
    ...
    ASSERT_EQ(AnyValUtil::from_string_temp(context, std::string("")),
              StringFunctions::substring(context, StringVal("hello"), 0, 3));
    ASSERT_EQ(AnyValUtil::from_string_temp(context, std::string("")),
              StringFunctions::substring(context, StringVal("hello"), 0, 0));
    delete context;
}

TEST_F(StringFunctionsTest, reverse) {
    FunctionUtils fu;
    starrocks_udf::FunctionContext* context = fu.get_fn_ctx();
    ...
    ASSERT_EQ(AnyValUtil::from_string_temp(context, std::string("")), StringFunctions::reverse(context, StringVal("")));
...
TEST_F(StringFunctionsTest, append_trailing_char_if_absent) {
    ASSERT_EQ(StringVal("ac"), StringFunctions::append_trailing_char_if_absent(ctx, StringVal("a"), StringVal("c")));

    ASSERT_EQ(StringVal("c"), StringFunctions::append_trailing_char_if_absent(ctx, StringVal("c"), StringVal("c")));

    ASSERT_EQ(StringVal("123c"),
              StringFunctions::append_trailing_char_if_absent(ctx, StringVal("123c"), StringVal("c")));

    ASSERT_EQ(StringVal("c"), StringFunctions::append_trailing_char_if_absent(ctx, StringVal(""), StringVal("c")));

    ASSERT_EQ(StringVal::null(),
              StringFunctions::append_trailing_char_if_absent(ctx, StringVal::null(), StringVal("c")));

    ASSERT_EQ(StringVal::null(),
              StringFunctions::append_trailing_char_if_absent(ctx, StringVal("a"), StringVal::null()));

    ASSERT_EQ(StringVal::null(),
              StringFunctions::append_trailing_char_if_absent(ctx, StringVal("a"), StringVal("abc")));
}
...
TEST_F(StringFunctionsTest, lpad) {
    ...
    ASSERT_EQ(StringVal("g8%7IgY%AHx7luNtf8Kh"),
              StringFunctions::lpad(ctx, StringVal("g8%7IgY%AHx7luNtf8Kh"), IntVal(20), StringVal("")));
    ...
    ASSERT_EQ(StringVal("h"), StringFunctions::lpad(ctx, StringVal("hi"), IntVal(1), StringVal("")));
    ASSERT_EQ(StringVal(), StringFunctions::lpad(ctx, StringVal("hi"), IntVal(5), StringVal("")));
...
TEST_F(StringFunctionsTest, rpad) {
    ...
    ASSERT_EQ(StringVal("g8%7IgY%AHx7luNtf8Kh"),
              StringFunctions::rpad(ctx, StringVal("g8%7IgY%AHx7luNtf8Kh"), IntVal(20), StringVal("")));
    ...
    ASSERT_EQ(StringVal("h"), StringFunctions::rpad(ctx, StringVal("hi"), IntVal(1), StringVal("")));
    ASSERT_EQ(StringVal(), StringFunctions::rpad(ctx, StringVal("hi"), IntVal(5), StringVal("")));
