...
//   https://github.com/apache/incubator-doris/blob/master/be/test/runtime/load_channel_mgr_test.cpp
...
TEST_F(LoadChannelMgrTest, check_builder) {
    TDescriptorTableBuilder table_builder;
    {
        ...
        tuple.add_slot(TSlotDescriptorBuilder().type(TYPE_INT).column_name("c1").column_pos(0).build());
        tuple.add_slot(TSlotDescriptorBuilder().type(TYPE_BIGINT).column_name("c2").column_pos(1).build());
        tuple.add_slot(TSlotDescriptorBuilder().string_type(64).column_name("c3").column_pos(2).build());
...
TDescriptorTable create_descriptor_table() {
    ...
    tuple_builder.add_slot(TSlotDescriptorBuilder().type(TYPE_BIGINT).column_name("c2").column_pos(1).build());
