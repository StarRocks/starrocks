...
TEST_F(ParquetCLIReaderTest, ReadDataPageV2ParquetFiles) {
    std::vector<std::string> files = {
            ...
            // boolean values RLE-encoded (parquet-mr PARQUET_2_0 default, pyarrow data_page_version=2.0)
            "rle_boolean_v2_parquet_mr.parquet", "rle_boolean_v2_pyarrow.parquet"};
