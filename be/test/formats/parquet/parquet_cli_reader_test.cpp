...
TEST_F(ParquetCLIReaderTest, ReadDataPageV2ParquetFiles) {
    ...
    std::vector<std::string> files = {"data_page_v2_float10k.parquet", "data_page_v2_int1m.parquet",
                                      "data_page_v2_string4k.parquet", "data_page_v2_test.parquet",
                                      "data_page_v2_test2.parquet"};
