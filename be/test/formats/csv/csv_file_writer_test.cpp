...
TEST_F(CSVFileWriterTest, TestWriteArrayInt) {
    ...
    auto chunk = std::make_shared<Chunk>();
    {
        ...
        auto array_column = ArrayColumn::create(NullableColumn::create(elements_data, UInt8Column::create(6, 0)),
                                                offsets);
...
TEST_F(CSVFileWriterTest, TestWriteArrayBigInt) {
    ...
    auto chunk = std::make_shared<Chunk>();
    {
        ...
        auto array_column = ArrayColumn::create(NullableColumn::create(elements_data, UInt8Column::create(3, 0)),
                                                offsets);
...
TEST_F(CSVFileWriterTest, TestWriteNestedArray) {
    ...
    auto chunk = std::make_shared<Chunk>();
    {
        ...
        auto inner_array = ArrayColumn::create(
                NullableColumn::create(inner_elements, UInt8Column::create(4, 0)), inner_offsets);
        ...
        auto outer_array = ArrayColumn::create(
                NullableColumn::create(inner_array, UInt8Column::create(3, 0)), outer_offsets);
