...
//   https://github.com/apache/incubator-doris/blob/master/be/test/exec/broker_scanner_test.cpp
...
void BrokerScannerTest::init_params() {
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        cast_expr.fn.scalar_fn.symbol = "starrocks::CastFunctions::cast_to_int_val";
