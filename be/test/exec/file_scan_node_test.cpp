...
//   https://github.com/apache/incubator-doris/blob/master/be/test/exec/file_scan_node_test.cpp
...
void FileScanNodeTest::init_desc_table() {
...
TEST_F(FileScanNodeTest, normal) {
