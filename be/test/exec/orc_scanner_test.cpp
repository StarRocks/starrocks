...
//   https://github.com/apache/incubator-doris/blob/master/be/test/exec/orc_scanner_test.cpp
...
TEST_F(OrcScannerTest, normal) {
    ...
    //col6 varchar -> float
    {
        ...
        cast_expr.fn.__set_signature("casttoint(VARCHAR(*))");
        cast_expr.fn.__isset.scalar_fn = true;
        cast_expr.fn.scalar_fn.symbol = "starrocks::CastFunctions::cast_to_float_val";
    ...
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().type(TYPE_BIGINT).column_name("col1").column_pos(1).build());
    dest_tuple_builder.add_slot(
            TSlotDescriptorBuilder().string_type(65535).nullable(true).column_name("col2").column_pos(2).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().string_type(65535).column_name("col3").column_pos(3).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().type(TYPE_DOUBLE).column_name("col5").column_pos(4).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().type(TYPE_FLOAT).column_name("col6").column_pos(5).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().type(TYPE_INT).column_name("col7").column_pos(6).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().type(TYPE_INT).column_name("col8").column_pos(7).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().string_type(65535).column_name("col9").column_pos(8).build());
    ...
    ASSERT_EQ(Tuple::to_string(tuple, *_desc_tbl->get_tuple_descriptor(1)),
              "(0 null starrocks      1.567 1.567000031471252 12345 1 starrocks)");
    ASSERT_TRUE(scanner.get_next(tuple, &tuple_pool, &eof).ok());
    ASSERT_EQ(Tuple::to_string(tuple, *_desc_tbl->get_tuple_descriptor(1)),
              "(1 true starrocks      1.567 1.567000031471252 12345 1 starrocks)");
    ASSERT_FALSE(eof);
    for (int i = 2; i < 10; i++) {
        ASSERT_TRUE(scanner.get_next(tuple, &tuple_pool, &eof).ok());
    }
...
TEST_F(OrcScannerTest, normal3) {
...

    {
        for (int i = 0; i < 5; ++i) {
            ...
            cast_expr.fn.__isset.scalar_fn = true;
            cast_expr.fn.scalar_fn.symbol = "starrocks::DecimalOperators::cast_to_decimal_val";
...

        {
            ...
            cast_expr.fn.__isset.scalar_fn = true;
            cast_expr.fn.scalar_fn.symbol = "starrocks::CastFunctions::cast_to_tiny_int_val";
...

        {
            ...
            cast_expr.fn.__isset.scalar_fn = true;
            cast_expr.fn.scalar_fn.symbol = "starrocks::CastFunctions::cast_to_datetime_val";
        ...
        }
        {
            ...
            cast_expr.fn.__set_signature("casttoint(VARCHAR(*))");
            cast_expr.fn.__isset.scalar_fn = true;
            cast_expr.fn.scalar_fn.symbol = "starrocks::CastFunctions::cast_to_date_val";
    ...
    TTupleDescriptorBuilder dest_tuple_builder;
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().decimal_type(10, 9).column_name("col1").column_pos(1).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().decimal_type(7, 5).column_name("col2").column_pos(2).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().decimal_type(10, 9).column_name("col3").column_pos(3).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().decimal_type(10, 5).column_name("col4").column_pos(4).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().decimal_type(10, 5).column_name("col5").column_pos(5).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().type(TYPE_TINYINT).column_name("col6").column_pos(6).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().type(TYPE_DATETIME).column_name("col7").column_pos(7).build());
    dest_tuple_builder.add_slot(
            TSlotDescriptorBuilder().type(TYPE_DATE).nullable(true).column_name("col8").column_pos(8).build());
    dest_tuple_builder.add_slot(TSlotDescriptorBuilder().decimal_type(27, 9).column_name("col9").column_pos(9).build());
