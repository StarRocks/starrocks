...
//   https://github.com/apache/incubator-doris/blob/master/be/test/exec/plain_text_line_reader_lz4frame_test.cpp
...
TEST_F(PlainTextLineReaderTest, lz4_normal_use) {
    LocalFileReader file_reader("./be/test/exec/test_data/plain_text_line_reader/test_file.csv.lz4", 0);
