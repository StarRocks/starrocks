...
protected:
    void SetUp() override {
        ...
        _int_type = TypeDescriptor::from_primtive_type(TYPE_INT);
        _tinyint_type = TypeDescriptor::from_primtive_type(TYPE_TINYINT);
        _varchar_type = TypeDescriptor::from_primtive_type(TYPE_VARCHAR);
    }
