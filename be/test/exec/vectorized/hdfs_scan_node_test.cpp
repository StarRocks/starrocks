...
vectorized::ChunkPtr HdfsScanNodeTest::_create_chunk() {
    ...
    auto col2 = vectorized::ColumnHelper::create_column(TypeDescriptor::from_primtive_type(LogicalType::TYPE_BIGINT),
                                                        true);
    ...
    auto col4 = vectorized::ColumnHelper::create_column(
            TypeDescriptor::from_primtive_type(LogicalType::TYPE_DATETIME), true);
...
DescriptorTbl* HdfsScanNodeTest::_create_table_desc() {
    ...
    auto slot4 = slot_desc_builder.type(LogicalType::TYPE_DATETIME)
                         .column_name("col4")
                         .column_pos(3)
                         .nullable(true)
                         .build();
