...
ChunkPtr HdfsScanNodeTest::_create_chunk() {
    ...
    auto col1 = ColumnHelper::create_column(TypeDescriptor::from_primtive_type(PrimitiveType::TYPE_INT), true);
    auto col2 = ColumnHelper::create_column(TypeDescriptor::from_primtive_type(PrimitiveType::TYPE_BIGINT), true);
    auto col3 = ColumnHelper::create_column(TypeDescriptor::from_primtive_type(PrimitiveType::TYPE_VARCHAR), true);
    auto col4 = ColumnHelper::create_column(TypeDescriptor::from_primtive_type(PrimitiveType::TYPE_DATETIME), true);
