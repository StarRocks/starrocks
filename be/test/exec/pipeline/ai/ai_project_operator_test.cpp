...
OperatorPair create_operator_pair(AIBufferSinkOperatorFactory* sink_factory, AISourceOperatorFactory* source_factory,
                                  RuntimeState* state) {
    OperatorPair pair;
...
TEST(AIProjectOperatorTest, PendingSinkChunkIsRetriedBeforeFinishingPublishesEos) {
    ...
    AIBufferSinkOperatorFactory sink_factory(1, 7, processor);
