...
PARALLEL_TEST(QuerySharedDriverQueueTest, test_basic) {
    ...
    auto driver71 = std::make_shared<PipelineDriver>(_gen_operators(), query_context.query_runtime_state(), nullptr,
                                                     nullptr, nullptr, -1);
    _set_driver_level(driver71.get(), 7);
    driver71->driver_acct().update_last_time_spent(5'000'000L * 1);

    auto driver72 = std::make_shared<PipelineDriver>(_gen_operators(), query_context.query_runtime_state(), nullptr,
                                                     nullptr, nullptr, -1);
    ...
    auto driver61 = std::make_shared<PipelineDriver>(_gen_operators(), query_context.query_runtime_state(), nullptr,
                                                     nullptr, nullptr, -1);
    ...
    auto driver51 = std::make_shared<PipelineDriver>(_gen_operators(), query_context.query_runtime_state(), nullptr,
                                                     nullptr, nullptr, -1);
...
PARALLEL_TEST(QuerySharedDriverQueueTest, test_cancel) {
    ...
    // prepare drivers
    auto driver1 = std::make_shared<PipelineDriver>(_gen_operators(), nullptr, nullptr, nullptr, nullptr, -1);
    _set_driver_level(driver1.get(), 1);
    auto driver2 = std::make_shared<PipelineDriver>(_gen_operators(), nullptr, nullptr, nullptr, nullptr, -1);
    _set_driver_level(driver2.get(), 1);
    auto driver3 = std::make_shared<PipelineDriver>(_gen_operators(), nullptr, nullptr, nullptr, nullptr, -1);
    _set_driver_level(driver3.get(), 1);
    auto driver4 = std::make_shared<PipelineDriver>(_gen_operators(), nullptr, nullptr, nullptr, nullptr, -1);
...
PARALLEL_TEST(QuerySharedDriverQueueTest, test_take_block) {
    ...
    // Prepare drivers.
    QueryContext query_context;
    auto driver1 = std::make_shared<PipelineDriver>(_gen_operators(), query_context.query_runtime_state(), nullptr,
                                                    nullptr, nullptr, -1);
    _set_driver_level(driver1.get(), 1);
...
TEST_F(WorkGroupDriverQueueTest, test_basic) {
    ...
    auto driver271 = std::make_shared<PipelineDriver>(_gen_operators(), query_ctx.query_runtime_state(), nullptr,
                                                      nullptr, nullptr, -1);
    ...
    auto driver272 = std::make_shared<PipelineDriver>(_gen_operators(), query_ctx.query_runtime_state(), nullptr,
                                                      nullptr, nullptr, -1);
    ...
    auto driver261 = std::make_shared<PipelineDriver>(_gen_operators(), query_ctx.query_runtime_state(), nullptr,
                                                      nullptr, nullptr, -1);
    ...
    auto driver251 = std::make_shared<PipelineDriver>(_gen_operators(), query_ctx.query_runtime_state(), nullptr,
                                                      nullptr, nullptr, -1);
    ...
    auto driver1 = std::make_shared<PipelineDriver>(_gen_operators(), query_ctx.query_runtime_state(), nullptr, nullptr,
                                                    nullptr, -1);
    _set_driver_level(driver1.get(), 1);
    ...
    auto driver3 = std::make_shared<PipelineDriver>(_gen_operators(), query_ctx.query_runtime_state(), nullptr, nullptr,
                                                    nullptr, -1);
    ...
    auto driver4 = std::make_shared<PipelineDriver>(_gen_operators(), query_ctx.query_runtime_state(), nullptr, nullptr,
                                                    nullptr, -1);
...
TEST_F(WorkGroupDriverQueueTest, test_take_uses_injected_policy) {
    ...
    auto driver = std::make_shared<PipelineDriver>(_gen_operators(), query_ctx.query_runtime_state(), nullptr, nullptr,
                                                   nullptr, -1);
