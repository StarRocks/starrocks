...
>>>>>>> 77baf33881 ([BugFix] Fix otel SIGSEGV on cancelled load: idempotent close_wait + opentelemetry-cpp 1.9.1 (#76869)):be/test/data_sink/tablet/olap_table_sink_test.cpp
