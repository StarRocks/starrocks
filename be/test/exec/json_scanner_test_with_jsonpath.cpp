...
//   https://github.com/apache/incubator-doris/blob/master/be/test/exec/json_scanner_test_with_jsonpath.cpp
...
class JsonScannerTest2 : public testing::Test {
public:
    JsonScannerTest2() : _runtime_state(TQueryGlobals()) {
        init();
...
int JsonScannerTest2::create_src_tuple(TDescriptorTable& t_desc_table, int next_slot_id) {
...
int JsonScannerTest2::create_dst_tuple(TDescriptorTable& t_desc_table, int next_slot_id) {
...
void JsonScannerTest2::init_desc_table() {
...
void JsonScannerTest2::create_expr_info() {
...
TEST_F(JsonScannerTest2, normal) {
