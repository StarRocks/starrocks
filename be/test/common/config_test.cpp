...
TEST_F(ConfigTest, test_set_config) {
    ...
    ASSERT_TRUE(config::rollback_config("cfg_bool"));
    ASSERT_FALSE(cfg_bool);
    ...
    ASSERT_TRUE(config::rollback_config("cfg_double"));
    ASSERT_EQ(cfg_double, 123.456);
    ...
    ASSERT_TRUE(config::rollback_config("cfg_int16_t"));
    ASSERT_EQ(cfg_double, 2561);

    // int32
    ASSERT_EQ(cfg_int32_t, 65536123);
    ASSERT_TRUE(config::set_config("cfg_int32_t", "65536124").ok());
    ASSERT_EQ(cfg_int32_t, 65536124);
    ASSERT_TRUE(config::rollback_config("cfg_int32_t"));
    ASSERT_EQ(cfg_double, 65536123);
    ...
    ASSERT_TRUE(config::rollback_config("cfg_int64_t"));
    ASSERT_EQ(cfg_double, 4294967296123);
    ...
    ASSERT_TRUE(config::rollback_config("cfg_std_string_mutable"));
    ASSERT_EQ(cfg_std_string_mutable.value(), "starrocks_config_test_string_mutable");
