...
private:
    ...
    int64_t _current_adaptive_task_start_ns = 0;
    bool _current_adaptive_pending_has_output = false;
    bool _current_adaptive_pending_open_before_prepared = false;
    bool _current_adaptive_refined_has_output = false;
    bool _current_adaptive_pending_running_counted = false;
    lake::PreparedSegmentReadStatePtr _current_adaptive_prepared_segment_state = nullptr;
    ...
    RuntimeProfile::Counter* _lake_adaptive_seed_issued_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_final_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_estimated_fanout_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_build_state_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_init_options_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_prune_range_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_seek_bounds_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_tablet_bounds_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_schema_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_iterator_prune_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_split_tasks_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_column_iterator_init_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_key_range_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_bitmap_index_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_zone_map_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_bloom_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_gin_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_stats_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_bloom_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_bitmap_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_prepare_gin_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_reader_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_raw_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_seed_output_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_task_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_create_segment_iter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_segment_init_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_block_load_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_column_iterator_init_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_key_range_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_seek_bounds_cache_hit_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_seek_bounds_cache_miss_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_bitmap_index_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_zone_map_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_bloom_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_gin_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_stats_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_bloom_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_bitmap_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_gin_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_reader_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_wall_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_start_delay_after_ready_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_start_delay_after_ready_task_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_first_output_delay_after_ready_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_first_output_after_ready_task_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_raw_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_refined_output_rows_counter = nullptr;
    ...
    RuntimeProfile::Counter* _lake_adaptive_pending_open_before_prepared_task_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_open_before_prepared_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_open_before_prepared_reader_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_open_before_prepared_block_load_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_open_after_prepared_task_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_open_after_prepared_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_open_after_prepared_reader_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_open_after_prepared_block_load_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_open_after_seek_bounds_ready_task_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_open_before_seek_bounds_ready_task_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_create_segment_iter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_segment_init_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_block_load_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_column_iterator_init_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_key_range_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_seek_bounds_cache_hit_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_seek_bounds_cache_miss_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_bitmap_index_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_zone_map_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_bloom_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_gin_filter_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_stats_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_bloom_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_bitmap_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_gin_filtered_rows_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_reader_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_wall_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_before_refined_ready_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_after_refined_ready_timer = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_after_refined_ready_task_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_output_rows_before_refined_ready_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_output_rows_after_refined_ready_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_chunks_before_refined_ready_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_chunks_after_refined_ready_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_first_output_before_refined_ready_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_first_output_after_refined_ready_counter = nullptr;
    RuntimeProfile::Counter* _lake_adaptive_pending_running_at_refined_ready_counter = nullptr;
