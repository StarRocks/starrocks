...
void FileDataSource::_init_counter() {
    ...
    _scanner_total_timer = ADD_TIMER(_runtime_profile, "ScannerTotalTime");
    {
        ...
        _scanner_file_pipe_read_wait_timer = ADD_CHILD_TIMER(p, "FilePiepReadWaitTime", "FileReadTime");
        _scanner_file_pipe_read_process_timer = ADD_CHILD_TIMER(p, "FilePiepReadProcessTime", "FileReadTime");
        ...
        _scanner_file_pipe_write_wait_timer = ADD_CHILD_TIMER(p, "FilePiepWriteWaitTime", prefix);
        _scanner_file_pipe_write_process_timer = ADD_CHILD_TIMER(p, "FilePiepWriteProcessTime", prefix);
    }
}
...
void FileDataSource::_update_counter() {
    ...
    COUNTER_UPDATE(_scanner_file_pipe_read_wait_timer, _counter.file_pipe_read_wait_ns);
    COUNTER_UPDATE(_scanner_file_pipe_read_process_timer, _counter.file_pipe_read_process_ns);
    ...
    COUNTER_UPDATE(_scanner_file_pipe_write_wait_timer, _counter.file_pipe_write_wait_ns);
    COUNTER_UPDATE(_scanner_file_pipe_write_process_timer, _counter.file_pipe_write_process_ns);
}
