...
- Remediation: Keep ConnectorBenchmark limited to the benchgen connector implementation; move registration into Bootstrap and avoid pulling Connector, storage, service, or full Exec code into the connector library.
