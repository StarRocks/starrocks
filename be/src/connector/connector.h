...
public:
    ...
    void set_runtime_profile(RuntimeProfile* runtime_profile) {
        _runtime_profile = runtime_profile;
        _data_source_profile = runtime_profile->create_child("DataSource");
    }
...
protected:
    ...
    RuntimeProfile* _data_source_profile = nullptr;
