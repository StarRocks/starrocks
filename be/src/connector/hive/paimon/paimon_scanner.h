...
// Reads a Java-serialized Paimon DataSplit through paimon-cpp, converts the
// Arrow C Data batches to StarRocks chunks, then evaluates the regular
// StarRocks scan predicates for correctness.
