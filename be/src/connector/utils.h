...
public:
    ...
    static StatusOr<std::string> iceberg_make_partition_name(const std::vector<std::string>& partition_column_names,
    ...
    static std::string to_string_int128(int128_t value);
