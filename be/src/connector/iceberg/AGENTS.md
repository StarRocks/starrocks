...
- Allowed target deps: `ConnectorCommon`, `ConnectorPrimitive`, `Expr`, `Runtime`, `FormatCore`, `FormatParquet`, `Formats`, `FileSystem`, `ColumnSortCore`, `ChunkCore`, `ColumnCore`, `Types`, `Common`, `Base`, `Gutil`, `StarRocksGen`
