...
// The brpc default is 0 (sleep until the nearest task's run time), which strands tasks that are
// unscheduled long before their far-future deadline. Wake up at least once a second instead.
CONF_Int32(brpc_timer_max_wakeup_interval_ms, "1000");
