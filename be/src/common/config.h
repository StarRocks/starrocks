...
// To control whether cache raw data in memory.
// If true, the raw data will be written to disk directly and read from disk without promotion.
// For object data, such as parquet footer object, which can only be cached in memory are not affected
// by this configuration.
CONF_Bool(datacache_through_data_mode_enable, "false");
