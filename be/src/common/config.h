...
// This will cause FE to fail during deserialization when the returned result set is larger than 100M. And to support
// larger result sets, we set a default value close to 2G and the maximum configurable value is 2G - 1.
