...
CONF_mInt64(lake_pk_compaction_max_sstable_versions, "5");
CONF_mInt64(lake_memtable_max_mem_usage, /*100MB=*/"104857600");
CONF_mInt64(lake_pk_index_sst_cache_limit, /*100MB=*/"104857600");
