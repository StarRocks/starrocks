...
<<<<<<< HEAD:be/src/common/logconfig.cpp
...
>>>>>>> c2f305af63 ([BugFix] Force BE exit when the fatal-signal handler hangs after marking the process as crashing (#76491)):be/src/service/failure_handler.cpp
