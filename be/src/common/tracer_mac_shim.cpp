...
Span Tracer::start_trace(const std::string&) {
    return make_noop_span();
}

Span Tracer::start_trace_txn(const std::string&, int64_t) {
    return make_noop_span();
}

Span Tracer::start_trace_tablet(const std::string&, int64_t) {
    return make_noop_span();
}
...
Span Tracer::add_span(const std::string&, const Span&) {
    return make_noop_span();
}

Span Tracer::add_span(const std::string&, const SpanContext&) {
    return make_noop_span();
}
...
std::string Tracer::to_trace_parent(const SpanContext&) {
    return {};
}
