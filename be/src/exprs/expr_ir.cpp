...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/expr_ir.cpp
...
void dummy(starrocks_udf::FunctionContext*, starrocks_udf::BooleanVal*, starrocks_udf::TinyIntVal*,
           starrocks_udf::SmallIntVal*, starrocks_udf::IntVal*, starrocks_udf::BigIntVal*, starrocks_udf::FloatVal*,
           starrocks_udf::DoubleVal*, starrocks_udf::StringVal*, starrocks_udf::DateTimeVal*,
           starrocks_udf::DecimalVal*, starrocks::ExprContext*) {}
#endif
