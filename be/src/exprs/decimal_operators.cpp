...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/decimal_operators.cpp
...
#define CAST_INT_TO_DECIMAL(from_type)                                                                 \
    DecimalVal DecimalOperators::cast_to_decimal_val(FunctionContext* context, const from_type& val) { \
...
#define CAST_DECIMAL_TO_INT(to_type, type_name)                                                      \
    to_type DecimalOperators::cast_to_##type_name(FunctionContext* context, const DecimalVal& val) { \
...
DateTimeVal DecimalOperators::cast_to_datetime_val(FunctionContext* context, const DecimalVal& val) {
    if (val.is_null) {
...
#define DECIMAL_ARITHMETIC_OP(FN_NAME, OP)                                                                         \
    DecimalVal DecimalOperators::FN_NAME##_decimal_val_decimal_val(FunctionContext* context, const DecimalVal& v1, \
                                                                   const DecimalVal& v2) {                         \
...
#define DECIMAL_BINARY_PREDICATE_NONNUMERIC_FN(NAME, OP)                                                  \
    BooleanVal DecimalOperators::NAME##_decimal_val_decimal_val(FunctionContext* c, const DecimalVal& v1, \
                                                                const DecimalVal& v2) {                   \
