...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/binary_predicate.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXPRS_BINARY_PREDICATE_H
#define STARROCKS_BE_SRC_QUERY_EXPRS_BINARY_PREDICATE_H
