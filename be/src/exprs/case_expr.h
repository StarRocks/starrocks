...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/case_expr.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXPRS_CASE_EXPR_H
#define STARROCKS_BE_SRC_QUERY_EXPRS_CASE_EXPR_H
