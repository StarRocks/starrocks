...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/decimalv2_operators.cpp
...
#define CAST_INT_TO_DECIMAL(from_type)                                                                       \
    DecimalV2Val DecimalV2Operators::cast_to_decimalv2_val(FunctionContext* context, const from_type& val) { \
...
DecimalV2Val DecimalV2Operators::cast_to_decimalv2_val(FunctionContext* context, const FloatVal& val) {
    if (val.is_null) {
...
DecimalV2Val DecimalV2Operators::cast_to_decimalv2_val(FunctionContext* context, const DoubleVal& val) {
    if (val.is_null) {
        return DecimalV2Val::null();
    }
    DecimalV2Value dv;
...
DecimalV2Val DecimalV2Operators::cast_to_decimalv2_val(FunctionContext* context, const DateTimeVal& val) {
    if (val.is_null) {
        return DecimalV2Val::null();
    }
...
DecimalV2Val DecimalV2Operators::cast_to_decimalv2_val(FunctionContext* context, const StringVal& val) {
    if (val.is_null) {
        return DecimalV2Val::null();
    }
    DecimalV2Value dv;
...
#define CAST_DECIMAL_TO_INT(to_type, type_name)                                                          \
    to_type DecimalV2Operators::cast_to_##type_name(FunctionContext* context, const DecimalV2Val& val) { \
...
DateTimeVal DecimalV2Operators::cast_to_datetime_val(FunctionContext* context, const DecimalV2Val& val) {
    if (val.is_null) {
...
DateTimeVal DecimalV2Operators::cast_to_date_val(FunctionContext* context, const DecimalV2Val& val) {
    if (val.is_null) {
        return DateTimeVal::null();
    }
...
DecimalVal DecimalV2Operators::cast_to_decimal_val(FunctionContext* context, const DecimalV2Val& val) {
...
#define DECIMAL_BINARY_PREDICATE_NONNUMERIC_FN(NAME, OP)                                                          \
    BooleanVal DecimalV2Operators::NAME##_decimalv2_val_decimalv2_val(FunctionContext* c, const DecimalV2Val& v1, \
                                                                      const DecimalV2Val& v2) {                   \
