...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/cast_expr.cpp
...
#define CAST_FROM_BOOLEAN(TO_TYPE, TO_FN) CAST_FUNCTION(CastBooleanExpr, TO_TYPE, TO_FN, BooleanVal, get_boolean_val)
...
#define CAST_FROM_TINYINT(TO_TYPE, TO_FN) CAST_FUNCTION(CastTinyIntExpr, TO_TYPE, TO_FN, TinyIntVal, get_tiny_int_val)
...
#define CAST_FROM_INT(TO_TYPE, TO_FN) CAST_FUNCTION(CastIntExpr, TO_TYPE, TO_FN, IntVal, get_int_val)
...
#define CAST_FROM_BIGINT(TO_TYPE, TO_FN) CAST_FUNCTION(CastBigIntExpr, TO_TYPE, TO_FN, BigIntVal, get_big_int_val)
...
#define CAST_FROM_FLOAT(TO_TYPE, TO_FN) CAST_FUNCTION(CastFloatExpr, TO_TYPE, TO_FN, FloatVal, get_float_val)
...
#define CAST_FROM_DOUBLE(TO_TYPE, TO_FN) CAST_FUNCTION(CastDoubleExpr, TO_TYPE, TO_FN, DoubleVal, get_double_val)
