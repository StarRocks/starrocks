...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/agg_fn.h
...
#ifndef STARROCKS_BE_SRC_QUERY_NEW_EXPRS_AGG_FN_H
#define STARROCKS_BE_SRC_QUERY_NEW_EXPRS_AGG_FN_H
...
public:
    ...
    static Status Create(const TExpr& texpr, const RowDescriptor& row_desc,
                         ...
                         RuntimeState* state, AggFn** agg_fn) WARN_UNUSED_RESULT;
...
private:
    ...
    AggFn(const TExprNode& node, const SlotDescriptor& intermediate_slot_desc, const SlotDescriptor& output_slot_desc);
