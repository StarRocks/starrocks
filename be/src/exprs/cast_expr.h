...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/cast_expr.h
...
#ifndef STARROCKS_BE_SRC_EXPRS_CAST_EXPR_H
#define STARROCKS_BE_SRC_EXPRS_CAST_EXPR_H
