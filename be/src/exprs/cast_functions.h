...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/cast_functions.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXPRS_CAST_FUNCTIONS_H
#define STARROCKS_BE_SRC_QUERY_EXPRS_CAST_FUNCTIONS_H
