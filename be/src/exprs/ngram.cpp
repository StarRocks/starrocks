...
public:
    StatusOr<ColumnPtr> static ngram_search_impl(FunctionContext* context, const Columns& columns) {
        ...
        //
        // Test what get_const_value actually needs -- a ConstColumn over a non-nullable column --
        // rather than asking the FunctionContext whether it registered a constant: a caller can
        // hand over a perfectly good ConstColumn without registering it.
