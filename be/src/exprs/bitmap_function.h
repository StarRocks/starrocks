...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/bitmap_function.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXPRS_BITMAP_FUNCTION_H
#define STARROCKS_BE_SRC_QUERY_EXPRS_BITMAP_FUNCTION_H
...
public:
    ...
    template <typename T, typename ValType>
    static void bitmap_intersect_update(FunctionContext* ctx, const StringVal& src, const ValType& key, int num_key,
                                        const ValType* keys, const StringVal* dst);
    template <typename T>
...
#endif //STARROCKS_BE_SRC_QUERY_EXPRS_BITMAP_FUNCTION_H
