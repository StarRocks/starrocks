...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/decimalv2_operators.h
...
#ifndef STARROCKS_BE_SRC_EXPRS_DECIMAL_OPERATORS_H
#define STARROCKS_BE_SRC_EXPRS_DECIMAL_OPERATORS_H
...
public:
    ...
    static DecimalV2Val add_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&, const DecimalV2Val&);
    ...
    static DecimalV2Val multiply_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&,
                                                             const DecimalV2Val&);
    static DecimalV2Val divide_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&, const DecimalV2Val&);
    static DecimalV2Val mod_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&, const DecimalV2Val&);

    static BooleanVal eq_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&, const DecimalV2Val&);
    static BooleanVal ne_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&, const DecimalV2Val&);
    static BooleanVal gt_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&, const DecimalV2Val&);
    static BooleanVal lt_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&, const DecimalV2Val&);
    static BooleanVal ge_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&, const DecimalV2Val&);
    static BooleanVal le_decimalv2_val_decimalv2_val(FunctionContext*, const DecimalV2Val&, const DecimalV2Val&);
};
