...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/in_predicate.cpp
...
Status InPredicate::open(RuntimeState* state, ExprContext* context, FunctionContext::FunctionStateScope scope) {
...
Status InPredicate::prepare(RuntimeState* state, const RowDescriptor& row_desc, ExprContext* context) {
