...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/decimal_operators.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXPRS_DECIMAL_OPERATORS_H
#define STARROCKS_BE_SRC_QUERY_EXPRS_DECIMAL_OPERATORS_H
...
public:
    ...
    static DecimalVal add_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
    static DecimalVal subtract_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
    static DecimalVal multiply_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
    static DecimalVal divide_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
    static DecimalVal mod_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);

    static BooleanVal eq_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
    static BooleanVal ne_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
    static BooleanVal gt_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
    static BooleanVal lt_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
    static BooleanVal ge_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
    static BooleanVal le_decimal_val_decimal_val(FunctionContext*, const DecimalVal&, const DecimalVal&);
};
