...
<<<<<<< HEAD:be/src/exprs/runtime_filter.h
    using ContainerType =
...
>>>>>>> 31ad752273 ([Refactor] Use BinaryImmContainer as the immutable container of all binary column (#70701)):be/src/runtime/runtime_filter.h
