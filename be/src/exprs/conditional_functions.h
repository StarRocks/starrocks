...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/conditional_functions.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXPRS_CONDITIONAL_FUNCTIONS_H
#define STARROCKS_BE_SRC_QUERY_EXPRS_CONDITIONAL_FUNCTIONS_H
...
public:
    virtual ~IfNullExpr();
    virtual Expr* clone(ObjectPool* pool) const override { return pool->add(new IfNullExpr(*this)); }
...
public:
    virtual ~NullIfExpr();
    virtual Expr* clone(ObjectPool* pool) const override { return pool->add(new NullIfExpr(*this)); }
    virtual BooleanVal get_boolean_val(ExprContext* context, TupleRow* row);
    virtual TinyIntVal get_tiny_int_val(ExprContext* context, TupleRow* row);
    virtual SmallIntVal get_small_int_val(ExprContext* context, TupleRow* row);
    virtual IntVal get_int_val(ExprContext* context, TupleRow* row);
...
public:
    ...
    virtual Expr* clone(ObjectPool* pool) const override { return pool->add(new CoalesceExpr(*this)); }
    virtual BooleanVal get_boolean_val(ExprContext* context, TupleRow* row);
    virtual TinyIntVal get_tiny_int_val(ExprContext* context, TupleRow* row);
    virtual SmallIntVal get_small_int_val(ExprContext* context, TupleRow* row);
    virtual IntVal get_int_val(ExprContext* context, TupleRow* row);
