...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exprs/hybird_set.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXPRS_HYBIRD_SET_H
#define STARROCKS_BE_SRC_QUERY_EXPRS_HYBIRD_SET_H
...
public:
    ...
    public:
        Iterator(typename std::unordered_set<_iT>::iterator begin, typename std::unordered_set<_iT>::iterator end)
    ...
    IteratorBase* begin() { return _pool.add(new (std::nothrow) Iterator<T>(_set.begin(), _set.end())); }
...
public:
    ...
    class Iterator : public IteratorBase {
    public:
        Iterator(std::unordered_set<std::string>::iterator begin, std::unordered_set<std::string>::iterator end)
                : _begin(begin), _end(end) {}
        virtual ~Iterator() {}
        virtual bool has_next() const { return !(_begin == _end); }
    ...
    IteratorBase* begin() { return _pool.add(new (std::nothrow) Iterator(_set.begin(), _set.end())); }
...
#endif // STARROCKS_BE_SRC_QUERY_EXPRS_HYBIRD_SET_H
