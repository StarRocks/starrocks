...
StatusOr<ColumnPtr> BitmapFunctions::to_bitmap(FunctionContext* context, const Columns& columns) {
...
>>>>>>> 3684456677 ([Enhancement] Avoid repeated calculation of bitmap memory usage (#41767)):be/src/exprs/bitmap_functions.cpp
