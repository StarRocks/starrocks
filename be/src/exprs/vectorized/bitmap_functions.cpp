...
ColumnPtr BitmapFunctions::to_bitmap(FunctionContext* context, const starrocks::Columns& columns) {
...
ColumnPtr BitmapFunctions::bitmap_hash(FunctionContext* context, const starrocks::Columns& columns) {
    ColumnViewer<TYPE_VARCHAR> viewer(columns[0]);
...
ColumnPtr BitmapFunctions::bitmap_count(FunctionContext* context, const starrocks::Columns& columns) {
...
ColumnPtr BitmapFunctions::bitmap_empty(FunctionContext* context, const starrocks::Columns& columns) {
    BitmapValue bitmap;
    return ColumnHelper::create_const_column<TYPE_OBJECT>(&bitmap, 1);
}

ColumnPtr BitmapFunctions::bitmap_or(FunctionContext* context, const starrocks::Columns& columns) {
...
ColumnPtr BitmapFunctions::bitmap_and(FunctionContext* context, const starrocks::Columns& columns) {
    RETURN_IF_COLUMNS_ONLY_NULL(columns);
...
ColumnPtr BitmapFunctions::bitmap_to_string(FunctionContext* context, const starrocks::Columns& columns) {
...
ColumnPtr BitmapFunctions::bitmap_contains(FunctionContext* context, const starrocks::Columns& columns) {
...
ColumnPtr BitmapFunctions::bitmap_has_any(FunctionContext* context, const starrocks::Columns& columns) {
    return VectorizedStrictBinaryFunction<bitmapHasAny>::evaluate<TYPE_OBJECT, TYPE_BOOLEAN>(columns[0], columns[1]);
}

ColumnPtr BitmapFunctions::bitmap_andnot(FunctionContext* context, const starrocks::Columns& columns) {
    RETURN_IF_COLUMNS_ONLY_NULL(columns);
...
ColumnPtr BitmapFunctions::bitmap_xor(FunctionContext* context, const starrocks::Columns& columns) {
    RETURN_IF_COLUMNS_ONLY_NULL(columns);
...
ColumnPtr BitmapFunctions::bitmap_remove(FunctionContext* context, const starrocks::Columns& columns) {
    RETURN_IF_COLUMNS_ONLY_NULL(columns);
...
ColumnPtr BitmapFunctions::bitmap_to_array(FunctionContext* context, const starrocks::Columns& columns) {
...
ColumnPtr BitmapFunctions::array_to_bitmap(FunctionContext* context, const starrocks::Columns& columns) {
    RETURN_IF_COLUMNS_ONLY_NULL(columns);
...
ColumnPtr BitmapFunctions::bitmap_max(FunctionContext* context, const starrocks::Columns& columns) {
    ColumnViewer<TYPE_OBJECT> viewer(columns[0]);
...
ColumnPtr BitmapFunctions::bitmap_min(FunctionContext* context, const starrocks::Columns& columns) {
    ColumnViewer<TYPE_OBJECT> viewer(columns[0]);
...
ColumnPtr BitmapFunctions::base64_to_bitmap(FunctionContext* context, const starrocks::Columns& columns) {
    ColumnViewer<TYPE_VARCHAR> viewer(columns[0]);
    size_t size = columns[0]->size();
    ColumnBuilder<TYPE_OBJECT> builder(size);
...
ColumnPtr BitmapFunctions::sub_bitmap(FunctionContext* context, const starrocks::Columns& columns) {
    RETURN_IF_COLUMNS_ONLY_NULL(columns);
