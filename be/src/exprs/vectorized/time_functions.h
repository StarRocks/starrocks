...
public:
    ...
    static ColumnPtr convert_tz_general(FunctionContext* context, const starrocks::vectorized::Columns& columns);

    static ColumnPtr convert_tz_const(FunctionContext* context, const starrocks::vectorized::Columns& columns,
