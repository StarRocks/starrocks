...
template <bool IsWindowFunc>
class CountIfAggregateFunction final : public AggregateFunctionBatchHelper<CountIfFunctionState<IsWindowFunc>,
                                                                           CountIfAggregateFunction<IsWindowFunc>> {
public:
