...
struct ArrayFlattenAggregateState {
...
class ArrayFlattenAggregateFunction
        : public AggregateFunctionBatchHelper<ArrayFlattenAggregateState<LT, is_distinct, MyHashSet>,
                                              ArrayFlattenAggregateFunction<LT, is_distinct, MyHashSet>> {
public:
