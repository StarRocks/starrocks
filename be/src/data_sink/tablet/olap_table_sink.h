...
public:
    ...
    ~OlapTableSink() override { _release_cset_dict(); }
...
private:
    ...
    // Gives back the reference to the flexible partial update column-set dictionary taken in prepare().
    void _release_cset_dict();
    ...
    // Flexible partial update (TOlapTableSink.flexible_partial_update): the plan carries the hidden
