...
Status UpdateConfigAction::update_config(const std::string& name, const std::string& value) {
    std::call_once(_once_flag, [&]() {
        ...
        _config_callback.emplace("pk_index_load_thread_pool_num_max", [&]() -> Status {
            LOG(INFO) << "set pk_index_load_thread_pool_num_max: " << config::pk_index_load_thread_pool_num_max;
