...
public:
    explicit MetricsAction(MetricRegistry* metrics) : _metrics(metrics), _func(nullptr) {}
    // for tests
    explicit MetricsAction(MetricRegistry* metrics, MockFunc func) : _metrics(metrics), _func(func) {}
