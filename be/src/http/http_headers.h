...
//   https://github.com/apache/incubator-doris/blob/master/be/src/http/http_headers.h
...
#ifndef STARROCKS_BE_SRC_COMMON_UTIL_HTTP_HEADERS_H
#define STARROCKS_BE_SRC_COMMON_UTIL_HTTP_HEADERS_H
