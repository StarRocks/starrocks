...
<<<<<<< HEAD:be/src/storage/projection_iterator.cpp
=======
...
>>>>>>> 2893cdb ([BugFix] Let the ANN distance column tolerate a reused scan chunk (#78686)):be/src/storage_primitive/projection_iterator.cpp
    }
#ifndef NDEBUG
    if (st.ok()) {
