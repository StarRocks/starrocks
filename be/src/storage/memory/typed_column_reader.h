...
//   https://github.com/apache/incubator-doris/blob/master/be/src/olap/memory/typed_column_reader.h
...
public:
    TypedColumnReader(Column* column, uint64_t version, uint64_t real_version, vector<ColumnDelta*>&& deltas)
            : _column(column),
              _base(&_column->_base),
              _version(version),
