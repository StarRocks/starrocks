...
//   https://github.com/apache/incubator-doris/blob/master/be/src/olap/memory/hash_index.cpp
...
HashIndex::HashIndex(size_t capacity) : _size(0), _max_size(0), _num_chunks(0), _chunk_mask(0), _chunks(nullptr) {
