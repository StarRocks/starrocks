...
//   https://github.com/apache/incubator-doris/blob/master/be/src/olap/memory/mem_sub_tablet.h
...
public:
    ...
    static Status create(uint64_t version, const Schema& schema, std::unique_ptr<MemSubTablet>* ret);
