...
class TantivyPlugin : public InvertedPlugin {
public:
    static TantivyPlugin& get_instance() {
        static TantivyPlugin instance;
        return instance;
    }

    TantivyPlugin(const TantivyPlugin&) = delete;
    void operator=(const TantivyPlugin&) = delete;
