...
class CharReplaceCharFilter final : public lucene::analysis::CharFilter {
public:
    CharReplaceCharFilter(lucene::util::Reader* in, const std::string& pattern, const std::string& replacement);
...
private:
    void fill();
    void process_pattern(std::string& buf) const;
