...
// Those two u8 fields are part of the frozen format, so raising the block size past 255 is a
// format-version change, not a writer-side tunable (unlike the width-selection heuristic).
namespace gin_pfor {
