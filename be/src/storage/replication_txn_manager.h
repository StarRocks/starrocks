...
private:
    ...
    static std::string get_tablet_txn_dir_path(DataDir* data_dir, TTransactionId transaction_id,
    ...
    static std::string get_tablet_snapshot_dir_path(const std::string& tablet_txn_dir_path);
