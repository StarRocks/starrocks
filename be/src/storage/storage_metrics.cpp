...
#define REGISTER_ENGINE_REQUEST_METRIC(type, status, metric)                                                     \
    ...
    REGISTER_STORAGE_METRIC(compression_dict_pages_written);
    REGISTER_STORAGE_METRIC(compression_dict_bytes);
    REGISTER_STORAGE_METRIC(compression_dict_build_fallback);
