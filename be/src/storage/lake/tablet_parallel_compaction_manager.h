...
public:
    ...
    // Record the parent outcome at callback acceptance, before it can complete the RPC.
    void record_parent_task_completion(const std::shared_ptr<TabletParallelCompactionState>& state, bool success);
