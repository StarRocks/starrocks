    ...
    if (has_auto_increment_partial_update_state(params) &&
        ...
        if (filter_unowned_rows) {
            RETURN_IF_ERROR(SegmentRewriter::rewrite_partial_update_owned_only(
                    src, &file_info, params.tablet_schema, flat_json_config, unmodified_column_ids,
                    *rewrite_write_columns, owned, _upserts[segment_id]->physical_rowid_base(), segment_id,
            ...
            RETURN_IF_ERROR(SegmentRewriter::rewrite_partial_update(
                    src, &file_info, params.tablet_schema, flat_json_config, unmodified_column_ids,
                    *rewrite_write_columns, segment_id, partial_rowset_footer,
