...
private:
    ...
    // Rebuild _sstable_vec from _sstable_map for cache-friendly binary search in multi_get.
    void _rebuild_sstable_vec();

    // Flattened view of _sstable_map for cache-friendly binary search in multi_get.
    // Sorted by start_key. Slices point into _sstable_map's string keys (stable pointers).
