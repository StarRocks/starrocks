...
Block::Block(const BlockContents& contents)
        : data_(contents.data.get_data()), size_(contents.data.get_size()), owned_(contents.heap_allocated) {
...
private:
    ...
    inline uint32_t NextEntryOffset() const { return (value_.get_data() + value_.get_size()) - data_; }
