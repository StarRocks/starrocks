...
public:
    ...
    // Fence a replication transaction on this CN. New tasks are rejected and in-flight shared-data
    // copy tasks observe the marker and clean their late writes without blocking the abort RPC.
