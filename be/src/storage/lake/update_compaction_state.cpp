...
Status CompactionState::load_segments(Rowset* rowset, UpdateManager* update_manager, const TabletSchema& tablet_schema, uint32_t segment_id) {
...
std::string CompactionState::to_string() const {
    return strings::Substitute("CompactionState");
}
