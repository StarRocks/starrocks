...
void PrimaryIndex::_set_schema(const Schema& pk_schema) {
    ...
    _enc_pk_type = PrimaryKeyEncoder::encoded_primary_key_type(_pk_schema, sort_key_idxes, PrimaryKeyEncodingType::V1);
    _key_size = PrimaryKeyEncoder::get_encoded_fixed_size(_pk_schema, PrimaryKeyEncodingType::V1);
