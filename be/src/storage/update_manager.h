...
public:
    ...
    PersistentIndexRebuildExecutor* get_pindex_rebuild_executor() { return _pindex_rebuild_executor.get(); }
...
private:
    ...
    std::unique_ptr<PersistentIndexRebuildExecutor> _pindex_rebuild_executor;
