...
Status RowsetUpdateState::apply(Tablet* tablet, const TabletSchemaCSPtr& tablet_schema, Rowset* rowset,
    ...
    if (txn_meta.has_auto_increment_partial_update_column_id() &&
        ...
        RETURN_IF_ERROR(
                SegmentRewriter::rewrite_auto_increment(src_path, dest_path, _tablet_schema, tablet->flat_json_config(),
                                                        _auto_increment_partial_update_states[segment_id],
                                                        read_column_ids, partial_update_columns, segment_file_mark));
        ...
        RETURN_IF_ERROR(SegmentRewriter::rewrite_partial_update(src, &dest, _tablet_schema, tablet->flat_json_config(),
                                                                read_column_ids,
