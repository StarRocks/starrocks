...
public:
    ...
    void set_source_schema(const std::shared_ptr<const TabletSchema>& source_schema) { _source_schema = source_schema; }

    const std::shared_ptr<const TabletSchema>& source_schema() const { return _source_schema; }
...
private:
    ...
    std::shared_ptr<const TabletSchema> _source_schema = nullptr;
