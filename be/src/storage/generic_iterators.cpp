...
//   https://github.com/apache/incubator-doris/blob/master/be/src/olap/generic_iterators.cpp
...
private:
    ...
    using MergeHeap =
            std::priority_queue<MergeIteratorContext*, std::vector<MergeIteratorContext*>, MergeContextComparator>;
