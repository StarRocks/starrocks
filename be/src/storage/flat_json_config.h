...
<<<<<<< HEAD:be/src/storage/flat_json_config.h
...
>>>>>>> a43b68ac51 ([Enhancement] Propagate flat_json config ALTER to BE via versioned task (#74747)):be/src/storage_primitive/flat_json_config.h
};
} // namespace starrocks