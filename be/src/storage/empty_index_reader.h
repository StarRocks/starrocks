...
#pragma once
#include "storage/vector_index_reader.h"
...
public:
    ...
    Status search(tenann::PrimitiveSeqView query_vector, int k, int64_t* result_ids,
                          uint8_t* result_distances, tenann::IdFilter* id_filter = nullptr) override {
        return Status::NotSupported("Not implement");
    }
