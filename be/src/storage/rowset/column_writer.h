...
public:
    ...
    virtual Status write_gist_index(uint64_t* index_size) { return Status::OK(); }
...
public:
    ...
    Status write_gist_index(uint64_t* index_size) override;
...
#endif
    std::unique_ptr<GiSTIndexWriter> _gist_index_writer;
