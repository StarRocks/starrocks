...
ColumnReader::~ColumnReader() {
    ...
    if (_ordinal_index_meta != nullptr) {
        ...
        _onetime_meta_bytes.fetch_sub(_ordinal_index_meta->SpaceUsedLong());
    ...
    if (_zonemap_index_meta != nullptr) {
        ...
        _onetime_meta_bytes.fetch_sub(_zonemap_index_meta->SpaceUsedLong());
    ...
    if (_bitmap_index_meta != nullptr) {
        ...
        _onetime_meta_bytes.fetch_sub(_bitmap_index_meta->SpaceUsedLong());
    ...
    if (_bloom_filter_index_meta != nullptr) {
        ...
        _onetime_meta_bytes.fetch_sub(_bloom_filter_index_meta->SpaceUsedLong());
        ...
        for (int i = 0; i < meta->indexes_size(); i++) {
            ...
            case ORDINAL_INDEX:
                ...
                MEM_TRACKER_SAFE_CONSUME(ExecEnv::GetInstance()->ordinal_index_mem_tracker(),
                                         _ordinal_index_meta->SpaceUsedLong());
                _onetime_meta_bytes.fetch_add(_ordinal_index_meta->SpaceUsedLong());
            ...
            case ZONE_MAP_INDEX:
                ...
                MEM_TRACKER_SAFE_CONSUME(ExecEnv::GetInstance()->column_zonemap_index_mem_tracker(),
                                         _zonemap_index_meta->SpaceUsedLong())
                _onetime_meta_bytes.fetch_add(_zonemap_index_meta->SpaceUsedLong());
            ...
            case BITMAP_INDEX:
                ...
                MEM_TRACKER_SAFE_CONSUME(ExecEnv::GetInstance()->bitmap_index_mem_tracker(),
                                         _bitmap_index_meta->SpaceUsedLong());
                _onetime_meta_bytes.fetch_add(_bitmap_index_meta->SpaceUsedLong());
            ...
            case BLOOM_FILTER_INDEX:
                ...
                MEM_TRACKER_SAFE_CONSUME(ExecEnv::GetInstance()->bloom_filter_index_mem_tracker(),
                                         _bloom_filter_index_meta->SpaceUsedLong());
                _onetime_meta_bytes.fetch_add(_bloom_filter_index_meta->SpaceUsedLong());
