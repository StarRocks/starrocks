...
Status ScalarColumnIterator::init(const ColumnIteratorOptions& opts) {
    ...
    index_opts.use_page_cache = !opts.temporary_data && config::enable_ordinal_index_memory_page_cache || !config::disable_storage_page_cache;
...
Status ScalarColumnIterator::get_row_ranges_by_zone_map(const std::vector<const ColumnPredicate*>& predicates,
    ...
    if (_reader->has_zone_map()) {
        ...
        opts.use_page_cache = !opts.temporary_data && config::enable_zonemap_index_memory_page_cache || !config::disable_storage_page_cache;
...
Status ScalarColumnIterator::get_row_ranges_by_bloom_filter(const std::vector<const ColumnPredicate*>& predicates,
    ...
    IndexReadOptions opts;
    opts.use_page_cache = !opts.temporary_data && !config::disable_storage_page_cache;
