...
Status Segment::_open(size_t* footer_length_hint, const FooterPointerPB* partial_rowset_footer,
    ...
    ASSIGN_OR_RETURN(auto read_file, _fs->new_random_access_file_with_sharing(opts, _segment_file_info));
...
Status Segment::_load_index(const LakeIOOptions& lake_io_opts) {
    ...
    ASSIGN_OR_RETURN(auto read_file, _fs->new_random_access_file_with_sharing(file_opts, _segment_file_info));
