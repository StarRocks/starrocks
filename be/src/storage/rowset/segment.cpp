...
Status Segment::parse_segment_footer(std::unique_ptr<fs::ReadableBlock>* rblock, SegmentFooterPB* footer,
...
Status Segment::_open(MemTracker* mem_tracker, size_t* footer_length_hint) {
    ...
    RETURN_IF_ERROR(Segment::parse_segment_footer(&rblock, &footer, footer_length_hint, nullptr));
