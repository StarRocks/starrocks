...
public:
    BinlogFileReadHolder(std::shared_ptr<std::atomic<int64_t>> _reader_count, BinlogFileMetaPBPtr file_meta)
            : _reader_count(_reader_count), _file_meta(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(file_meta)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) {
...
class BinlogFile {
public:
    BinlogFile(BinlogFileMetaPBPtr file_meta) : _file_meta(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(std::move(file_meta)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) {
