...
class ColumnNePredicate : public ColumnPredicate {
...
public:
    ...
    ~ColumnNePredicate() override = default;
    ...
    PredicateType type() const override { return PredicateType::kNE; }
...
// use logical operators (&&, ||) instead of bit operators (&, |).
template <FieldType field_type>
class BinaryColumnNePredicate : public ColumnPredicate {
...
public:
    ...
    ~BinaryColumnNePredicate() override = default;
