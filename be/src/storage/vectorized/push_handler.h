...
private:
    ...
    Status _convert(const TabletSharedPtr& cur_tablet, RowsetSharedPtr* cur_rowset);
    Status _convert_v2(const TabletSharedPtr& cur_tablet, RowsetSharedPtr* cur_rowset);
