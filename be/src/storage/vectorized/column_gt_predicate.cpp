...
class ColumnGtPredicate : public ColumnPredicate {
...
public:
    ...
    ~ColumnGtPredicate() override = default;
    ...
    Status convert_to(const ColumnPredicate** output, const TypeInfoPtr& target_type_info,
        ...
        return predicate_convert_to<field_type>(*this, _value, new_column_gt_predicate, output, target_type_info,
                                                obj_pool);
    }
...
template <FieldType field_type>
class BinaryColumnGtPredicate : public ColumnPredicate {
...
public:
    ...
    ~BinaryColumnGtPredicate() override = default;
