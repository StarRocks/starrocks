...
class ColumnLePredicate : public ColumnPredicate {
...
public:
    ...
    PredicateType type() const override { return PredicateType::kLE; }
    ...
    Status convert_to(const ColumnPredicate** output, const TypeInfoPtr& target_type_info,
        ...
        return predicate_convert_to<field_type>(*this, _value, new_column_le_predicate, output, target_type_info,
                                                obj_pool);
    }
...
template <FieldType field_type>
class BinaryColumnLePredicate : public ColumnPredicate {
    using ValueType = Slice;

public:
    BinaryColumnLePredicate(const TypeInfoPtr& type_info, ColumnId id, const ValueType& value)
