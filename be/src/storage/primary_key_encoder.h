...
public:
    ...
    static Status create_column(const Schema& schema, MutableColumnPtr* pcolumn, bool enable_null_primary_key, bool large_column = false);
    ...
    //   large_column: some usage may fill the column with more than uint32_max elements, set true to support this
    static Status create_column(const Schema& schema, MutableColumnPtr* pcolumn, const std::vector<ColumnId>& key_idxes, bool enable_null_primary_key,
