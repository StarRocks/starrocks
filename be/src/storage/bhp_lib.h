...
//   https://github.com/apache/incubator-doris/blob/master/be/src/olap/bhp_lib.h
...
/*__attribute__((always_inline))*/ inline int memcmp_sse32(const void* buf1, const void* buf2, int count)
...
/*__attribute__((always_inline))*/ inline int memcmp_sse64(const void* buf1, const void* buf2, size_t count) {
    int result;
    __asm__ __volatile__(
            "cmp $1, %%rdx;"
            "jbe 6f;"
...
#endif // STARROCKS_BE_SRC_OLAP_BHP_LIB_H
