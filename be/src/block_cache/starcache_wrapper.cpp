...
Status StarCacheWrapper::init(const CacheOptions& options) {
    ...
    _enable_through_data_mode = options.enable_through_data_mode;
...
Status StarCacheWrapper::write_buffer(const std::string& key, const IOBuffer& buffer, WriteCacheOptions* options) {
    ...
    opts.keep_alive = options->keep_alive;
    opts.callback = options->callback;
    opts.mode = _enable_through_data_mode ? starcache::WriteOptions::WriteMode::WRITE_THROUGH
                                          : starcache::WriteOptions::WriteMode::WRITE_BACK;
    Status st;
    {
...
Status StarCacheWrapper::read_buffer(const std::string& key, size_t off, size_t size, IOBuffer* buffer,
    ...
    opts.mode = _enable_through_data_mode ? starcache::ReadOptions::ReadMode::READ_THROUGH
                                          : starcache::ReadOptions::ReadMode::READ_BACK;
