...
- Targets: `ExprUtility`
- Allowed internal include prefixes: `exprs_ext/utility/`, `exprs/`, `exec/pipeline/fragment_context.h`, `storage_primitive/`, `platform/`, `runtime/`, `column/`, `types/`, `common/`, `base/`, `gutil/`, `gen_cpp/`
