...
const char* const PlatformMetrics::_s_hook_name = "platform_metrics";
...
PlatformMetrics* PlatformMetrics::instance() {
    // Process-lifetime singleton: IO instrumentation may touch PlatformMetrics
    ...
    static auto* instance = new PlatformMetrics();
    return instance;
}
...
void PlatformMetrics::install(MetricRegistry* registry, const std::set<std::string>& disk_devices,
...
void PlatformMetrics::_install_disk_metrics(MetricRegistry* registry, const std::set<std::string>& devices) {
...
#undef REGISTER_DISK_METRIC
    }
}

void PlatformMetrics::_update_disk_metrics() {
#ifdef BE_TEST
...
void PlatformMetrics::_install_net_metrics(MetricRegistry* registry, const std::vector<std::string>& interfaces) {
...
#undef REGISTER_NETWORK_METRIC
    }
}

void PlatformMetrics::_install_snmp_metrics(MetricRegistry* registry) {
...
#undef REGISTER_SNMP_METRIC
}

void PlatformMetrics::_update_net_metrics() {
#ifdef BE_TEST
...
void PlatformMetrics::_update_snmp_metrics() {
#ifdef BE_TEST
...
void PlatformMetrics::_install_fd_metrics(MetricRegistry* registry) {
...
void PlatformMetrics::_update_fd_metrics() {
#ifdef BE_TEST
...
int64_t PlatformMetrics::get_max_io_util(const std::map<std::string, int64_t>& lst_value, int64_t interval_sec) {
    int64_t max = 0;
    for (auto& it : _disk_metrics) {
...
void PlatformMetrics::get_disks_io_time(std::map<std::string, int64_t>* map) {
    map->clear();
    for (auto& it : _disk_metrics) {
...
void PlatformMetrics::get_network_traffic(std::map<std::string, int64_t>* send_map,
...
void PlatformMetrics::get_max_net_traffic(const std::map<std::string, int64_t>& lst_send_map,
