...
// ExecCore-owned build-side metadata for producing and publishing a runtime-filter payload.
// This layer owns planner/build descriptors and probe-time orchestration inputs, not the payload
// format itself or Runtime transport/cache lifecycle.
