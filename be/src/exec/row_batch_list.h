...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/row_batch_list.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXEC_ROW_BATCH_LIST_H
#define STARROCKS_BE_SRC_QUERY_EXEC_ROW_BATCH_LIST_H
...
public:
    ...
    private:
        ...
        TupleRowIterator(RowBatchList* list) : _list(list), _batch_it(list->_row_batches.begin()), _row_idx(0) {}
