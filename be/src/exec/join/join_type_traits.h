...
#define APPLY_JOIN_HASH_MAP_METHOD_TYPE(M) \
    ...
    M(GERMAN_STRING_BUCKET_CHAINED)
...
enum class JoinHashMapMethodUnaryType {
    GERMAN_STRING_BUCKET_CHAINED_VARCHAR,
#define NAME_TO_ENUM(NAME) NAME,
...
REGISTER_KEY_CONSTRUCTOR(ONE_KEY_GERMAN_STRING, TYPE_VARCHAR, KeyConstructorForOneGermanStringKey,
                         ONE_KEY_GERMAN_STRING);
...
REGISTER_KEY_CONSTRUCTOR(SERIALIZED_GERMAN_STRING, TYPE_VARCHAR, KeyConstructorForGermanStringSerialized,
                         SERIALIZED_GERMAN_STRING);
...
REGISTER_JOIN_MAP_METHOD_TYPE(GERMAN_STRING_BUCKET_CHAINED, TYPE_VARCHAR, GermanStringBucketChainedJoinHashMap,
                              GERMAN_STRING_BUCKET_CHAINED);
