...
#define APPLY_JOIN_HASH_MAP_METHOD_UNARY_TYPE(M) \
    ...
    M(LINEAR_CHAINED_VARCHAR)                    \
                                                 \
    M(LINEAR_CHAINED2_INT)                       \
    M(LINEAR_CHAINED2_BIGINT)                    \
    M(LINEAR_CHAINED2_LARGEINT)                  \
    M(LINEAR_CHAINED2_FLOAT)                     \
    M(LINEAR_CHAINED2_DOUBLE)                    \
    M(LINEAR_CHAINED2_DATE)                      \
    M(LINEAR_CHAINED2_DATETIME)                  \
    M(LINEAR_CHAINED2_DECIMALV2)                 \
    M(LINEAR_CHAINED2_DECIMAL32)                 \
    M(LINEAR_CHAINED2_DECIMAL64)                 \
    M(LINEAR_CHAINED2_DECIMAL128)                \
    M(LINEAR_CHAINED2_VARCHAR)                   \
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_INT, LinearChainedJoinHashMap2, LINEAR_CHAINED2_INT);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_BIGINT, LinearChainedJoinHashMap2, LINEAR_CHAINED2_BIGINT);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_LARGEINT, LinearChainedJoinHashMap2, LINEAR_CHAINED2_LARGEINT);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_FLOAT, LinearChainedJoinHashMap2, LINEAR_CHAINED2_FLOAT);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_DOUBLE, LinearChainedJoinHashMap2, LINEAR_CHAINED2_DOUBLE);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_DATE, LinearChainedJoinHashMap2, LINEAR_CHAINED2_DATE);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_DATETIME, LinearChainedJoinHashMap2, LINEAR_CHAINED2_DATETIME);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_DECIMALV2, LinearChainedJoinHashMap2, LINEAR_CHAINED2_DECIMALV2);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_DECIMAL32, LinearChainedJoinHashMap2, LINEAR_CHAINED2_DECIMAL32);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_DECIMAL64, LinearChainedJoinHashMap2, LINEAR_CHAINED2_DECIMAL64);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_DECIMAL128, LinearChainedJoinHashMap2, LINEAR_CHAINED2_DECIMAL128);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2, TYPE_VARCHAR, LinearChainedJoinHashMap2, LINEAR_CHAINED2_VARCHAR);
