...
public:
    ...
    virtual Status append_chunk_to_hashtable(RuntimeState* state, ChunkPtr& chunk) { return Status::OK(); }
};
...
public:
    ...
    Status append_chunk_to_hashtable(RuntimeState* state, ChunkPtr& chunk) override;
