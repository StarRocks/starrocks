...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/cross_join_node.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXEC_CROSS_JOIN_NODE_H
#define STARROCKS_BE_SRC_QUERY_EXEC_CROSS_JOIN_NODE_H
