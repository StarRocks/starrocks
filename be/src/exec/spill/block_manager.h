...
struct AcquireBlockOptions {
    ...
    //
    // Reclamation: vacuum_full (60s cycle) scans load_spill_txns/ and removes expired files
    // by parsing the leading hex txn_id and comparing against the cluster-wide min_active_txn_id.
    //
