...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/merge_node.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXEC_MERGE_NODE_H
#define STARROCKS_BE_SRC_QUERY_EXEC_MERGE_NODE_H
...
private:
    ...
    bool eval_and_materialize_exprs(const std::vector<ExprContext*>& exprs, bool const_exprs, Tuple** tuple,
                                    RowBatch* row_batch);
};
