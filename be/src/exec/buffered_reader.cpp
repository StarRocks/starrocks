...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/buffered_reader.cpp
...
BufferedReader::BufferedReader(FileReader* reader, int64_t buffer_size)
        : _reader(reader), _buffer_size(buffer_size), _buffer_offset(0), _buffer_limit(0), _cur_offset(0) {
