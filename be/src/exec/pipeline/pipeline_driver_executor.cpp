...
int64_t GlobalDriverExecutor::driver_queue_len() const {
    return _driver_queue->size();
}

int64_t GlobalDriverExecutor::driver_poller_block_queue_len() const {
    return _blocked_driver_poller->num_drivers();
}
