...
private:
    ...
    bool _build_medium_chunk(size_t chunk_size, const ChunkPtr& probe_chunk, size_t* probe_start, size_t* probe_end,
                          const ChunkPtr& build_chunk, size_t* build_start, size_t* build_end, ChunkPtr* result_chunk);
    bool _build_tmp_chunk(size_t chunk_size, const ChunkPtr& probe_chunk, size_t* probe_start, size_t* probe_end,
                          const ChunkPtr& build_chunk, size_t* build_start, size_t* build_end, ChunkPtr* result_chunk);
