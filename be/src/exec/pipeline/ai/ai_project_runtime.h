...
// Production dispatcher adapter. Each endpoint and bound BE-local credential
// are copied once at fragment construction. Keys never enter plans or diagnostics.
