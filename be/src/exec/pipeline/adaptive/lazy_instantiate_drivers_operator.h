...
public:
    LazyCreateDriversOperator(OperatorFactory* factory, int32_t id, int32_t plan_node_id, const int32_t driver_sequence,
                              const PipelineGroupMap& unready_pipeline_groups);
...
public:
    LazyCreateDriversOperatorFactory(int32_t id, int32_t plan_node_id, PipelineGroupMap&& unready_pipeline_groups);
