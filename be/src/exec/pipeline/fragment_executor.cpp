...
StatusOr<std::unique_ptr<FragmentContext>> FragmentExecutor::_prepare_fragment_ctx(
...
StatusOr<WorkGroupPtr> FragmentExecutor::_prepare_workgroup(const TExecPlanFragmentParams& request) {
