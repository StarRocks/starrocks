...
public:
    ...
    query_cache::TicketCheckerPtr& ticket_checker() { return _ticket_checker; }
...
private:
    ...
    query_cache::TicketCheckerPtr _ticket_checker = std::make_shared<query_cache::TicketChecker>();
