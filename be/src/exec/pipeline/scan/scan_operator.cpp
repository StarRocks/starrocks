...
Status ScanOperatorFactory::prepare(RuntimeState* state) {
    ...
    RETURN_IF_ERROR(ExecExecutor::prepare(_scan_node->get_heavy_expr_ctxs(), state));
    RETURN_IF_ERROR(ExecExecutor::open(_scan_node->get_heavy_expr_ctxs(), state));
    RETURN_IF_ERROR(do_prepare(state));
...
void ScanOperatorFactory::close(RuntimeState* state) {
    ...
    // ExecExecutor::close(_scan_node->get_heavy_expr_ctxs(), state);
