...
public:
    ...
    bool can_reuse_with(const Morsel& morsel) const override;
    bool can_reuse_after_finish() const override;
    Status reset_morsel(RuntimeState* state, MorselPtr&& morsel) override;
