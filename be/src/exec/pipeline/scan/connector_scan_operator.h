...
private:
    ...
    RuntimeProfile::Counter* _chunk_source_reuse_miss_counter = nullptr;
    RuntimeProfile::Counter* _chunk_source_reuse_stale_close_counter = nullptr;
    RuntimeProfile::Counter* _chunk_source_reuse_failure_counter = nullptr;
};
