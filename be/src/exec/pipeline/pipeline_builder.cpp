...
OpFactories PipelineBuilderContext::maybe_interpolate_local_shuffle_exchange(
    ...
    // the output (see _do_maybe_interpolate_local_shuffle_exchange), falsely telling a downstream
    ...
    return _do_maybe_interpolate_local_shuffle_exchange(
            state, plan_node_id, pred_operators, self_partition_exprs, source_op->partition_type(),
