...
Status TabletScanner::_init_reader_params(const std::vector<OlapScanRange*>* key_ranges) {
    ...
    _params.enable_predicate_col_late_materialize = _runtime_state->query_options().enable_predicate_col_late_materialize;
    _params.enable_predicate_order_sorting = _runtime_state->query_options().enable_predicate_order_sorting;
