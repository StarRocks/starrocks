...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/blocking_join_node.cpp
...
BlockingJoinNode::BlockingJoinNode(const std::string& node_name, const TJoinOp::type join_op, ObjectPool* pool,
