...
Status SchemaPartitionsMetaScanner::start(RuntimeState* state) {
    ...
    while (true) {
        ...
        RETURN_IF_ERROR(SchemaHelper::get_partitions_meta(_ss_state, partitions_meta_req,
                                                          &partitions_meta_response));
        _partitions_meta_vec.insert(_partitions_meta_vec.end(),
                                    partitions_meta_response.partitions_meta_infos.begin(),
