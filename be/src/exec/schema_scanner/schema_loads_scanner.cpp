...
SchemaScanner::ColumnDesc SchemaLoadsScanner::_s_tbls_columns[] = {
        ...
        {"PROFILE_ID", TYPE_VARCHAR, sizeof(StringValue), true},
        {"DB_NAME", TYPE_VARCHAR, sizeof(StringValue), false},
        {"TABLE_NAME", TYPE_VARCHAR, sizeof(StringValue), false},
        {"USER", TYPE_VARCHAR, sizeof(StringValue), false},
