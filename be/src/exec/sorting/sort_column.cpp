...
public:
    ...
    Status do_visit(const StructColumn& column) {
<<<<<<< HEAD:be/src/exec/sorting/sort_column.cpp
        // TODO(SmithCruise)
...
=======
        ...
        _prune_limit();
        return Status::OK();
>>>>>>> 819d5030d6 ([BugFix] Sort a run and merge the runs by the same NULL convention  (#77679)):be/src/column/sorting/sort_column.cpp
    }
