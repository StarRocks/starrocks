...
Status ParquetScanner::new_column(const arrow::DataType* arrow_type, const SlotDescriptor* slot_desc, MutableColumnPtr* column,
...
Status ParquetScanner::convert_array_to_column(ConvertFuncTree* conv_func, size_t num_elements,
                                               const arrow::Array* array, MutableColumnPtr& column, size_t batch_start_idx,
