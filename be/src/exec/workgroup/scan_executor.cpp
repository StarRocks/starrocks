...
<<<<<<< HEAD:be/src/exec/workgroup/scan_executor.cpp
...
>>>>>>> ec7f3f53b2 ([Enhancement] Export worker-thread metrics for the scan executors (#77435)):be/src/compute_env/workgroup/scan_executor.cpp
