...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/mysql_scan_node.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXEC_MYSQL_SCAN_NODE_H
#define STARROCKS_BE_SRC_QUERY_EXEC_MYSQL_SCAN_NODE_H
...
class MysqlScanNode : public ConvertScanNode {
public:
...
private:
    ...
    Status write_text_slot(char* value, int value_length, SlotDescriptor* slot, RuntimeState* state);
