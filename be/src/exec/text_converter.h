...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/text_converter.h
...
#ifndef STARROCKS_BE_SRC_QUERY_EXEC_TEXT_CONVERTER_H
#define STARROCKS_BE_SRC_QUERY_EXEC_TEXT_CONVERTER_H
...
public:
    ...
    bool write_slot(const SlotDescriptor* slot_desc, Tuple* tuple, const char* data, int len, bool copy_string,
                    bool need_escape, MemPool* pool);
