...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/parquet_scanner.cpp
...
ParquetScanner::ParquetScanner(RuntimeState* state, RuntimeProfile* profile, const TBrokerScanRangeParams& params,
...
Status ParquetScanner::open_next_reader() {
    ...
    while (true) {
        ...
        case TFileType::FILE_BROKER: {
            ...
            file_reader.reset(
                    new BufferedReader(new BrokerReader(_state->exec_env(), _broker_addresses, _params.properties,
