...
pipeline::OpFactories ExceptNode::decompose_to_pipeline(pipeline::PipelineBuilderContext* context) {
    ...
    operators_with_except_build_sink =
            context->maybe_interpolate_local_shuffle_exchange(runtime_state(), operators_with_except_build_sink, _child_expr_lists[0]);
    ...
    for (size_t i = 1; i < _children.size(); i++) {
        ...
        operators_with_except_probe_sink = context->maybe_interpolate_local_shuffle_exchange(runtime_state(), 
