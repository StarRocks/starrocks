...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/union_node.h
...
private:
    ...
    void materialize_exprs(const std::vector<ExprContext*>& exprs, TupleRow* row, uint8_t* tuple_buf,
                           RowBatch* dst_batch);
