...
ThriftSerializer::ThriftSerializer(bool compact, size_t initial_buffer_size)
        : _mem_buffer(new apache::thrift::transport::TMemoryBuffer(static_cast<uint32_t>(initial_buffer_size))) {
    if (compact) {
