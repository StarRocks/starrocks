...
//   https://github.com/apache/incubator-doris/blob/master/be/src/util/broker_load_error_hub.h
...
#ifndef STARROCKS_BE_SRC_UTIL_BROKER_LOAD_ERROR_HUB_H
#define STARROCKS_BE_SRC_UTIL_BROKER_LOAD_ERROR_HUB_H
...
public:
    struct BrokerInfo {
        ...
        BrokerInfo(const TBrokerErrorHubInfo& t_info, const std::string& error_log_file_name) : props(t_info.prop) {
...
#endif // STARROCKS_BE_SRC_UTIL_BROKER_LOAD_ERROR_HUB_H
