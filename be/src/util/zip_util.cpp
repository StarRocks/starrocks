...
//   https://github.com/apache/incubator-doris/blob/master/be/src/util/zip_util.cpp
...
Status ZipFile::extract_file(const std::string& target_path) {
    ...
    int err = unzGetCurrentFileInfo64(_zip_file, &file_info_inzip, file_name, DEFAULT_FILE_NAME_SIZE, nullptr, 0,
                                      nullptr, 0);
    ...
    ASSIGN_OR_RETURN(auto wfile, FileSystem::Default()->new_writable_file(path));
