...
//   https://github.com/apache/incubator-doris/blob/master/be/src/util/load_error_hub.cpp
...
Status LoadErrorHub::create_hub(ExecEnv* env, const TLoadErrorHubInfo* t_hub_info,
                                const std::string& error_log_file_name, std::unique_ptr<LoadErrorHub>* hub) {
