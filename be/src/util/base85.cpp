...
// Use Base85Byte instead of byte to avoid conflicts with std::byte in C++17
typedef unsigned char Base85Byte;

static Base85Byte base256[] = {0x00, 0x44, 0x00, 0x54, 0x53, 0x52, 0x48, 0x00, 0x4B, 0x4C, 0x46, 0x41, 0x00, 0x3F,
...
char* base85_decode_impl(const char* source, const char* sourceEnd, char* dest) {
    Base85Byte* src = (Base85Byte*)source;
    Base85Byte* end = (Base85Byte*)sourceEnd;
    Base85Byte* dst = (Base85Byte*)dest;
    uint32_t value;
    ...
    for (; src != end; src += 5, dst += 4) {
        ...
        dst[0] = value >> 24;
        dst[1] = (Base85Byte)(value >> 16);
        dst[2] = (Base85Byte)(value >> 8);
        dst[3] = (Base85Byte)(value);
    }
