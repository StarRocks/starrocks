...
//   https://github.com/apache/incubator-doris/blob/master/be/src/util/once.h
...
#ifndef STARROCKS_BE_SRC_UTIL_ONCE_H
#define STARROCKS_BE_SRC_UTIL_ONCE_H
...
#endif // STARROCKS_BE_SRC_UTIL_ONCE_H
