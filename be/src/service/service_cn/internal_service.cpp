...
template <typename T>
void ComputeNodeInternalServiceImpl<T>::tablet_writer_open(google::protobuf::RpcController* cntl_base,
...
template <typename T>
void ComputeNodeInternalServiceImpl<T>::tablet_writer_add_batch(google::protobuf::RpcController* controller,
...
template <typename T>
void ComputeNodeInternalServiceImpl<T>::tablet_writer_add_chunk(google::protobuf::RpcController* cntl_base,
...
template <typename T>
void ComputeNodeInternalServiceImpl<T>::tablet_writer_add_chunks(google::protobuf::RpcController* cntl_base,
...
template <typename T>
void ComputeNodeInternalServiceImpl<T>::tablet_writer_add_segment(google::protobuf::RpcController* controller,
...
template <typename T>
void ComputeNodeInternalServiceImpl<T>::tablet_writer_cancel(google::protobuf::RpcController* cntl_base,
...
template class ComputeNodeInternalServiceImpl<PInternalService>;
template class ComputeNodeInternalServiceImpl<doris::PBackendService>;
} // namespace starrocks
