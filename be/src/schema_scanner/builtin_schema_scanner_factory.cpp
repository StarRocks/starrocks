...
<<<<<<< HEAD:be/src/exec/builtin_schema_scanner_factory.cpp
...
=======
#include "schema_scanner/schema_analyze_status.h"
#include "schema_scanner/schema_applicable_roles_scanner.h"
#include "schema_scanner/schema_be_bvars_scanner.h"
#include "schema_scanner/schema_be_cloud_native_compactions_scanner.h"
#include "schema_scanner/schema_be_compactions_scanner.h"
#include "schema_scanner/schema_be_configs_scanner.h"
#include "schema_scanner/schema_be_datacache_metrics_scanner.h"
#include "schema_scanner/schema_be_logs_scanner.h"
#include "schema_scanner/schema_be_metrics_scanner.h"
#include "schema_scanner/schema_be_tablet_write_log_scanner.h"
#include "schema_scanner/schema_be_tablets_scanner.h"
#include "schema_scanner/schema_be_threads_scanner.h"
#include "schema_scanner/schema_be_txns_scanner.h"
#include "schema_scanner/schema_charsets_scanner.h"
#include "schema_scanner/schema_cluster_snapshot_jobs_scanner.h"
...
#include "schema_scanner/schema_fe_threads_scanner.h"
#include "schema_scanner/schema_keywords_scanner.h"
#include "schema_scanner/schema_load_tracking_logs_scanner.h"
#include "schema_scanner/schema_loads_scanner.h"
#include "schema_scanner/schema_materialized_view_refresh_jobs_scanner.h"
#include "schema_scanner/schema_materialized_views_scanner.h"
#include "schema_scanner/schema_partitions_meta_scanner.h"
#include "schema_scanner/schema_pipe_files.h"
...
#include "schema_scanner/schema_tasks_scanner.h"
#include "schema_scanner/schema_temp_tables_scanner.h"
#include "schema_scanner/schema_user_privileges_scanner.h"
#include "schema_scanner/schema_variables_scanner.h"
#include "schema_scanner/schema_views_scanner.h"
#include "schema_scanner/schema_warehouse_metrics.h"
#include "schema_scanner/schema_warehouse_queries.h"
#include "schema_scanner/starrocks_grants_to_scanner.h"
#include "schema_scanner/starrocks_role_edges_scanner.h"
#include "schema_scanner/sys_fe_locks.h"
#include "schema_scanner/sys_fe_memory_usage.h"
#include "schema_scanner/sys_object_dependencies.h"
>>>>>>> 6a6543f879b... [Refactor] Extract schema scanners from the Exec module (#76285):be/src/schema_scanner/builtin_schema_scanner_factory.cpp

namespace starrocks {

namespace {

class BuiltinSchemaScannerFactory final : public SchemaScannerFactory {
public:
    std::unique_ptr<SchemaScanner> create(TSchemaTableType::type type) const override;
};

std::unique_ptr<SchemaScanner> BuiltinSchemaScannerFactory::create(TSchemaTableType::type type) const {
    switch (type) {
    ...
    case TSchemaTableType::STARROCKS_POLICY_REFERENCES:
        return std::make_unique<StarrocksPolicyReferencesScanner>();
    ...
    case TSchemaTableType::SCH_TABLE_BOOKMARK_SUMMARY:
        return std::make_unique<SchemaTableBookmarkSummaryScanner>();
    case TSchemaTableType::SCH_TABLE_BOOKMARK_PARTITIONS:
        return std::make_unique<SchemaTableBookmarkPartitionsScanner>();
    case TSchemaTableType::SCH_TABLE_BOOKMARK_REFERENCES:
        return std::make_unique<SchemaTableBookmarkReferencesScanner>();
    default:
...
std::unique_ptr<SchemaScannerFactory> create_builtin_schema_scanner_factory() {
    return std::make_unique<BuiltinSchemaScannerFactory>();
}
