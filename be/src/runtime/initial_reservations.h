...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/initial_reservations.h
...
#ifndef STARROCKS_BE_RUNTIME_INITIAL_RESERVATIONS_H
#define STARROCKS_BE_RUNTIME_INITIAL_RESERVATIONS_H
...
public:
    ...
    InitialReservations(ObjectPool* obj_pool, ReservationTracker* query_reservation, MemTracker* query_mem_tracker,
