...
std::string HudiTableDescriptor::get_base_path() const {
    return _table_location;
}

std::string HudiTableDescriptor::get_instant_time() const {
    return _hudi_instant_time;
}

std::string HudiTableDescriptor::get_hive_column_names() const {
    return _hive_column_names;
}

std::string HudiTableDescriptor::get_hive_column_types() const {
    return _hive_column_types;
}

std::string HudiTableDescriptor::get_input_format() const {
    return _input_format;
}

std::string HudiTableDescriptor::get_serde_lib() const {
    return _serde_lib;
}
