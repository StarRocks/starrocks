...
#ifndef STARROCKS_BE_SRC_RUNTIME_VECTORIZED_ROW_BATCH_H
#define STARROCKS_BE_SRC_RUNTIME_VECTORIZED_ROW_BATCH_H
...
#endif // _STARROCKS_BE_SRC_RUNTIME_VECTORIZED_ROW_BATCH_H
