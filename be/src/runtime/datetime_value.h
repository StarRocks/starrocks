...
public:
    ...
    bool unix_timestamp(int64_t* timestamp, const TimezoneHsScan& timezone_hsscan, const std::string& timezone) const;
    ...
    bool from_unixtime(int64_t, const TimezoneHsScan& timezone_hsscan, const std::string& timezone);
