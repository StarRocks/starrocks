...
public:
    ...
    bool unix_timestamp(HsScanUtils hsScanUtils, int64_t* timestamp, const std::string& timezone) const;
    ...
    bool from_unixtime(HsScanUtils hsScanUtils, int64_t, const std::string& timezone);
