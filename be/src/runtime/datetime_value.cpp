...
bool DateTimeValue::unix_timestamp(int64_t* timestamp, const TimezoneHsScan& timezone_hsscan, const std::string& timezone) const {
    cctz::time_zone ctz;
...
bool DateTimeValue::from_unixtime(int64_t timestamp, const TimezoneHsScan& timezone_hsscan, const std::string& timezone) {
    cctz::time_zone ctz;
    if (!TimezoneUtils::find_cctz_time_zone(timezone_hsscan, timezone, ctz)) {
        return false;
    }
