...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/dpp_sink_internal.h
...
public:
    ...
    static Status from_thrift(ObjectPool* pool, const TPartitionRange& t_part_range, PartRange* range);
...
public:
    ...
    static Status from_thrift(ObjectPool* pool, const TRangePartition& t_partition, PartitionInfo* partition, int32_t batch_size);
    ...
    const std::vector<ExprContext*>& distributed_expr_ctxs() const { return _distributed_expr_ctxs; }
