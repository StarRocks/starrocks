...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/tuple.h
...
#ifndef STARROCKS_BE_RUNTIME_TUPLE_H
#define STARROCKS_BE_RUNTIME_TUPLE_H
...
public:
    ...
    Tuple* deep_copy(const TupleDescriptor& desc, MemPool* pool) { return deep_copy(desc, pool, false); }
