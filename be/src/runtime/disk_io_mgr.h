...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/disk_io_mgr.h
...
#ifndef STARROCKS_BE_SRC_QUERY_RUNTIME_DISK_IO_MGR_H
#define STARROCKS_BE_SRC_QUERY_RUNTIME_DISK_IO_MGR_H
...
private:
    ...
    BufferDescriptor* get_buffer_desc(RequestContext* reader, ScanRange* range, char* buffer, int64_t buffer_size);
    ...
    bool get_next_request_range(DiskQueue* disk_queue, RequestRange** range, RequestContext** request_context);
    ...
    void handle_write_finished(RequestContext* writer, WriteRange* write_range, const Status& write_status);
...
#endif // STARROCKS_BE_SRC_QUERY_RUNTIME_DISK_IO_MGR_H
