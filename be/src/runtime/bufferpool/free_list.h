...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/bufferpool/free_list.h
...
#ifndef STARROCKS_BE_RUNTIME_BUFFERPOOL_FREE_LIST_H
#define STARROCKS_BE_RUNTIME_BUFFERPOOL_FREE_LIST_H
...
private:
    ...
    inline static bool HeapCompare(const BufferHandle& b1, const BufferHandle& b2) { return SortCompare(b2, b1); }
