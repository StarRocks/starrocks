...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/bufferpool/reservation_util.cc
...
int64_t ReservationUtil::GetReservationLimitFromMemLimit(int64_t mem_limit) {
    int64_t max_reservation =
            std::min<int64_t>(RESERVATION_MEM_FRACTION * mem_limit, mem_limit - RESERVATION_MEM_MIN_REMAINING);
