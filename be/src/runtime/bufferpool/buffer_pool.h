...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/bufferpool/buffer_pool.h
...
public:
    ...
    Status RegisterClient(const std::string& name, //TmpFileMgr::FileGroup* file_group,
                          ReservationTracker* parent_reservation, MemTracker* mem_tracker, int64_t reservation_limit,
    ...
    Status ExtractBuffer(ClientHandle* client, PageHandle* page_handle, BufferHandle* buffer_handle) WARN_UNUSED_RESULT;
    ...
    Status AllocateBuffer(ClientHandle* client, int64_t len, BufferHandle* handle) WARN_UNUSED_RESULT;
