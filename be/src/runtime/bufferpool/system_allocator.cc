...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/bufferpool/system_allocator.cc
...
SystemAllocator::SystemAllocator(int64_t min_buffer_len) : min_buffer_len_(min_buffer_len) {
    ...
    LOG_IF(WARNING, !aggressive_decommit_enabled) << "Disable aggressive memory decommit";
#endif
}
