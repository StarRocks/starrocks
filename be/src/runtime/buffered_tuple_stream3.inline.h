...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/buffered_tuple_stream3.inline.h
...
#ifndef STARROCKS_BE_RUNTIME_BUFFERED_TUPLE_STREAM_INLINE_H
#define STARROCKS_BE_RUNTIME_BUFFERED_TUPLE_STREAM_INLINE_H
