...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/tmp_file_mgr.h
...
public:
    ...
    Status init_custom(const std::vector<std::string>& tmp_dirs, bool one_dir_per_device, MetricRegistry* metrics);
...
#endif // STARROCKS_BE_SRC_QUERY_RUNTIME_TMP_FILE_MGR_H
