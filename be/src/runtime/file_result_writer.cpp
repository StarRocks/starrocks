...
Status FileResultWriter::_create_file_writer() {
    ...
    case TFileFormatType::FORMAT_PARQUET: {
        ...
        auto schema = parquet::ParquetBuildHelper::make_schema(_file_opts->file_column_names, _output_expr_ctxs);
        _file_builder = std::make_unique<ParquetBuilder>(std::move(writable_file), std::move(properties), std::move(schema),
