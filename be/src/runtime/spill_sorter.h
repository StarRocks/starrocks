...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/spill_sorter.h
...
#ifndef STARROCKS_BE_SRC_RUNTIME_SPILL_SORTER_H
#define STARROCKS_BE_SRC_RUNTIME_SPILL_SORTER_H
...
public:
    ...
    static uint64_t estimate_merge_mem(uint64_t available_blocks, RowDescriptor* row_desc, int merge_batch_size);
...
#endif // STARROCKS_BE_SRC_RUNTIME_SPILL_SORTER_H
