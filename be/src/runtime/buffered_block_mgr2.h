...
//   https://github.com/apache/incubator-doris/blob/master/be/src/runtime/buffered_block_mgr2.h
...
#ifndef STARROCKS_BE_SRC_RUNTIME_BUFFERED_BLOCK_MGR2_H
#define STARROCKS_BE_SRC_RUNTIME_BUFFERED_BLOCK_MGR2_H
...
public:
    ...
    private:
        ...
        BufferedBlockMgr2* _block_mgr = nullptr;
    ...
    static Status create(
            ...
            RuntimeState* state, MemTracker* parent, RuntimeProfile* profile, TmpFileMgr* tmp_file_mgr,
            int64_t mem_limit, int64_t buffer_size, std::shared_ptr<BufferedBlockMgr2>* block_mgr);
    ...
    Status register_client(int num_reserved_buffers, MemTracker* tracker, RuntimeState* state, Client** client);
...
private:
    ...
    Status allocate_scratch_space(int64_t block_size, TmpFileMgr::File** tmp_file, int64_t* file_offset);
    ...
    typedef boost::unordered_map<TUniqueId, std::weak_ptr<BufferedBlockMgr2> > BlockMgrsMap;
...
#endif // STARROCKS_BE_SRC_RUNTIME_BUFFERED_BLOCK_MGR2_H
