...
//   https://github.com/apache/incubator-doris/blob/master/be/src/plugin/plugin_mgr.h
...
#ifndef STARROCKS_BE_PLUGIN_PLUGIN_MGR_H
#define STARROCKS_BE_PLUGIN_PLUGIN_MGR_H
