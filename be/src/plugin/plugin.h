...
//   https://github.com/apache/incubator-doris/blob/master/be/src/plugin/plugin.h
...
#define STARROCKS_PLUGIN_VERSION 001100UL
...
#define __DECLARE_PLUGIN(VERSION, PSIZE, DECLS) \
    int VERSION = STARROCKS_PLUGIN_VERSION;     \
    int PSIZE = sizeof(struct Plugin);          \
    Plugin DECLS[] = {
// Plugin Name must be same with plugin's description file
#define declare_plugin(NAME) __DECLARE_PLUGIN(NAME##_plugin_interface_version, NAME##_sizeof_plugin, NAME##_plugin)
