...
// Forward-declare fmt::basic_format_string so Status can declare fmt overloads
...
public:
    ...
    static Status Unknown(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status PublishTimeout(std::string_view msg) { return Status(TStatusCode::PUBLISH_TIMEOUT, msg); }
    template <typename... Args>
    static Status PublishTimeout(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status MemoryAllocFailed(std::string_view msg) { return Status(TStatusCode::MEM_ALLOC_FAILED, msg); }
    template <typename... Args>
    static Status MemoryAllocFailed(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status BufferAllocFailed(std::string_view msg) { return Status(TStatusCode::BUFFER_ALLOCATION_FAILED, msg); }
    template <typename... Args>
    static Status BufferAllocFailed(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status InvalidArgument(std::string_view msg) { return Status(TStatusCode::INVALID_ARGUMENT, msg); }
    template <typename... Args>
    static Status InvalidArgument(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);
    ...
    template <typename... Args>
    static Status JsonFormatError(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status VariantError(std::string_view msg) { return Status(TStatusCode::DATA_QUALITY_ERROR, msg); }
    template <typename... Args>
    static Status VariantError(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);
    ...
    template <typename... Args>
    static Status GlobalDictError(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);
    ...
    template <typename... Args>
    static Status JitCompileError(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status CapacityLimitExceed(std::string_view msg) { return Status(TStatusCode::CAPACITY_LIMIT_EXCEED, msg); }
    template <typename... Args>
    static Status CapacityLimitExceed(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status Shutdown(std::string_view msg) { return Status(TStatusCode::SHUTDOWN, msg); }
    template <typename... Args>
    static Status Shutdown(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);
    ...
    template <typename... Args>
    static Status BigQueryCpuSecondLimitExceeded(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);
    ...
    template <typename... Args>
    static Status BigQueryScanRowsLimitExceeded(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status NotAuthorized(std::string_view msg) { return Status(TStatusCode::NOT_AUTHORIZED, msg); }
    template <typename... Args>
    static Status NotAuthorized(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status TableNotExist(std::string_view msg) { return Status(TStatusCode::TABLE_NOT_EXIST, msg); }
    template <typename... Args>
    static Status TableNotExist(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);

    static Status QueryNotExist(std::string_view msg) { return Status(TStatusCode::QUERY_NOT_EXIST, msg); }
    template <typename... Args>
    static Status QueryNotExist(fmt::basic_format_string<char, Args...> fmt_str, Args&&... args);
