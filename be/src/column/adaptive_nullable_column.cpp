...
void AdaptiveNullableColumn::append_selective_fixed_size(const Column& src, const uint32_t* indexes, uint32_t from,
                                                         uint32_t size) {
    materialized_nullable();
    NullableColumn::append_selective_fixed_size(src, indexes, from, size);
}
