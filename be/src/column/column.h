...
public:
    ...
    void fnv_hash(uint32_t* seed, uint32_t from, uint32_t to) const;
    void fnv_hash_with_selection(uint32_t* seed, uint8_t* selection, uint16_t from, uint16_t to) const;
    void fnv_hash_selective(uint32_t* seed, uint16_t* sel, uint16_t sel_size) const;
    void fnv_hash_at(uint32_t* seed, uint32_t idx) const { fnv_hash(seed - idx, idx, idx + 1); }

    // used by data loading compute tablet bucket
    void crc32_hash(uint32_t* seed, uint32_t from, uint32_t to) const;
    void crc32_hash_with_selection(uint32_t* seed, uint8_t* selection, uint16_t from, uint16_t to) const;
    void crc32_hash_selective(uint32_t* seed, uint16_t* sel, uint16_t sel_size) const;
    void crc32_hash_at(uint32_t* seed, uint32_t idx) const { crc32_hash(seed - idx, idx, idx + 1); }
    ...
    void murmur_hash3_x86_32(uint32_t* hash, uint32_t from, uint32_t to) const;
