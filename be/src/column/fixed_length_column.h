...
namespace starrocks {
template <typename T>
class FixedLengthColumn final : public COWHelper<ColumnFactory<FixedLengthColumnBase<T>, FixedLengthColumn<T>>,
                                                 FixedLengthColumn<T>, Column> {
    friend class COWHelper<ColumnFactory<FixedLengthColumnBase<T>, FixedLengthColumn<T>>, FixedLengthColumn<T>, Column>;

public:
    using ValueType = T;
    using Container = Buffer<ValueType>;
    using SuperClass =
            COWHelper<ColumnFactory<FixedLengthColumnBase<T>, FixedLengthColumn<T>>, FixedLengthColumn<T>, Column>;
