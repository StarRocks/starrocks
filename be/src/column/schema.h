...
public:
    ...
    explicit Schema(Fields fields, KeysType keys_type, std::vector<size_t> sort_column_idxes);
    ...
    const std::vector<size_t> sort_key_idxes() const { return _sort_key_idxes; }
...
private:
    ...
    Fields _fields;
    size_t _num_keys = 0;
    std::vector<size_t> _sort_key_idxes;
