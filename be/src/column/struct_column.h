...
private:
    // _fields and _field_names should have the same size.
    // A collection that contains StructType's field column.
    Columns _fields;
    // A collection that contains each struct field name.
