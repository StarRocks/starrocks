...
class NullableColumn : public COWHelper<ColumnFactory<Column, NullableColumn>, NullableColumn> {
    friend class COWHelper<ColumnFactory<Column, NullableColumn>, NullableColumn>;
...
public:
    ...
    inline static ColumnPtr wrap_if_necessary(ColumnPtr column) {
        ...
        return NullableColumn::create(column->assume_mutable(), null->assume_mutable());
    }
    ...
    using Base = COWHelper<ColumnFactory<Column, NullableColumn>, NullableColumn>;
    static Ptr create(const ColumnPtr& data_column, const ColumnPtr& null_column) {
        return NullableColumn::create(data_column->assume_mutable(), null_column->assume_mutable());
    }
    ...
    MutableColumnPtr data_column_mutable_ptr() { return _data_column->assume_mutable(); }
    ...
    NullColumn::MutablePtr null_column_mutable_ptr() {
        return NullColumn::static_pointer_cast(_null_column->assume_mutable());
    }
