...
// StorageColumnTraits: maps LogicalType to the storage-layer Column type.
// Separated from StorageTypeTraits so that TypesCore (types/) can remain
// independent of the column layer.
