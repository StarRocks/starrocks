...
public:
    ...
    inline SubstituteArg(const char* value) // NOLINT(runtime/explicit)
            : text_(value), size_(value == nullptr ? 0 : static_cast<int>(strlen(text_))) {}
    ...
    inline SubstituteArg(__int128 value) // NOLINT(runtime/explicit)
            : text_(scratch_),
              size_(static_cast<int>(FastInt64ToBufferLeft(static_cast<int64_t>(value), scratch_) - scratch_)) {}
    inline SubstituteArg(unsigned __int128 value) // NOLINT(runtime/explicit)
            : text_(scratch_),
              size_(static_cast<int>(FastUInt64ToBufferLeft(static_cast<uint64_t>(value), scratch_) - scratch_)) {}
