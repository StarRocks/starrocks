...
extern void GoogleOnceInternalInit(Atomic32* state, void (*func)(), void (*func_with_arg)(void*), void* arg);
...
public:
    ...
    void Init(void (*func_with_arg)(T*), T* arg) {
        ...
        if (PREDICT_FALSE(s != GOOGLE_ONCE_INTERNAL_DONE)) {
            // Deal with const T as well as non-const T.
            typedef typename base::remove_const<T>::type mutable_T;
            GoogleOnceInternalInit(&this->state_, 0, reinterpret_cast<void (*)(void*)>(func_with_arg),
                                   const_cast<mutable_T*>(arg));
        }
