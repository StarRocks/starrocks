...
//   https://github.com/apache/orc/tree/main/c++/test/TestDictionaryEncoding.cc
...
static std::unique_ptr<Reader> createReader(MemoryPool* memoryPool, std::unique_ptr<InputStream> stream) {
