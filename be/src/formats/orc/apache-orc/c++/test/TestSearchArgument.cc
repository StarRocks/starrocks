...
//   https://github.com/apache/orc/tree/main/c++/test/TestSearchArgument.cc
...
TEST(TestSearchArgument, predicateLeafTest) {
    ...
    PredicateLeaf leaf4(PredicateLeaf::Operator::LESS_THAN_EQUALS, PredicateDataType::DECIMAL, "sales",
                        {Literal(111222, 6, 3)});
...
TEST(TestSearchArgument, testNotPushdown) {
    ...
    EXPECT_EQ("(not leaf-1)", SearchArgumentBuilderImpl::pushDownNot(_not(_not(_not(_leaf(1)))))->toString());
    ...
    EXPECT_EQ("(or (or (not leaf-1) leaf-2) leaf-3)",
              SearchArgumentBuilderImpl::pushDownNot(_or(_not(_and(_leaf(1), _not(_leaf(2)))), _not(_not(_leaf(3)))))
                      ->toString());
    EXPECT_EQ("NO", SearchArgumentBuilderImpl::pushDownNot(_not(_constant(TruthValue::YES)))->toString());
    EXPECT_EQ("YES", SearchArgumentBuilderImpl::pushDownNot(_not(_constant(TruthValue::NO)))->toString());
    EXPECT_EQ("IS_NULL", SearchArgumentBuilderImpl::pushDownNot(_not(_constant(TruthValue::IS_NULL)))->toString());
    EXPECT_EQ("YES_NO", SearchArgumentBuilderImpl::pushDownNot(_not(_constant(TruthValue::YES_NO)))->toString());
    EXPECT_EQ("YES_NULL", SearchArgumentBuilderImpl::pushDownNot(_not(_constant(TruthValue::NO_NULL)))->toString());
    EXPECT_EQ("NO_NULL", SearchArgumentBuilderImpl::pushDownNot(_not(_constant(TruthValue::YES_NULL)))->toString());
...
TEST(TestSearchArgument, testFlatten) {
    ...
    EXPECT_EQ("(not (not leaf-1))", SearchArgumentBuilderImpl::flatten(_not(_not(_leaf(1))))->toString());
    EXPECT_EQ("(and leaf-1 leaf-2)", SearchArgumentBuilderImpl::flatten(_and(_leaf(1), _leaf(2)))->toString());
    ...
    EXPECT_EQ("(and leaf-1 leaf-2 leaf-3 leaf-4)",
              SearchArgumentBuilderImpl::flatten(_and(_and(_leaf(1), _leaf(2)), _and(_leaf(3), _leaf(4))))->toString());
    EXPECT_EQ("(or leaf-1 leaf-2 leaf-3 leaf-4)",
              SearchArgumentBuilderImpl::flatten(_or(_leaf(1), _or(_leaf(2), _or(_leaf(3), _leaf(4)))))->toString());
    EXPECT_EQ("(or leaf-1 leaf-2 leaf-3 leaf-4)",
              SearchArgumentBuilderImpl::flatten(_or(_or(_or(_leaf(1), _leaf(2)), _leaf(3)), _leaf(4)))->toString());
    ...
    EXPECT_EQ("(not (and leaf-1 leaf-2 leaf-3))",
              SearchArgumentBuilderImpl::flatten(_not(_and(_leaf(1), _and(_leaf(2), _leaf(3)))))->toString());
}

TEST(TestSearchArgument, testFoldMaybe) {
    EXPECT_EQ("(and leaf-1)",
              SearchArgumentBuilderImpl::foldMaybe(_and(_leaf(1), _constant(TruthValue::YES_NO_NULL)))->toString());
    ...
    EXPECT_EQ("(and leaf-1 leaf-2)",
              SearchArgumentBuilderImpl::foldMaybe(_and(NodeList{_constant(TruthValue::YES_NO_NULL), _leaf(1), _leaf(2),
    ...
    EXPECT_EQ("YES_NO_NULL", SearchArgumentBuilderImpl::foldMaybe(
                                     ...
                                     ->toString());
    EXPECT_EQ("YES_NO_NULL",
              SearchArgumentBuilderImpl::foldMaybe(_or(_leaf(1), _constant(TruthValue::YES_NO_NULL)))->toString());
    EXPECT_EQ("(or leaf-1 (and leaf-2))",
              SearchArgumentBuilderImpl::foldMaybe(_or(_leaf(1), _and(_leaf(2), _constant(TruthValue::YES_NO_NULL))))
                      ->toString());
    EXPECT_EQ("(and leaf-1)",
              SearchArgumentBuilderImpl::foldMaybe(_and(_or(_leaf(2), _constant(TruthValue::YES_NO_NULL)), _leaf(1)))
                      ->toString());
    EXPECT_EQ("(and leaf-100)",
              SearchArgumentBuilderImpl::foldMaybe(
                      SearchArgumentBuilderImpl::convertToCNF(_and(
                              _leaf(100),
                              _or(NodeList{_and(_leaf(0), _leaf(1)), _and(_leaf(2), _leaf(3)), _and(_leaf(4), _leaf(5)),
                                           _and(_leaf(6), _leaf(7)), _and(_leaf(8), _leaf(9)),
                                           _and(_leaf(10), _leaf(11)), _and(_leaf(12), _leaf(13)),
                                           _and(_leaf(14), _leaf(15)), _and(_leaf(16), _leaf(17))}))))
                      ->toString());
}
...
TEST(TestSearchArgument, testCNF) {
    ...
    EXPECT_EQ("(and leaf-1 leaf-2)", SearchArgumentBuilderImpl::convertToCNF(_and(_leaf(1), _leaf(2)))->toString());
    ...
    EXPECT_EQ("(and (or leaf-1 leaf-2) (not leaf-3))",
              SearchArgumentBuilderImpl::convertToCNF(_and(_or(_leaf(1), _leaf(2)), _not(_leaf(3))))->toString());
    EXPECT_EQ(
            "(and (or leaf-1 leaf-3) (or leaf-2 leaf-3)"
            " (or leaf-1 leaf-4) (or leaf-2 leaf-4))",
            SearchArgumentBuilderImpl::convertToCNF(_or(_and(_leaf(1), _leaf(2)), _and(_leaf(3), _leaf(4))))
                    ->toString());
    EXPECT_EQ(
            "(and"
    ...
    EXPECT_EQ(
            ...
            SearchArgumentBuilderImpl::convertToCNF(_or(NodeList{_and(_leaf(1), _leaf(2)), _and(_leaf(3), _leaf(4)),
    ...
    EXPECT_EQ("YES_NO_NULL",
              SearchArgumentBuilderImpl::convertToCNF(
                      _or(NodeList{_and(_leaf(0), _leaf(1)), _and(_leaf(2), _leaf(3)), _and(_leaf(4), _leaf(5)),
                                   _and(_leaf(6), _leaf(7)), _and(_leaf(8), _leaf(9)), _and(_leaf(10), _leaf(11)),
                                   _and(_leaf(12), _leaf(13)), _and(_leaf(14), _leaf(15)), _and(_leaf(16), _leaf(17))}))
                      ->toString());
...
TEST(TestSearchArgument, testBuilderComplexTypes2) {
    auto sarg = SearchArgumentFactory::newBuilder()
                        ->startAnd()
                        .lessThan("x", PredicateDataType::DATE, Literal(PredicateDataType::DATE, 11111L)) // "2005-3-12"
                        .lessThanEquals("y", PredicateDataType::STRING, Literal("hi        ", 10))
                        .equals("z", PredicateDataType::DECIMAL, Literal(10, 2, 1))
                        .end()
                        .build();
