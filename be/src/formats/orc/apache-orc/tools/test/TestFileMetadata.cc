...
TEST(TestFileMetadata, testAttributes) {
    ...
    const std::string expected =
            ...
            "\",\n"
            "  \"type\": "
            "\"struct<id:bigint,int_array:array<int>,int_array_array:array<array<int>>,int_map:map<string,int>,int_map_"
            "array:array<map<string,int>>,nested_struct:struct<a:int,b:array<int>,c:struct<d:array<array<struct<e:int,"
            "f:string>>>>,g:map<string,struct<h:struct<i:array<double>>>>>>\",\n"
            "  \"attributes\": {\n"
