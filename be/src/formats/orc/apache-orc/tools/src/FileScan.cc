...
// https://github.com/apache/orc/tree/main/tools/src/FileScan.cc
...
void scanFile(std::ostream& out, const char* filename, uint64_t batchSize, const orc::RowReaderOptions& rowReaderOpts,
              bool showMetrics) {
