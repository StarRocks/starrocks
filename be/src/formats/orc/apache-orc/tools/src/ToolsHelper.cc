...
void printReaderMetrics(std::ostream& out, const orc::ReaderMetrics* metrics) {
    if (metrics != nullptr) {
        ...
        out << "DecompressionLatencySeconds: " << metrics->DecompressionLatencyUs / US_PER_SECOND << std::endl;
        out << "DecodingLatencySeconds: " << metrics->DecodingLatencyUs / US_PER_SECOND << std::endl;
        out << "ByteDecodingLatencySeconds: " << metrics->ByteDecodingLatencyUs / US_PER_SECOND << std::endl;
        out << "IOBlockingLatencySeconds: " << metrics->IOBlockingLatencyUs / US_PER_SECOND << std::endl;
