...
public:
    ...
    static void orc_date_to_native_date(DateValue* dv, int64_t value) {
        dv->_julian = static_cast<JulianDate>(value + date::UNIX_EPOCH_JULIAN);
    }
    static void orc_date_to_native_date(JulianDate* jd, int64_t value) {
        *jd = static_cast<JulianDate>(value + date::UNIX_EPOCH_JULIAN);
    }
};
