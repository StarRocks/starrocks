...
public:
    ...
    virtual Status get_next(orc::ColumnVectorBatch* cvb, Column* col, size_t from, size_t size) = 0;
...
public:
    ...
    Status get_next(orc::ColumnVectorBatch* cvb, Column* col, size_t from, size_t size) override;
};
...
private:
    ...
    Status _fill_int_column_with_null_from_cvb(OrcColumnVectorBatch* data, Column* col, size_t from, size_t size);

    template <typename OrcColumnVectorBatch>
    Status _fill_int_column_from_cvb(OrcColumnVectorBatch* data, Column* col, size_t from, size_t size);
};
...
private:
    template <typename OrcColumnVectorBatch>
    Status _fill_double_column_from_cvb(OrcColumnVectorBatch* data, Column* col, const size_t vb_pos_from,
...
private:
    template <typename T>
    inline void _fill_decimal_column_generic(orc::ColumnVectorBatch* cvb, Column* col, size_t from, size_t size);
};
...
private:
    Status _fill_array_column(orc::ColumnVectorBatch* cvb, Column* col, size_t from, size_t size);
};
...
private:
    Status _fill_map_column(orc::ColumnVectorBatch* cvb, Column* col, size_t from, size_t size);
};
...
private:
    Status _fill_struct_column(orc::ColumnVectorBatch* cvb, Column* col, size_t from, size_t size);
};
