...
>>>>>>> 91a4bc69e1 ([Enhancement] Support write iceberg row lineage fields into data files during compaction (#70128))
    ...
    Status IcebergRowLineageReader::prepare() { return _delegate == nullptr ? Status::OK() : _delegate->prepare(); }
    ...
    StatusOr<ColumnPtr> IcebergRowLineageReader::read_physical_bigint_range(const Range<uint64_t>& range,
        ...
        ColumnPtr physical =
                ColumnHelper::create_column(TypeDescriptor::from_logical_type(LogicalType::TYPE_BIGINT), true);
    ...
    StatusOr<bool> IcebergRowIdReader::row_group_zone_map_filter(
    ...
    StatusOr<bool> IcebergRowIdReader::page_index_zone_map_filter(
    ...
    IcebergLastUpdatedSequenceNumberReader::IcebergLastUpdatedSequenceNumberReader(
            ColumnReaderPtr delegate, bool can_use_fallback, Datum fallback_value)
    ...
    StatusOr<bool> IcebergLastUpdatedSequenceNumberReader::page_index_zone_map_filter(
        ...
        FixedValueColumnReader fallback_reader(_can_use_fallback ? _fallback_value : kNullDatum);
        return fallback_reader.page_index_zone_map_filter(predicates, row_ranges, pred_relation, rg_first_row,
                                                          rg_num_rows);
    }
