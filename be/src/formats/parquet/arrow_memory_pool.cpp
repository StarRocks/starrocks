...
ArrowMemoryPool::Status ArrowMemoryPool::Allocate(int64_t size, uint8_t** out) {
    if (size == 0) {
        *out = kZeroSizeArea;
    }
...
ArrowMemoryPool::Status ArrowMemoryPool::Reallocate(int64_t old_size, int64_t new_size, uint8_t** ptr) {
