...
public:
    ...
    CSVReader(const std::string& row_delimiter, const std::string& column_separator, bool trim_space, char escape,
              char enclose, const size_t bufferSize = kMinBufferSize)
