...
public class KerberosConfiguration {
    private final KerberosPrincipal kerberosPrincipalObject;
    ...
    public KerberosConfiguration withDebug() {
        ...
        optionsBuilder.putAll(options)
                .put("debug", "true");
        return new KerberosConfiguration(kerberosPrincipalObject, optionsBuilder.build());
    }
    ...
    public static class Builder {
        ...
        public KerberosConfiguration build() {
            ...
            checkArgument(keytabLocation.isPresent() ^ credentialCacheLocation.isPresent(),
                    "Either keytab or credential cache must be specified");
            ...
            return new KerberosConfiguration(kerberosPrincipal, optionsBuilder.build());
        }
