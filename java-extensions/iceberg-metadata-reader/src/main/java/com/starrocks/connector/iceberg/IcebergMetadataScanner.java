...
public class IcebergMetadataScanner extends ConnectorScanner {
    ...
    public void open() throws IOException {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            this.predicate = predicateInfo.length() == 0 ? Expressions.alwaysTrue() : deserializeFromBase64(predicateInfo);
    ...
    private byte[] getPartitionData(ContentFile<?> file) {
        ...
        return SerializationUtil.serializeToBytes(partitionData);
    }
