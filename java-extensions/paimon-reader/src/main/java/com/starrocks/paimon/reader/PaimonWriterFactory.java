...
public class PaimonWriterFactory implements ScannerFactory {
    ...
    static {
        ...
        Collections.addAll(preloadFiles, dir.listFiles());
        classLoader = ScannerHelper.createChildFirstClassLoader(preloadFiles, "paimon writer");
    }
