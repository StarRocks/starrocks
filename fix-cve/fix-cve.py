...
io_netty_clean_version = "4.1.137.Final"

fixed_poms = [
    ("com.fasterxml.jackson.core:jackson-core", "2.21.4"),
    ("com.fasterxml.jackson.core:jackson-databind", "2.21.4"),
    # io.netty (complete Netty 4.1 runtime module set)
    ("io.netty:netty-all", io_netty_clean_version),
    ("io.netty:netty-buffer", io_netty_clean_version),
    ("io.netty:netty-common", io_netty_clean_version),
    ("io.netty:netty-resolver", io_netty_clean_version),
    ("io.netty:netty-resolver-dns", io_netty_clean_version),
    ("io.netty:netty-resolver-dns-classes-macos", io_netty_clean_version),
    ("io.netty:netty-resolver-dns-native-macos", io_netty_clean_version),
    ("io.netty:netty-handler", io_netty_clean_version),
    ("io.netty:netty-handler-proxy", io_netty_clean_version),
    ("io.netty:netty-handler-ssl-ocsp", io_netty_clean_version),
    ...
    ("io.netty:netty-codec-memcache", io_netty_clean_version),
    ("io.netty:netty-codec-mqtt", io_netty_clean_version),
    ("io.netty:netty-codec-redis", io_netty_clean_version),
    ("io.netty:netty-codec-smtp", io_netty_clean_version),
    ("io.netty:netty-codec-socks", io_netty_clean_version),
    ("io.netty:netty-codec-stomp", io_netty_clean_version),
    ("io.netty:netty-codec-xml", io_netty_clean_version),
    ("io.netty:netty-transport", io_netty_clean_version),
    ("io.netty:netty-transport-classes-epoll", io_netty_clean_version),
    ("io.netty:netty-transport-classes-kqueue", io_netty_clean_version),
    ("io.netty:netty-transport-native-epoll", io_netty_clean_version),
    ("io.netty:netty-transport-native-kqueue", io_netty_clean_version),
    ("io.netty:netty-transport-native-unix-common", io_netty_clean_version),
    ("io.netty:netty-transport-rxtx", io_netty_clean_version),
    ("io.netty:netty-transport-sctp", io_netty_clean_version),
    ("io.netty:netty-transport-udt", io_netty_clean_version),
    ("com.google.protobuf:protobuf-java", "3.25.5"),
    ("org.apache.avro:avro", "1.11.4"),
    ("org.apache.commons:commons-compress", "1.26.0"),
    ("com.google.guava:guava", "32.0.1-jre"),
    ("org.eclipse.jetty:jetty-webapp", "10.0.31"),
    ("org.eclipse.jetty:jetty-security", "10.0.31"),
    ("org.eclipse.jetty:jetty-server", "10.0.31"),
    ("org.eclipse.jetty:jetty-http", "10.0.28-celerdata-b20260421"),
    ("org.eclipse.jetty:jetty-xml", "10.0.31"),
    ("org.eclipse.jetty:jetty-io", "10.0.31"),
