...
# benchmark
BENCHMARK_DOWNLOAD="https://github.com/google/benchmark/archive/refs/tags/v1.6.1.tar.gz"
BENCHMARK_NAME="benchmark-1.6.1.tar.gz"
BENCHMARK_SOURCE="benchmark-1.6.1"
BENCHMARK_MD5SUM="8c33c51f9b7154e6c290df3750081c87"
...
TP_ARCHIVES="LIBEVENT OPENSSL THRIFT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SIMDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP CURL \
            ...
            CCTZ FMT RYU BREAK_PAD HADOOP JDK RAGEL HYPERSCAN MARIADB ALIYUN_OSS_JARS AWS_SDK_CPP VPACK BENCHMARK"
