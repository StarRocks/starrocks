...
# starcache
STARCACHE_DOWNLOAD="https://github.com/StarRocks/starcache/archive/refs/tags/v1.0.0-rc01.tar.gz"
STARCACHE_NAME="starcache-v1.0.0-rc01.tar.gz"
STARCACHE_SOURCE="starcache-v1.0.0-rc01"
STARCACHE_MD5SUM="d50333fd31e0dbd3d049a46e857c3208"
...
TP_ARCHIVES="LIBEVENT OPENSSL THRIFT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SIMDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP CURL \
            ...
            BENCHMARK FAST_FLOAT CACHELIB STREAMVBYTE BROKER_THIRDPARTY_JARS JANSSON AVRO SERDES GCS_CONNECTOR STARCACHE"
