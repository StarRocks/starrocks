...
HADOOPSRC_DOWNLOAD="https://archive.apache.org/dist/hadoop/common/hadoop-3.4.0/hadoop-3.4.0-src.tar.gz"
HADOOPSRC_NAME="hadoop-3.4.0-src.tar.gz"
HADOOPSRC_SOURCE="hadoop-3.4.0-src"
HADOOPSRC_MD5SUM="869c13ad53df6da46a81b5e797852458"
...
TP_ARCHIVES="CLUCENE LIBEVENT OPENSSL THRIFT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SIMDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP CURL \
            ...
            JEMALLOC CCTZ FMT RYU BREAK_PAD HADOOP HADOOPSRC JDK RAGEL HYPERSCAN MARIADB JINDOSDK AWS_SDK_CPP VPACK OPENTELEMETRY \
