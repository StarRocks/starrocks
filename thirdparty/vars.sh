...
# zstd
ZSTD_DOWNLOAD="https://github.com/facebook/zstd/releases/download/v1.5.6/zstd-1.5.6.tar.gz"
ZSTD_NAME=zstd-1.5.6.tar.gz
ZSTD_SOURCE=zstd-1.5.6
ZSTD_MD5SUM="5a473726b3445d0e5d6296afd1ab6854"
