...
# aliyun_oss_jars
ALIYUN_OSS_JARS_DOWNLOAD="http://cdn-thirdparty.starrocks.com/aliyun_oss_jars.tar.gz"
ALIYUN_OSS_JARS_NAME="aliyun_oss_jars.tar.gz"
ALIYUN_OSS_JARS_SOURCE="aliyun_oss_jars"
ALIYUN_OSS_JARS_MD5SUM="e3120907a3d976ba55c04d51df898d30"

# all thirdparties which need to be downloaded is set in array TP_ARCHIVES
TP_ARCHIVES="LIBEVENT OPENSSL THRIFT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SIMDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP CURL RE2 BOOST LEVELDB BRPC ROCKSDB LIBRDKAFKA FLATBUFFERS ARROW BROTLI ZSTD S2 BITSHUFFLE CROARINGBITMAP JEMALLOC CCTZ FMT RYU BREAK_PAD HADOOP JDK RAGEL HYPERSCAN MARIADB ALIYUN_OSS_JARS"
