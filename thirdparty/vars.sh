...
# thrift
THRIFT_DOWNLOAD="http://archive.apache.org/dist/thrift/0.14.1/thrift-0.14.1.tar.gz"
THRIFT_NAME=thrift-0.14.1.tar.gz
THRIFT_SOURCE=thrift-0.14.1
THRIFT_MD5SUM="c64434548438df2cb1e53fb27c600e85"
