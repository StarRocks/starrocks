...
# ALP (Adaptive Lossless floating-Point compression), used by the ALP_ENCODING
# column encoding for FLOAT/DOUBLE data pages.
ALP_DOWNLOAD="https://github.com/cwida/ALP/archive/31ca0ed11c93c99d3f5b5c30e01a3e1c3832d3ce.tar.gz"
ALP_NAME=ALP-31ca0ed.tar.gz
ALP_SOURCE=ALP-31ca0ed11c93c99d3f5b5c30e01a3e1c3832d3ce
ALP_MD5SUM="9cfe18ea74d6d970d0722fc3890ee3a5"
...
TP_ARCHIVES="CLUCENE LIBEVENT OPENSSL THRIFT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SIMDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP CURL \
            ...
            BLAKE3 BENCHGEN PAIMON_CPP ALP"
