...
# libunistring
LIBFUNISTRING_DOWNLOAD="https://ftp.gnu.org/gnu/libunistring/libunistring-1.2.tar.gz"
LIBFUNISTRING_NAME="libunistring-1.2.tar.gz"
LIBFUNISTRING_SOURCE="libunistring-1.2"
LIBFUNISTRING_MD5SUM="71ddadc6482184d5936c4afd5d712ec0"
...
TP_ARCHIVES="CLUCENE LIBEVENT OPENSSL THRIFT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SIMDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP CURL \
            ...
            ASYNC_PROFILER FIU LIBDEFLATE LLVM LIBFUNISTRING GMP LIBFPE"
