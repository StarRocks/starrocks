...
StarRocks v3.0 支持为 [CREATE TABLE AS SELECT](../data-definition/CREATE%20TABLE%20AS%20SELECT.md) 和 [INSERT](../data-manipulation/insert.md) 创建异步任务。

您可以使用 [DROP TASK](./DROP%20TASK.md) 删除异步任务。
