...
可以使用两种方式导入 STRUCT 数据到 StarRocks：[INSERT INTO](../../../loading/InsertInto.md) 和 [ORC/Parquet 文件导入](../../../loading/BrokerLoad.md)。
...
StarRocks 的 STRUCT 类型对应 ORC 和 Parquet 格式中的嵌套列 (nested columns structure)，无需您做额外的转换或定义。具体导入操作，参考 [Broker Load 文档](../../../loading/BrokerLoad.md)。
