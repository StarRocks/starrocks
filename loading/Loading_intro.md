...
* Mysql data import. It is recommend to use [Mysql external table](/loading/External_table) to import (`insert into new_table select * from external_table`)
...
* **Tablet**: Logical partitioning of StarRocks tables. A table can be divided into multiple tablets according to partitioning and bucketing rules (refer to [Data Distribution](section 3.3 Data Distribution.md)).
