...
# Explicitly put fe-core-4.1.1.jar at the front of classpath to ensure StarRocks'
...
export CLASSPATH=${STARROCKS_HOME}/lib/fe-core-4.1.1.jar:${STARROCKS_HOME}/lib/starrocks-hadoop-ext.jar:${CLASSPATH}:${STARROCKS_HOME}/lib:${STARROCKS_HOME}/conf
