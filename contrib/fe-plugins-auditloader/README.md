...
1. Download the Audit Loader installation package. The package varies in accordance with different StarRocks versions. You must install the package that is compatible with your StarRocks.
