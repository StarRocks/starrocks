...
enum TStatusCode {
    ...
    INVERTED_INDEX_NOT_SUPPORTED = 56,
    INVERTED_INDEX_FILE_NOT_FOUND = 57,
    INVERTED_INDEX_NO_TERMS = 58,
    INVERTED_INDEX_INVALID_PARAMETERS = 59,
    INVERTED_INDEX_FILE_HIT_LIMIT = 60,
    INVERTED_INDEX_CLUCENE_ERROR = 61,
