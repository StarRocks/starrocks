...
struct TRuntimeFilterDescription {
  ...
  23: optional bool is_close_interval;
  24: optional i64 limit;
}
...
struct TRuntimeFilterParams {
  ...
  // Runtime filter Id which is generated by skew join, these rfs need wait broadcast's GRF instance
  // only set when this query is optimized by SkewShuffleJoinEliminationRule
  5: optional set<i32> skew_join_runtime_filters;
}
