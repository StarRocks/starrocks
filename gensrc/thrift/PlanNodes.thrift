...
// Compressed values node for efficient serialization of large constant lists
struct TCompressedValuesNode {
    // Tuple ID for the output
    1: required Types.TTupleId tuple_id
    // The data type of the constants
    2: required Types.TTypeDesc value_type
    // Number of constants in the list
    3: required i32 constant_count
    // Typed constant lists for better compression
    4: optional list<i64> long_values      // For BIGINT, INT types
    5: optional list<string> string_values // For VARCHAR types
}
...
struct TPlanNode {
  ...
  36: optional TCompressedValuesNode compressed_values_node
