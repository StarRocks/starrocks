...
struct TStreamLoadPutRequest {
    ...
    // Flexible partial update: set by the BE stream load handler for partial_update_mode=flexible and
    // partial_update_mode=flexible_row. partial_update_mode carries the storage mode; this bit asks FE to
    // plan per-row column sets.
