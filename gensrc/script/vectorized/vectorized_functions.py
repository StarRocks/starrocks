...
vectorized_functions = [
    ...
    [110016, "json_length", "INT", ["JSON"], "JsonFunctions::json_length", "JsonFunctions::native_json_path_prepare", "JsonFunctions::native_json_path_close", False],
    [110017, "json_length", "INT", ["JSON", "VARCHAR"], "JsonFunctions::json_length", "JsonFunctions::native_json_path_prepare", "JsonFunctions::native_json_path_close", False],
