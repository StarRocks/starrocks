...
vectorized_functions = [
    ...
    [150160, 'array_difference', 'ARRAY_SMALLINT', ['ARRAY_TINYINT'], 'ArrayFunctions::array_difference_tinyint'],
    [150161, 'array_difference', 'ARRAY_INT', ['ARRAY_SMALLINT'], 'ArrayFunctions::array_difference_smallint'],
    [150162, 'array_difference', 'ARRAY_BIGINT', ['ARRAY_INT'], 'ArrayFunctions::array_difference_int'],
    [150163, 'array_difference', 'ARRAY_LARGEINT', ['ARRAY_BIGINT'], 'ArrayFunctions::array_difference_bigint'],
    ...
    [150170, 'array_slice', 'ARRAY_BOOLEAN',   ['ARRAY_BOOLEAN', 'BIGINT', 'BIGINT'],   'ArrayFunctions::array_slice_boolean'],
    [150171, 'array_slice', 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'BIGINT', 'BIGINT'],   'ArrayFunctions::array_slice_tinyint'],
    [150172, 'array_slice', 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'BIGINT', 'BIGINT'],  'ArrayFunctions::array_slice_smallint'],
    [150173, 'array_slice', 'ARRAY_INT',       ['ARRAY_INT', 'BIGINT', 'BIGINT'],       'ArrayFunctions::array_slice_int'],
    [150174, 'array_slice', 'ARRAY_BIGINT',    ['ARRAY_BIGINT', 'BIGINT', 'BIGINT'],    'ArrayFunctions::array_slice_bigint'],
    ...
    [150190, 'array_concat', 'ARRAY_BOOLEAN',   ['ARRAY_BOOLEAN', "..."],   'ArrayFunctions::array_concat_boolean'],
    [150191, 'array_concat', 'ARRAY_TINYINT',   ['ARRAY_TINYINT', "..."],   'ArrayFunctions::array_concat_tinyint'],
    [150192, 'array_concat', 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', "..."],  'ArrayFunctions::array_concat_smallint'],
    [150193, 'array_concat', 'ARRAY_INT',       ['ARRAY_INT', "..."],       'ArrayFunctions::array_concat_int'],
    [150194, 'array_concat', 'ARRAY_BIGINT',    ['ARRAY_BIGINT', "..."],    'ArrayFunctions::array_concat_bigint'],
    [150195, 'array_concat', 'ARRAY_LARGEINT',  ['ARRAY_LARGEINT', "..."],  'ArrayFunctions::array_concat_largeint'],
    [150196, 'array_concat', 'ARRAY_FLOAT',     ['ARRAY_FLOAT', "..."],     'ArrayFunctions::array_concat_float'],
    [150197, 'array_concat', 'ARRAY_DOUBLE',    ['ARRAY_DOUBLE', "..."],    'ArrayFunctions::array_concat_double'],
    [150198, 'array_concat', 'ARRAY_VARCHAR',   ['ARRAY_VARCHAR', "..."],   'ArrayFunctions::array_concat_varchar'],
    [150199, 'array_concat', 'ARRAY_DECIMALV2', ['ARRAY_DECIMALV2', "..."], 'ArrayFunctions::array_concat_decimalv2'],
    [150200, 'array_concat', 'ARRAY_DATETIME',  ['ARRAY_DATETIME', "..."],  'ArrayFunctions::array_concat_datetime'],
    [150201, 'array_concat', 'ARRAY_DATE',      ['ARRAY_DATE', "..."],      'ArrayFunctions::array_concat_date'],
]
