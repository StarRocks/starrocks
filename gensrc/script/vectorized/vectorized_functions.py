...
vectorized_functions = [
    ...
    [120171, "fpe_encrypt", "VARCHAR", ["VARCHAR", "VARCHAR"], "EncryptionFunctions::fpe_encrypt_num", False],
    [120172, "fpe_ff1_decrypt", "VARCHAR", ["VARCHAR", "VARCHAR", "INT"], "EncryptionFunctions::fpe_ff1_decrypt", False],
    [120173, "fpe_decrypt", "VARCHAR", ["VARCHAR", "VARCHAR",], "EncryptionFunctions::fpe_decrypt_num", False],
