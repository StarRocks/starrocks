...
vectorized_functions = [
    ...
    [150185, 'array_slice', 'ARRAY_DATE',      ['ARRAY_DATE', 'BIGINT'],      'ArrayFunctions::array_slice_date'],
    [150186, 'array_slice', 'ARRAY_DATETIME',  ['ARRAY_DATETIME', 'BIGINT'],  'ArrayFunctions::array_slice_datetime'],
    [150187, 'array_slice', 'ARRAY_BOOLEAN',   ['ARRAY_BOOLEAN', 'BIGINT'],   'ArrayFunctions::array_slice_boolean'],
    [150188, 'array_slice', 'ARRAY_TINYINT',   ['ARRAY_TINYINT', 'BIGINT'],   'ArrayFunctions::array_slice_tinyint'],
    [150189, 'array_slice', 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', 'BIGINT'],  'ArrayFunctions::array_slice_smallint'],
    [150190, 'array_slice', 'ARRAY_INT',       ['ARRAY_INT', 'BIGINT'],       'ArrayFunctions::array_slice_int'],
    [150191, 'array_slice', 'ARRAY_BIGINT',    ['ARRAY_BIGINT', 'BIGINT'],    'ArrayFunctions::array_slice_bigint'],
    [150192, 'array_slice', 'ARRAY_LARGEINT',  ['ARRAY_LARGEINT', 'BIGINT'],  'ArrayFunctions::array_slice_largeint'],
    [150193, 'array_slice', 'ARRAY_FLOAT',     ['ARRAY_FLOAT', 'BIGINT'],     'ArrayFunctions::array_slice_float'],
    [150194, 'array_slice', 'ARRAY_DOUBLE',    ['ARRAY_DOUBLE', 'BIGINT'],    'ArrayFunctions::array_slice_double'],
    [150195, 'array_slice', 'ARRAY_DECIMALV2', ['ARRAY_DECIMALV2', 'BIGINT'], 'ArrayFunctions::array_slice_decimalv2'],
    [150196, 'array_slice', 'ARRAY_VARCHAR',   ['ARRAY_VARCHAR', 'BIGINT'],   'ArrayFunctions::array_slice_varchar'],

    [150200, 'array_concat', 'ARRAY_DATE',      ['ARRAY_DATE', "..."],      'ArrayFunctions::array_concat_date'],
    [150201, 'array_concat', 'ARRAY_DATETIME',  ['ARRAY_DATETIME', "..."],  'ArrayFunctions::array_concat_datetime'],
    [150202, 'array_concat', 'ARRAY_BOOLEAN',   ['ARRAY_BOOLEAN', "..."],   'ArrayFunctions::array_concat_boolean'],
    [150203, 'array_concat', 'ARRAY_TINYINT',   ['ARRAY_TINYINT', "..."],   'ArrayFunctions::array_concat_tinyint'],
    [150204, 'array_concat', 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', "..."],  'ArrayFunctions::array_concat_smallint'],
    [150205, 'array_concat', 'ARRAY_INT',       ['ARRAY_INT', "..."],       'ArrayFunctions::array_concat_int'],
    [150206, 'array_concat', 'ARRAY_BIGINT',    ['ARRAY_BIGINT', "..."],    'ArrayFunctions::array_concat_bigint'],
    [150207, 'array_concat', 'ARRAY_LARGEINT',  ['ARRAY_LARGEINT', "..."],  'ArrayFunctions::array_concat_largeint'],
    [150208, 'array_concat', 'ARRAY_FLOAT',     ['ARRAY_FLOAT', "..."],     'ArrayFunctions::array_concat_float'],
    [150209, 'array_concat', 'ARRAY_DOUBLE',    ['ARRAY_DOUBLE', "..."],    'ArrayFunctions::array_concat_double'],
    [150210, 'array_concat', 'ARRAY_DECIMALV2', ['ARRAY_DECIMALV2', "..."], 'ArrayFunctions::array_concat_decimalv2'],
    [150211, 'array_concat', 'ARRAY_VARCHAR',   ['ARRAY_VARCHAR', "..."],   'ArrayFunctions::array_concat_varchar'],

    [150220, 'array_overlap', 'BOOLEAN',      ['ARRAY_DATE', 'ARRAY_DATE'],        'ArrayFunctions::array_overlap_date'],
    [150221, 'array_overlap', 'BOOLEAN',  ['ARRAY_DATETIME', 'ARRAY_DATETIME'],    'ArrayFunctions::array_overlap_datetime'],
    [150222, 'array_overlap', 'BOOLEAN',   ['ARRAY_BOOLEAN', 'ARRAY_BOOLEAN'],     'ArrayFunctions::array_overlap_boolean'],
    [150223, 'array_overlap', 'BOOLEAN',   ['ARRAY_TINYINT', 'ARRAY_TINYINT'],     'ArrayFunctions::array_overlap_tinyint'],
    [150224, 'array_overlap', 'BOOLEAN',  ['ARRAY_SMALLINT', 'ARRAY_SMALLINT'],    'ArrayFunctions::array_overlap_smallint'],
    [150225, 'array_overlap', 'BOOLEAN',       ['ARRAY_INT', 'ARRAY_INT'],         'ArrayFunctions::array_overlap_int'],
    [150226, 'array_overlap', 'BOOLEAN',    ['ARRAY_BIGINT', 'ARRAY_BIGINT'],      'ArrayFunctions::array_overlap_bigint'],
    [150227, 'array_overlap', 'BOOLEAN',  ['ARRAY_LARGEINT', 'ARRAY_LARGEINT'],    'ArrayFunctions::array_overlap_largeint'],
    [150228, 'array_overlap', 'BOOLEAN',     ['ARRAY_FLOAT', 'ARRAY_FLOAT'],       'ArrayFunctions::array_overlap_float'],
    [150229, 'array_overlap', 'BOOLEAN',    ['ARRAY_DOUBLE', 'ARRAY_DOUBLE'],      'ArrayFunctions::array_overlap_double'],
    [150230, 'array_overlap', 'BOOLEAN', ['ARRAY_DECIMALV2', 'ARRAY_DECIMALV2'],   'ArrayFunctions::array_overlap_decimalv2'],
    [150231, 'array_overlap', 'BOOLEAN',   ['ARRAY_VARCHAR', 'ARRAY_VARCHAR'],     'ArrayFunctions::array_overlap_varchar'],

    [150240, 'array_intersect', 'ARRAY_DATE',      ['ARRAY_DATE', "..."],        'ArrayFunctions::array_intersect_date'],
    [150241, 'array_intersect', 'ARRAY_DATETIME',  ['ARRAY_DATETIME', "..."],    'ArrayFunctions::array_intersect_datetime'],
    [150242, 'array_intersect', 'ARRAY_BOOLEAN',   ['ARRAY_BOOLEAN', "..."],     'ArrayFunctions::array_intersect_boolean'],
    [150243, 'array_intersect', 'ARRAY_TINYINT',   ['ARRAY_TINYINT', "..."],     'ArrayFunctions::array_intersect_tinyint'],
    [150244, 'array_intersect', 'ARRAY_SMALLINT',  ['ARRAY_SMALLINT', "..."],    'ArrayFunctions::array_intersect_smallint'],
    [150245, 'array_intersect', 'ARRAY_INT',       ['ARRAY_INT', "..."],         'ArrayFunctions::array_intersect_int'],
    [150246, 'array_intersect', 'ARRAY_BIGINT',    ['ARRAY_BIGINT', "..."],      'ArrayFunctions::array_intersect_bigint'],
    [150247, 'array_intersect', 'ARRAY_LARGEINT',  ['ARRAY_LARGEINT', "..."],    'ArrayFunctions::array_intersect_largeint'],
    [150248, 'array_intersect', 'ARRAY_FLOAT',     ['ARRAY_FLOAT', "..."],       'ArrayFunctions::array_intersect_float'],
    [150249, 'array_intersect', 'ARRAY_DOUBLE',    ['ARRAY_DOUBLE', "..."],      'ArrayFunctions::array_intersect_double'],
    [150250, 'array_intersect', 'ARRAY_DECIMALV2', ['ARRAY_DECIMALV2', "..."],   'ArrayFunctions::array_intersect_decimalv2'],
    [150251, 'array_intersect', 'ARRAY_VARCHAR',   ['ARRAY_VARCHAR', "..."],     'ArrayFunctions::array_intersect_varchar'],
]
