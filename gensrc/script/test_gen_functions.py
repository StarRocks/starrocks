...
class AIFunctionGenerationTest(unittest.TestCase):
    ...
    def test_existing_ids_and_semantic_positions(self):
        ...
        for fid in range(200140, 200144):
            ...
            self.assertEqual('PROVIDER', metadata['model_source'])
            self.assertEqual(0, metadata['provider_argument'])
    ...
    def test_generated_descriptors_and_dispatch_are_consistent(self):
        ...
        self.assertTrue('int providerArgument)' in java, 'FE descriptor must name the Provider selector explicitly')
        self.assertNotIn('resourceArgument', java)
        self.assertIn('.model_source = TAIModelSource::PROVIDER,', cpp)
        self.assertIn('.provider_argument = 0,', cpp)
    ...
    def test_invalid_semantics_are_rejected_before_registration(self):
        ...
        invalid = [
            ...
            ('model_source', 'UNKNOWN'), ('model_argument', 4), ('provider_argument', 0),
    ...
    def test_provider_selector_cannot_override_the_provider_model(self):
