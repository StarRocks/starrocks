...
vectorized_functions = [
    ...
    [91001, 'bitmap_subset_in_range', 'BITMAP', ['BITMAP', 'BIGINT', 'BIGINT'], 'BitmapFunctions::bitmap_subset_in_range', False],
    ...
    # [150012, 'array_sum', 'DECIMAL64',   ['ARRAY_DECIMAL32'],   'ArrayFunctions::array_sum<TYPE_DECIMAL32>'],
    # [150013, 'array_sum', 'DECIMAL64',   ['ARRAY_DECIMAL64'],   'ArrayFunctions::array_sum<TYPE_DECIMAL64>'],
