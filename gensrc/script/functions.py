...
vectorized_functions = [
    ...
    [120015, "ST_GeogFromText", False, False, "GEOGRAPHY", ["VARCHAR"],
     "GeoFunctions::st_geog_from_text"],
    [120016, "ST_GeogFromText", False, False, "GEOGRAPHY", ["VARCHAR", "INT"],
     "GeoFunctions::st_geog_from_text"],
    [120017, "ST_GeogFromWKB", False, False, "GEOGRAPHY", ["VARBINARY"],
     "GeoFunctions::st_geog_from_wkb"],
    [120018, "ST_GeogFromWKB", False, False, "GEOGRAPHY", ["VARBINARY", "INT"],
     "GeoFunctions::st_geog_from_wkb"],
    [120019, "ST_AsText", False, False, "VARCHAR", ["GEOGRAPHY"],
     "GeoFunctions::st_geography_as_text"],
    [120020, "ST_AsWKT", False, False, "VARCHAR", ["GEOGRAPHY"],
     "GeoFunctions::st_geography_as_text"],
    [120021, "ST_AsBinary", False, False, "VARBINARY", ["GEOGRAPHY"],
     "GeoFunctions::st_geography_as_wkb"],
    [120022, "ST_AsWKB", False, False, "VARBINARY", ["GEOGRAPHY"],
     "GeoFunctions::st_geography_as_wkb"],
