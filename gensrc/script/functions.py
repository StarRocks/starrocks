...
vectorized_functions = [
    ...
    [30423, 'compress', 'VARBINARY', ['VARCHAR', 'VARCHAR'], 'StringFunctions::compress',
     'StringFunctions::compress_prepare', 'StringFunctions::compress_close'],
    [30424, 'uncompress', 'VARCHAR', ['VARBINARY', 'VARCHAR'], 'StringFunctions::uncompress',
     'StringFunctions::compress_prepare', 'StringFunctions::compress_close'], 
