...
vectorized_functions = [
    ...
    [120170, "fpe_ff1_encrypt", "VARCHAR", ["VARCHAR", "VARCHAR"], "EncryptionFunctions::fpe_ff1_encrypt", False],
    [120171, "fpe_encrypt_num", "VARCHAR", ["VARCHAR", "VARCHAR"], "EncryptionFunctions::fpe_encrypt_num", False],
    [120172, "fpe_ff1_decrypt", "VARCHAR", ["VARCHAR", "VARCHAR"], "EncryptionFunctions::fpe_ff1_decrypt", False],
    [120173, "fpe_decrypt_num", "VARCHAR", ["VARCHAR", "VARCHAR"], "EncryptionFunctions::fpe_decrypt_num", False],
