...
vectorized_functions = [
    ...
    [120021, "ST_GeogFromText", False, False, "GEOGRAPHY", ["VARCHAR", "INT"],
     "GeoFunctions::st_geog_from_text"],
    [120022, "ST_GeomFromText", False, False, "GEOMETRY", ["VARCHAR", "VARCHAR"],
     "GeoFunctions::st_geom_from_text"],
    ...
    [120031, "ST_GeogFromWKB", False, False, "GEOGRAPHY", ["VARBINARY", "INT"],
     "GeoFunctions::st_geog_from_wkb"],
    [120032, "ST_GeomFromWKB", False, False, "GEOMETRY", ["VARBINARY", "VARCHAR"],
     "GeoFunctions::st_geom_from_wkb"],
    [120040, "ST_AsText", False, False, "VARCHAR", ["GEOGRAPHY"],
     "GeoFunctions::st_geography_as_text"],
    [120041, "ST_AsText", False, False, "VARCHAR", ["GEOMETRY"],
     "GeoFunctions::st_geometry_as_text"],
    [120050, "ST_AsWKT", False, False, "VARCHAR", ["GEOGRAPHY"],
     "GeoFunctions::st_geography_as_text"],
    [120051, "ST_AsWKT", False, False, "VARCHAR", ["GEOMETRY"],
     "GeoFunctions::st_geometry_as_text"],
    [120060, "ST_AsBinary", False, False, "VARBINARY", ["GEOGRAPHY"],
     "GeoFunctions::st_geography_as_wkb"],
    [120061, "ST_AsBinary", False, False, "VARBINARY", ["GEOMETRY"],
     "GeoFunctions::st_geometry_as_wkb"],
    [120070, "ST_AsWKB", False, False, "VARBINARY", ["GEOGRAPHY"],
     "GeoFunctions::st_geography_as_wkb"],
    [120071, "ST_AsWKB", False, False, "VARBINARY", ["GEOMETRY"],
     "GeoFunctions::st_geometry_as_wkb"],
    ...
    [120091, "ST_Y", False, False, "DOUBLE", ["GEOMETRY"],
     "GeoFunctions::st_geometry_y"],
    [120170, "ST_GeometryType", False, False, "VARCHAR", ["GEOGRAPHY"],
     "GeoFunctions::st_geography_type"],
    [120171, "ST_GeometryType", False, False, "VARCHAR", ["GEOMETRY"],
     "GeoFunctions::st_geometry_type"],
    [120180, "ST_Distance", False, False, "DOUBLE", ["GEOGRAPHY", "GEOGRAPHY"],
     "GeoFunctions::st_geography_distance"],
    [120181, "ST_Distance", False, False, "DOUBLE", ["GEOMETRY", "GEOMETRY"],
     "GeoFunctions::st_geometry_distance"],
    [120190, "ST_Contains", False, False, "BOOLEAN", ["GEOGRAPHY", "GEOGRAPHY"],
     "GeoFunctions::st_geography_contains"],
    [120191, "ST_Contains", False, False, "BOOLEAN", ["GEOMETRY", "GEOMETRY"],
     "GeoFunctions::st_geometry_contains"],
    [120200, "ST_Within", False, False, "BOOLEAN", ["GEOGRAPHY", "GEOGRAPHY"],
     "GeoFunctions::st_geography_within"],
    [120201, "ST_Within", False, False, "BOOLEAN", ["GEOMETRY", "GEOMETRY"],
     "GeoFunctions::st_geometry_within"],
    [120210, "ST_Covers", False, False, "BOOLEAN", ["GEOGRAPHY", "GEOGRAPHY"],
     "GeoFunctions::st_geography_covers"],
    [120211, "ST_Covers", False, False, "BOOLEAN", ["GEOMETRY", "GEOMETRY"],
     "GeoFunctions::st_geometry_covers"],
    [120220, "ST_CoveredBy", False, False, "BOOLEAN", ["GEOGRAPHY", "GEOGRAPHY"],
     "GeoFunctions::st_geography_covered_by"],
    ...
    # Scalar: resolution → scalar
    [120020, "h3EdgeAngle",    False, False, "DOUBLE",  ["INT"],    "H3Functions::h3_edge_angle"],
    [120021, "h3EdgeLengthM",  False, False, "DOUBLE",  ["INT"],    "H3Functions::h3_edge_length_m"],
    [120022, "h3EdgeLengthKm", False, False, "DOUBLE",  ["INT"],    "H3Functions::h3_edge_length_km"],
    [120023, "h3GetBaseCell",  False, False, "INT",     ["BIGINT"], "H3Functions::h3_get_base_cell"],
    [120024, "h3HexAreaM2",    False, False, "DOUBLE",  ["INT"],    "H3Functions::h3_hex_area_m2"],
    [120025, "h3HexAreaKm2",   False, False, "DOUBLE",  ["INT"],    "H3Functions::h3_hex_area_km2"],
    [120026, "h3IndexesAreNeighbors", False, False, "BOOLEAN", ["BIGINT", "BIGINT"],
     "H3Functions::h3_indexes_are_neighbors"],
    [120027, "h3ToParent",     False, False, "BIGINT",  ["BIGINT", "INT"], "H3Functions::h3_to_parent"],
    [120028, "h3ToString",     False, False, "VARCHAR", ["BIGINT"], "H3Functions::h3_to_string"],
    [120029, "stringToH3",     False, False, "BIGINT",  ["VARCHAR"], "H3Functions::string_to_h3"],
    [120030, "h3IsResClassIII",False, False, "BOOLEAN", ["BIGINT"], "H3Functions::h3_is_res_class_iii"],
    [120031, "h3IsPentagon",   False, False, "BOOLEAN", ["BIGINT"], "H3Functions::h3_is_pentagon"],
    [120032, "h3CellAreaM2",   False, False, "DOUBLE",  ["BIGINT"], "H3Functions::h3_cell_area_m2"],
    [120033, "h3CellAreaRads2",False, False, "DOUBLE",  ["BIGINT"], "H3Functions::h3_cell_area_rads2"],
    [120034, "h3ToCenterChild",False, False, "BIGINT",  ["BIGINT", "INT"], "H3Functions::h3_to_center_child"],
    [120035, "h3ExactEdgeLengthM",   False, False, "DOUBLE", ["BIGINT"], "H3Functions::h3_exact_edge_length_m"],
    [120036, "h3ExactEdgeLengthKm",  False, False, "DOUBLE", ["BIGINT"], "H3Functions::h3_exact_edge_length_km"],
    [120037, "h3ExactEdgeLengthRads",False, False, "DOUBLE", ["BIGINT"], "H3Functions::h3_exact_edge_length_rads"],
    [120038, "h3NumHexagons",  False, False, "BIGINT",  ["INT"],    "H3Functions::h3_num_hexagons"],
    [120039, "h3PointDistM",   False, False, "DOUBLE",  ["DOUBLE", "DOUBLE", "DOUBLE", "DOUBLE"],
     "H3Functions::h3_point_dist_m"],
    [120040, "h3PointDistKm",  False, False, "DOUBLE",  ["DOUBLE", "DOUBLE", "DOUBLE", "DOUBLE"],
     "H3Functions::h3_point_dist_km"],
    [120041, "h3PointDistRads",False, False, "DOUBLE",  ["DOUBLE", "DOUBLE", "DOUBLE", "DOUBLE"],
     "H3Functions::h3_point_dist_rads"],
    [120042, "h3Distance",     False, False, "BIGINT",  ["BIGINT", "BIGINT"], "H3Functions::h3_distance"],
    [120043, "h3GetUnidirectionalEdge", False, False, "BIGINT", ["BIGINT", "BIGINT"],
     "H3Functions::h3_get_unidirectional_edge"],
    [120044, "h3UnidirectionalEdgeIsValid", False, False, "BOOLEAN", ["BIGINT"],
     "H3Functions::h3_unidirectional_edge_is_valid"],
    [120045, "h3GetOriginIndexFromUnidirectionalEdge", False, False, "BIGINT", ["BIGINT"],
     "H3Functions::h3_get_origin_index_from_unidirectional_edge"],
    [120046, "h3GetDestinationIndexFromUnidirectionalEdge", False, False, "BIGINT", ["BIGINT"],
     "H3Functions::h3_get_destination_index_from_unidirectional_edge"],
    # Array-returning H3 functions
    [120047, "h3kRing",      False, False, "ARRAY_BIGINT", ["BIGINT", "INT"],    "H3Functions::h3k_ring"],
    [120048, "h3ToChildren", False, False, "ARRAY_BIGINT", ["BIGINT", "INT"],    "H3Functions::h3_to_children"],
    [120049, "h3GetFaces",   False, False, "ARRAY_INT",    ["BIGINT"],           "H3Functions::h3_get_faces"],
    [120050, "h3GetRes0Indexes",     False, False, "ARRAY_BIGINT", [],            "H3Functions::h3_get_res0_indexes"],
    [120051, "h3GetPentagonIndexes", False, False, "ARRAY_BIGINT", ["INT"],       "H3Functions::h3_get_pentagon_indexes"],
    [120052, "h3Line",       False, False, "ARRAY_BIGINT", ["BIGINT", "BIGINT"], "H3Functions::h3_line"],
    [120053, "h3HexRing",    False, False, "ARRAY_BIGINT", ["BIGINT", "INT"],    "H3Functions::h3_hex_ring"],
    [120054, "h3GetUnidirectionalEdgesFromHexagon", False, False, "ARRAY_BIGINT", ["BIGINT"],
     "H3Functions::h3_get_unidirectional_edges_from_hexagon"],
