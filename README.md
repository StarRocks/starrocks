...
Download the current release: [StarRocks-1.18.2.tar.gz](http://starrocks-cn-release.oss-cn-zhangjiakou.aliyuncs.com/StarRocks-1.18.2.tar.gz?Expires=1632228718&OSSAccessKeyId=***REMOVED***&Signature=zrhN8oZCr3U6HqlCVw020TaXKNE%3D)   
