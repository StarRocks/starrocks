...
Also, you can directly transform and load data from Iceberg by using [INSERT INTO](../../../docs/sql-reference/sql-statements/data-manipulation/SELECT.md) based on Iceberg catalogs. StarRocks supports Iceberg catalogs from v2.4 onwards.
