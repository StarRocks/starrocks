...
Also, you can directly transform and load data from Hive by using [INSERT INTO](../../../docs/sql-reference/sql-statements/data-manipulation/SELECT.md) based on Hive catalogs. StarRocks supports Hive catalogs from v2.4 onwards.
