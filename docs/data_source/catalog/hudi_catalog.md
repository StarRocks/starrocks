...
Also, you can directly transform and load data from Hudi by using [INSERT INTO](../../../docs/sql-reference/sql-statements/data-manipulation/SELECT.md) based on Hudi catalogs. StarRocks supports Hudi catalogs from v2.4 onwards.
