...
| dynamic_partition.start_day_of_week     | No       | When time_unit is WEEK, this parameter is used to specify the first day of each week. Values are 1 to 7. 1 means Monday and 7 means Sunday. The default value is 1, which means that every week starts on Monday.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
