...
| dynamic_partition.history_partition_num| No       |the number of historical partitions created by the dynamic partitions mechanism, with a default value of `0`. When the value is greater than 0, historical partitions are created in advance. From V 2.5.2, StarRocks supports this parameter.|
