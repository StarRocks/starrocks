...
- Currently, StarRocks does not support creating [asynchronous materialized views](../../using_starrocks/async_materialized_view/Materialized_view.md) with base tables created with the list partitioning strategy.
