...
> **NOTICE**
>
> - When you create a table, you must specify the bucketing column by using the `DISTRIBUTED BY HASH` clause. For detailed information, see [bucketing](../Data_distribution/Data_distribution.md#design-partitioning-and-bucketing-rules).
