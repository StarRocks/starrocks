...
+ Reference
  + SQL Reference
    ...
    + User Account Management
      ...
      + [SHOW AUTHENTICATION](./sql-reference/sql-statements/data-definition/SHOW_AUTHENTICATION.md)
...
=======
      ...
      + Plugin, SQL blacklist
        ...
        + [SHOW SQLBLACKLIST](./sql-reference/sql-statements/Administration/SHOW_SQLBLACKLIST.md)
        + [UNINSTALL PLUGIN](./sql-reference/sql-statements/Administration/UNINSTALL_PLUGIN.md)
>>>>>>> 23d933350a ([Doc] add command list and re-categorize command reference (backport #32828) (#32853))
    + DDL
<<<<<<< HEAD
...
=======
    ...
    + DML
      ...
      + Manipulation
        ...
        + [UPDATE](./sql-reference/sql-statements/data-manipulation/UPDATE.md)
    + Utility Commands
>>>>>>> 04d07b7a0 ([Doc] add command list and re-categorize command reference (backport #32828) (#32853))
