...
- Supports loading data into columns of the MAP and STRUCT data types, and supports nesting the Fast Decimal data type in the ARRAY, MAP, and STRUCT data types.
