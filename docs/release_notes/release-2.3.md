...
- Optimized the memory usage for the primary key table with a large number of accumulated versions.  [#20760](https://github.com/StarRocks/starrocks/pull/20760)
