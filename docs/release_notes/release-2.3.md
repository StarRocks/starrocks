...
- When a table enables dynamic partitioning and some partitions are dynamically deleted, if you execute TRUNCATE TABLE, an error NullPointerException returns. Meanwhile, if data load into the table, FE crashes and can not restart. [#16822](https://github.com/StarRocks/starrocks/pull/16822)
