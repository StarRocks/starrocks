...
- When users try to drop tablets from a Primary Key table, the drop operation fails because some expired rowsets are still being referenced by other threads and cannot be released. [# 15959](https://github.com/StarRocks/starrocks/pull/15959)
