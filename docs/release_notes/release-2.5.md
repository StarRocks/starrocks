...
- [Preview] Supports creating [Delta Lake catalogs](../data_source/file_external_table.md), which allow direct queries on data from Delta Lake. [#11972](https://github.com/StarRocks/starrocks/issues/11972)
...
- Supports [QueryCache](../using_starrocks/query_cache.md) that helps improve QPS and reduces the average latency of highly concurrent, simple queries by saving the intermediate computation results of queries. [#9194](https://github.com/StarRocks/starrocks/pull/9194)
...
- [Preview] Supports specifying the number of replicas of StarRocks native tables that needs to be loaded with data. For more information, see [CREATE TABLE](../sql-reference/sql-statements/data-definition/CREATE TABLE.md). [#11253](https://github.com/StarRocks/starrocks/pull/11253)
...
- Supports specifying the result returned by the uuid or uuid_numeric function as a default value of a column when you create a table. For more information, see [CREATE TABLE](../sql-reference/sql-statements/data-definition/CREATE TABLE.md). [#11155](https://github.com/StarRocks/starrocks/pull/11155)
...
- Optimizes data backup and restore:
  ...
  - Supports backing up and restoring data from Primary Key tables. For more information, see [Backup and restore](../administration/Backup_and_restore.md).  [#11885](https://github.com/StarRocks/starrocks/pull/11885)
- Optimizes the following functions:
  ...
  - Supports specifying multiple arguments in the unnest() function. [#12484](https://github.com/StarRocks/starrocks/pull/12484)
