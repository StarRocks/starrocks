...
- BEs crash when users drop tablets from a Primary Key table because some expired rowsets are still referenced by other threads and cannot be deleted. [# 15959](https://github.com/StarRocks/starrocks/pull/15959)
