...
- Supported JSON data types in the tables that use the Primary Key table and tables that use the Unique Key table. [#6544](https://github.com/StarRocks/starrocks/pull/6544)
