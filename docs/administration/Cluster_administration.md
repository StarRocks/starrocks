...
|---|---|---|
|be_port|Thrift Server port of the Compute Node. The port is used to receive requests from FE. From v3.1 onwards, this configuration item is renamed from `thrift_port` to `be_port`.|9060|
