...
| background_refresh_metadata_interval_millis                  | ms   | 600000 | he interval between two consecutive Hive metadata cache refreshes. This parameter is supported from v2.5.5 onwards. |
