...
| ignore_materialized_view_error   | -    | FALSE   | When the materialized view fails to start FE due to metadata problems, you can try to use this configuration, and it can ignore some metadata exceptions.                                                                                                                                                                                                                                                                                                     |
