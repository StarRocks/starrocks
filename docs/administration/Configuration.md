...
| mysql_server_version                 | 5.1.0             | The mysql version return to client. modifying this configuration will affect the version information of the following situations: 1.select version(); 2.handshake packet version. 3.global/session variable version.                                                                                                                                                                                      |
