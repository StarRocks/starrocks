...
- Manually refresh your Apache Hive table. For more information, see [Metadata caching strategy](../using_starrocks/External_table.md#metadata-caching-strategy).
