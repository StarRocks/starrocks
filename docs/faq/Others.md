...
- Manually refresh your Apache Hive table. For more information, see [Metadata caching strategy](http://../using_starrocks/External_table#metadata-caching-strategy).
...
## Why does the profile fail to display after I set `is_report_success` to `tru``e`?
