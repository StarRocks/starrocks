...
description: "Overview of StarRocks table types: Duplicate Key, Aggregate, Unique Key, and Primary Key tables, with use case guidance for log analysis, aggregation, and..."
---
