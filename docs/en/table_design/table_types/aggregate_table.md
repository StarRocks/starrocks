...
- Some built-in functions, such as `GROUP_CONCAT`, `WINDOW_FUNNEL`, and `APPROX_TOP_K`, are not supported. For detailed information, see [FunctionSet.java#UNSUPPORTED_AGG_STATE_FUNCTIONS]().
