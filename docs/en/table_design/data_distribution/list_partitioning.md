...
sidebar_position: 20
description: "How to use list partitioning in StarRocks (from v3.1) to partition data by predefined enumeration values, accelerating queries and management on categorical..."
---
