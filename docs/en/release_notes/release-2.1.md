...
description: "StarRocks 2.1 release notes: Iceberg external tables (preview), pipeline execution engine for adaptive multicore scheduling, CREATE TABLE AS SELECT, SQL..."
---
