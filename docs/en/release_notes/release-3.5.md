...
- FILES() and LOAD now respect Parquet `isAdjustedToUTC=false` for INT64 timestamps. [#73674](https://github.com/StarRocks/starrocks/pull/73674)
- Incremental scan range drivers now reuse DOP correctly. [#74674](https://github.com/StarRocks/starrocks/pull/74674)
- MySQL protocol exceptions are now handled to avoid client-side `ERROR 2013` connection failures. [#70072](https://github.com/StarRocks/starrocks/pull/70072)
...
- Optimized constant evaluation for `base64_to_bitmap`. [#74684](https://github.com/StarRocks/starrocks/pull/74684)
- Added catalog recycle bin size gauges, vacuum batch and retry metrics, exported row count in audit logs, and support for duplicate audit emission. [#74440](https://github.com/StarRocks/starrocks/pull/74440) [#74112](https://github.com/StarRocks/starrocks/pull/74112) [#74467](https://github.com/StarRocks/starrocks/pull/74467) [#73896](https://github.com/StarRocks/starrocks/pull/73896)
- Added the bugfix version index workflow for release and backport tracking. [#74716](https://github.com/StarRocks/starrocks/pull/74716)

### Bug fixes

The following issues have been fixed:

- Prevented incorrect materialized view rewrites for `avg(DISTINCT ...)` and aggregate materialized views with HAVING predicates. [#75071](https://github.com/StarRocks/starrocks/pull/75071) [#73610](https://github.com/StarRocks/starrocks/pull/73610)
- Fixed TopN correctness issues in ranking boundary handling and partition TopN output columns. [#75045](https://github.com/StarRocks/starrocks/pull/75045) [#72848](https://github.com/StarRocks/starrocks/pull/72848)
- Fixed potential out-of-bounds access in partitioned joins. [#74315](https://github.com/StarRocks/starrocks/pull/74315)
- Fixed `ALTER MODIFY COLUMN ... AFTER` error handling when the referenced column does not exist. [#75073](https://github.com/StarRocks/starrocks/pull/75073)
- Preserved declared `VARCHAR` lengths in CTAS results. [#73498](https://github.com/StarRocks/starrocks/pull/73498)
- Fixed datetime prepared parameter parsing. [#74141](https://github.com/StarRocks/starrocks/pull/74141)
- Fixed nested-type partial append in JSON load. [#73715](https://github.com/StarRocks/starrocks/pull/73715)
- Fixed handling of NULL values in Paimon DATE partition columns. [#73950](https://github.com/StarRocks/starrocks/pull/73950)
- Fixed Iceberg equality delete matching by using null-safe comparisons. [#67321](https://github.com/StarRocks/starrocks/pull/67321)
- Fixed unexpected BE restarts and fork-unsafe tracing during parallel profile collection. [#74424](https://github.com/StarRocks/starrocks/pull/74424) [#74746](https://github.com/StarRocks/starrocks/pull/74746)
- Fixed cleanup after failed JIT compilation to avoid use-after-free issues. [#74396](https://github.com/StarRocks/starrocks/pull/74396)
- Fixed memory accounting in `OlapTableSink` and a memory leak introduced by the UDAF cache. [#73807](https://github.com/StarRocks/starrocks/pull/73807) [#74025](https://github.com/StarRocks/starrocks/pull/74025)
- Fixed Lake partial column update crashes and silent corruption under schema drift. [#74005](https://github.com/StarRocks/starrocks/pull/74005)
- Prevented vector index rewrite from polluting the shared table schema. [#74785](https://github.com/StarRocks/starrocks/pull/74785)
- Added self-healing for non-primary-key replicas stuck with permanent version holes. [#74408](https://github.com/StarRocks/starrocks/pull/74408)
- Prevented zero row counts from corrupting partition statistics. [#74801](https://github.com/StarRocks/starrocks/pull/74801)
- Prevented `CatalogRecycleBin` from freezing when cluster snapshot creation repeatedly fails. [#74379](https://github.com/StarRocks/starrocks/pull/74379)
- Fixed privilege cache invalidation after public role changes. [#73717](https://github.com/StarRocks/starrocks/pull/73717)
- Fixed dependency CVEs in JLine, Netty, Tomcat, and libthrift. [#75066](https://github.com/StarRocks/starrocks/pull/75066) [#74668](https://github.com/StarRocks/starrocks/pull/74668) [#73797](https://github.com/StarRocks/starrocks/pull/73797) [#73243](https://github.com/StarRocks/starrocks/pull/73243)
