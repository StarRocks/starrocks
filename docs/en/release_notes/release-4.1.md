...
- Supports `ANALYZE SAMPLE TABLE PREDICATE COLUMNS` for external tables. [#77243](https://github.com/StarRocks/starrocks/pull/77243)
- Extended sample-based tablet pre-split: supports non-key expressions, dynamic-overwrite temporary partitions, and Iceberg and overwrite loads. [#77843](https://github.com/StarRocks/starrocks/pull/77843) [#77842](https://github.com/StarRocks/starrocks/pull/77842) [#77983](https://github.com/StarRocks/starrocks/pull/77983)
- Streams source segments for lake column updates to reduce memory usage. [#77275](https://github.com/StarRocks/starrocks/pull/77275)
- The background metadata refresh for Paimon catalogs now refreshes only recently accessed and changed tables instead of enumerating the whole warehouse each cycle. [#78057](https://github.com/StarRocks/starrocks/pull/78057)
- Passes `limit` to the Paimon `getRemoteFiles` call during partition pruning. [#76943](https://github.com/StarRocks/starrocks/pull/76943)
- Extended GROUPING SETS pushdown to support `AVG` and `COUNT`. [#77832](https://github.com/StarRocks/starrocks/pull/77832)
- Allows including `EXPLAIN COSTS` output in the query profile. [#73005](https://github.com/StarRocks/starrocks/pull/73005)
- Makes starlet object-store upload thresholds configurable at runtime. [#78448](https://github.com/StarRocks/starrocks/pull/78448)
- Reduced lock contention: removed the global metacache lock for lake segments and made SQL blacklist verification lock-free. [#78260](https://github.com/StarRocks/starrocks/pull/78260) [#78476](https://github.com/StarRocks/starrocks/pull/78476)
- Reclaims tablet metadata by dropping `delete_predicate` on compaction and replication archival. [#76870](https://github.com/StarRocks/starrocks/pull/76870)
- Checksums shared-data delete files with CRC32C. [#77798](https://github.com/StarRocks/starrocks/pull/77798)
- Bounds how long a cancelled query waits for unreported instances. [#76909](https://github.com/StarRocks/starrocks/pull/76909)
- Various jemalloc improvements for better memory efficiency and observability: builds a 4K-page variant alongside the 64K one on arm64, exposes dirty/muzzy page and mapped/retained metrics, and applies mutable `jemalloc_conf` options at runtime. [#77886](https://github.com/StarRocks/starrocks/pull/77886) [#78159](https://github.com/StarRocks/starrocks/pull/78159) [#78225](https://github.com/StarRocks/starrocks/pull/78225) [#78320](https://github.com/StarRocks/starrocks/pull/78320) [#78333](https://github.com/StarRocks/starrocks/pull/78333)
- Added observability: a `max_journal_replay_lag` gauge on the leader FE, and additional lake publish-version tracing. [#78382](https://github.com/StarRocks/starrocks/pull/78382) [#76658](https://github.com/StarRocks/starrocks/pull/76658) [#77048](https://github.com/StarRocks/starrocks/pull/77048)
- Releases the reshard output shards' placement pin when the job finishes. [#76945](https://github.com/StarRocks/starrocks/pull/76945)
- Upgraded StarOS to v4.1.2. [#77657](https://github.com/StarRocks/starrocks/pull/77657)

### Security

- [CVE-2025-55163] Aligned all `io.grpc` artifacts via `grpc-bom` so `grpc-netty` matches `grpc-core`. [#77171](https://github.com/StarRocks/starrocks/pull/77171)
- [CVE-2026-59902] Bumped Netty to 4.1.137.Final. [#78287](https://github.com/StarRocks/starrocks/pull/78287)
- [CVE-2026-54399] Bumped Apache HttpCore to 5.4.3 to fix an uncontrolled-resource-consumption (DoS) vulnerability in the HTTP/1.1 message parser. [#77753](https://github.com/StarRocks/starrocks/pull/77753)
- [CVE-2025-48924] Upgraded the Broker `commons-lang3` to 3.20.0 and removed unused `commons-lang` 2.6 and `commons-configuration` 1.6. [#77748](https://github.com/StarRocks/starrocks/pull/77748)
- [CVE] Rebuilt the pprof binary on a newer release and removed unused flamegraph tooling from the BE container image. [#77846](https://github.com/StarRocks/starrocks/pull/77846)
...
- Force BE exit when the fatal-signal handler hangs after marking the process as crashing. [#76491](https://github.com/StarRocks/starrocks/pull/76491)
- Fixed BE crashes from constant/invalid arguments in `tokenize`, `ngram_search`, `generate_series`, `corr`/`covar_pop`/`covar_samp`, `strpos` (INT32_MIN), and `count()` over an array of decimal. [#77102](https://github.com/StarRocks/starrocks/pull/77102) [#77103](https://github.com/StarRocks/starrocks/pull/77103) [#77216](https://github.com/StarRocks/starrocks/pull/77216) [#77260](https://github.com/StarRocks/starrocks/pull/77260) [#77092](https://github.com/StarRocks/starrocks/pull/77092)
- Fixed a BE crash when one `ALTER` adds an ordinary column and a generated column, and a cache-select crash after a read-schema reorder. [#77436](https://github.com/StarRocks/starrocks/pull/77436) [#77245](https://github.com/StarRocks/starrocks/pull/77245)
- Fixed a BE crash when the query cache reuses a lane for a partitioned hash join, and a hang when a lane's join has an empty build side. [#77564](https://github.com/StarRocks/starrocks/pull/77564) [#77571](https://github.com/StarRocks/starrocks/pull/77571)
- Fixed an out-of-range read and silent row loss in `JsonColumn` append, an integer overflow in `BinaryColumnBase::replicate`, and an `array_map` DCHECK failure when one array column is passed as several lambda arguments. [#77090](https://github.com/StarRocks/starrocks/pull/77090) [#77545](https://github.com/StarRocks/starrocks/pull/77545) [#77433](https://github.com/StarRocks/starrocks/pull/77433)
- Fixed `substr` returning bytes of neighboring rows on invalid UTF-8, and `array_sort`'s lambda comparator driving the sort out of bounds. [#78722](https://github.com/StarRocks/starrocks/pull/78722) [#77687](https://github.com/StarRocks/starrocks/pull/77687)
- Keep parquet decoder scratch buffers off the stack, and bound the raw-JSON view in the `SimdJsonConverter` error path. [#77615](https://github.com/StarRocks/starrocks/pull/77615)
- Fixed a tablet-scheduler NPE on a disk with no reported storage medium, and NPEs when deparsing `INSERT ... VALUES (DEFAULT, ...)` and in `PrepareCollectMetaTask` when the optimizer has no query id. [#76966](https://github.com/StarRocks/starrocks/pull/76966) [#76963](https://github.com/StarRocks/starrocks/pull/76963) [#77051](https://github.com/StarRocks/starrocks/pull/77051)

**Query engine and optimizer**

- Fixed wrong or missing results in several optimizer paths: streaming distinct global limit, ranking window pre-agg across sort groups, constant aggregated value re-appended in the merge phase, GROUP BY rules not applied to every child, and analytic frames starting at a FOLLOWING offset. [#77086](https://github.com/StarRocks/starrocks/pull/77086) [#77068](https://github.com/StarRocks/starrocks/pull/77068) [#77069](https://github.com/StarRocks/starrocks/pull/77069) [#77099](https://github.com/StarRocks/starrocks/pull/77099) [#77342](https://github.com/StarRocks/starrocks/pull/77342)
- Fixed an NL Join null-aware anti join losing probe rows, conjunct evaluation on an empty chunk in NL Join probe, and a `GROUPING SETS` aggregation joined on its group-by keys failing with no executable plan. [#77970](https://github.com/StarRocks/starrocks/pull/77970) [#77344](https://github.com/StarRocks/starrocks/pull/77344) [#77296](https://github.com/StarRocks/starrocks/pull/77296)
- Fixed grouping-sets-to-union-all rewrite ordering, duplicating a limit as a set operator, and keeping Set operators out of colocate exec groups to avoid a hang. [#77380](https://github.com/StarRocks/starrocks/pull/77380) [#77692](https://github.com/StarRocks/starrocks/pull/77692) [#77025](https://github.com/StarRocks/starrocks/pull/77025)
- Fixed subquery planning in a window's `PARTITION BY`/`ORDER BY`, keeping the decimal type of the `if()` built for multi-column `count(distinct)`, and normalizing scan heavy-expr result columns to the slot's nullability. [#77087](https://github.com/StarRocks/starrocks/pull/77087) [#77346](https://github.com/StarRocks/starrocks/pull/77346) [#77242](https://github.com/StarRocks/starrocks/pull/77242)
- Fixed an untyped array literal gaining a bogus type (breaking views), a CTE anchoring issue when the force-inline limit is hit, and reuse of inferred CTAS columns for a recursive CTE. [#76986](https://github.com/StarRocks/starrocks/pull/76986) [#77018](https://github.com/StarRocks/starrocks/pull/77018) [#76453](https://github.com/StarRocks/starrocks/pull/76453)
- Fixed several query cache correctness issues by adding the scan schema, join predicate common sub-expressions, and the ANN search spec to the query cache digest, and disabling the cache when a `SortNode` builds the TOPN filter. [#77559](https://github.com/StarRocks/starrocks/pull/77559) [#77565](https://github.com/StarRocks/starrocks/pull/77565) [#77586](https://github.com/StarRocks/starrocks/pull/77586) [#77404](https://github.com/StarRocks/starrocks/pull/77404)
- Fixed folding `COUNT(*)` from row counts that never covered the visible version, unconditional UKFK constraint collection in join reorder, and keeping columns read by OR-resident predicates after inverted-index filtering. [#77190](https://github.com/StarRocks/starrocks/pull/77190) [#77197](https://github.com/StarRocks/starrocks/pull/77197) [#77659](https://github.com/StarRocks/starrocks/pull/77659)
- Fixed datetime parsing correctness: bounded the Teradata and Joda parsers to the input string, and kept `DateValue::weekday()` in range for out-of-range Julian values. [#77098](https://github.com/StarRocks/starrocks/pull/77098) [#77310](https://github.com/StarRocks/starrocks/pull/77310)
- Serialize `EXCEPT`/`INTERSECT` keys by row when the batch buffer would be huge, and rebuild the JSON key column when a set operation deserializes its keys. [#77821](https://github.com/StarRocks/starrocks/pull/77821) [#77215](https://github.com/StarRocks/starrocks/pull/77215)
- Additional optimizer/expression fixes: check the status before unwrapping a `StatusOr`, decide property satisfaction once when enforcing it, read constant arguments at index 0 in `encode_fingerprint_sha256`, skip `CHAR` predicate zero-padding for non-positive column length, do not push a non-positive ranking predicate into a TopN, keep the NULL partition when pruning with a deduced partition predicate, stop reading past the end of the output schema in `_switch_context`, sort a run and merge runs by the same NULL convention, fill `Analytor::_fns` before prepare can fail, and stop forcing external CTAS list partition columns to `NOT NULL`. [#77052](https://github.com/StarRocks/starrocks/pull/77052) [#77091](https://github.com/StarRocks/starrocks/pull/77091) [#77104](https://github.com/StarRocks/starrocks/pull/77104) [#77444](https://github.com/StarRocks/starrocks/pull/77444) [#77445](https://github.com/StarRocks/starrocks/pull/77445) [#77596](https://github.com/StarRocks/starrocks/pull/77596) [#77660](https://github.com/StarRocks/starrocks/pull/77660) [#77679](https://github.com/StarRocks/starrocks/pull/77679) [#77758](https://github.com/StarRocks/starrocks/pull/77758) [#78468](https://github.com/StarRocks/starrocks/pull/78468)
- Fixed statement/deparse issues: validate the static partition clause for Iceberg/Hive `INSERT` with a column list, keep the `TEMPORARY` qualifier when deparsing a partition reference, support CTAS deparse to fix an empty SQL statement in the profile, and set `isSingleStmt` in `proxyExecute` so forwarded statements keep the origin SQL. [#76659](https://github.com/StarRocks/starrocks/pull/76659) [#76987](https://github.com/StarRocks/starrocks/pull/76987) [#77978](https://github.com/StarRocks/starrocks/pull/77978) [#77982](https://github.com/StarRocks/starrocks/pull/77982)

**JSON and data types**

- Fixed a large `BinaryColumn` SerDe issue, statistics collection for columns with dots in names, and reading `multi_unnest`/`unnest` array offsets as `uint32` instead of `int32`. [#75504](https://github.com/StarRocks/starrocks/pull/75504) [#71301](https://github.com/StarRocks/starrocks/pull/71301) [#78479](https://github.com/StarRocks/starrocks/pull/78479) [#78480](https://github.com/StarRocks/starrocks/pull/78480)
- Fixed reduced Flat JSON vertical-compaction memory usage and reading the values themselves when a struct-subfield predicate is evaluated by rowid. [#77682](https://github.com/StarRocks/starrocks/pull/77682) [#77891](https://github.com/StarRocks/starrocks/pull/77891)

**Materialized views**

- Fixed IVM refresh with external authorization, the MV rewrite staleness baseline (now uses the last-freshness-confirmed time), and skipping MV rewrite for time-travel queries. [#77210](https://github.com/StarRocks/starrocks/pull/77210) [#76758](https://github.com/StarRocks/starrocks/pull/76758) [#77683](https://github.com/StarRocks/starrocks/pull/77683)
- Fixed assigning index ids to GIN indexes created on a materialized view, and keeping view scan projection when replacing it back in view-based MV rewrite. [#77340](https://github.com/StarRocks/starrocks/pull/77340) [#77613](https://github.com/StarRocks/starrocks/pull/77613)
- Additional materialized view fixes: validate `default_mv_refresh_mode`, fix `ORDER BY` on an incremental MV widening its primary key instead of sorting, and bound `information_schema.materialized_views` internal queries by `query_timeout`. [#77231](https://github.com/StarRocks/starrocks/pull/77231) [#77680](https://github.com/StarRocks/starrocks/pull/77680) [#77585](https://github.com/StarRocks/starrocks/pull/77585)

**Data Lake connectors (Iceberg, Paimon, Delta, Hive)**

- Fixed Iceberg correctness and stability: enforce NOT NULL columns on the write path, validate rewrite commits from the plan-time snapshot, invalidate the metadata cache after `TRUNCATE`, drop a table whose metadata file is missing, refresh the native table before cast-on-string-partition metadata delete, silent data loss in `rewrite_data_files` with a `WHERE` clause, and a too-small retention window in `remove_orphan_files`. [#77589](https://github.com/StarRocks/starrocks/pull/77589) [#77709](https://github.com/StarRocks/starrocks/pull/77709) [#77385](https://github.com/StarRocks/starrocks/pull/77385) [#77786](https://github.com/StarRocks/starrocks/pull/77786) [#77335](https://github.com/StarRocks/starrocks/pull/77335) [#77797](https://github.com/StarRocks/starrocks/pull/77797) [#77394](https://github.com/StarRocks/starrocks/pull/77394)
- Isolated Delta Lake per-table cloud credentials. [#77424](https://github.com/StarRocks/starrocks/pull/77424)
- Supports OpenX JsonSerDe column-name mapping for Hive external tables, one JSON field mapping to multiple Hive columns, and fixed table qualification in connector views for absent default-catalog and CTE references. [#65515](https://github.com/StarRocks/starrocks/pull/65515) [#77716](https://github.com/StarRocks/starrocks/pull/77716) [#77887](https://github.com/StarRocks/starrocks/pull/77887)
- Fixed Ranger view/MV authorization for external tables and restored the Ranger Solr audit destination on the FE classpath. [#56316](https://github.com/StarRocks/starrocks/pull/56316) [#77294](https://github.com/StarRocks/starrocks/pull/77294)
- Fixed the corrupt `DELTA_BINARY_PACKED` header being returned instead of thrown, and marking filter-excluded FLBA dictionary rows NULL in the Parquet reader. [#77446](https://github.com/StarRocks/starrocks/pull/77446) [#78685](https://github.com/StarRocks/starrocks/pull/78685)
- Fixed an NPE on `ALTER TABLE RENAME` for Iceberg REST catalogs, an NPE reading Iceberg `$partitions` with decimal or null `timestamptz` partition values, sharing one Hadoop `FileSystem` across Iceberg catalogs, and honoring `paimon.option.cache-enabled=false` again. [#76498](https://github.com/StarRocks/starrocks/pull/76498) [#77742](https://github.com/StarRocks/starrocks/pull/77742) [#77297](https://github.com/StarRocks/starrocks/pull/77297) [#78271](https://github.com/StarRocks/starrocks/pull/78271)

**Shared-data: compaction, vacuum, reshard, and replication**

- Compaction fixes: cache the compaction txn log that file bundling skips, sort candidates by max tablet score, fix read-chunk-size estimation, fix the Limiter resize losing tokens on shrink, and skip the publish-time segment rewrite for a delete-only write. [#77578](https://github.com/StarRocks/starrocks/pull/77578) [#77482](https://github.com/StarRocks/starrocks/pull/77482) [#78192](https://github.com/StarRocks/starrocks/pull/78192) [#78087](https://github.com/StarRocks/starrocks/pull/78087) [#78071](https://github.com/StarRocks/starrocks/pull/78071)
- Vacuum fixes: fixed wasted reads and stray v1 deletes in grace-blocked vacuum, kept the autovacuum retain floor at or above a reshard takeover, and avoided redundant lake metadata 404 probes. [#78460](https://github.com/StarRocks/starrocks/pull/78460) [#78545](https://github.com/StarRocks/starrocks/pull/78545) [#78466](https://github.com/StarRocks/starrocks/pull/78466)
- Reshard/split fixes: reject a reshard whose source tablet lives in a superseded materialized index, fix tablet split fallback cross-publish, silence expected reshard history lookup warnings, and prevent lake alter jobs from getting stuck after failover. [#77512](https://github.com/StarRocks/starrocks/pull/77512) [#78270](https://github.com/StarRocks/starrocks/pull/78270) [#78059](https://github.com/StarRocks/starrocks/pull/78059) [#78517](https://github.com/StarRocks/starrocks/pull/78517)
- Replication fixes: preserve shared lake files, read remote bundled lake metadata, and re-encrypt source lake files during replication. [#77361](https://github.com/StarRocks/starrocks/pull/77361) [#77362](https://github.com/StarRocks/starrocks/pull/77362) [#78080](https://github.com/StarRocks/starrocks/pull/78080)
- Recover corrupted local caches: drop and retry on checksum failure for delvec pages, and rebuild on corruption for PK-index SST compaction and tablet-merge SSTable rebuild. [#78086](https://github.com/StarRocks/starrocks/pull/78086) [#77481](https://github.com/StarRocks/starrocks/pull/77481) [#78003](https://github.com/StarRocks/starrocks/pull/78003)
- Fixed reading lake version-1 metadata from the partition-shared object, protecting snapshot-owned shared shard groups, and preserving dependency ordering in `TransactionGraph.remove`. [#78731](https://github.com/StarRocks/starrocks/pull/78731) [#78800](https://github.com/StarRocks/starrocks/pull/78800) [#78077](https://github.com/StarRocks/starrocks/pull/78077)
- Additional shared-data fixes: throttle transactions at final commit, do not pick a `DECOMMISSION` replica as the load primary, fix DML with shadow generated columns during online optimize, make `spill_enable_direct_io` actually engage `O_DIRECT`, fix a label-uniqueness race between concurrent `BEGIN WITH LABEL`, derive the query tracker reserve limit from the effective query memory limit, safely remap rowset IDs and references during tablet merge, apply a cross-published del file only to the keys the child owns, make tablet merge honor range-distribution colocate, refuse an incomplete combined txn log and stop `replication_num` from weakening the shared-data write quorum, keep explicit transactions on one tablet layout during reshard, drop a del file's local cache and retry on checksum failure, and report the abort reason when a closed lake delta writer rejects a task. [#77015](https://github.com/StarRocks/starrocks/pull/77015) [#77035](https://github.com/StarRocks/starrocks/pull/77035) [#77252](https://github.com/StarRocks/starrocks/pull/77252) [#77255](https://github.com/StarRocks/starrocks/pull/77255) [#77401](https://github.com/StarRocks/starrocks/pull/77401) [#77408](https://github.com/StarRocks/starrocks/pull/77408) [#77690](https://github.com/StarRocks/starrocks/pull/77690) [#77744](https://github.com/StarRocks/starrocks/pull/77744) [#78113](https://github.com/StarRocks/starrocks/pull/78113) [#78162](https://github.com/StarRocks/starrocks/pull/78162) [#78625](https://github.com/StarRocks/starrocks/pull/78625) [#78022](https://github.com/StarRocks/starrocks/pull/78022) [#78632](https://github.com/StarRocks/starrocks/pull/78632)
- Fixed shared-data sort-key and rowset-identity edge cases: project split boundaries onto the current sort key after a trailing key-column add, surface internal `INSERT` failures in recursive CTE execution, do not let an apportioned row count decide whether a cross-published rowset exists, make `encode_sort_key` reachable for narrow fixed-length IVM row ids and expand its constant argument, resolve the delta column group of an extended column through its root column, conserve range-split cross-publish statistics, fix FE max tablet compaction score collection, skip dead nodes when dropping the auto-increment map, measure the unsorted PK SST writer's map instead of counting allocations, propagate `compression_level` to synthetic sub-column metas, and skip standalone GIN index directory handling for the builtin inverted-index backend. [#77504](https://github.com/StarRocks/starrocks/pull/77504) [#77510](https://github.com/StarRocks/starrocks/pull/77510) [#77511](https://github.com/StarRocks/starrocks/pull/77511) [#77751](https://github.com/StarRocks/starrocks/pull/77751) [#77847](https://github.com/StarRocks/starrocks/pull/77847) [#77759](https://github.com/StarRocks/starrocks/pull/77759) [#78269](https://github.com/StarRocks/starrocks/pull/78269) [#78496](https://github.com/StarRocks/starrocks/pull/78496) [#78561](https://github.com/StarRocks/starrocks/pull/78561) [#77498](https://github.com/StarRocks/starrocks/pull/77498) [#76949](https://github.com/StarRocks/starrocks/pull/76949) [#77101](https://github.com/StarRocks/starrocks/pull/77101)

**Loading, transactions, and DML**

- Fixed bounding and checking chunk capacity on the data-load and column-mode partial-update paths, deciding condition update and partial update per owning child, and recording a merged rowset's del `op_offset` per statement. [#77163](https://github.com/StarRocks/starrocks/pull/77163) [#78099](https://github.com/StarRocks/starrocks/pull/78099) [#78313](https://github.com/StarRocks/starrocks/pull/78313)
- Fixed not journaling an insert-overwrite failure for a dropped table, and keeping the current row lifecycle correct across several partial-update paths. [#77212](https://github.com/StarRocks/starrocks/pull/77212)
- Fixed handing the disconnect kill to a worker instead of the I/O thread, and propagating `accept()` status in `GroupedExecutionSinkOperator::push_chunk`. [#77590](https://github.com/StarRocks/starrocks/pull/77590) [#77737](https://github.com/StarRocks/starrocks/pull/77737)
- Fail an internal DML/CONTROL statement that only records an error state, so the failure surfaces instead of being silently swallowed. [#77388](https://github.com/StarRocks/starrocks/pull/77388)

**Statistics, metrics, and FE/metadata**

- Fixed statistics correctness: reject null buckets/MCV in histograms, and make `CancelableAnalyzeTask.cancel` pick a single winner. [#77024](https://github.com/StarRocks/starrocks/pull/77024) [#78593](https://github.com/StarRocks/starrocks/pull/78593)
- Registered the `pipe_driver_queue_len` metric, added a BE metric for NotFound lake tablet metadata reads, skipped table metrics for non-table StarOS shards and checkpoint thread-pool metrics, and fixed the misspelled `ZoneMapIndexFilter` key in the profile dictionary. [#77890](https://github.com/StarRocks/starrocks/pull/77890) [#78451](https://github.com/StarRocks/starrocks/pull/78451) [#78116](https://github.com/StarRocks/starrocks/pull/78116) [#77367](https://github.com/StarRocks/starrocks/pull/77367) [#78728](https://github.com/StarRocks/starrocks/pull/78728)
- FE/metadata fixes: ignore recycled missing shard groups in meta sync, restore multiple connection groups per endpoint in bRPC, resolve compute-node hostnames in FE before shipping them to BE, make dropped FE exit itself on `DROP FOLLOWER`/`OBSERVER`, and expose colocate group scheduling sample knobs. [#76604](https://github.com/StarRocks/starrocks/pull/76604) [#76765](https://github.com/StarRocks/starrocks/pull/76765) [#78390](https://github.com/StarRocks/starrocks/pull/78390) [#78215](https://github.com/StarRocks/starrocks/pull/78215) [#78450](https://github.com/StarRocks/starrocks/pull/78450)
- Fixed skipping non-extended access paths when extending meta-scan tablets, matching a scan's access paths by column id, narrowing an OLAP scan's complex type only when the BE prunes it, and not pruning subfields of aggregate-state columns. [#76593](https://github.com/StarRocks/starrocks/pull/76593) [#77987](https://github.com/StarRocks/starrocks/pull/77987) [#77894](https://github.com/StarRocks/starrocks/pull/77894) [#77901](https://github.com/StarRocks/starrocks/pull/77901)
- Do not use a global dictionary for aggregate-state columns or dictionarize expressions returning `ARRAY`/`STRUCT`, and index page null flags by ordinal when a pushed-down predicate reads a sparse range. [#77096](https://github.com/StarRocks/starrocks/pull/77096) [#78488](https://github.com/StarRocks/starrocks/pull/78488)
- Additional metrics and FE fixes: report bRPC method error bvars as counters, report the real tablet count as Buckets for range-distribution partitions, fix an NPE in `show proc '/global_current_queries'`, report data cache read stats in intermediate query statistics, use a minimal TSD fetch in jemalloc `malloc_usable_size`, stop the heap-profile toggle from writing `prof.thread_active_init`, prevent FE connection ID collisions after wrap, fix table stats health pinned at ~1.0 when many partitions are stale, use `feature_log_dir` for FE features-log paths, preserve `inputIsBinary` when copying logical window operators, and fix a Thrift client leak after cache invalidation. [#76956](https://github.com/StarRocks/starrocks/pull/76956) [#77465](https://github.com/StarRocks/starrocks/pull/77465) [#77407](https://github.com/StarRocks/starrocks/pull/77407) [#77696](https://github.com/StarRocks/starrocks/pull/77696) [#77625](https://github.com/StarRocks/starrocks/pull/77625) [#78384](https://github.com/StarRocks/starrocks/pull/78384) [#78217](https://github.com/StarRocks/starrocks/pull/78217) [#76927](https://github.com/StarRocks/starrocks/pull/76927) [#77221](https://github.com/StarRocks/starrocks/pull/77221) [#77058](https://github.com/StarRocks/starrocks/pull/77058) [#77072](https://github.com/StarRocks/starrocks/pull/77072)

**Other**

- Applied request timeouts to the pooled Poco session, upgraded Hyperscan to Vectorscan 5.4.12 on Linux AArch64, escalated the `JAVA_OPTS_FOR_JDK_*` warning, and stopped shipping test-scope jars in the java-extensions reader libs. [#78361](https://github.com/StarRocks/starrocks/pull/78361) [#78326](https://github.com/StarRocks/starrocks/pull/78326) [#78328](https://github.com/StarRocks/starrocks/pull/78328) [#77752](https://github.com/StarRocks/starrocks/pull/77752)
- Serialize `dictionary_get` keys by key size, catch exceptions in the thrift processor, and keep `files()` schema inference off the planner meta lock for CTAS. [#78706](https://github.com/StarRocks/starrocks/pull/78706) [#78805](https://github.com/StarRocks/starrocks/pull/78805) [#78772](https://github.com/StarRocks/starrocks/pull/78772)
- Read the last conf line when the file has no trailing newline, resolve the config YAML path against the cwd, name the GCS upload-threshold BE config `gcs` (not `gs`), upgrade StarOS and Starlet to 4.1.3, and removed an obsolete config forward-header split and a stray U+200E in doc filenames. [#78065](https://github.com/StarRocks/starrocks/pull/78065) [#77132](https://github.com/StarRocks/starrocks/pull/77132) [#78452](https://github.com/StarRocks/starrocks/pull/78452) [#78038](https://github.com/StarRocks/starrocks/pull/78038) [#78780](https://github.com/StarRocks/starrocks/pull/78780) [#78612](https://github.com/StarRocks/starrocks/pull/78612)
...
- In shared-data mode, the `TABLESAMPLE` / `SAMPLE` clause and `ANALYZE SAMPLE TABLE` now take effect on lake tables. Previously the sample options never reached the BE, so a full scan was performed. [#71874](https://github.com/StarRocks/starrocks/pull/71874)
- `ALTER TABLE` changes to the `flat_json` configuration are now propagated to BE nodes through a versioned task so they take effect reliably. [#74747](https://github.com/StarRocks/starrocks/pull/74747)
- `NOT MATCH` predicates answered by a GIN inverted index no longer return NULL rows; NULL rows are now correctly excluded from the result. [#75578](https://github.com/StarRocks/starrocks/pull/75578)
- `ANALYZE ... UPDATE HISTOGRAM ON` no longer computes histograms for char-family columns (which the optimizer does not use) and computes only MCVs, reducing analyze cost. [#75968](https://github.com/StarRocks/starrocks/pull/75968)
- `rewrite_manifests` now clusters output manifests by order-preserving partition ranges, producing tighter per-manifest partition bounds and better manifest pruning on tables with many partitions. [#76193](https://github.com/StarRocks/starrocks/pull/76193)
- Multi-table stream load now honors each table's `file_bundling` property when deciding whether to use a combined transaction log, instead of following only the global `lake_use_combined_txn_log` config. [#76806](https://github.com/StarRocks/starrocks/pull/76806)
- A GIN inverted index combined with column-mode partial update on a Primary Key table no longer returns corrupted results; the index is now served from the delta column group segment. [#76271](https://github.com/StarRocks/starrocks/pull/76271)
- `array_difference` on integer arrays now computes adjacent differences in 64-bit before widening to `BIGINT`, fixing int32 overflow. [#76569](https://github.com/StarRocks/starrocks/pull/76569)
- Division expressions with a non-constant divisor are no longer treated as monotonic, fixing incorrect ZoneMap pruning that could produce wrong results. [#76744](https://github.com/StarRocks/starrocks/pull/76744)
- Array and map constructors now raise an error instead of silently corrupting data when the flattened result of a chunk exceeds 4 GB. [#76419](https://github.com/StarRocks/starrocks/pull/76419)
- Primary Key inserts now correctly reject keys that already exist in the L1/L2 persistent index; the existence check was previously skipped. [#76591](https://github.com/StarRocks/starrocks/pull/76591)
- Sample-based tablet pre-split on range-colocate tables now spreads new shards across compute nodes instead of packing them onto the source tablet's worker, fixing range batch imports that were roughly 3x slower than hash. [#76608](https://github.com/StarRocks/starrocks/pull/76608)
- Incremental-or-AUTO materialized views now rebuild the maintenance query for the PCT fallback in `AUTO` refresh mode, fixing refresh failures for shapes that IVM does not support. [#75961](https://github.com/StarRocks/starrocks/pull/75961)
- `ALTER MATERIALIZED VIEW ... ACTIVE` now works for non-aggregate INCREMENTAL materialized views; the storage-filled `__ROW_ID__` column is kept out of the MV DDL column list so an inactive IVM can be re-activated. [#77017](https://github.com/StarRocks/starrocks/pull/77017)
- The Iceberg partition cache is now bounded by memory (not just entry count) and its usage is exposed, preventing unbounded growth on tables with many partitions. [#76165](https://github.com/StarRocks/starrocks/pull/76165)
- Iceberg REST catalogs using OAuth2 client credentials now self-heal after the background token-refresh task dies, instead of failing all subsequent requests. [#76457](https://github.com/StarRocks/starrocks/pull/76457)
- Lake full vacuum now reclaims orphaned `.lcrm` (Lake Compaction Rows Mapper) files that were previously skipped. [#76522](https://github.com/StarRocks/starrocks/pull/76522)
- Shared-data publish now refuses to write a bundle tablet metadata file that is missing tablets, preventing a partition from getting permanently stuck on publish. [#76850](https://github.com/StarRocks/starrocks/pull/76850)
- Abandoned external (Spark/Flink connector) scan contexts now cancel their pipeline fragments when reaped, and external scan plans set `query_delivery_timeout` to bound the QueryContext lifetime. [#76535](https://github.com/StarRocks/starrocks/pull/76535) [#76536](https://github.com/StarRocks/starrocks/pull/76536)
- Materialized view pinned-range maps are now keyed correctly (by table UUID), fixing MV bootstrap pinning being disabled for OLAP tables and mishandling of same-named tables in different databases. [#76320](https://github.com/StarRocks/starrocks/pull/76320) [#76351](https://github.com/StarRocks/starrocks/pull/76351)
- Audit logs for statements forwarded to the leader FE now record fully-qualified queried relations (matching the leader) instead of CTE aliases and unqualified table names. [#76387](https://github.com/StarRocks/starrocks/pull/76387)
- Aggregating a full `STRUCT` column together with `ROLLUP`, `CUBE`, or `GROUPING SETS` no longer fails at plan time with a `usedStructFiledPos` error. [#76804](https://github.com/StarRocks/starrocks/pull/76804)
- The FE memory `Estimator` now counts container overhead, and the Parquet scanner now pads missing columns using the bounded chunk size instead of the full batch size, improving memory accounting accuracy. [#75971](https://github.com/StarRocks/starrocks/pull/75971) [#75981](https://github.com/StarRocks/starrocks/pull/75981)

### Improvements

- Added support for an `INCLUDE METADATA` clause in Routine Load to expose Kafka/Pulsar message metadata (such as partition, offset, and timestamp). [#73840](https://github.com/StarRocks/starrocks/pull/73840)
- Made the Routine Load metadata alias optional. [#76294](https://github.com/StarRocks/starrocks/pull/76294)
- Added a `LAST_FRESHNESS_CONFIRMED_AT` column to `information_schema.materialized_views`. [#74585](https://github.com/StarRocks/starrocks/pull/74585)
- Exposed data cache metrics through the `/metrics` endpoint, and added FE compaction metrics, `ALTER TABLE` column-operation metrics and durations, and a `CompressedInputBytes` metric on the exchange sink. [#58204](https://github.com/StarRocks/starrocks/pull/58204) [#72941](https://github.com/StarRocks/starrocks/pull/72941) [#76247](https://github.com/StarRocks/starrocks/pull/76247) [#76309](https://github.com/StarRocks/starrocks/pull/76309)
- Exposed authentication and connectivity error details from connector metadata operations to end users. [#75490](https://github.com/StarRocks/starrocks/pull/75490)
- Improved error messages for large-column capacity limit checks. [#76303](https://github.com/StarRocks/starrocks/pull/76303)
- Added the `hdfs_backend_selector_cache_replica_num` variable, and made the object storage client cache size runtime mutable. [#75023](https://github.com/StarRocks/starrocks/pull/75023) [#75851](https://github.com/StarRocks/starrocks/pull/75851)
- Extended sample-based tablet pre-split meta-tier readers to more sort-key types, including `CHAR`, composite sort keys, and UTC-adjusted Parquet `TIMESTAMP` / ORC `TIMESTAMP_INSTANT`. [#75937](https://github.com/StarRocks/starrocks/pull/75937) [#76011](https://github.com/StarRocks/starrocks/pull/76011) [#76114](https://github.com/StarRocks/starrocks/pull/76114)
- Improved external-table statistics collection: predicate column usage is now tracked, multiple columns are collected in a single scan, and a bounded-cost scan budget is applied for Iceberg tables. [#75938](https://github.com/StarRocks/starrocks/pull/75938) [#76638](https://github.com/StarRocks/starrocks/pull/76638) [#76549](https://github.com/StarRocks/starrocks/pull/76549)
- Supports right-outer, semi, anti, and full-outer range-colocate joins. [#76040](https://github.com/StarRocks/starrocks/pull/76040)
- Optimized Query Queue V2 cost estimators. [#76609](https://github.com/StarRocks/starrocks/pull/76609)
- Pushed the wildcard literal prefix down to the S3 `ListObjectsV2` call for `FILES()` globs, reducing objects listed. [#76210](https://github.com/StarRocks/starrocks/pull/76210)
- When scanning Iceberg manifest entries in `remove_orphan_files`, only the `file_path` column is now projected. [#76020](https://github.com/StarRocks/starrocks/pull/76020)
- Supports base compaction for lake Primary Key tablets, and load spill plus eager PK-index SST for separate-sort-key cloud-native PK tables. [#76794](https://github.com/StarRocks/starrocks/pull/76794) [#76094](https://github.com/StarRocks/starrocks/pull/76094)
- Supports a metadata-only add of a trailing sort-key column on shared-data range-distribution tables. [#76341](https://github.com/StarRocks/starrocks/pull/76341)
- Cancels in-flight exchange sink RPCs on fragment cancellation, and cancels in-flight compactions on resharded partitions during reshard cleaning. [#75613](https://github.com/StarRocks/starrocks/pull/75613) [#76759](https://github.com/StarRocks/starrocks/pull/76759)
- Fires multi-statement stream load channels before waiting, reducing load latency. [#76715](https://github.com/StarRocks/starrocks/pull/76715)
- Added a memory-limit check for column upgrades in `Analytor::process`. [#75821](https://github.com/StarRocks/starrocks/pull/75821)
- Preserves the real error status when an async delta writer is stopped. [#76216](https://github.com/StarRocks/starrocks/pull/76216)
- Records generation version on lake PK-index SSTables, applies `op_write.seg_delvecs` at lake Primary Key publish, and skips opening output segment footers during compaction publish conflict resolution. [#76208](https://github.com/StarRocks/starrocks/pull/76208) [#76474](https://github.com/StarRocks/starrocks/pull/76474) [#76657](https://github.com/StarRocks/starrocks/pull/76657)
- Added stack-trace and fine-grained trace counters for lake load and publish-version paths to aid diagnosis. [#75901](https://github.com/StarRocks/starrocks/pull/75901) [#76810](https://github.com/StarRocks/starrocks/pull/76810)

### Security

- [CVE-2026-44891] Bumped Netty to 4.1.136.Final to fix a memory-exhaustion (DoS) vulnerability in the STOMP subframe decoder. [#76555](https://github.com/StarRocks/starrocks/pull/76555)
- [CVE-2026-55971] [CVE-2026-43871] Bumped Apache Thrift to 0.24.0 to fix a heap-based buffer overflow in the C++ bindings and an infinite-loop vulnerability. [#76922](https://github.com/StarRocks/starrocks/pull/76922)
- [CVE-2026-10050] Excluded vulnerable Jetty jars (client-side Digest auth bypass, pulled in transitively via Hadoop) and bumped pgjdbc to 42.7.12. [#76783](https://github.com/StarRocks/starrocks/pull/76783)
- [CVE-2011-4969] [CVE-2014-6071] Excluded the unused `avro-ipc` jar that bundled a vulnerable jQuery 1.4.2 (and other jQuery XSS CVEs). [#76270](https://github.com/StarRocks/starrocks/pull/76270)
- [CVE-2024-29857] Removed vulnerable stale transitive dependencies that shipped alongside their fixed counterparts (for example `bcprov-jdk15on` 1.70 and EOL `okhttp` 2.x) and added dependency bans to prevent regressions. [#76097](https://github.com/StarRocks/starrocks/pull/76097)

### Bug Fixes

The following issues have been fixed:

- Planner crash on an empty range in join predicate derivation. [#75011](https://github.com/StarRocks/starrocks/pull/75011)
- Aggregate incorrectly pushed down over a `CASE` with a non-null constant `ELSE`. [#75037](https://github.com/StarRocks/starrocks/pull/75037)
- `PARTITION-TOP-N` partition-by rewritten to a pruned dictionary slot. [#75956](https://github.com/StarRocks/starrocks/pull/75956)
- Wrong operator precedence in the join shuffle-join output-property branch, and `predicateCommonOperators` not carried through join operator construction. [#76203](https://github.com/StarRocks/starrocks/pull/76203) [#76330](https://github.com/StarRocks/starrocks/pull/76330) [#76388](https://github.com/StarRocks/starrocks/pull/76388)
- Incorrect nullability for view columns and for `ROLLUP` keys at analysis time. [#75684](https://github.com/StarRocks/starrocks/pull/75684) [#76149](https://github.com/StarRocks/starrocks/pull/76149)
- `regexp_extract_all` infinite loop on a zero-length capture group. [#75798](https://github.com/StarRocks/starrocks/pull/75798)
- Wrong `nullsFraction` clamp in `LargeOrCalculatingVisitor`. [#75864](https://github.com/StarRocks/starrocks/pull/75864)
- Incorrect `CAST` semantics for string-to-number schema-change conversion. [#75538](https://github.com/StarRocks/starrocks/pull/75538)
- Sync MV rewrite losing a rollup column for same-column `min`/`max`. [#75528](https://github.com/StarRocks/starrocks/pull/75528)
- Rewrite incorrectly applied inside an `array_map` lambda when pulling scan predicates up. [#76380](https://github.com/StarRocks/starrocks/pull/76380)
- `COUNT(DISTINCT)` over-count on Iceberg bucket tables under bucket-aware execution. [#76601](https://github.com/StarRocks/starrocks/pull/76601)
- Error on nullable output for `UNNEST` + `GROUP BY` of a required Iceberg column. [#76730](https://github.com/StarRocks/starrocks/pull/76730)
- Reduced lock contention across the `INSERT OVERWRITE` code path, and restored `Operator` salt to avoid a Memo self-reference during CBO table prune. [#75828](https://github.com/StarRocks/starrocks/pull/75828) [#76542](https://github.com/StarRocks/starrocks/pull/76542)
- Iceberg partition pruning, manifest row-count estimation, metadata delete, equality-delete application, and Delta Lake partition pruning were incorrect when a string date partition column is compared with a temporal value. [#76068](https://github.com/StarRocks/starrocks/pull/76068) [#76107](https://github.com/StarRocks/starrocks/pull/76107) [#76197](https://github.com/StarRocks/starrocks/pull/76197) [#76280](https://github.com/StarRocks/starrocks/pull/76280) [#76348](https://github.com/StarRocks/starrocks/pull/76348)
- Iceberg reads did not honor the targeted snapshot's schema and partition spec; query failure on an Iceberg V1 table after dropping a partition field; and MV rewrite serving stale results after `rollback_to_snapshot`. [#74711](https://github.com/StarRocks/starrocks/pull/74711) [#75149](https://github.com/StarRocks/starrocks/pull/75149) [#75924](https://github.com/StarRocks/starrocks/pull/75924)
- Iceberg manifest data-file cache served an incomplete file set; the incremental scan-range iterator was unsafe to close concurrently; and analysis-time time-travel snapshot binding is now best-effort. [#76215](https://github.com/StarRocks/starrocks/pull/76215) [#75953](https://github.com/StarRocks/starrocks/pull/75953) [#76448](https://github.com/StarRocks/starrocks/pull/76448)
- Iceberg/Delta metadata-derived statistics are now tagged with `StatsSource=TABLE_METADATA`. [#76560](https://github.com/StarRocks/starrocks/pull/76560)
- Delta Lake and Kudu un-partitioned materialized view query rewrite. [#76359](https://github.com/StarRocks/starrocks/pull/76359)
- GCS vended credentials ignored due to a `gcs-connector` 3.x config rename. [#75979](https://github.com/StarRocks/starrocks/pull/75979)
- Hive `getTable()` now reconnects before the `get_table_req` fallback and detects table-not-found by exception type instead of message text. [#76456](https://github.com/StarRocks/starrocks/pull/76456) [#76459](https://github.com/StarRocks/starrocks/pull/76459)
- `BOOLEAN` min/max not supported in Parquet column-index statistics. [#74752](https://github.com/StarRocks/starrocks/pull/74752)
- Flat-JSON subfield reads for keys whose name contains `.`, and reconstruction of an intermediate flat-JSON object instead of returning NULL; JSON subfield pushdown is now skipped when subfield keys collide case-insensitively. [#75583](https://github.com/StarRocks/starrocks/pull/75583) [#75764](https://github.com/StarRocks/starrocks/pull/75764) [#76594](https://github.com/StarRocks/starrocks/pull/76594)
- Kept OR-nested predicates when only one branch is bitmap-indexed. [#76275](https://github.com/StarRocks/starrocks/pull/76275)
- BE crash in Primary Key auto-increment partial-update apply. [#76119](https://github.com/StarRocks/starrocks/pull/76119)
- BE crash from a `LoadChunkSpiller` init race during load spill. [#76098](https://github.com/StarRocks/starrocks/pull/76098)
- Native Parquet reader crash on an incomplete nested lake schema, and an ASAN crash for `BOOLEAN` nested in Avro complex-type columns. [#76455](https://github.com/StarRocks/starrocks/pull/76455) [#76041](https://github.com/StarRocks/starrocks/pull/76041)
- `bad_variant_access` during schema change when converting an invalid string to a `NOT NULL` numeric column. [#76707](https://github.com/StarRocks/starrocks/pull/76707)
- Heap-buffer-overflow in the `SimdJsonConverter` error path, and a use-after-free on a multi-character CSV delimiter straddling a buffer expansion. [#76752](https://github.com/StarRocks/starrocks/pull/76752) [#76718](https://github.com/StarRocks/starrocks/pull/76718)
- Use-after-free on `MorselQueueFactory` during scan teardown, in the spillable join build `set_finishing` at cancel time, and a global runtime-filter timer leak / unscheduled timer in the `PipelineDriver` destructor. [#76259](https://github.com/StarRocks/starrocks/pull/76259) [#76633](https://github.com/StarRocks/starrocks/pull/76633) [#76252](https://github.com/StarRocks/starrocks/pull/76252)
- Null-safe `SparseRangeIterator::has_more()` to fix a physical-split empty-tablet CN crash, and a bRPC stub cache clean timer leak. [#75985](https://github.com/StarRocks/starrocks/pull/75985) [#75973](https://github.com/StarRocks/starrocks/pull/75973)
- `ConnectContext` not restored on query-deploy workers. [#76366](https://github.com/StarRocks/starrocks/pull/76366)
- Preserve upsert/delete order within a transaction for shared-data Primary Key tables, including making the spill merge op-aware. [#75338](https://github.com/StarRocks/starrocks/pull/75338) [#75366](https://github.com/StarRocks/starrocks/pull/75366)
- Read durable metadata in `cal_new_base_version` to avoid a dangling `prev_garbage_version`; keep `base_version` in sync with `base_metadata` in `publish_version`; and persist the merged parallel-compaction transaction log on the regular path. [#75904](https://github.com/StarRocks/starrocks/pull/75904) [#76313](https://github.com/StarRocks/starrocks/pull/76313) [#76460](https://github.com/StarRocks/starrocks/pull/76460)
- Range-colocate fixes: stopped an alignment job storm and fail-close unaligned colocate joins, fixed null-safe joins dropping matches under bucket-shuffle, and improved range-colocate join detection in plan feedback. [#75930](https://github.com/StarRocks/starrocks/pull/75930) [#76104](https://github.com/StarRocks/starrocks/pull/76104) [#76121](https://github.com/StarRocks/starrocks/pull/76121)
- Tablet split/reshard fixes: bump the table optimistic version on split so concurrent queries re-plan, flush the PK-index memtable before identical-tablet reshard, retain lake vacuum files by version interval across reshard, stop the auto-split job loop on un-splittable range-distribution tablets, and fix `IS NULL` pruning on range-distributed sort keys after a split. [#76123](https://github.com/StarRocks/starrocks/pull/76123) [#76367](https://github.com/StarRocks/starrocks/pull/76367) [#76209](https://github.com/StarRocks/starrocks/pull/76209) [#76663](https://github.com/StarRocks/starrocks/pull/76663) [#76797](https://github.com/StarRocks/starrocks/pull/76797)
- Reject a full-column `ORDER BY` that reorders the key columns of a key-derived range-distribution table. [#76256](https://github.com/StarRocks/starrocks/pull/76256)
- Consolidate load-spill parallel merge results in flush order, and exclude touched indexes by `metaId` in file-bundling carry-forward. [#75951](https://github.com/StarRocks/starrocks/pull/75951) [#76368](https://github.com/StarRocks/starrocks/pull/76368)
- Reserve dictionary size + 1 for NULL-absorbing dict-mapping group-by keys, and check driver readiness before a profile-report reschedule. [#75357](https://github.com/StarRocks/starrocks/pull/75357) [#75725](https://github.com/StarRocks/starrocks/pull/75725)
- `PlannerMetaLocker` skipped unlock when the lock never succeeded. [#74041](https://github.com/StarRocks/starrocks/pull/74041)
- Filter resource groups by warehouse. [#73209](https://github.com/StarRocks/starrocks/pull/73209)
- Escape the `jsonpaths` value in `SHOW CREATE ROUTINE LOAD` output. [#75755](https://github.com/StarRocks/starrocks/pull/75755)
- Fixed Arrow Flight prepared-statement forwarding. [#76310](https://github.com/StarRocks/starrocks/pull/76310)
- Fixed dictionary refresh-interval overflow and unintended auto refresh. [#76634](https://github.com/StarRocks/starrocks/pull/76634)
- Fixed a statistics cache load failure on empty min/max under `ERROR_IF_OVERFLOW`. [#76684](https://github.com/StarRocks/starrocks/pull/76684)
- Made the catalog-drop existence check atomic under a write lock. [#76778](https://github.com/StarRocks/starrocks/pull/76778)
...
- `FILES()` and broker/stream load no longer apply a session timezone shift to `INT64` Parquet timestamps written with `isAdjustedToUTC=false`; those timestamps are now treated as wall-clock values and loaded as-is. Data loaded from such files before v4.1.3 may differ from data loaded after upgrading; reload if consistency is required. [#73674](https://github.com/StarRocks/starrocks/pull/73674)
...
- Routine Load now supports the `property.kafka_partition_discovery` property, which allows partition auto-discovery to continue even when `kafka_partitions` and `kafka_offsets` are specified to seed exact starting offsets. When `property.kafka_default_offsets` is not set, the default starting offset for partitions discovered after the job already has consuming progress changes from `OFFSET_END` to `OFFSET_BEGINNING` — and this applies to **all** auto-discovery jobs, not only those using the new property. [#74729](https://github.com/StarRocks/starrocks/pull/74729)
...
- BE process could exit unexpectedly during startup (typically right after deployment) because SIGPIPE was not ignored in BE signal initialization. [#74424](https://github.com/StarRocks/starrocks/pull/74424)
