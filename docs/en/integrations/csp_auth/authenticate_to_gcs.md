...
- Query [Hive](../../data_source/catalog/hive_catalog.md), [Iceberg](../../data_source/catalog/iceberg/iceberg.md), [Hudi](../../data_source/catalog/hudi_catalog.md), and [Delta Lake](../../data_source/catalog/deltalake_catalog.md) tables in GCS.

In this topic, [Hive catalog](../../data_source/catalog/hive_catalog.md), [file external table](../../data_source/file_external_table.md), and [Broker Load](../../sql-reference/sql-statements/loading_unloading/BROKER_LOAD.md) are used as examples to show how StarRocks integrates with GCS in different scenarios. For information about `StorageCredentialParams` in the examples, see the "[Parameters](./authenticate_to_gcs.md#parameters)" section of this topic.
