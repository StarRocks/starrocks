...
<<<<<<< HEAD:docs/en/using_starrocks/create_partitioned_materialized_view.md
=======
...
>>>>>>> 164b1b2b2d ([Doc] Organize query acceleration and administration (#51291)):docs/en/using_starrocks/async_mv/use_cases/create_partitioned_materialized_view.md
