...
For Hive Catalog, Iceberg Catalog (starting from v3.1.4), and Paimon Catalog (starting from v3.2.1), StarRocks supports detecting data changes at the partition level. As a result, StarRocks can:
