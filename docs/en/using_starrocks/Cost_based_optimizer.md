...
sidebar_position: 10
description: "How to configure StarRocks' cost-based optimizer (CBO) by collecting full, sampled, and histogram statistics for internal and external tables to improve query plan accuracy."
---
