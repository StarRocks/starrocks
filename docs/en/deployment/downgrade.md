...
1. Create a metadata snapshot.
   ...
   a. Run [ALTER SYSTEM CREATE IMAGE](../sql-reference/sql-statements/Administration/cluster-management/nodes_processes/ALTER_SYSTEM.md) to create a meatedata snapshot.
