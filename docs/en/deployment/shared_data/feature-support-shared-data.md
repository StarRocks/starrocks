...
| Partial Update                | v3.1.0                   | <ul><li>Currently, shared-data clusters support only Partial Update in Row mode.</li><li>Future support will include Column mode.</li></ul> |
