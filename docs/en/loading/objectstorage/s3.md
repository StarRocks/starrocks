...
The examples in this topic use IAM user-based authentication. To ensure that you have permission to read data from AWS S3, we recommend that you read [Preparation for IAM user-based authentication](../../integrations/csp_auth/authenticate_to_aws_resources.md) and follow the instructions to create an IAM user with proper [IAM policies](../../sql-reference/aws_iam_policies.md) configured.
...
For information about all the authentication methods available, see [Authenticate to AWS resources](../../integrations/csp_auth/authenticate_to_aws_resources.md).
