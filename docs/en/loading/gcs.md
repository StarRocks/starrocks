...
description: "How to load data from Google Cloud Storage (GCS) into StarRocks using INSERT+FILES(), Broker Load, or Spark Load."
---
...
- Query the data directly from GCS using [SELECT](../sql-reference/sql-statements/table_bucket_part_index/SELECT/SELECT.md).
...
You can query the progress of INSERT jobs from the [`loads`](../sql-reference/information_schema/loads.md) view in the StarRocks Information Schema. This feature is supported from v3.1 onwards.
