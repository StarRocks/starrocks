...
>>>>>>> 68e1e33433 ([Doc] Change loading mode to loading method in stream load doc (#36411))
...
Use the SHOW LOAD statement or the curl command to view the progress of Broker Load jobs.

For usage of the SHOW LOAD statement, see [SHOW LOAD](../sql-reference/sql-statements/data-manipulation/SHOW_LOAD.md).

The syntax for curl is as follows:
