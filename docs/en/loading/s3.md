...
description: "How to load data from AWS S3 into StarRocks using INSERT+FILES(), Broker Load, Spark Load, or Pipe, with IAM and instance profile authentication options."
---
...
- Query the data directly from S3 using [SELECT](../sql-reference/sql-statements/table_bucket_part_index/SELECT/SELECT.md).
