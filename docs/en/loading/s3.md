...
- Query the progress of the Pipe job from the [`pipes`](../reference/information_schema/pipes.md) view in the StarRocks Information Schema.
  ...
  ```SQL
  SELECT * FROM information_schema.pipes WHERE pipe_name = 'user_behavior_pipe' \G
  ```
  ...
  *************************** 1. row ***************************
  DATABASE_NAME: mydatabase
      ...
      PIPE_NAME: user_behavior_pipe
          STATE: RUNNING
     TABLE_NAME: mydatabase.user_behavior_from_pipe
    LOAD_STATUS: {"loadedFiles":0,"loadedBytes":0,"loadingFiles":57}
     LAST_ERROR:
...
*************************** 1. row ***************************
   DATABASE_NAME: mydatabase
         PIPE_ID: 10127
       PIPE_NAME: user_behavior_pipe
       FILE_NAME: s3://starrocks-examples/user-behavior-10-million-rows/data_0_0_15.parquet
    FILE_VERSION: 1709212359828
       FILE_SIZE: 136901706
   LAST_MODIFIED: 2024-02-29 13:12:39
      LOAD_STATE: FINISHED
     STAGED_TIME: 2024-02-29 14:51:42
 START_LOAD_TIME: 2024-02-29 14:51:43
FINISH_LOAD_TIME: 2024-02-29 14:51:56
       ERROR_MSG:
```
