...
You can query the progress of INSERT jobs from the [`information_schema.loads`](../sql-reference/information_schema.md) view. This feature is supported from v3.1 onwards. Example:
...
For information about the fields provided in the `loads` view, see [Information Schema](../sql-reference/information_schema.md).
...
You can query the progress of Broker Load jobs from the [`information_schema.loads`](../sql-reference/information_schema.md) view. This feature is supported from v3.1 onwards.
