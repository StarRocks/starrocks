...
- Learn about how Broker Load supports data transformation during loading at [Transform data at loading](./Etl_in_loading.md) and [Change data through loading](./Load_to_Primary_Key_tables.md).
- This document only covered IAM user-based authentication. For other options please see [authenticate to AWS resources](../integrations/csp_auth/authenticate_to_aws_resources.md).
