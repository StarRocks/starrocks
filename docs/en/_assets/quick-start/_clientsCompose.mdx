...
![Add a connection](/_assets/quick-start/DBeaver-1.png)
- Configure the port, IP, and username. Test the connection, and click Finish if the test succeeds:
![Configure and test](/_assets/quick-start/DBeaver-2.png)
...
![Connection settings](/_assets/quick-start/Workbench-1.png)
...
![Ignore warning](/_assets/quick-start/Workbench-2.png)
</TabItem>
