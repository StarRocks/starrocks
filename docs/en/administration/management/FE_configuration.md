...
- Unit: -
- Is mutable: Yes
- Description: Whether to trace the historical nodes. This is the main basis for cache sharing ability to choose the right cache nodes during elastic scaling.
- Introduced in: v3.5.1
