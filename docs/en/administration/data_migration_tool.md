...
The following FE parameters are dynamic configuration items. Refer to [Configure FE Dynamic Parameters](../administration/Configuration.md#configure-fe-dynamic-parameters) on how to modify them.
...
The following BE parameter is a dynamic configuration item. Refer to [Configure BE Dynamic Parameters](../administration/Configuration.md#configure-be-dynamic-parameters) on how to modify it.
