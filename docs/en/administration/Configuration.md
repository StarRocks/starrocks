...
- **Unit**: -
- **Default**: 5
- **Description**: The maximum number of concurrent Routine Load tasks on each BE. This parameter needs to be less than or equal to the value of BE static parameter `routine_load_thread_pool_size` (deprecated).
