...
| tablet_sched_slot_num_per_path                | -    | 4                      | The maximum number of tablet-related tasks that can run concurrently in a BE storage directory. The alias is `schedule_slot_num_per_path`. |
