...
- Is mutable: No
- Description:
- Introduced in: A boolean value to control whether to serialize the row batches in RPCs between BEs. `true` indicates serializing the row batches, and `false` indicates -->
