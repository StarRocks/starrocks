...
Create the StarRocks deployment topology file based on the following YAML template. See [Configuration](../administration/management/management.mdx) for detailed information.
...
Create the scale-out task topology file based on the following template. You can specify the file to add FE and/or BE nodes based on your demand. See [Configuration](../administration/management/management.mdx) for detailed information.
