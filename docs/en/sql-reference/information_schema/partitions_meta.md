...
| BUCKETS                       | Number of buckets in the partition. For a table with range distribution, this is the actual number of tablets in the partition's base index, which changes as tablets are split and merged. |
