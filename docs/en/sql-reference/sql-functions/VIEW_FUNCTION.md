...
Since version 4.1, StarRocks supports creating View Functions, allowing users to create functions using SQL expressions.

View Function is a lightweight function definition method that encapsulates a SQL expression into a reusable function, which is dynamically expanded into the actual SQL expression at query time.

## Overview

Main features of View Function:
...
### Example 5: Global View Function
...
View Function supports nested calls:
...
View Function supports implicit type conversion:
...
View Function can be freely combined with StarRocks built-in functions:
...
View Function is expanded into actual SQL expressions during the query optimization phase, with the following performance characteristics:
