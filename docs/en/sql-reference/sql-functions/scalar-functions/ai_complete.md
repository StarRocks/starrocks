...
- `model`: A VARCHAR expression that selects the model for this call. When omitted, StarRocks uses
  [`ai_default_chat_model`](../../../administration/management/FE_parameters/user_query_loading.md#ai_default_chat_model).
...
- The BE configuration
  [`ai_function_on_error`](../../../administration/management/BE_parameters/query_loading.md#ai_function_on_error)
...
|-----------|---------|-------------|
| [`ai_default_chat_endpoint`](../../../administration/management/FE_parameters/user_query_loading.md#ai_default_chat_endpoint) | Empty string | Required. A complete HTTPS POST URL for the chat-completions endpoint. |
| [`ai_default_chat_model`](../../../administration/management/FE_parameters/user_query_loading.md#ai_default_chat_model) | Empty string | Required for prompt-only overloads; optional when every call supplies an explicit model. |
| [`ai_default_chat_provider`](../../../administration/management/FE_parameters/user_query_loading.md#ai_default_chat_provider) | Empty string | Required. The only valid value is `openai_compatible`. |
...
- [`ai_function_rate_limit_qps_chat`](../../../administration/management/BE_parameters/query_loading.md#ai_function_rate_limit_qps_chat)
  and
  [`ai_function_max_inflight`](../../../administration/management/BE_parameters/query_loading.md#ai_function_max_inflight)
...
- StarRocks cannot guarantee exactly-once execution at the model provider. A timed-out or otherwise failed attempt may
  ...
  [`ai_function_max_retries`](../../../administration/management/BE_parameters/query_loading.md#ai_function_max_retries)
  and
  [`ai_function_max_retries_on_throttle`](../../../administration/management/BE_parameters/query_loading.md#ai_function_max_retries_on_throttle)
...
- Request and response payloads are charged to the query memory tracker, and the execution pipeline applies
  ...
  [`ai_function_max_response_bytes`](../../../administration/management/BE_parameters/query_loading.md#ai_function_max_response_bytes)
...
- The independent task timeout is fixed for the task and does not restart on retry. Query cancellation and deadline
  ...
  [BE AI function parameters](../../../administration/management/BE_parameters/query_loading.md#ai_function_request_timeout_ms).
