...
description: "Returns the Haversine (great-circle) distance in radians between two geographic points."
---

# h3PointDistRads

Returns the Haversine (great-circle) distance in radians between two geographic points specified by their latitude and longitude in degrees. One radian equals the Earth's mean radius (~6,371 km).
...
Returns a DOUBLE representing the great-circle distance in radians between the two points. Returns NULL if any argument is NULL.
