...
| `ai_translate` | VARCHAR | Translated text. NULL or an empty source language requests automatic detection. A NULL, empty, or ASCII-whitespace-only target language returns NULL without a request. |
