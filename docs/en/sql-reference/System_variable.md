...
* **Description**: The maximum number of consecutive DataCache blocks fetched by one remote read for the paimon-cpp native reader. Increasing this value reduces fragmented remote requests at the cost of a larger temporary buffer.
* **Default**: 64, equivalent to 16 MiB with the default 256 KiB DataCache block
* **Data type**: Integer
* **Value range**: [1, 256]
* **Introduced in**: v4.2
