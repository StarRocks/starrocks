...
- Method 4: Use [Routine Load](../../../loading/loading_introduction/Loading_intro.md) to continuously consume JSON format data from Kafka and import it into StarRocks.
