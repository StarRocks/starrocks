...
Shows the logical or physical execution plans for a query statement. For instructions on how analyze a query plan, refer to [Plan analysis](../../../administration/Query_planning.md#plan-analysis).
