...
- VARCHAR[(length)]: A variable-length string. The default value is 1. Unit: bytes. In versions earlier than StarRocks 2.1, the value range of `length` is 1–65533. From StarRocks 2.1 to 4.1, the range is 1–1048576. From StarRocks 4.2 onwards, the range is 1–2147482624 (2 GiB minus 1 KiB).
