...
description: "REFRESH EXTERNAL TABLE metadata cached in StarRocks."
---
...
> **NOTE**
>
> Only users with the ALTER privilege on the corresponding external table can perform this operation.
