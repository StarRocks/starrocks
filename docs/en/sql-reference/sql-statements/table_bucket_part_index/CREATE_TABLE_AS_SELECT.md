...
| Properties        | No           | The properties of the new table.When using the `unified` type of Catalog, the `CTAS` method is used to create tables. The `unified_ctas_engine` specifies the engine name, which defaults to `hive`                             |
