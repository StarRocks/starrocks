...
- [Iceberg catalog](../../../data_source/catalog/iceberg/iceberg.md): used for querying data from Apache Iceberg.
...
- [ADBC catalog](../../../data_source/catalog/adbc_catalog.md): used to query Arrow Flight SQL services through a native ADBC driver.
...
| PROPERTIES    | Yes          | The properties of an external catalog. Configure properties based on the types of external catalogs. For more information, see [Hive catalog](../../../data_source/catalog/hive_catalog.md), [Iceberg catalog](../../../data_source/catalog/iceberg/iceberg.md), [Hudi catalog](../../../data_source/catalog/hudi_catalog.md), [Delta Lake catalog](../../../data_source/catalog/deltalake_catalog.md), [JDBC catalog](../../../data_source/catalog/jdbc_catalog.md), [ADBC catalog](../../../data_source/catalog/adbc_catalog.md), and [Fluss catalog](../../../data_source/catalog/fluss_catalog.md). |
