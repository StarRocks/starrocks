...
<<<<<<< HEAD:docs/en/sql-reference/sql-statements/data-definition/CREATE_MATERIALIZED_VIEW.md
...
>>>>>>> e06217c368 ([Doc] Ref docs (#50111)):docs/en/sql-reference/sql-statements/materialized_view/CREATE_MATERIALIZED_VIEW.md
