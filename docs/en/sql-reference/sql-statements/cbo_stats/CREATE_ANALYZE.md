...
description: "CREATE ANALYZE customizes an automatic collection task for collecting CBO statistics."
---
...
[SHOW ANALYZE JOB](SHOW_ANALYZE_JOB.md): view the status of a custom collection task.
