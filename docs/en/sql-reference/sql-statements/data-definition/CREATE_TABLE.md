...
This aggregation type applies ONLY to the Aggregate table whose key_desc type is AGGREGATE KEY. Additionally, since v3.1.9,  `REPLACE_IF_NOT_NULL` is newly supported for columns of the BITMAP type.
