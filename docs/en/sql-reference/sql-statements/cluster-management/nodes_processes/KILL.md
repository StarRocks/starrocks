...
| query_id                 | The ID of the query you want to terminate. You can get the IDs of the query that are pending or being executed using SHOW RUNNING QUERIES or [SHOW PROC](SHOW_PROC.md) with `'/current_queries'` and `'/global_current_queries'`. |
