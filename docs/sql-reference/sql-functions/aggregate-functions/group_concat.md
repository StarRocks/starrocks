...
You can limit the length of the string returned by group_concat by setting the [session variable](../../../sql-reference/System_variable.md) `group_concat_max_len`, which defaults to 1024. Minimum value: 4. Unit: characters.
