...
| [json_each](./json-query-and-processing-functions/json_each.md) | Expands the top-level elements of a JSON object into key-value pairs. | SELECT * FROM tj_test, LATERAL JSON_EACH(j); | ![json_each](../../../assets/json_each.png) |
