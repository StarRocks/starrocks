...
| [json_each](./json-query-and-processing-functions/json_each.md) | Expands the top-level elements of a JSON object into key-value pairs. | SELECT `key`, `value` FROM tbl, JSON_EACH('{"a": 2, "b":{"c": 3, "d": null}}') | key \| value -----+----  a \| 1  b \|  {"c": 3, "d": null} |
