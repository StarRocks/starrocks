...
<<<<<<< HEAD:docs/sql-reference/sql-statements/data-definition/CREATE TABLE AS SELECT.md
=======
You can submit an asynchronous CTAS task using [SUBMIT TASK](../data-manipulation/SUBMIT_TASK.md).

>>>>>>> ad1d16540e ([Doc] Fix filename spaces (#32525)):docs/sql-reference/sql-statements/data-definition/CREATE_TABLE_AS_SELECT.md
## Syntax
