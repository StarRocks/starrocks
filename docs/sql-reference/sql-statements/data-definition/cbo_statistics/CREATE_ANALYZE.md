...
[SHOW ANALYZE JOB](../../data-definition/cbo_statistics/SHOW_ANALYZE_JOB.md): view the status of a custom collection task.

[DROP ANALYZE](../../data-definition/cbo_statistics/DROP_ANALYZE.md): delete a custom collection task.
