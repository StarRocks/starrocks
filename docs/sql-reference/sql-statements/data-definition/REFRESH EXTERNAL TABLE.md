...
- **External catalog**: When using a [Hive catalog](https://starrocks.feishu.cn/docx/doxcnlR8GftQuvLnb2FgSl69OKd) or [Hudi catalog](https://starrocks.feishu.cn/docx/doxcnIS2ibBegPtmWu3kaWMdWQc) to query data in Hive or Hudi, you can execute this statement to update the metadata of a Hive table or Hudi table cached in StarRocks.
