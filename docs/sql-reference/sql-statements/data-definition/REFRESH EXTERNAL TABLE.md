...
- **External catalog**: When using a [Hive catalog](../../../using_starrocks/catalog/hive_catalog.md) or [Hudi catalog](../../../using_starrocks/catalog/hudi_catalog.md) to query data in Hive or Hudi, you can execute this statement to update the metadata of a Hive table or Hudi table cached in StarRocks.
