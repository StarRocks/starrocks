...
- If DROP Table FORCE is executed, the table will be directly deleted and cannot be restore without checking whether there are ongoing activities in the database. This operation is not recommended.
