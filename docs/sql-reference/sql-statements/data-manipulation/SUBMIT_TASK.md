...
<<<<<<< HEAD:docs/sql-reference/sql-statements/data-manipulation/SUBMIT TASK.md
StarRocks v2.5 supports submitting asynchronous tasks for [CREATE TABLE AS SELECT](../data-definition/CREATE%20TABLE%20AS%20SELECT.md).
=======
...
>>>>>>> ad1d16540e ([Doc] Fix filename spaces (#32525)):docs/sql-reference/sql-statements/data-manipulation/SUBMIT_TASK.md
...
<<<<<<< HEAD:docs/sql-reference/sql-statements/data-manipulation/SUBMIT TASK.md
| etl_statement | The ETL statement that you want to submit as an asynchronous task. StarRocks currently supports submitting asynchronous tasks for [CREATE TABLE AS SELECT](../data-definition/CREATE%20TABLE%20AS%20SELECT.md). |
=======
