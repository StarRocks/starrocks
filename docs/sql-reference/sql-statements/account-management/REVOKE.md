...
- Revoke the privilege that allows a user to perform operations as another user. This operation is supported only in StarRock 2.4 and later versions.
- Revoke a role from a user. This operation is supported only in StarRock 2.4 and later versions.
