...
| starrocks.request.connect.timeout.ms | 30000             | The maximum amount of time for a read request establishing a connection to StarRocks.|
| starrocks.request.read.timeout.ms    | 30000             | The maximum amount of time after which a read request waiting for data from StarRocks.  |
