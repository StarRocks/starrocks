...
| username                          | Yes          | NONE              | The username of the account that you want to use to load data into StarRocks.  The account must have load permissions on the StarRocks table. See [User privileges](../administration/User_privilege.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
