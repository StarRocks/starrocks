        ...
        fromElements(new String[]{
            ...
            StarRocksSink.sink(
                ...
                StarRocksSinkOptions.builder()
                    ...
                    // Since 2.4, StarRocks support partial updates for Primary Key table. You can specify the columns to be updated by configuring the following two properties.
...
| sink.properties.*             | No           | NONE              | STRING        | The properties of the stream load. The properties include k1, k2, and k3. Since 2.4, the flink-connector-starrocks supports partial updates for Primary Key table. |
