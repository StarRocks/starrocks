...
- If you the label of a previous transaction to call the `/api/transaction/begin` operation to start a new transaction, starting the new transaction fails and moreover the previous transaction will fail and be rolled back.
