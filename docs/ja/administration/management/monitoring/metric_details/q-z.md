...
<<<<<<< HEAD:docs/ja/administration/management/monitoring/metric_details/q-z.md
=======
...
>>>>>>> afd8d66d11 ([Enhancement] Expose statistics cache stats via metrics (if enabled) (#76044)):docs/ja/administration/management/monitoring/metric_details/s.md
