...
StarRocks と Trino は、同じ構成のホストにデプロイされています - [AWS m6id.4xlarge](https://aws.amazon.com/ec2/instance-types/m6i/?nc1=h_ls).
...
|                   | **StarRocks**                              | **Trino**                                                      |
| ----------------- | ------------------------------------------ | -------------------------------------------------------------- |
| **クラスタサイズ** | One FE, four BE                            | One Coordinator, four Workers                                  |
| **バージョン**     | 3.5.0                                      | 475                                                            |
| **リリース日**     | 2025.6.13                                  | 2025.4.23                                                      |
| **設定**           | `set query_mem_limit=66571993088;` (62 GB) | `query.max-memory=224GB`<br />`query.max-memory-per-node=35GB` |
