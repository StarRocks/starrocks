...
<table align="center">
    ...
    <tr>
        ...
        <td>はい</td>
        <td rowspan="6">はい (v3.3+)</td>
        <td colspan="3">はい [1]</td>
    </tr>
    <tr>
        <td>row_delimiter</td>
        <td>はい</td>
    ...
    <tr>
        <td>enclose</td>
        <td rowspan="4">はい (v3.0+)</td>
        <td rowspan="4">はい (v3.0+)</td>
        <td rowspan="2">はい (v3.0+)</td>
...
<table align="center">
    ...
    <tr>
        ...
        <td rowspan="2">N/A</td>
        <td rowspan="2" colspan="2">はい [4]</td>
        <td rowspan="2">サポート予定</td>
        <td rowspan="2">はい [4]</td>
    </tr>
    <tr>
        <td>ORC</td>
    </tr>
...
<table align="center">
    ...
    <tr>
        ...
        <td rowspan="2">はい (v3.1.10+/v3.2.1+)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>N/A</td>
        <td colspan="2">はい (HDFS および S3 互換オブジェクトストレージ)</td>
        <td>はい [3]</td>
        <td>はい</td>
    </tr>
</table>
