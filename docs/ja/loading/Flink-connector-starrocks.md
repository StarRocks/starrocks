...
>>>>>>> 26afa5444b ([Doc] Add Flink 1.2.11 Doc (#59572))
...
**デフォルト値**: NONE<br/>
<<<<<<< HEAD
**説明**: 1.2.10 以降でサポートされています。Stream Load に使用される圧縮アルゴリズム。現在、圧縮は JSON 形式のみサポートされています。有効な値: `lz4_frame`。JSON 形式の圧縮は StarRocks v3.2.7 以降でのみサポートされています。
=======
