...
例 1: `boundary` パラメータを指定せずに、与えられた時間を5年の時間間隔の始まりに変換します。
...
例 3: 与えられた DATE 値を5秒の時間間隔の始まりに変換します。
...
例 4: 与えられた DATE 値を5日の時間間隔の始まりに変換します。
...
例 5: 与えられた DATE 値を5日の時間間隔の終わりに変換します。
