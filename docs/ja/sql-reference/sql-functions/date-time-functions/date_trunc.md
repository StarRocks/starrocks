...
- `fmt`: 日付部分、つまり `datetime` がどの精度に切り捨てられるかを指定します。値は VARCHAR 定数でなければなりません。
...
| 値   | 説明                                                  |
| ------- | ------------------------------------------------------------ |
| microsecond  | マイクロ秒に切り捨てます (3.1.7 以降)。            |
| millisecond  | ミリ秒に切り捨てます (3.1.7 以降)。            |
| second  | 秒に切り捨てます。                                     |
...
例 8: DATE 値を時間に切り捨てます。エラーが返されます。
