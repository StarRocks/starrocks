...
例4: 入力パラメータが数値と文字列の混合で、文字列が数値に変換できる場合。パラメータは数値として比較されます。
...
例5: 入力パラメータが数値と文字列の混合で、文字列が数値に変換できない場合。パラメータは文字列として比較されます。文字列 `'1'` は `'at'` より小さいです。
