...
:::tip
すべてのユーザーは自分の認証情報を表示する権限を持っています。`user_admin` ロールを持つユーザーのみが、すべてのユーザーまたは指定されたユーザーの認証情報を表示できます。
:::
...
| USERNAME       | いいえ   | このパラメータが指定されている場合、指定されたユーザーの認証情報を表示できます。このパラメータが指定されていない場合、現在のユーザーの認証情報のみを表示できます。 |
