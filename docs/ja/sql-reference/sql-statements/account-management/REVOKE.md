...
description: "REVOKE removes specific privileges or roles from a user or role."
---
...
特定の権限またはロールをユーザーまたはロールから取り消します。StarRocks がサポートする権限については、[Privileges supported by StarRocks](../../../administration/user_privs/authorization/user_privs.md) を参照してください。
