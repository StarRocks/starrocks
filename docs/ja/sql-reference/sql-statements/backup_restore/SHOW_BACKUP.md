...
指定されたデータベースで最後の BACKUP タスクを表示します。詳細については、[データのバックアップと復元](../../../administration/management/Backup_and_restore.md)を参照してください。
...
例 1: データベース `example_db` で最後の BACKUP タスクを表示します。
