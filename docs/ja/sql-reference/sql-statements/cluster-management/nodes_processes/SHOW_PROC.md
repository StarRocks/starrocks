...
| '/auth'                      | クラスター内のユーザー名と対応する権限情報を表示します。 |
...
| **戻り値**     | **説明**                                              |
| -------------- | ------------------------------------------------------------ |
| UserIdentity   | ユーザー識別子 ('ユーザー名'@'ホスト')。                     |
| Password       | セキュリティ上の理由でアスタリスク (*) として表示されるパスワード。 |
| AuthPlugin     | ユーザー認証に使用されるプラグイン。                         |
| Roles          | ユーザーに付与されているロールのリスト。                     |
| GlobalPrivs    | グローバル権限のリスト。                                     |
| CatalogPrivs   | カタログレベルの権限のリスト。                               |
| DatabasePrivs  | データベースレベルの権限のリスト。                           |
| TablePrivs     | テーブルレベルの権限のリスト。                               |
| ResourcePrivs  | リソースに対する権限のリスト。                               |
