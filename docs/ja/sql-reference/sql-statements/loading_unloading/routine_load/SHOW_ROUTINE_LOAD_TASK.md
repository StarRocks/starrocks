...
| Timeout              | FE パラメータ [`routine_load_task_timeout_second`](../../../../administration/configuration/FE_parameters/FE_parameters.md#routine_load_task_timeout_second) と [job_properties](./CREATE_ROUTINE_LOAD.md) の `task_timeout_second` パラメータによって制御されるロードタスクのタイムアウト期間。 |
