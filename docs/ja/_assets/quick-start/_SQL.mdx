...
凍結温度での結果は少し驚きました。寒い1月の日曜日の朝に市内であまり交通がないと思っていました。[weather.com](https://weather.com/storms/winter/news/northeast-storm-rain-snow-wind) を見ると、その日は大きな嵐があり、多くの事故が発生したことがデータからもわかります。
