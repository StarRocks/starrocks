...
詳細については、 [AWS IAM での認証の準備](../../../integrations/csp_auth/authenticate_to_aws_resources.md#preparations) を参照してください。
...
AWS Glue へのアクセス認証方法の選択方法および AWS IAM コンソールでのアクセス制御ポリシーの構成方法については、 [AWS Glue へのアクセス認証パラメーター](../../../integrations/csp_auth/authenticate_to_aws_resources.md#authentication-parameters-for-accessing-aws-glue) を参照してください。
