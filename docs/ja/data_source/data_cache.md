...
また、セッション変数 [`populate_datacache_mode`](../sql-reference/System_variables/scan_io_datacache.md#populate_datacache_mode) を使用して Block Cache のポピュレーション動作を微調整することもできます。
