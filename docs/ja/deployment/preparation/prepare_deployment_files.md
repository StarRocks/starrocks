...
3. ディレクトリ **fe** をすべての FE インスタンスに、ディレクトリ **be** をすべての BE または CN インスタンスに[手動デプロイメント](../deploy_manually.md)のために配布します。
...
3. デプロイメントファイルを対応するインスタンスに[手動デプロイメント](../deploy_manually.md)のために配布します。