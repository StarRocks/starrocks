...
- `avg(DISTINCT ...)` および HAVING 述語付き集約 materialized view の誤った rewrite を防止しました。 [#75071](https://github.com/StarRocks/starrocks/pull/75071) [#73610](https://github.com/StarRocks/starrocks/pull/73610)
- Ranking 境界処理と Partition TopN の出力列に関する TopN の正確性問題を修正しました。 [#75045](https://github.com/StarRocks/starrocks/pull/75045) [#72848](https://github.com/StarRocks/starrocks/pull/72848)
- Partitioned Join で発生する可能性がある範囲外アクセスを修正しました。 [#74315](https://github.com/StarRocks/starrocks/pull/74315)
- `ALTER MODIFY COLUMN ... AFTER` が存在しない列を参照した場合のエラー処理を修正しました。 [#75073](https://github.com/StarRocks/starrocks/pull/75073)
- CTAS 結果で宣言された `VARCHAR` 長が保持されるように修正しました。 [#73498](https://github.com/StarRocks/starrocks/pull/73498)
- Datetime prepared parameter の解析を修正しました。 [#74141](https://github.com/StarRocks/starrocks/pull/74141)
- JSON Load でネスト型の partial append を修正しました。 [#73715](https://github.com/StarRocks/starrocks/pull/73715)
- Paimon DATE パーティション列の NULL 値処理を修正しました。 [#73950](https://github.com/StarRocks/starrocks/pull/73950)
- NULL-safe comparison を使用して Iceberg Equality Delete のマッチングを修正しました。 [#67321](https://github.com/StarRocks/starrocks/pull/67321)
- 予期しない BE restart と、parallel profile collection 中の fork-safe でない Tracer の問題を修正しました。 [#74424](https://github.com/StarRocks/starrocks/pull/74424) [#74746](https://github.com/StarRocks/starrocks/pull/74746)
- JIT コンパイル失敗後のクリーンアップを修正し、use-after-free を回避しました。 [#74396](https://github.com/StarRocks/starrocks/pull/74396)
- `OlapTableSink` の memory accounting と、UDAF cache による memory leak を修正しました。 [#73807](https://github.com/StarRocks/starrocks/pull/73807) [#74025](https://github.com/StarRocks/starrocks/pull/74025)
- Schema drift 下で Lake partial column update がクラッシュまたは silent corruption を引き起こす問題を修正しました。 [#74005](https://github.com/StarRocks/starrocks/pull/74005)
- Vector Index Rewrite が共有テーブル schema を汚染しないようにしました。 [#74785](https://github.com/StarRocks/starrocks/pull/74785)
- 永続的な version hole に陥った非主キーレプリカの self-healing を追加しました。 [#74408](https://github.com/StarRocks/starrocks/pull/74408)
- Partition statistics の zero row count による統計情報の破損を防止しました。 [#74801](https://github.com/StarRocks/starrocks/pull/74801)
- Cluster snapshot の作成が繰り返し失敗した場合に `CatalogRecycleBin` が freeze しないようにしました。 [#74379](https://github.com/StarRocks/starrocks/pull/74379)
- Public Role 変更後の privilege cache invalidation を修正しました。 [#73717](https://github.com/StarRocks/starrocks/pull/73717)
- JLine、Netty、Tomcat、libthrift の依存関係 CVE を修正しました。 [#75066](https://github.com/StarRocks/starrocks/pull/75066) [#74668](https://github.com/StarRocks/starrocks/pull/74668) [#73797](https://github.com/StarRocks/starrocks/pull/73797) [#73243](https://github.com/StarRocks/starrocks/pull/73243)
