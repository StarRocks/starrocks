...
本リリースは v4.1 のメンテナンスリリースであり、安定性・性能・セキュリティに重点を置いています。重要な新機能は含まれません。

### 動作の変更

- `pipeline_enable_large_column_checker` がデフォルトで有効になりました。[#72798](https://github.com/StarRocks/starrocks/pull/72798)
- COW（コピーオンライト）最適化は、クラッシュを引き起こす可能性のある設計上の欠陥により無効化されました。[#73480](https://github.com/StarRocks/starrocks/pull/73480)
- Hive カタログにおいて INSERT-only ACID Hive テーブルが無効化されました。[#71460](https://github.com/StarRocks/starrocks/pull/71460)

### 改善点

**関数と SQL**

- `query_id()` 組み込み関数を追加しました。[#73621](https://github.com/StarRocks/starrocks/pull/73621)
- すべての FE ノードにまたがってクエリプロファイル情報を取得する `get_query_profile` 関数を追加しました。[#71123](https://github.com/StarRocks/starrocks/pull/71123)
- 明示的な読み取りスキーマを指定するための `schema` パラメータを `FILES()` に追加しました。[#72033](https://github.com/StarRocks/starrocks/pull/72033)
- Arrow-to-JSON コンバータが LARGE_LIST および FIXED_SIZE_LIST をサポートしました。[#73714](https://github.com/StarRocks/starrocks/pull/73714)
- 型付き MySQL 結果ライターを追加しました。[#66316](https://github.com/StarRocks/starrocks/pull/66316)
- `information_schema` に不足していた MySQL 8 のカラムを追加しました。[#73370](https://github.com/StarRocks/starrocks/pull/73370)

**データレイク分析**

- Iceberg Connector が AND 複合述語の部分プッシュダウンをサポートしました。[#70293](https://github.com/StarRocks/starrocks/pull/70293)
- 進化した Iceberg テーブル上での非パーティション化マテリアライズドビューを許可しました。[#72285](https://github.com/StarRocks/starrocks/pull/72285)
- Iceberg スキャンの投影メトリクス報告を改善しました。[#74338](https://github.com/StarRocks/starrocks/pull/74338)
- `CachingIcebergCatalog` のロックをカタログ単位からテーブル単位に変更し、ロック競合を軽減しました。[#73079](https://github.com/StarRocks/starrocks/pull/73079)
- BE 側で AWS S3 認証情報に WebIdentity トークンプロバイダをサポートしました。[#69966](https://github.com/StarRocks/starrocks/pull/69966)
- スキーマ変更のメタスキャンをサポートしました。[#72901](https://github.com/StarRocks/starrocks/pull/72901)

**ロードとエクスポート**

- INSERT-from-FILES、Broker Load、ORC 入力向けに、マルチパーティション対応のサンプリングベースのタブレット事前分割を追加しました。[#73101](https://github.com/StarRocks/starrocks/pull/73101) [#74048](https://github.com/StarRocks/starrocks/pull/74048) [#73912](https://github.com/StarRocks/starrocks/pull/73912) [#74489](https://github.com/StarRocks/starrocks/pull/74489)
- FRONTEND_STREAMING ロードで結合 txn log / ファイルバンドリングをサポートしました。[#74460](https://github.com/StarRocks/starrocks/pull/74460)

**クエリエンジンとオプティマイザ**

- DATETIME/DATE から文字列への Cast を最適化し、行ごとのヒープ割り当てを排除しました。[#73801](https://github.com/StarRocks/starrocks/pull/73801)
- 集約ハッシュのプリフェッチを L2 常駐時に限定し、プリフェッチ距離を設定可能にしました。[#73943](https://github.com/StarRocks/starrocks/pull/73943)
- 重い SpinLock をロックフリーの並列 Map に置き換え、競合を軽減しました。[#73796](https://github.com/StarRocks/starrocks/pull/73796)
- PK Compaction の競合リゾルバでチャンクごとの `replace()` 呼び出しをバッチ化しました。[#73349](https://github.com/StarRocks/starrocks/pull/73349)

**統計情報**

- 統計収集向けに、オプトインのワイド文字列カラム分離を追加しました。[#73258](https://github.com/StarRocks/starrocks/pull/73258)

**共有データアーキテクチャ**

- CN 側フォールバック付きで、FE RPC による CN フリーのタブレット作成をサポートしました。[#72270](https://github.com/StarRocks/starrocks/pull/72270)
- 共有データテーブル向けに `ADMIN SKIP COMMITTED TRANSACTION` を追加しました（フェーズ 1）。[#73553](https://github.com/StarRocks/starrocks/pull/73553)
- `load_from_lake_tablet` におけるコールド PK-index 再構築スキャンを並列化しました。[#74249](https://github.com/StarRocks/starrocks/pull/74249) [#74394](https://github.com/StarRocks/starrocks/pull/74394)
- タブレット分割/マージの改善：セグメント単位の共有最適化と UID ベースの Rowset アイデンティティ。[#74013](https://github.com/StarRocks/starrocks/pull/74013) [#74105](https://github.com/StarRocks/starrocks/pull/74105)
- 共有データのタブレットマージにおける `DCG x gap` の NotSupported 制限を解除しました。[#74499](https://github.com/StarRocks/starrocks/pull/74499)
- `SHOW ALTER TABLE COLUMN` に Lake meta alter ジョブを表示するようにしました。[#74198](https://github.com/StarRocks/starrocks/pull/74198)
- txn-id ベースの Vacuum を伴うフラットレイアウトの Lake `load_spill`。[#73064](https://github.com/StarRocks/starrocks/pull/73064)

**マテリアライズドビュー**

- IVM 集約関数のホワイトリストを MIN/MAX(DECIMAL) まで拡張しました。[#73969](https://github.com/StarRocks/starrocks/pull/73969)

**管理と可観測性**

- `current_queries` に内部クエリをタイプ付きで表示し、KILL 可能にしました。[#74488](https://github.com/StarRocks/starrocks/pull/74488)
- 1 つのステートメントを 2 回（送信時と完了時）監査できるようにしました。[#73883](https://github.com/StarRocks/starrocks/pull/73883)
- LockManager と `QueryableReentrantReadWriteLock` に低速ロックのログスロットリングと内容制御を追加しました。[#73647](https://github.com/StarRocks/starrocks/pull/73647)
- `enable_profile_log` 設定を変更可能にしました。[#73894](https://github.com/StarRocks/starrocks/pull/73894)
- Load プロファイルを FE プロファイルログに出力する FE 設定を追加しました。[#74150](https://github.com/StarRocks/starrocks/pull/74150)
- カタログリサイクルビンのサイズゲージと、Lake Vacuum のバッチサイズ/リトライ回数メトリクスを追加しました。[#74440](https://github.com/StarRocks/starrocks/pull/74440) [#74112](https://github.com/StarRocks/starrocks/pull/74112)
- FE DDL でストレージボリュームのアクセス可能性を検証するようにしました。[#70053](https://github.com/StarRocks/starrocks/pull/70053)

### セキュリティ

- [CVE] Netty を 4.1.135.Final にアップグレードしました。[#74668](https://github.com/StarRocks/starrocks/pull/74668)
- [CVE] プリビルドの pprof を Go 1.25.11 でビルドしたものに更新しました。[#74669](https://github.com/StarRocks/starrocks/pull/74669)
- [CVE] Tomcat を 9.0.118 にアップグレードしました。[#73797](https://github.com/StarRocks/starrocks/pull/73797)
- [CVE] libthrift を 0.23.0 にアップグレードしました。[#73243](https://github.com/StarRocks/starrocks/pull/73243)
- `SHOW FUNCTIONS` の出力で UDF のファイルパスをマスクしました。[#73425](https://github.com/StarRocks/starrocks/pull/73425)
...
- JIT コンパイル失敗時の `LLVMContext` の Use-after-free を修正しました。[#74396](https://github.com/StarRocks/starrocks/pull/74396)
- when と結果の型が float/int 混在の CASE WHEN で生成される無効な JIT IR を修正しました。[#74382](https://github.com/StarRocks/starrocks/pull/74382)
- サブライターに append がない場合の FlatJson クラッシュを修正しました。[#73730](https://github.com/StarRocks/starrocks/pull/73730)
- 共有データの Lake レプリケーションにおけるファイルコピーのクラッシュを修正しました。[#73666](https://github.com/StarRocks/starrocks/pull/73666)
- パーティション Join に起因する潜在的な範囲外アクセスを修正しました。[#74315](https://github.com/StarRocks/starrocks/pull/74315)
- スキーマ変更で gtid を読み取る前に rowset の null チェックを追加しました。[#74855](https://github.com/StarRocks/starrocks/pull/74855)

**正確性**

- `count_combine(nullable_col)` が `count(*)` のように NULL 行を黙ってカウントする問題を修正しました。[#74029](https://github.com/StarRocks/starrocks/pull/74029)
- 型が一致しない集約関数を使用する集約を修正しました。[#74159](https://github.com/StarRocks/starrocks/pull/74159)
- すべて NULL の場合に `NullableColumnUnaryFunction` が decimal の scale を失う問題を修正しました。[#73789](https://github.com/StarRocks/starrocks/pull/73789)
- Partition TopN が子の出力カラムを失う可能性を修正しました。[#72848](https://github.com/StarRocks/starrocks/pull/72848)
- `f(null) != null` となる式の派生辞書変換を修正しました。[#69376](https://github.com/StarRocks/starrocks/pull/69376)
- `extract` が URL から誤ったホストを取得する問題を修正しました。[#63542](https://github.com/StarRocks/starrocks/pull/63542)
- ネスト型の JSON ロードにおける部分追加を修正しました。[#73715](https://github.com/StarRocks/starrocks/pull/73715)
- Iceberg の等値削除カラムで NULL セーフな等価比較を使用するようにしました。[#67321](https://github.com/StarRocks/starrocks/pull/67321)
- PostgreSQL および Oracle の JDBC 型マッピングの問題を修正しました。[#70842](https://github.com/StarRocks/starrocks/pull/70842) [#71412](https://github.com/StarRocks/starrocks/pull/71412)
- Paimon DATE パーティションカラムの NULL 値、および Paimon 主キーカラムが誤って非 nullable とマークされる問題を修正しました。[#73950](https://github.com/StarRocks/starrocks/pull/73950) [#71660](https://github.com/StarRocks/starrocks/pull/71660)

**マテリアライズドビュー**

- インクリメンタルマテリアライズドビューにおける SELECT DISTINCT と位置指定 GROUP BY の `__ROW_ID__` グループキーを修正しました。[#74493](https://github.com/StarRocks/starrocks/pull/74493) [#74030](https://github.com/StarRocks/starrocks/pull/74030)
- HAVING 述語を伴う集約 MV リライトを拒否し、作成時にインクリメンタル MV での集約を伴う HAVING を拒否するようにしました。[#73610](https://github.com/StarRocks/starrocks/pull/73610) [#74054](https://github.com/StarRocks/starrocks/pull/74054)
- ネストされたマテリアライズドビューのリフレッシュにおける NPE を修正しました。[#73644](https://github.com/StarRocks/starrocks/pull/73644)
- リフレッシュ時に Iceberg/外部 MV のスキーマドリフトを検出するようにしました。[#73770](https://github.com/StarRocks/starrocks/pull/73770)
- IVM MV のリフレッシュは、行を黙って破棄するのではなく strict-load エラーを表面化するようになりました。[#73938](https://github.com/StarRocks/starrocks/pull/73938)
- 同期 MV の `SHOW CREATE MATERIALIZED VIEW` を復元しました。[#73396](https://github.com/StarRocks/starrocks/pull/73396)

**メモリ、リーク、競合**

- UDAF キャッシュが引き起こすメモリリークを修正しました。[#74025](https://github.com/StarRocks/starrocks/pull/74025)
- `OlapTableSink` のメモリ会計を修正しました。[#73807](https://github.com/StarRocks/starrocks/pull/73807)
- `MaterializedIndexMeta` の `updateSchemaBackendId` 上のデータ競合を修正しました。[#74412](https://github.com/StarRocks/starrocks/pull/74412)
- 並列マージモードに入る際の Spill Writer の `auto_flush` フラグ上のデータ競合を修正しました。[#73616](https://github.com/StarRocks/starrocks/pull/73616)
- `TabletSinkSender::_send_chunk_by_node` における競合を修正しました。[#73820](https://github.com/StarRocks/starrocks/pull/73820)
- データディレクトリのロードスレッド上の `set_thread_name` 競合を修正しました。[#73862](https://github.com/StarRocks/starrocks/pull/73862)

**共有データとストレージ**

- 永続的なバージョンホールで停止した非 PK レプリカを自己修復するようにしました。[#74408](https://github.com/StarRocks/starrocks/pull/74408)
- PK index compaction の出力 SSTable を適用する際にタブレットメタデータを渡すようにしました。[#74037](https://github.com/StarRocks/starrocks/pull/74037)
- 共有セグメント向けに PK index publish で物理 rowid を接続しました。[#73686](https://github.com/StarRocks/starrocks/pull/73686)
- V1→V2 のクラスター間レプリケーションで PK `.del` ファイルをトランスコードするようにしました。[#73958](https://github.com/StarRocks/starrocks/pull/73958) [#73649](https://github.com/StarRocks/starrocks/pull/73649)
- retain-boundary メタデータが失われた場合に、実際の Vacuum ウォーターマークを報告するようにしました。[#74429](https://github.com/StarRocks/starrocks/pull/74429)

**ロックとデッドロック**

- `InformationSchemaDataSource` と `FrontendServiceImpl` で DB 読み取りロックを intensive テーブルロックに緩和しました。[#73936](https://github.com/StarRocks/starrocks/pull/73936) [#73913](https://github.com/StarRocks/starrocks/pull/73913)
- テーブルおよびマテリアライズドビューの RENAME と SWAP に DB 書き込みロックを使用するようにしました。[#74100](https://github.com/StarRocks/starrocks/pull/74100)
- Routine Load の Broker RPC をジョブごとの書き込みロックの外に移動しました。[#73591](https://github.com/StarRocks/starrocks/pull/73591)

**Connector と外部データ**

- Hive ビューの Ranger ポリシーリライトを修正しました。[#73265](https://github.com/StarRocks/starrocks/pull/73265)
- Hive パーティション統計の自動リフレッシュを回避するようにしました。[#73563](https://github.com/StarRocks/starrocks/pull/73563)
- `SerializableTable` の `LocationProvider` を遅延初期化し、カスタム LocationProvider を持つテーブルの読み取り失敗を修正しました。[#73482](https://github.com/StarRocks/starrocks/pull/73482)
- Iceberg メタデータエントリが pin されている場合のディスクキャッシュオーバーフローを修正しました。[#71651](https://github.com/StarRocks/starrocks/pull/71651)

**その他**

- `ERROR 2013` を防ぐため `MysqlProto` で例外をキャッチするようにしました。[#70072](https://github.com/StarRocks/starrocks/pull/70072)
- `MysqlChannel` の結果送信パスに書き込みタイムアウトを追加しました。[#73646](https://github.com/StarRocks/starrocks/pull/73646)
- `AZURE_PATH_KEY` の検証に起因する ADLS2 共有データディザスタリカバリ時の FE 起動失敗を修正しました。[#73509](https://github.com/StarRocks/starrocks/pull/73509)
- 統計タスクで `SET WAREHOUSE` によって発生するセッション変数の上書きを修正しました。[#74385](https://github.com/StarRocks/starrocks/pull/74385)
- TimeUtils のセッションタイムゾーン、タイムゾーン対応のフォーマット、year-0000 のパースを復元しました。[#73619](https://github.com/StarRocks/starrocks/pull/73619)
