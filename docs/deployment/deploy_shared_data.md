...
- About how to start the nodes in your StarRocks cluster, see [Deploy StarRocks](../deployment/deploy_manually.md).
- After your shared-data StarRocks cluster is deployed, you must check how to [use a shared-data StarRocks cluster](./post_deployment_setup.md#use-your-shared-data-starrocks-cluster).
