...
:::note
When you use the `db.*` or `db.tbl` format, you can specify a database or a table that does not exist.
:::
...
:::note
When you use the `resource` format, you can specify a resource that does not exist.
:::
