...
CelerData Manager also provides an easy-to-use SQL editor for managing queries, tracking TopN scans, and analyzing query execution, helping you accelerate queries and simplify operations.
