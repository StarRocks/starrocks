...
- **支持**：请在 [GitHub issue](https://github.com/StarRocks/starrocks/issues) 上提交问题或在 [Slack](https://docs.starrocks.io/join/) 上提问，StarRocks 工程团队会尽力帮助您。
...
- **可用性**：GA 功能默认开启。
- **生产就绪度**：已准备好用于生产。
- **支持**：支持团队为客户提供支持。开源社区成员应在 [GitHub issue](https://github.com/StarRocks/starrocks/issues) 上提交问题或在 [Slack](https://docs.starrocks.io/join/) 上提问，StarRocks 工程团队会尽力帮助您。
