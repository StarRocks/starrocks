...
根据以下 YAML 模板，创建部署 StarRocks 集群的拓扑文件。具体配置项参考[参数配置](../administration/management/management.mdx)。
...
根据以下 YAML 模板，创建扩容 StarRocks 集群的拓扑文件。您可以根据需求配置相应的 EF 和/或 BE 节点。具体配置项参考[参数配置](../administration/management/management.mdx)。
