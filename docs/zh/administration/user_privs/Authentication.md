<<<<<<< HEAD:docs/zh/administration/user_privs/Authentication.md
---
...
在 ODBC 的 DSN 中添加 `default\_auth=mysql_clear_password` 和 `ENABLE_CLEARTEXT\_PLUGIN=1`，以及用户名和密码。
>>>>>>> df72ea742e ([Doc] Fix Incorrect MySQL Port in LDAP Authentication Example):docs/zh/administration/user_privs/authentication/ldap_authentication.md
