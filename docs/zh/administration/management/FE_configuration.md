...
##### tablet_sched_distribution_balance_threshold_ratio
...
- 单位：-
- 是否动态：是
- 描述：做分布均衡时可能会打破磁盘大小均衡，但磁盘间的最大差距不能超过tablet_sched_distribution_balance_threshold_ratio * table_sched_balance_load_score_threshold。 如果集群中存在不断从 A 到 B、从 B 到 A 的克隆，请减小该值。 如果希望tablet分布更加均衡，请调大该值。
- 引入版本：3.1
