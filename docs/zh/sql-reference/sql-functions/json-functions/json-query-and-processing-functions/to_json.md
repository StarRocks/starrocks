...
description: "将 Array、Map 或 Struct 值转换为 JSON 值。"
---

# to_json

将 Array、Map 或 Struct 值转换为 JSON 值。如果输入值为 NULL，则返回 NULL。
...
`any_value`：需要转换的 Array、Map 或 Struct 表达式。如果输入值无效，则返回错误。Array 的元素以及 Map 或 Struct 值中的每个键值对的值均可为空。
