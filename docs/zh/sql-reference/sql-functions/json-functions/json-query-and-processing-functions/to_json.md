...
description: "将 Map、Struct 或 Array 值转换为 JSON 字符串。"
---

# to_json

将 Map、Struct 或 Array 值转换为 JSON 字符串。如果输入值为 NULL，则返回 NULL。
...
`any_value`：您想要转换的 Map、Struct 或 Array 表达式。如果输入值无效，则返回错误。Map 或 Struct 值中的键值以及 Array 元素均可为 NULL。请参阅最后一个示例。
...
- [Array 数据类型](../../../data-types/semi_structured/Array.md)
