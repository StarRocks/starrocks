...
description: "对两个 Apache DataSketches Theta 草图执行并集运算，返回不同值估计为 |A∪B| 的序列化紧凑草图。"
---
...
如需对多个草图一次性进行聚合式并集，请使用 [ds_theta_combine](../aggregate-functions/ds_theta_combine.md)。
