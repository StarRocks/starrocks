...
```plain text
mysql> SELECT array_top_n(ARRAY [1, 100, 2, 5, 3], 3);
+----------------------------------------+
| array_top_n(ARRAY [1,100,2,5,3], 3)   |
+----------------------------------------+
| [100,5,3]                              |
+----------------------------------------+
```
...
```plain text
mysql> SELECT array_top_n(ARRAY [1, 100], 5);
+-------------------------------+
| array_top_n(ARRAY [1,100], 5) |
+-------------------------------+
| [100,1]                       |
+-------------------------------+
```
...
```plain text
mysql> SELECT array_top_n(ARRAY ['a', 'zzz', 'zz', 'b', 'g', 'f'], 3);
+---------------------------------------------------------+
| array_top_n(ARRAY ['a','zzz','zz','b','g','f'], 3)     |
+---------------------------------------------------------+
| ['zzz','zz','g']                                        |
+---------------------------------------------------------+
```
...
```plain text
mysql> SELECT array_top_n(ARRAY [1, 2, 3], 0);
+-------------------------------+
| array_top_n(ARRAY [1,2,3], 0) |
+-------------------------------+
| []                            |
+-------------------------------+
```
...
```plain text
mysql> SELECT array_top_n(ARRAY [1, NULL, 3, 2], 3);
+--------------------------------------+
| array_top_n(ARRAY [1,null,3,2], 3)  |
+--------------------------------------+
| [3,2,1]                              |
+--------------------------------------+
```
