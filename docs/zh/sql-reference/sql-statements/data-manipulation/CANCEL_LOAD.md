...
取消指定的 [Broker Load](../data-manipulation/BROKER_LOAD.md)、[Spark Load](../data-manipulation/SPARK_LOAD.md) 或 [INSERT](./INSERT.md) 导入作业，状态为 PREPARED、CANCELLED 或 FINISHED 的导入作业不能取消。
