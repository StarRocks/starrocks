...
| **参数**    | **必选** | **说明**                                                     |
| ----------- | -------- | ------------------------------------------------------------ |
<<<<<<< HEAD:docs/zh/sql-reference/sql-statements/data-definition/CREATE_INDEX.md
...
>>>>>>> e06217c368 ([Doc] Ref docs (#50111)):docs/zh/sql-reference/sql-statements/table_bucket_part_index/CREATE_INDEX.md
| table_name  | 是       | 表名。                                                       |
