...
数据备份为异步操作。您可以通过 [SHOW BACKUP](../../data-manipulation/backup_restore/SHOW_BACKUP.md) 语句查看备份作业状态，或通过 [CANCEL BACKUP](../../data-definition/backup_restore/CANCEL_BACKUP.md) 语句取消备份作业。作业成功后，您可以通过 [SHOW SNAPSHOT](../../data-manipulation/backup_restore/SHOW_SNAPSHOT.md) 查看特定仓库对应的数据快照信息。
