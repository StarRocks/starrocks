...
description: "SHOW BACKENDS 查看当前集群中所有 BE 节点的相关信息。"
---
...
| StatusCode            | BE 节点状态码。有效值：<ul><li>`CONNECTING`：BE 节点正在被首次加入集群。</li><li>`OK`：BE 节点正在运行。</li><li>`SHUTDOWN`：BE 节点正在优雅退出。</li><li>`DISCONNECTED`：BE 节点已断链。</li></ul> |
