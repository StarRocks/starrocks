...
| 参数         | 必选 | 说明                                                         |
| ------------ | ---- | ------------------------------------------------------------ |
<<<<<<< HEAD:docs/zh/sql-reference/sql-statements/data-definition/CREATE_EXTERNAL_CATALOG.md
...
>>>>>>> e06217c368 ([Doc] Ref docs (#50111)):docs/zh/sql-reference/sql-statements/Catalog/CREATE_EXTERNAL_CATALOG.md
