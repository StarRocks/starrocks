...
该错误由数据写入超时而引起。需要修改[系统变量](../../sql-reference/System_variable.md) `query_timeout` 和 [BE 配置项](../../administration/management/BE_configuration.md#配置-be-静态参数) `streaming_load_rpc_max_alive_time_sec` 的配置。
