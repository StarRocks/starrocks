...
<<<<<<< HEAD:docs/zh/using_starrocks/query_rewrite_with_materialized_views.md
=======
## 基于文本的物化视图改写
...
>>>>>>> 164b1b2b2d ([Doc] Organize query acceleration and administration (#51291)):docs/zh/using_starrocks/async_mv/use_cases/query_rewrite_with_materialized_views.md
## 设置物化视图查询改写
