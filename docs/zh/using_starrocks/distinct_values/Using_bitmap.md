...
<<<<<<< HEAD:docs/zh/using_starrocks/Using_bitmap.md
...
- 建表时，指定指标列类型为 BITMAP，使用 [BITMAP_UNION](../../sql-reference/sql-functions/bitmap-functions/bitmap_union.md) 函数进行聚合。
>>>>>>> 164b1b2b2d ([Doc] Organize query acceleration and administration (#51291)):docs/zh/using_starrocks/distinct_values/Using_bitmap.md
