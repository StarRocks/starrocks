...
从 v3.3.3 开始，StarRocks 支持 [周期性元数据刷新策略](#附录-a-周期性元数据刷新策略)。在大多数情况下，您可以忽略设置以下参数，不需要调整其中的策略参数，因为这些参数的默认值已经为您提供了开箱即用的性能。您可以使用系统变量 [`plan_mode`](../../../sql-reference/System_variables/optimizer_planning.md#plan_mode) 调整 Iceberg 元数据解析模式。
...
从 v3.3.3 开始，StarRocks 支持 [周期性元数据刷新策略](#附录-a-周期性元数据刷新策略)。您可以使用系统变量 [`plan_mode`](../../../sql-reference/System_variables/optimizer_planning.md#plan_mode) 调整 Iceberg 元数据缓存计划。
...
您可以使用系统变量 [`plan_mode`](../../../sql-reference/System_variables/optimizer_planning.md#plan_mode) 调整 Iceberg 元数据缓存计划。
