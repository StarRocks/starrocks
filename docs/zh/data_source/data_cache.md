...
关于 `enable_populate_datacache` 的更多信息，参见 [系统变量](../sql-reference/System_variable.md#支持的变量)。
...
当前系统默认以同步方式进行缓存，您可以通过修改 session 变量 [enable_datacache_async_populate_mode](../sql-reference/System_variable.md) 来启用异步填充：
