...
- INSERT INTO FILES 导出数据到 Parquet 文件时，可以使用 `parquet.version` 来指定导出 Parquet 文件的版本，以能让其他工具读取导出的 Parquet 文件更好地兼容。[#60843](https://github.com/StarRocks/starrocks/pull/60843)
