...
- 防止 `avg(DISTINCT ...)` 以及带 HAVING 谓词的聚合物化视图被错误改写。 [#75071](https://github.com/StarRocks/starrocks/pull/75071) [#73610](https://github.com/StarRocks/starrocks/pull/73610)
- 修复 Ranking 边界处理和 Partition TopN 输出列相关的 TopN 正确性问题。 [#75045](https://github.com/StarRocks/starrocks/pull/75045) [#72848](https://github.com/StarRocks/starrocks/pull/72848)
- 修复 Partitioned Join 中潜在的越界访问问题。 [#74315](https://github.com/StarRocks/starrocks/pull/74315)
- 修复 `ALTER MODIFY COLUMN ... AFTER` 引用不存在列时的错误处理问题。 [#75073](https://github.com/StarRocks/starrocks/pull/75073)
- 修复 CTAS 结果中声明的 `VARCHAR` 长度未保留的问题。 [#73498](https://github.com/StarRocks/starrocks/pull/73498)
- 修复 Datetime 预处理参数解析问题。 [#74141](https://github.com/StarRocks/starrocks/pull/74141)
- 修复 JSON Load 中嵌套类型 Partial Append 的问题。 [#73715](https://github.com/StarRocks/starrocks/pull/73715)
- 修复 Paimon DATE 分区列中 NULL 值的处理问题。 [#73950](https://github.com/StarRocks/starrocks/pull/73950)
- 通过使用 NULL-safe 比较修复 Iceberg Equality Delete 匹配问题。 [#67321](https://github.com/StarRocks/starrocks/pull/67321)
- 修复 BE 异常重启，以及并行 Profile 收集时 Tracer 非 fork-safe 的问题。 [#74424](https://github.com/StarRocks/starrocks/pull/74424) [#74746](https://github.com/StarRocks/starrocks/pull/74746)
- 修复 JIT 编译失败后的清理逻辑，避免 use-after-free 问题。 [#74396](https://github.com/StarRocks/starrocks/pull/74396)
- 修复 `OlapTableSink` 内存统计问题，以及 UDAF Cache 引入的内存泄漏。 [#73807](https://github.com/StarRocks/starrocks/pull/73807) [#74025](https://github.com/StarRocks/starrocks/pull/74025)
- 修复 Schema Drift 场景下 Lake Partial Column Update 可能崩溃或静默损坏数据的问题。 [#74005](https://github.com/StarRocks/starrocks/pull/74005)
- 防止 Vector Index Rewrite 污染共享表 Schema。 [#74785](https://github.com/StarRocks/starrocks/pull/74785)
- 支持自动修复出现永久版本空洞的非主键副本。 [#74408](https://github.com/StarRocks/starrocks/pull/74408)
- 防止分区统计中的零行数破坏统计信息。 [#74801](https://github.com/StarRocks/starrocks/pull/74801)
- 防止集群快照反复失败时 `CatalogRecycleBin` 冻结。 [#74379](https://github.com/StarRocks/starrocks/pull/74379)
- 修复 Public Role 变更后的权限缓存失效问题。 [#73717](https://github.com/StarRocks/starrocks/pull/73717)
- 修复 JLine、Netty、Tomcat 和 libthrift 中的依赖安全漏洞。 [#75066](https://github.com/StarRocks/starrocks/pull/75066) [#74668](https://github.com/StarRocks/starrocks/pull/74668) [#73797](https://github.com/StarRocks/starrocks/pull/73797) [#73243](https://github.com/StarRocks/starrocks/pull/73243)
