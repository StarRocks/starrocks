...
description: "How to use hybrid row-column storage in StarRocks for high-concurrency point queries and partial column updates with analytical query efficiency."
sidebar_position: 60
---
