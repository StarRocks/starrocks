...
description: "Overview of StarRocks table types: Duplicate Key, Aggregate, Unique Key, and Primary Key, with use case guidance for various analytics scenarios."
---
