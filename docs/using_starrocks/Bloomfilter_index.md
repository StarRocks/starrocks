...
- You can create bloom filter indexes for all columns of a table that uses the Duplicate Key table or Primary Key table. For a table that uses the Aggregate Key table or Unique Key table, you can only create bloom filter indexes for key columns.
