...
- You can create bitmap indexes for all columns of a table that uses the Duplicate Key table or Unique Key table. For a table that uses the Aggregate Key table or Primary Key table, you can only create bitmap indexes for key columns.
