...
- You can create bitmap indexes for all columns of a Duplicate Key table or Unique Key table. For an Aggregate Key table or Primary Key table, you can only create bitmap indexes for key columns.
