...
| ldap_group_member_attr         | No           | The attribute that represents group members. You can explicitly define an attribute or use a regular expression. Default: `member`.        |
