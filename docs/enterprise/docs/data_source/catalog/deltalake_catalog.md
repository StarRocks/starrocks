...
Also, you can directly transform and load data from Delta Lake by using [INSERT INTO](https://docs.starrocks.io/docs/sql-reference/sql-statements/data-manipulation/INSERT/) based on Delta Lake catalogs. StarRocks supports Delta Lake catalogs from v2.5 onwards.
...
- Metastore like Hive metastore, AWS Glue, or Databricks Unity Catalog
...
For more information, see [Preparation for authentication in AWS IAM](https://docs.starrocks.io/docs/integrations/authenticate_to_aws_resources/#preparation-for-iam-user-based-authentication).
...
StarRocks implements the [automatic asynchronous update policy](https://docs.starrocks.io/docs/data_source/catalog/deltalake_catalog/#appendix-understand-metadata-automatic-asynchronous-update) by default.
...
You can use [SHOW CATALOGS](https://docs.starrocks.io/docs/sql-reference/sql-statements/data-manipulation/SHOW_CATALOGS/) to query all catalogs in the current StarRocks cluster:

```SQL
SHOW CATALOGS;
```

You can also use [SHOW CREATE CATALOG](https://docs.starrocks.io/docs/sql-reference/sql-statements/data-manipulation/SHOW_CREATE_CATALOG/) to query the creation statement of an external catalog. The following example queries the creation statement of a Delta Lake catalog named `deltalake_catalog_glue`:
...
- Use [SET CATALOG](https://docs.starrocks.io/docs/sql-reference/sql-statements/data-definition/SET_CATALOG/) to specify a Delta Lake catalog in the current session, and then use [USE](https://docs.starrocks.io/docs/sql-reference/sql-statements/data-definition/USE/) to specify an active database:
...
- Directly use [USE](https://docs.starrocks.io/docs/sql-reference/sql-statements/data-definition/USE/) to switch to a Delta Lake catalog and a database in it:
...
You can use [DROP CATALOG](https://docs.starrocks.io/docs/sql-reference/sql-statements/data-definition/DROP_CATALOG/) to drop an external catalog.
...
1. Use [SHOW DATABASES](https://docs.starrocks.io/docs/sql-reference/sql-statements/data-manipulation/SHOW_DATABASES/) to view the databases in your Delta Lake cluster:

```SQL
SHOW DATABASES FROM <catalog_name>
```

1. [Switch to a Delta Lake Catalog and a database in it](https://docs.starrocks.io/docs/data_source/catalog/deltalake_catalog/#switch-to-a-delta-lake-catalog-and-a-database-in-it).
2. Use [SELECT](https://docs.starrocks.io/docs/sql-reference/sql-statements/data-manipulation/SELECT/) to query the destination table in the specified database:
...
- Currently, StarRocks only supports the Delta Lake tables in the Unity Catalog.
