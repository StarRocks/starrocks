...
From v4.0 onwards, StarRocks supports [Service Principal](https://docs.databricks.com/aws/en/dev-tools/auth/oauth-m2m) as a credential method for Databricks Unity Catalog, in addition to the original [Personal Access Token](https://docs.databricks.com/aws/en/dev-tools/auth/pat) credential method.

From v4.0 onwards, StarRocks supports vended credentials for Databricks Unity Catalog.
...
- Currently, Unity Catalog does not support Deletion Vectors.
