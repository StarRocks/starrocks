...
The maximum length of string returned by the [group_concat](./sql-functions/string-functions/group_concat.md) function. Default value: 1024. Min value: 4. Unit: characters.
...
For more information, see [UPDATE](./sql-statements/data-manipulation/UPDATE.md#partial-updates-in-column-mode-since-v31).
