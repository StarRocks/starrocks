// Copy code from with unmodified
// When Hudi upgrade hbase dependency, we can remove this file
// https://github.com/apache/hbase/blob/rel/2.4.18/hbase-server/src/main/java/org/apache/hadoop/hbase/io/FSDataInputStreamWrapper.java
