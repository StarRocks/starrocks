...
class StarRocksManifestGroup {
    ...
    StarRocksManifestGroup(FileIO io, Iterable<ManifestFile> manifests) {
        this(
                io,
    ...
    StarRocksManifestGroup specsById(Map<Integer, PartitionSpec> newSpecsById) {
        this.specsById = newSpecsById;
        deleteIndexBuilder.specsById(newSpecsById);
        return this;
    }

    StarRocksManifestGroup filterData(Expression newDataFilter) {
        this.dataFilter = Expressions.and(dataFilter, newDataFilter);
        deleteIndexBuilder.filterData(newDataFilter);
        return this;
    }

    StarRocksManifestGroup filterFiles(Expression newFileFilter) {
        this.fileFilter = Expressions.and(fileFilter, newFileFilter);
        return this;
    }

    StarRocksManifestGroup filterPartitions(Expression newPartitionFilter) {
    ...
    StarRocksManifestGroup filterManifests(Predicate<ManifestFile> newManifestPredicate) {
        this.manifestPredicate = manifestPredicate.and(newManifestPredicate);
        return this;
    }

    StarRocksManifestGroup filterManifestEntries(
    ...
    StarRocksManifestGroup scanMetrics(ScanMetrics metrics) {
        this.scanMetrics = metrics;
        return this;
    }

    StarRocksManifestGroup ignoreDeleted() {
        this.ignoreDeleted = true;
        return this;
    }

    StarRocksManifestGroup ignoreExisting() {
        this.ignoreExisting = true;
        return this;
    }

    StarRocksManifestGroup ignoreResiduals() {
        this.ignoreResiduals = true;
        return this;
    }

    StarRocksManifestGroup select(List<String> newColumns) {
        this.columns = Lists.newArrayList(newColumns);
        return this;
    }

    StarRocksManifestGroup caseSensitive(boolean newCaseSensitive) {
        this.caseSensitive = newCaseSensitive;
        deleteIndexBuilder.caseSensitive(newCaseSensitive);
        return this;
    }

    StarRocksManifestGroup planWith(ExecutorService newExecutorService) {
    ...
    public CloseableIterable<FileScanTask> planFiles() {
        return plan(StarRocksManifestGroup::createFileScanTasks);
    }
                        ...
                        new CloseableIterable<T>() {
                            ...
                            public CloseableIterator<T> iterator() {
                                StarRocksManifestReader<DataFile> reader =
                                        StarRocksManifestFiles.read(manifest, io, specsById)
