...
import com.starrocks.connector.iceberg.dlf.CachedDLFClientPool;
...
public class IcebergDLFCatalog extends BaseMetastoreCatalog implements IcebergCatalog, Configurable<Configuration> {
    private static final Logger LOG = LogManager.getLogger(IcebergDLFCatalog.class);
    ...
    public void initialize(String inputName, Map<String, String> properties) {
        ...
        this.clients = new CachedDLFClientPool(conf, properties);
    }
