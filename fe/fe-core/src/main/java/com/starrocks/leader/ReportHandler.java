...
public class ReportHandler extends Daemon implements MemoryTrackable {
    ...
    private static void sync(Map<Long, TTablet> backendTablets, ListMultimap<Pair<Long, Long>, Long> tabletSyncMap,
        ...
        for (Pair<Long, Long> dbTableIdPair : tabletSyncMap.keySet()) {
            long dbId = dbTableIdPair.first;
            long tableId = dbTableIdPair.second;
            ...
            List<Long> allTabletIds = tabletSyncMap.get(dbTableIdPair);
            int offset = 0;
