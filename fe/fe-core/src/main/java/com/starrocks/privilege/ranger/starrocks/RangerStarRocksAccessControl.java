...
public class RangerStarRocksAccessControl implements AccessControl {
    private static final Logger LOG = LoggerFactory.getLogger(RangerStarRocksAccessControl.class);
    private static RangerBasePlugin rangerPlugin = null;

    public RangerStarRocksAccessControl() {
        String serviceType = "starrocks";
        ...
        RangerPluginConfig rangerPluginContext = new RangerPluginConfig(serviceType, null, serviceType,
                null, null, null);
        /*
