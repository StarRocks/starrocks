...
public class PrivilegeCollectionDeprecate implements GsonPostProcessable {
    private static final Logger LOG = LogManager.getLogger(com.starrocks.privilege.PrivilegeCollection.class);
