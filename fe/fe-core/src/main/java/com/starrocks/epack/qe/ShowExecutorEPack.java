...
public class ShowExecutorEPack extends ShowExecutor {
    public ShowExecutorEPack() {
        super();
    }

    @Override
    public ShowResultSet execute(ShowStmt statement, ConnectContext context) {
        return statement.accept(ShowExecutorVisitorEPack.getInstance(), context);
    }

    protected static class ShowExecutorVisitorEPack extends ShowExecutor.ShowExecutorVisitor
            implements AstVisitorEPack<ShowResultSet, ConnectContext> {

        private static final Logger LOG = LogManager.getLogger(ShowExecutorEPack.ShowExecutorVisitorEPack.class);

        private static final ShowExecutorEPack.ShowExecutorVisitorEPack INSTANCE =
                new ShowExecutorEPack.ShowExecutorVisitorEPack();

        public static ShowExecutorEPack.ShowExecutorVisitorEPack getInstance() {
            return INSTANCE;
        }
