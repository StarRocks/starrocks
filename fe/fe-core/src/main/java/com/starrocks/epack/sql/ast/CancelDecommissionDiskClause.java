...
public class CancelDecommissionDiskClause extends AlterClause {
    private final String beHostPort;
    private final List<String> diskList;

    public CancelDecommissionDiskClause(String beHostPort, List<String> diskList) {
    ...
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
        return ((AstVisitorEPack<R, C>) visitor).visitCancelDecommissionDiskClause(this, context);
    }
}