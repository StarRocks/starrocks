 ...
 */
public class DatabaseTransactionGraph {
    private static final Logger LOG = LogManager.getLogger(DatabaseTransactionGraph.class);
    ...
    public DatabaseTransactionGraph() {
    }
