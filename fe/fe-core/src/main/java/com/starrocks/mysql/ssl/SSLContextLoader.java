...
public class SSLContextLoader {
    ...
    private static SSLContext createSSLContext() throws Exception {
        ...
        String sslProtocol = Strings.isNullOrEmpty(Config.ssl_protocol) ? "TLSv1.2" : Config.ssl_protocol;
    ...
    private static TrustManager[] createTrustManagers(String filepath, String keystorePassword,
        ...
        TrustManagerFactory trustFactory = SSLUtil.createTrustManagerFactory();
