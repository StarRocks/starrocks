...
public class WebBaseAction extends BaseAction {
    ...
    private boolean checkAuthWithCookie(BaseRequest request, BaseResponse response) {
        ...
        try {
            ...
            // Authorize on the context authentication populated: a security integration user carries its
            // privileges in the group derived role ids, which rebuilding from the identity alone discards.
