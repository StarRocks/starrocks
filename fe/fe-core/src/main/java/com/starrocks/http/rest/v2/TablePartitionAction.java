...
public class TablePartitionAction extends TableBaseAction {
    ...
    protected void doExecuteWithoutPassword(
        ...
        PagedResult<TablePartitionView> pagedResult = this.getAndApplyOlapTable(catalogName, dbName, tableName, olapTable -> {
            PagedResult<TablePartitionView> result = new PagedResult<>();
