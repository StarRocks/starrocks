...
public class HealthAction extends RestBaseAction {
    ...
    public void execute(BaseRequest request, BaseResponse response) {
        ...
        result.addResultEntry("total_backend_num", GlobalStateMgr.getCurrentSystemInfo().getTotalDataNodeNumber());
        result.addResultEntry("online_backend_num", GlobalStateMgr.getCurrentSystemInfo().getAliveDataNodeNumber());
