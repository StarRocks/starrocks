...
public class TransactionLoadAction extends RestBaseAction {
    ...
    public void executeWithoutPassword(BaseRequest request, BaseResponse response) throws DdlException {
        ...
        try {
            ...
            // After the HTTP accept window elapses, only these three terminal operations of an
            // already-started transaction are still admitted; TXN_BEGIN and TXN_LOAD (new work)
            // are rejected.
