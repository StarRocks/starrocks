...
// table meta info from remote doris db cluster
public class StarrocksExternalTableMetaSyncer {
    private static final Logger LOG = LogManager.getLogger(StarrocksExternalTableMetaSyncer.class);
