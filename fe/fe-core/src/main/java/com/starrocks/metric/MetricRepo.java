...
public final class MetricRepo {
    ...
    public static GaugeMetricImpl<Double> GAUGE_CACHE_MISS_RATIO_AVERAGE;
    public static GaugeMetricImpl<Double> GAUGE_CACHE_MISS_RATIO_P50;
    public static GaugeMetricImpl<Double> GAUGE_CACHE_MISS_RATIO_P90;
    public static GaugeMetricImpl<Double> GAUGE_CACHE_MISS_RATIO_P99;
    ...
    public static synchronized void init() {
        ...
        GAUGE_CACHE_MISS_RATIO_AVERAGE.setValue(0.0);
        ...
        GAUGE_CACHE_MISS_RATIO_P50.setValue(0.0);
        ...
        GAUGE_CACHE_MISS_RATIO_P90.setValue(0.0);
        ...
        GAUGE_CACHE_MISS_RATIO_P99.setValue(0.0);
