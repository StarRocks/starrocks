...
public final class MetricRepo {
    ...
    public static synchronized void init() {
        ...
        GaugeMetric<Long> metaLogCount = new GaugeMetric<Long>(
            ...
            @Override
            public Long getValue() {
                return GlobalStateMgr.getCurrentState().getMaxJournalId() - GlobalStateMgr.getCurrentState().getImageJournalId();
            }
        };
    ...
    private static void collectTableMetrics(MetricVisitor visitor, boolean minifyTableMetrics) {
        ...
        List<String> dbNames = catalog.getCurrentState().getLocalMetastore().getDbNames();
