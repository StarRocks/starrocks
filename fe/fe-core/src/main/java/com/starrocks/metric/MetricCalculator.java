...
public class MetricCalculator extends TimerTask {
    ...
    private void update() {
        ...
        List<Double> cacheMissRatioList = new ArrayList<>();
        double latencySum = 0L;
        double cacheMissRatioSum = 0L;
        ...
        if (latencyList.size() > 0) {
            ...
            MetricRepo.GAUGE_CACHE_MISS_RATIO_AVERAGE.setValue(0.0);
            MetricRepo.GAUGE_CACHE_MISS_RATIO_P50.setValue(0.0);
            MetricRepo.GAUGE_CACHE_MISS_RATIO_P90.setValue(0.0);
            MetricRepo.GAUGE_CACHE_MISS_RATIO_P99.setValue(0.0);
        }
