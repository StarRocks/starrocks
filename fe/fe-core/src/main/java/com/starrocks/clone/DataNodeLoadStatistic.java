...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/clone/DataNodeLoadStatistic.java
...
public class DataNodeLoadStatistic {
    ...
    public void calcScore(Map<TStorageMedium, Double> avgClusterUsedCapacityPercentMap,
                          Map<TStorageMedium, Double> avgClusterReplicaNumPerDataNodeMap) {
        ...
        for (TStorageMedium medium : TStorageMedium.values()) {
            LoadScore loadScore = calcSore(totalUsedCapacityMap.getOrDefault(medium, 0L),
                    ...
                    avgClusterReplicaNumPerDataNodeMap.getOrDefault(medium, 0.0));
    ...
    public static LoadScore calcSore(long beUsedCapacityB, long beTotalCapacityB, long beTotalReplicaNum,
                                     double avgClusterUsedCapacityPercent, double avgClusterReplicaNumPerDataNode) {
        ...
        double replicaNumProportion = avgClusterReplicaNumPerDataNode <= 0 ? 0.0
                : beTotalReplicaNum / avgClusterReplicaNumPerDataNode;
