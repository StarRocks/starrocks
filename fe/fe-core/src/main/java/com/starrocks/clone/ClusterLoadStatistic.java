...
public class ClusterLoadStatistic {
     ...
     */
    private void classifyDataNodeByLoad(TStorageMedium medium) {
    ...
    public DataNodeLoadStatistic getDataNodeLoadStatistic(long beId) {
    ...
    public List<DataNodeLoadStatistic> getAllDataNodeLoadStatistic() {
        return beLoadStatistics;
    }

    /*
     * If cluster is balance, all DataNodes will be in 'mid', and 'high' and 'low' is empty
     * If both 'high' and 'low' has DataNodes, just return
     * If no 'high' DataNodes, 'mid' DataNodes will be treated as 'high'
     * If no 'low' DataNodes, 'mid' DataNodes will be treated as 'low'
     */
    public void getDataNodeStatisticByClass(
