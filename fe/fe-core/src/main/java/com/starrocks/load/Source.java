...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/load/Source.java
...
public class Source implements Writable {
    ...
    public Source(List<String> fileUrls, List<String> columnNames, String columnSeprator,
                  String rowDelimiter, boolean isNegative) {
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        rowDelimiter = Text.readString(in).intern();
    ...
    public boolean equals(Object obj) {
        ...
        return columnSeparator.equals(source.columnSeparator)
                && rowDelimiter.equals(source.rowDelimiter)
