...
public class Pipe implements GsonPostProcessable {
    ...
    public static Pipe fromStatement(long id, CreatePipeStmt stmt) {
        ...
        long dbId = GlobalStateMgr.getCurrentState().getMetastore().getDb(pipeName.getDbName()).getId();
    ...
    private void buildNewTasks() {
        ...
        try (CloseableLock l = takeWriteLock()) {
            ...
            String dbName = GlobalStateMgr.getCurrentState().getStarRocksMetadata().mayGetDb(pipeId.getDbId())
