...
public class DppConfig implements Writable {
    ...
    public String getApplicationsPath() {
        return String.format("%s/%d/%s/%s", starrocksPath, GlobalStateMgr.getCurrentState().getClusterId(), APPLICATIONS_PATH,
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        if (getCurrentCatalogJournalVersion() >= FeMetaVersion.VERSION_15) {
