...
public abstract class AbstractStreamLoadTask extends AbstractTxnStateChangeCallback
    ...
    public abstract void waitCoordFinishAndPrepareTxn(TransactionResult resp);
    public abstract void commitTxn(TransactionResult resp) throws StarRocksException;
