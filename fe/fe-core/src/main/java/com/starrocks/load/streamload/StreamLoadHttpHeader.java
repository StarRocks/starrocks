...
public class StreamLoadHttpHeader {
    ...
    public static final String HTTP_ENVELOPE = "envelope";
    public static final String HTTP_FILL_DEFAULT_ON_ABSENT_KEY = "fill_default_on_absent_key";
    ...
    public static final List<String> HTTP_HEADER_LIST = Arrays.asList(
            ...
            HTTP_JSONPATHS, HTTP_JSONROOT, HTTP_STRIP_OUTER_ARRAY, HTTP_ENVELOPE,
            HTTP_FILL_DEFAULT_ON_ABSENT_KEY, HTTP_PARTIAL_UPDATE, HTTP_PARTIAL_UPDATE_MODE,
