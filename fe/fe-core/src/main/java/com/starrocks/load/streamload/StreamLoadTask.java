...
public class StreamLoadTask extends AbstractTxnStateChangeCallback
    ...
    public void unprotectedBeginTxn(TUniqueId requestId, TxnCoordinator txnCoordinator) throws UserException {
        ...
        switch (txnCoordinator.sourceType) {
            ...
            case BE:
                ...
                break;
            default:
                throw new UserException("Unknown source type: " + txnCoordinator.sourceType);
        }
        this.txnId = GlobalStateMgr.getCurrentState().getGlobalTransactionMgr().beginTransaction(
                ...
                sourceType, id, timeoutMs / 1000, warehouseId);
    }
