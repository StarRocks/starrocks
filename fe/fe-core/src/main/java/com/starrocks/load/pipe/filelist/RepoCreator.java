...
public class RepoCreator {
    ...
    public boolean checkDatabaseExists() {
        return GlobalStateMgr.getCurrentState().getMetastore().getDb(FileListTableRepo.FILE_LIST_DB_NAME) != null;
    }
    ...
    public static boolean correctTable() {
        ...
        int replica = GlobalStateMgr.getCurrentState()
                .getStarRocksMetadata().mayGetTable(FileListTableRepo.FILE_LIST_DB_NAME, FileListTableRepo.FILE_LIST_TABLE_NAME)
