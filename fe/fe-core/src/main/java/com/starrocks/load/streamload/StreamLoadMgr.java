...
public class StreamLoadMgr implements MemoryTrackable {
    ...
    protected Map<String, AbstractStreamLoadTask> idToStreamLoadTask;
    ...
    protected Map<Long, Map<String, AbstractStreamLoadTask>> dbToLabelToStreamLoadTask;
    ...
    public void addLoadTask(AbstractStreamLoadTask task, boolean addTxnCallback) {
        ...
        if (!task.isFinal() && addTxnCallback) {
