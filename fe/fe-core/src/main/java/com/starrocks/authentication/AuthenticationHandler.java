...
public class AuthenticationHandler {
    ...
    /**
     * Whether the credentials were checked against an LDAP directory. {@link LDAPAuthProvider} is the
     * only LDAP provider in this code base, so a single instanceof is enough.
     */
