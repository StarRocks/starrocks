...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/system/DataNode.java
...
public class DataNode extends ComputeNode {
    ...
    private final DataNodeStatus backendStatus = new DataNodeStatus();
    ...
    public void updateDisks(Map<String, TDisk> backendDisks) {
        ...
        if (isChanged) {
            ...
            // log disk changing
            GlobalStateMgr.getCurrentState().getEditLog().logDataNodeStateChange(this);
        }
    }
    ...
    public void write(DataOutput out) throws IOException {
        ...
        out.writeInt(getDataNodeState().ordinal());
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        if (GlobalStateMgr.getCurrentStateJournalVersion() >= FeMetaVersion.VERSION_30) {
            // ignore clusterName
            Text.readString(in);
            setDataNodeState(in.readInt());
            setDecommissionType(in.readInt());
        } else {
            setDataNodeState(DataNodeState.using.ordinal());
    ...
    public String toString() {
        return "DataNode [id=" + getId() + ", host=" + getHost() + ", heartbeatPort=" + getHeartbeatPort()
    ...
    public int getAvailableDataNodeStorageTypeCnt() {
        if (!getIsAlive().get()) {
            return 0;
        }
     ...
     * DataNodeStatus status = DataNode.getDataNodeStatus();
     * status.newItem = xxx;
     */
