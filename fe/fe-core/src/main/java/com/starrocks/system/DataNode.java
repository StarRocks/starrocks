...
public class DataNode extends ComputeNode {
    ...
    public boolean equals(Object obj) {
        ...
        return (getId() == dataNode.getId()) && (getHost().equals(dataNode.getHost()))
                && (getHeartbeatPort() == dataNode.getHeartbeatPort())
                && (getBePort() == dataNode.getBePort()) && (getIsAlive().get() == dataNode.getIsAlive().get());
    }
