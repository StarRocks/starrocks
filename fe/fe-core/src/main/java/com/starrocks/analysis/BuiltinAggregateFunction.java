...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/analysis/BuiltinAggregateFunction.java
...
import com.starrocks.thrift.TAggregationOp;
...
public class BuiltinAggregateFunction extends Function {
    ...
    private com.starrocks.catalog.Type intermediateType_;
    ...
    public BuiltinAggregateFunction(Operator op, ArrayList<Type> argTypes,
                                    Type retType, com.starrocks.catalog.Type intermediateType, boolean isAnalyticFn)
    ...
    public com.starrocks.catalog.Type getIntermediateType() {
        return intermediateType_;
    }

    public void setIntermediateType(com.starrocks.catalog.Type t) {
        intermediateType_ = t;
    }
    ...
    public enum Operator {
        ...
        private final com.starrocks.catalog.Type intermediateType;

        Operator(String description, TAggregationOp thriftOp,
                 com.starrocks.catalog.Type intermediateType) {
        ...
        public com.starrocks.catalog.Type intermediateType() {
