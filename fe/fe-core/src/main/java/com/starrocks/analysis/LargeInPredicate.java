...
public class LargeInPredicate extends InPredicate {
    ...
    public LargeInPredicate(Expr compareExpr, String rawConstantList, int constantCount,
        ...
        this.rawConstantList = trimParentheses(rawConstantList);
        this.constantCount = constantCount;
    }

    private static String trimParentheses(String rawConstantList) {
        if (rawConstantList == null) {
            return null;
        }

        String trimmed = rawConstantList.trim();
