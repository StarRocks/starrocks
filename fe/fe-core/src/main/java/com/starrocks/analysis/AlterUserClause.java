...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/analysis/AlterUserClause.java
...
public class AlterUserClause extends AlterClause {
    ...
    public void analyze(Analyzer analyzer) throws AnalysisException {
        ...
        // NOTICE: if we del hostname from whiltList, the hostname must be totally equal with globalStateMgr's hostname;
    }
