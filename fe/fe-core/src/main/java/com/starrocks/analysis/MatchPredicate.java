...
public class MatchPredicate extends Predicate {
    ...
    public enum Operator {
        MATCH_TERMS("MATCH_TERMS", "match_terms", TExprOpcode.MATCH_TERMS),
    ...
    public static void initBuiltins(FunctionSet functionSet) {
        ...
        // match_terms(column, [term1, term2, ...])
        functionSet.addBuiltin(ScalarFunction.createBuiltinOperator(
                Operator.MATCH_TERMS.getName(),
                symbolNotUsed,
                Lists.<Type>newArrayList(Type.VARCHAR, new ArrayType(Type.VARCHAR)),
                Type.BOOLEAN));
