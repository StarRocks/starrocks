...
public class TaskRunContext {
    ...
    /**
     * Check whether this task is generated by last task run, if so, it's an auto refresh task.
     */
    public boolean isAutoGeneratedTaskRun() {
        return properties != null && properties.containsKey(TaskRun.START_TASK_RUN_ID);
    }
