...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/planner/MaterializedViewSelector.java
...
public class MaterializedViewSelector {
    ...
    public BestIndexInfo selectBestMV(ScanNode scanNode) throws UserException {
        ...
        if (olapScanNode.getOlapTable().getKeysType() == KeysType.PRIMARY_KEYS) {
            return new BestIndexInfo(olapScanNode.getOlapTable().getBaseIndexId(),
                    false, "primary key tables do not have MV");
        }
