...
public class PaimonScanNode extends ScanNode {
    ...
    private void splitRawFileScanRangeLocations(RawFile rawFile) {
    ...
    private void splitScanRangeLocations(RawFile rawFile, long offset, long length, long splitSize) {
