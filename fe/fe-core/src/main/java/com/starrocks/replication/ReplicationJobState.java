...
public class ReplicationJobState {
    ...
    public static final ReplicationJobState REPLICATING = new ReplicationJobState(2);
    public static final ReplicationJobState FINISHED = new ReplicationJobState(3);
    public static final ReplicationJobState ABORTED = new ReplicationJobState(4);
