...
public class ClusterSnapshotLog implements Writable {
    public enum ClusterSnapshotLogType { NONE, CREATE_SNAPSHOT_PREFIX, CREATE_SNAPSHOT, DROP_SNAPSHOT }
    ...
    public void setCreateSnapshot(ClusterSnapshotJob snapshotJob) {
