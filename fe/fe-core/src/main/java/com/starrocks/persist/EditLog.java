...
public class EditLog {
        ...
        try {
            switch (opCode) {
                ...
                case OperationType.OP_BACKEND_STATE_CHANGE_V2: {
                    Backend be = (Backend) journal.data();
                    GlobalStateMgr.getCurrentState().getNodeMgr().getClusterInfo().replayBackendStateChange(be);
                    break;
                }
    ...
    public void logDropBackend(Backend be, WALApplier applier) {
        logJsonObject(OperationType.OP_DROP_BACKEND_V2, be, applier);
    }
    ...
    public void logRemoveFrontend(Frontend fe, WALApplier applier) {
        logJsonObject(OperationType.OP_REMOVE_FRONTEND_V2, fe, applier);
    }

    public void logUpdateFrontend(Frontend fe, WALApplier applier) {
        logJsonObject(OperationType.OP_UPDATE_FRONTEND_V2, fe, applier);
    }
    ...
    public void logBackendStateChange(Backend be, WALApplier applier) {
        logJsonObject(OperationType.OP_BACKEND_STATE_CHANGE_V2, be, applier);
    }
