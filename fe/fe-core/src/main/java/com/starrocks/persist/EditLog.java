            ...
            switch (opCode) {
                ...
                case OperationType.OP_DELETE_AUTO_INCREMENT_ID: {
                    ...
                    if (opCode == OperationType.OP_SAVE_AUTO_INCREMENT_ID) {
                        globalStateMgr.getLocalMetastore().replayAutoIncrementId(info);
                    } else if (opCode == OperationType.OP_DELETE_AUTO_INCREMENT_ID) {
                        globalStateMgr.getLocalMetastore().replayDeleteAutoIncrementId(info);
                    }
                    break;
                }
                ...
                case OperationType.OP_DROP_DB: {
                    ...
                    globalStateMgr.getLocalMetastore().replayDropDb(dropDbInfo.getDbName(), dropDbInfo.isForceDrop());
                    break;
                }
                ...
                case OperationType.OP_MODIFY_PARTITION_V2: {
                    ...
                    globalStateMgr.getLocalMetastore().replayModifyPartition(info);
                    break;
                }
                ...
                case OperationType.OP_CHANGE_MATERIALIZED_VIEW_REFRESH_SCHEME: {
                    ...
                    globalStateMgr.getLocalMetastore().replayChangeMaterializedViewRefreshScheme(log);
                    break;
                }
                case OperationType.OP_ALTER_MATERIALIZED_VIEW_PROPERTIES: {
                    ...
                    globalStateMgr.getLocalMetastore().replayAlterMaterializedViewProperties(opCode, log);
                    break;
                }
                case OperationType.OP_ALTER_MATERIALIZED_VIEW_STATUS: {
                    ...
                    globalStateMgr.getLocalMetastore().replayAlterMaterializedViewStatus(log);
                    break;
                }
                ...
                case OperationType.OP_DROP_ROLLUP_V2: {
                    DropInfo info = (DropInfo) journal.getData();
                    globalStateMgr.getLocalMetastore().replayDropRollup(info, globalStateMgr);
                    break;
                }
                case OperationType.OP_BATCH_DROP_ROLLUP: {
                    BatchDropInfo batchDropInfo = (BatchDropInfo) journal.getData();
                    for (long indexId : batchDropInfo.getIndexIdSet()) {
                        globalStateMgr.getLocalMetastore().replayDropRollup(
                ...
                case OperationType.OP_FINISH_CONSISTENCY_CHECK_V2: {
                    ...
                    globalStateMgr.getLocalMetastore().replayFinishConsistencyCheck(info);
                    break;
                }
                ...
                case OperationType.OP_SWAP_TABLE: {
                    ...
                    globalStateMgr.getLocalMetastore().replaySwapTable(log);
                    break;
                }
