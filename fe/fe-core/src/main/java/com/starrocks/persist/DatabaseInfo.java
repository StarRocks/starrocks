...
public class DatabaseInfo implements Writable {
    ...
    /**
     * Constructor for creating DatabaseInfo with new database name
     * DatabaseInfo for database rename
     * @param dbName database name
     * @param newDbName new database name
     * @param quota database quota
     * @param quotaType database quota type
     * @param storageVolumeId storage volume id
     */
