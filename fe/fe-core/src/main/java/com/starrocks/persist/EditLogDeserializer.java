...
public class EditLogDeserializer {
    ...
    private static final ImmutableMap<Short, Class<? extends Writable>> OPTYPE_TO_DESER_CLASS
            ...
            .put(OperationTypeEPack.OP_BOOKMARK_LOG, BookmarkLogEntry.class)
            .put(OperationTypeEPack.OP_CREATE_CONTEXTBASE, ContextOpLog.class)
            .put(OperationTypeEPack.OP_ALTER_CONTEXTBASE, ContextOpLog.class)
            .put(OperationTypeEPack.OP_RENAME_CONTEXTBASE, ContextOpLog.class)
            .put(OperationTypeEPack.OP_DROP_CONTEXTBASE, ContextOpLog.class)
            .put(OperationTypeEPack.OP_CREATE_CONTEXT_COLLECTION, ContextOpLog.class)
            .put(OperationTypeEPack.OP_DROP_CONTEXT_COLLECTION, ContextOpLog.class)
            .put(OperationTypeEPack.OP_CREATE_CONTEXT_WORKSPACE, ContextOpLog.class)
            .put(OperationTypeEPack.OP_DROP_CONTEXT_WORKSPACE, ContextOpLog.class)
            .put(OperationTypeEPack.OP_CREATE_CONTEXT_RETRIEVAL_PROFILE, ContextOpLog.class)
            .put(OperationTypeEPack.OP_DROP_CONTEXT_RETRIEVAL_PROFILE, ContextOpLog.class)
            .put(OperationTypeEPack.OP_CREATE_AI_PROVIDER, AIProvider.class)
            .put(OperationTypeEPack.OP_ALTER_AI_PROVIDER, AIProvider.class)
            .put(OperationTypeEPack.OP_DROP_AI_PROVIDER, DropAIProviderLog.class)
            .put(OperationTypeEPack.OP_SET_DEFAULT_AI_PROVIDER, SetDefaultAIProviderLog.class)
