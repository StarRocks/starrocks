...
public class EditLogDeserializer {
    ...
    private static final ImmutableMap<Short, Class<? extends Writable>> OPTYPE_TO_DESER_CLASS
            ...
            .put(OperationType.OP_CREATE_CONTEXTBASE, ContextOpLog.class)
            .put(OperationType.OP_ALTER_CONTEXTBASE, ContextOpLog.class)
            .put(OperationType.OP_RENAME_CONTEXTBASE, ContextOpLog.class)
            .put(OperationType.OP_DROP_CONTEXTBASE, ContextOpLog.class)
            .put(OperationType.OP_CREATE_CONTEXT_COLLECTION, ContextOpLog.class)
            .put(OperationType.OP_DROP_CONTEXT_COLLECTION, ContextOpLog.class)
            .put(OperationType.OP_CREATE_CONTEXT_WORKSPACE, ContextOpLog.class)
            .put(OperationType.OP_DROP_CONTEXT_WORKSPACE, ContextOpLog.class)
            .put(OperationType.OP_CREATE_CONTEXT_RETRIEVAL_PROFILE, ContextOpLog.class)
            .put(OperationType.OP_DROP_CONTEXT_RETRIEVAL_PROFILE, ContextOpLog.class)
