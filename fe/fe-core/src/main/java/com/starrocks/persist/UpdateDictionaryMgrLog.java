...
public class UpdateDictionaryMgrLog implements Writable {
    ...
    public UpdateDictionaryMgrLog(List<UpdateDictionaryLog> dictionaryLogList) {
        this.dictionaryLogList = dictionaryLogList;
    }
    ...
    public List<UpdateDictionaryLog> getDictionaryLogList() {
        return dictionaryLogList;
    }
}