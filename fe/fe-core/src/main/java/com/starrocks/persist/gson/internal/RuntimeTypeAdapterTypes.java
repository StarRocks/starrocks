...
public class RuntimeTypeAdapterTypes {
    ...
    static {
        ...
        final RuntimeTypeAdapterFactory<RoleMapping> role_mapping_runtime_type_adapter_factory =
                RuntimeTypeAdapterFactory.of(RoleMapping.class, "clazz")
                        .registerSubtype(LDAPRoleMapping.class, "LDAPRoleMapping");
        CLAZZ_TO_RUNTIME_TYPE_ADAPTOR_FACTORIES.put(RoleMapping.class, role_mapping_runtime_type_adapter_factory);
        ...
        final RuntimeTypeAdapterFactory<AlterPolicyLog.AlterPolicyClauseInfo>
        ...
        final RuntimeTypeAdapterFactory<ClusterSnapshot> cluster_snapshot_runtime_type_adapter_factory =
        ...
        CLAZZ_TO_RUNTIME_TYPE_ADAPTOR_FACTORIES.put(ClusterSnapshot.class, cluster_snapshot_runtime_type_adapter_factory);

        final RuntimeTypeAdapterFactory<ClusterSnapshotJob> cluster_snapshot_job_runtime_type_adapter_factory =
        ...
        CLAZZ_TO_RUNTIME_TYPE_ADAPTOR_FACTORIES.put(ClusterSnapshotJob.class, cluster_snapshot_job_runtime_type_adapter_factory);
