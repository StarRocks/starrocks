...
public class ClusterSnapshotUtils {
    ...
    public static void uploadAutomatedSnapshotToRemote(String snapshotName) throws UserException {
    ...
    public static void clearAutomatedSnapshotFromRemote(String snapshotName) throws UserException {
        if (snapshotName == null || snapshotName.isEmpty()) {
            return;
        }
