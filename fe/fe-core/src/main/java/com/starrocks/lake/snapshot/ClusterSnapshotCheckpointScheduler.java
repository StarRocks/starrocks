...
public class ClusterSnapshotCheckpointScheduler extends FrontendDaemon {
    ...
    protected void runAfterCatalogReady() {
        ...
        try {
            ...
            feController.setNeedNativeTableCheckpointVersions(false);
    ...
    protected void runCheckpointScheduler() {
        ...
        do {
            ...
            if (feImageJournalId < feCheckpointJournalId) {
                feController.setNeedNativeTableCheckpointVersions(job.needSnapshotVersions());
            ...
            job.setSnapshotVersions(feController.getNativeTableCheckpointVersions());
