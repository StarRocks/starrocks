...
public class RestoreClusterSnapshotMgr {
    ...
    private void downloadSnapshot() throws StarRocksException {
        ...
        if (snapshotImagePath.endsWith("/meta")) {
            ...
            BrokerDesc brokerDesc = new BrokerDesc(clusterSnapshot.getStorageVolume().getProperties());
            List<FileStatus> fileStatusList = HdfsUtil.listFileMeta(pathPattern, brokerDesc, false);
            ...
            for (FileStatus fs : fileStatusList) {
                ...
                if (ClusterSnapshotUtils.checkSnapshotMetaFileExist(candidatePath, brokerDesc)) {
