...
public class VariableVarConverters {
    ...
    static {
        ...
        CONVERTERS.put(SessionVariable.PAIMON_DATACACHE_REMOTE_READ_BUFFER_BLOCK_COUNT,
                new IntegerRangeConverter(SessionVariable.PAIMON_DATACACHE_REMOTE_READ_BUFFER_BLOCK_COUNT, 1,
                        SessionVariable.PAIMON_DATACACHE_REMOTE_READ_BUFFER_BLOCK_COUNT_MAX));
