...
public class StreamingAggNode extends SkeletonNode {

    private final List<ColumnRefOperator> groupBys;

    public StreamingAggNode(OptExpression optExpression, NodeExecStats nodeExecStats, SkeletonNode parent) {
    ...
    public boolean equals(Object o) {
        ...
        StreamingAggNode that = (StreamingAggNode) o;
        return Objects.equals(groupBys, that.groupBys);
    }
}
