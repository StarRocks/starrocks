...
public class LeaderOpExecutor extends FrontendOpExecutor {
    ...
    public LeaderOpExecutor(StatementBase parsedStmt, OriginStatement originStmt,
        ...
        super(ctx.getGlobalStateMgr().getLeaderIp(), ctx.getGlobalStateMgr().getLeaderRpcPort(),
                parsedStmt, originStmt, ctx, status);
    }
}
