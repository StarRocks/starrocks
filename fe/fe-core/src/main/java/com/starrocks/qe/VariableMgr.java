...
public class VariableMgr {
    ...
    private void fillValue(Object obj, Field field, VariableExpr desc) {
        try {
            switch (field.getType().getSimpleName()) {
                case "boolean":
                    desc.setType(StandardTypes.BOOLEAN);
                    desc.setValue(field.getBoolean(obj));
                    break;
                case "byte":
                    desc.setType(StandardTypes.TINYINT);
                    desc.setValue(field.getByte(obj));
                    break;
                case "short":
                    desc.setType(StandardTypes.SMALLINT);
                    desc.setValue(field.getShort(obj));
                    break;
                case "int":
                    desc.setType(StandardTypes.INT);
                    desc.setValue(field.getInt(obj));
                    break;
                case "long":
                    desc.setType(StandardTypes.BIGINT);
                    desc.setValue(field.getLong(obj));
                    break;
                case "float":
                    desc.setType(StandardTypes.FLOAT);
                    desc.setValue(field.getFloat(obj));
                    break;
                case "double":
                    desc.setType(StandardTypes.DOUBLE);
                    desc.setValue(field.getDouble(obj));
                    break;
                case "String":
                    desc.setType(StandardTypes.VARCHAR);
