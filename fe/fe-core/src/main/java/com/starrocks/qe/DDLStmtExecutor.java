        ...
        public ShowResultSet visitDropTaskStmt(DropTaskStmt dropTaskStmt, ConnectContext context) {
            ...
            if (!dropTaskStmt.isForce()) {
                ...
                if (task.getSource() == Constants.TaskSource.PIPE) {
                    throw new RuntimeException("Can not drop task generated by pipe. You can use " +
                            "DROP PIPE to drop the pipe, which will delete the related task automatically, " +
                            "or use DROP TASK ... FORCE to force delete this task.");
                }
            }
