...
import com.starrocks.datacache.DataCacheExecutor;
...
public class DDLStmtExecutor {
    ...
    static class StmtExecutorVisitor implements AstVisitor<ShowResultSet, ConnectContext> {
        ...
        public ShowResultSet visitDataCacheSelectStatement(DataCacheSelectStatement statement, ConnectContext context) {
            ...
            String errorMsg = "N/A";
            try {
                metrics = DataCacheExecutor.cacheSelect(statement, context);
            } catch (Exception e) {
                LOG.warn(e);
            ...
            if (properties != null) {
                verbose = Boolean.parseBoolean(properties.getOrDefault("verbose", "false"));
            }
