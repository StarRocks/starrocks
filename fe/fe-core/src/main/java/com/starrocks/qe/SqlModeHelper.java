...
public class SqlModeHelper {
    ...
    public static final long MODE_ALLOC_EXCEPTION = 1L << 8;
    ...
    public static final long MODE_ALLOWED_MASK =
            (MODE_REAL_AS_FLOAT | MODE_PIPES_AS_CONCAT | MODE_ANSI_QUOTES |
                    ...
                    MODE_NO_UNSIGNED_SUBTRACTION | MODE_NO_DIR_IN_CREATE | MODE_ALLOC_EXCEPTION | MODE_DOUBLE_LITERAL |
    ...
    static {
        ...
        SQL_MODE_SET.put("ALLOC_EXCEPTION", MODE_ALLOC_EXCEPTION);
