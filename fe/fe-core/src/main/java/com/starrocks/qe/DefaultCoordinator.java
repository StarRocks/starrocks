...
public class DefaultCoordinator extends Coordinator {
    ...
    private static final ExecutorService VENDED_REFRESH_EXECUTOR =
            ThreadPoolManager.newDaemonCacheThreadPool(32, 1024, "vended-cred-refresh", false);
    private volatile ScheduledFuture<?> vendedCredentialRefreshTask = null;
    ...
    private void refreshVendedCredentialsTick() {
        ...
        try {
            ...
            // Never let the timer thread die on one bad tick; retry the push next tick.
