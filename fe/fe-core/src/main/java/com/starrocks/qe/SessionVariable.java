...
public class SessionVariable implements Serializable, Writable, Cloneable {
    ...
    public static final String PAIMON_DATACACHE_REMOTE_READ_BUFFER_BLOCK_COUNT =
            "paimon_datacache_remote_read_buffer_block_count";
    public static final int PAIMON_DATACACHE_REMOTE_READ_BUFFER_BLOCK_COUNT_MAX = 256;
    ...
    // this is used to compatible mysql 8.0
    ...
    public void setEnableStructLowCardinalityOptimize(boolean enableStructLowCardinalityOptimize) {
    ...
    // CacheInputStream keeps its 16-block default for other readers. Paimon uses
    // 64 blocks to preserve a 16 MiB remote read with the default 256 KiB block.
    @VariableMgr.VarAttr(name = PAIMON_DATACACHE_REMOTE_READ_BUFFER_BLOCK_COUNT)
    private int paimonDataCacheRemoteReadBufferBlockCount = 64;
    ...
    public int getPaimonDataCacheRemoteReadBufferBlockCount() {
        return paimonDataCacheRemoteReadBufferBlockCount;
    }

    public void setPaimonDataCacheRemoteReadBufferBlockCount(int blockCount) {
        this.paimonDataCacheRemoteReadBufferBlockCount = blockCount;
    }
    ...
    public TQueryOptions toThrift() {
        ...
        tResult.setPaimon_datacache_remote_read_buffer_block_count(paimonDataCacheRemoteReadBufferBlockCount);
