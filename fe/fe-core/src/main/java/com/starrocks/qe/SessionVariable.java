...
public class SessionVariable implements Serializable, Writable, Cloneable {
    ...
    public static final String ENABLE_READ_BYPASS_BLOCK_CACHE = "enable_read_bypass_block_cache";
    ...
    @VariableMgr.VarAttr(name = ENABLE_READ_BYPASS_BLOCK_CACHE)
    private boolean enableReadBypassBlockCache = false;
    ...
    public boolean getEnableReadSkipBypassBlockCache() {
        return enableReadBypassBlockCache;
    }
