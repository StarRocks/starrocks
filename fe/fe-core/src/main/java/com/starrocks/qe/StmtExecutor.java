...
public class StmtExecutor {
    ...
    public int getExecTimeout() {
        if (parsedStmt instanceof CreateTableAsSelectStmt ctas) {
            ...
            int sessionQueryTimeout = ConnectContext.get().getSessionVariable().getQueryTimeoutS();
            boolean sessionTimeoutOverridden = false;
            try {
                sessionTimeoutOverridden = ConnectContext.get() != null && ConnectContext.get().isSessionQueryTimeoutOverridden();
            } catch (Exception ignored) {
                sessionTimeoutOverridden = false;
            }
            if (parsedStmt instanceof QueryStatement) {
                try {
