...
public class StmtExecutor {
    ...
    private void handleAnalyzeStmt() throws IOException {
        ...
        try {
            Runnable originalTask = () -> executeAnalyze(analyzeStmt, analyzeStatus, db, table, context.getCurrentWarehouseId());
...
>>>>>>> 4ccf09ccf92... [Enhancement] Surface internal queries in current_queries with a type and make them killable (#74488)
            coord.exec();
            RowBatch batch;
            do {
                batch = coord.getNext();
