...
public class StatisticsMetaManager extends FrontendDaemon {
    ...
    private boolean createDataCacheCopilotStatisticsTable(ConnectContext context) {
        ...
        try {
            ...
            // PARTITION BY date_trunc('day', `access_time`)
            List<String> columnList = List.of(DataCacheCopilotConstants.ACCESS_TIME_NAME);
            ...
            exprs.add(new SlotRef(null, DataCacheCopilotConstants.ACCESS_TIME_NAME,
        ...
        return checkTableExist(DataCacheCopilotConstants.DATACACHE_COPILOT_STATISTICS_TABLE_NAME);
    }
