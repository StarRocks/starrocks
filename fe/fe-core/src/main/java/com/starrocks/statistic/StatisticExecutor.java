...
public class StatisticExecutor {
    ...
    public static List<TStatisticData> queryDictSync(Long dbId, Long tableId, String column) {
        return queryDictSync(dbId, tableId, ImmutableList.of(column));
    }

    public static List<TStatisticData> queryDictSync(Long dbId, Long tableId, List<String> columnNames) {
        if (dbId == -1) {
            return Collections.emptyList();
        }
        ...
        try {
            ...
            LOG.warn("Parse statistic dict query fail.", e);
            return Collections.emptyList();
        }
        ...
        try {
            ...
            LOG.warn("Execute statistic dict query fail.", e);
        }
