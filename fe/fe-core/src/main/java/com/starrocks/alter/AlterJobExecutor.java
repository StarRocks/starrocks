...
public class AlterJobExecutor implements AstVisitor<Void, ConnectContext> {
    ...
    private void modifyPartitionsProperty(Database db,
        ...
        for (String partitionName : partitionNames) {
            ...
            if (coolDownSyncedTimeMs != -1L && preCoolDownSyncedTimeMs != null &&
                    coolDownSyncedTimeMs != preCoolDownSyncedTimeMs) {
            ...
            if (coolDownCheckTimeMs != -1L && preCoolDownCheckTimeMs != null &&
                    coolDownCheckTimeMs != preCoolDownCheckTimeMs) {
