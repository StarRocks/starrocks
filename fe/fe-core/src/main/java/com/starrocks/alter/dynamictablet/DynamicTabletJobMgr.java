...
public class DynamicTabletJobMgr extends FrontendDaemon {
    ...
    public void addDynamicTabletJob(DynamicTabletJob dynamicTabletJob) throws StarRocksException {
        ...
        long totalParallelTablets = getTotalParalelTablets() + dynamicTabletJob.getParallelTablets();
        ...
        if (existingJob != null) {
            throw new StarRocksException("Running dynamic tablet job is already existed. " + existingJob);
        }
