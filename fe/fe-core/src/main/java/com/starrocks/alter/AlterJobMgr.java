...
public class AlterJobMgr {
    ...
    public void replayAlterMaterializedViewBaseTableInfos(AlterMaterializedViewBaseTableInfosLog log) {
        ...
        MaterializedView mv = (MaterializedView) MetadataMgr.getTable(db.getId(), mvId);
        if (mv == null) {
            return;
        }
    ...
    public void replayAlterMaterializedViewStatus(AlterMaterializedViewStatusLog log) {
        ...
        Database db = MetadataMgr.getDb(dbId);
        MaterializedView mv = (MaterializedView) MetadataMgr.getTable(db.getId(), tableId);
        if (mv == null) {
            return;
        }
    ...
    public void replayRenameMaterializedView(RenameMaterializedViewLog log) {
        ...
        Database db = MetadataMgr.getDb(dbId);
        MaterializedView oldMaterializedView = (MaterializedView) MetadataMgr.getTable(db.getId(), materializedViewId);
    ...
    public void replayChangeMaterializedViewRefreshScheme(ChangeMaterializedViewRefreshSchemeLog log) {
        ...
        MaterializedView oldMaterializedView = (MaterializedView) MetadataMgr.getTable(db.getId(), id);
        if (oldMaterializedView == null) {
    ...
    public void replaySwapTable(SwapTableOperationLog log) {
        ...
        Database db = MetadataMgr.getDb(dbId);
        OlapTable origTable = (OlapTable) MetadataMgr.getTable(db.getId(), origTblId);
        OlapTable newTbl = (OlapTable) MetadataMgr.getTable(db.getId(), newTblId);
    ...
    public void alterView(AlterViewInfo alterViewInfo) {
        ...
        Database db = MetadataMgr.getDb(dbId);
        View view = (View) MetadataMgr.getTable(db.getId(), tableId);
    ...
    public void replayModifyPartition(ModifyPartitionInfo info) {
        Database db = MetadataMgr.getDb(info.getDbId());
        OlapTable olapTable = (OlapTable) MetadataMgr.getTable(db.getId(), info.getTableId());
