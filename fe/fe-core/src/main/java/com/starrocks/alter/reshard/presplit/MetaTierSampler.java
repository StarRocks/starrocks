...
/**
 * Meta-tier path-planner contract used by {@link DefaultPreSplitPipeline}.
 ...
 */
@FunctionalInterface
public interface MetaTierSampler {

    /**
     * @throws MetaTierUnavailableException when the caller should retry with data tier.
