    ...
    public void validateStorageVolumeConfig() throws InvalidConfException {
        switch (Config.cloud_native_storage_type.toLowerCase()) {
            ...
            case "adls2":
                ...
                break;
            case "gs":
                normalizeConfigPath(Config.gcp_gs_path, "gs", "Config.gcp_gs_path", true);
                break;
            default:
    ...
    public static List<String> parseLocationsFromConfig() throws InvalidConfException {
        ...
        switch (Config.cloud_native_storage_type.toLowerCase()) {
            ...
            case "adls2":
                ...
                break;
            case "gs":
                uri = normalizeConfigPath(Config.gcp_gs_path, "gs", "Config.gcp_gs_path", true);
                locations.add(uri.toString());
                break;
            default:
                return locations;
    ...
    private Map<String, String> parseParamsFromConfig() {
        ...
        switch (Config.cloud_native_storage_type.toLowerCase()) {
            ...
            case "adls2":
                ...
                break;
            case "gs":
                params.put(CloudConfigurationConstants.GCP_GCS_ENDPOINT, Config.gcp_gs_endpoint);
                params.put(CloudConfigurationConstants.GCP_GCS_USE_COMPUTE_ENGINE_SERVICE_ACCOUNT,
                        Config.gcp_gs_use_compute_engine_service_account);
                params.put(CloudConfigurationConstants.GCP_GCS_SERVICE_ACCOUNT_EMAIL, Config.gcp_gs_service_account_email);
                params.put(CloudConfigurationConstants.GCP_GCS_SERVICE_ACCOUNT_PRIVATE_KEY,
                        Config.gcp_gs_service_account_private_key);
                params.put(CloudConfigurationConstants.GCP_GCS_SERVICE_ACCOUNT_PRIVATE_KEY_ID,
                        Config.gcp_gs_service_account_private_key_id);
                params.put(CloudConfigurationConstants.GCP_GCS_IMPERSONATION_SERVICE_ACCOUNT,
                        Config.gcp_gs_impersonation_service_account);
                break;
            default:
                return params;
        }
