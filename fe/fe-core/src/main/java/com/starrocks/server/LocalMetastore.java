...
public class LocalMetastore implements ConnectorMetadata {
    ...
    public void refreshMaterializedView(RefreshMaterializedViewStatement refreshMaterializedViewStatement, int priority)
        ...
        boolean force = refreshMaterializedViewStatement.isForce();
        RangePartitionWithoutIntervalDesc range =
                refreshMaterializedViewStatement.getRangePartitionWithoutIntervalDesc();
        if (range == null && !force) {
            refreshMaterializedView(dbName, mvName, priority);
        } else {
            MaterializedView materializedView = getMaterializedViewToRefresh(dbName, mvName);
