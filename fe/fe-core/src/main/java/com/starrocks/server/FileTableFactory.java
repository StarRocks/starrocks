...
public class FileTableFactory implements AbstractTableFactory {
    ...
    @Override
    public void createTable(LocalMetastore metastore, Database database, CreateTableStmt stmt) throws DdlException {
        ...
        metastore.registerTable(database, fileTable, stmt);
    }
}
