...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/common/proc/DataNodeProcNode.java
...
public class DataNodeProcNode implements ProcNodeInterface {
    ...
    public ProcResult fetchResult() throws AnalysisException {
        ...
        for (Map.Entry<String, DiskInfo> entry : backend.getDisks().entrySet()) {
            ...
            // tablet num
            info.add(String.valueOf(GlobalStateMgr.getCurrentInvertedIndex().getTabletNumByDataNodeIdAndPathHash(
