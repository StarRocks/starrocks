...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/common/util/JdkUtils.java
...
public class JdkUtils {
    ...
    /*
     * StarRocks will check if the compiled and running versions of Java are compatible.
    ...
    public static boolean checkJavaVersion() {
        ...
        String javaCompileVersionStr = getJavaVersionFromFullVersion(Version.STARROCKS_JAVA_COMPILE_VERSION);
