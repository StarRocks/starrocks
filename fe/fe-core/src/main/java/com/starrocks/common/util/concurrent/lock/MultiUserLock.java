...
public class MultiUserLock extends Lock {
    ...
    @Override
    public LockGrantType lock(Locker locker, LockType lockType) throws NotSupportLockException {
    ...
    private LockGrantType tryLock(LockHolder lockHolderRequest) throws NotSupportLockException {
        if (ownerNum() == 0) {
