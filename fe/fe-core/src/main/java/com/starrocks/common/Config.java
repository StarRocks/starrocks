...
public class Config extends ConfigBase {
    ...
    @ConfField(mutable = true, comment = "Interval in seconds at which the leader FE flushes the collected " +
    ...
    public static int partition_access_time_flush_interval_sec = 60;
