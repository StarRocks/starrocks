...
public class LockUtils {
    ...
    private static void logSlowLockEventIfNeeded(long startMs, LockType type,
                                                 ...
                                                 String beforeLockInfo, String afterLockInfo,
        ...
        if (endMs - startMs > Config.slow_lock_threshold_ms &&
            ...
            // using list style stack trace instead of multi-line style, because for some logging collection
            // system, it's hard to collect and format those log
            LOG.warn("slow lock. type: {}, obj id: {}, obj name: {}, wait for: {}ms, " +
                            "before lock info [{}], after lock info: [{}]",
                    type,
                    objectId, objectName,
                    endMs - startMs,
                    beforeLockInfo, afterLockInfo);
        }
    }
    ...
    private static void logTryLockFailure(LockType type,
                                          ...
                                          long objectId, String objectName,
                                          String beforeLockInfo, String afterLockInfo) {
        LOG.warn("try lock failed. type: {}, timeout: {}, obj id: {}, obj name: {}," +
                        "before lock info [{}], after lock info: [{}]", type, unit.toMillis(timeout),
                objectId, objectName, beforeLockInfo, afterLockInfo);
    }
    ...
    private static void lock(QueryableReentrantReadWriteLock rwLock,
        ...
        String beforeLockInfo = rwLock.getLockInfoWithOwnerStack();
        switch (type) {
            case DB_READ_LOCK:
                rwLock.sharedLock();
                break;
        ...
        String afterLockInfo = rwLock.getLockInfoWithCurrStack();
    ...
    private static boolean tryLock(QueryableReentrantReadWriteLock rwLock,
        ...
        String afterLockInfo;
        if (lockingResult) {
            afterLockInfo = rwLock.getLockInfoWithCurrStack();
            ...
            afterLockInfo = rwLock.getLockInfoWithOwnerStack();
