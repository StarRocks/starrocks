...
public class DistributionSpec {
    ...
    protected DistributionPropertyInfo propertyInfo;

    protected DistributionSpec(DistributionType type) {
        this(type, new DistributionPropertyInfo());
    }

    protected DistributionSpec(DistributionType type, DistributionPropertyInfo propertyInfo) {
        this.type = type;
    ...
    public DistributionPropertyInfo getPropertyInfo() {
        return propertyInfo;
    }
