...
import com.starrocks.sql.optimizer.rule.transformation.PushDownTopNWithOuterJoin;
...
public class Optimizer {
    ...
    private OptExpression logicalRuleRewrite(ConnectContext connectContext,
        ...
        ruleRewriteOnlyOnce(tree, rootTaskContext, new PushDownTopNWithOuterJoin());
