...
public class GroupByCountDistinctDataSkewEliminateRule extends TransformationRule {
    ...
    private ScalarOperator createBucketColumn(ColumnRefOperator distinctColumn, int bucketNum) {
        ...
        ConstantOperator bucketConstOp = ConstantOperator.createInt(bucketNum / 2);
    ...
    public List<OptExpression> transform(OptExpression input, OptimizerContext context) {
        ...
        LogicalAggregationOperator fourthAggOp = new LogicalAggregationOperator.Builder().withOperator(thirdAggOp)
