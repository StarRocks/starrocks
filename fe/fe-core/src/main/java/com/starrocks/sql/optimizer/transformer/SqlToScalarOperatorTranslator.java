...
public final class SqlToScalarOperatorTranslator {
    ...
    private static class Visitor implements AstVisitorExtendInterface<ScalarOperator, Context> {
        ...
        public ScalarOperator visitLambdaFunctionExpr(LambdaFunctionExpr node,
            ...
            return new LambdaFunctionOperator(refs, lambda, StandardTypes.FUNCTION);
        }
        ...
        public ScalarOperator visitSubqueryExpr(Subquery node, Context context) {
            ...
            if (builder == null) {
                LogicalApplyOperator applyOperator = LogicalApplyOperator.builder()
                        ...
                        .build();
                return new SubqueryOperator(StandardTypes.INVALID, queryStatement, applyOperator, null);
            }
