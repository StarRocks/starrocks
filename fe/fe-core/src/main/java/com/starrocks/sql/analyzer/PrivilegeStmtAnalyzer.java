...
public class PrivilegeStmtAnalyzer {
    ...
    static class PrivilegeStatementAnalyzerVisitor extends AstVisitor<Void, ConnectContext> {
        ...
        public Void visitGrantRevokeRoleStatement(BaseGrantRevokeRoleStmt stmt, ConnectContext session) {
            ...
            stmt.setQualifiedRole(analyseRoleName(stmt.getRole(), session, true, "Can not granted/revoke role to user"));
            return null;
        }
        ...
        public Void visitCreateUserStatement(CreateUserStmt stmt, ConnectContext session) {
            ...
            if (stmt.hasRole()) {
                ...
                stmt.setRole(analyseRoleName(stmt.getQualifiedRole(), session, true, "Can not granted/revoke role to user"));
            }
            return null;
        }
