...
public class LogicalAggregationOperator extends LogicalOperator {
    ...
    private int singleDistinctFunctionColumnId = -1;
    ...
    private LogicalAggregationOperator() {
        ...
        this.isSplit = false;
        this.singleDistinctFunctionColumnId = -1;
    }
    ...
    public RowOutputInfo deriveRowOutputInfo(List<OptExpression> inputs) {
        ...
        groupingKeys.forEach(e -> columnOutputInfoList.add(new ColumnOutputInfo(e, e)));
        aggregations.forEach((key, value) -> columnOutputInfoList.add(new ColumnOutputInfo(key, value)));
    ...
    public boolean equals(Object o) {
        ...
        return isSplit == that.isSplit && singleDistinctFunctionColumnId == that.singleDistinctFunctionColumnId &&
    ...
    public static class Builder
        ...
        public LogicalAggregationOperator.Builder withOperator(LogicalAggregationOperator aggregationOperator) {
            ...
            builder.singleDistinctFunctionColumnId = aggregationOperator.singleDistinctFunctionColumnId;
        ...
        public Builder setSingleDistinctFunctionColumnId(int singleDistinctFunctionColumnId) {
            builder.singleDistinctFunctionColumnId = singleDistinctFunctionColumnId;
            return this;
        }
