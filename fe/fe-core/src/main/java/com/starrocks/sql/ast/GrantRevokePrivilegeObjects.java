...
public class GrantRevokePrivilegeObjects implements ParseNode {
    ...
    private List<User> userPrivilegeObjectList;
    ...
    public List<User> getUserPrivilegeObjectList() {
        return userPrivilegeObjectList;
    }

    public void setUserPrivilegeObjectList(List<User> userPrivilegeObjectList) {
