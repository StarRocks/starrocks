    ...
    private Void computeIcebergEqualityDeleteScanNode(Operator node, ExpressionContext context, Table table,
        ...
        if (context.getStatistics() == null) {
            ...
            if (node.isLogical()) {
                ...
                needCheckEqualityIds = ((LogicalIcebergEqualityDeleteScanOperator) node).isHitImmutableIdentifierColumns();
            } else {
                ...
                needCheckEqualityIds = ((PhysicalIcebergEqualityDeleteScanOperator) node).isHitImmutableIdentifierColumns();
            }
