...
public class QueryTransformer {
    ...
    public OptExprBuilder aggregate(OptExprBuilder subOpt,
        ...
        if (groupingSetsList != null) {
            ...
            ColumnRefOperator grouping = columnRefFactory.create(GROUPING_ID, StandardTypes.BIGINT, false);
            ...
            for (Expr groupingFunction : groupingFunctionCallExprs) {
                grouping = columnRefFactory.create(GROUPING, StandardTypes.BIGINT, false);
