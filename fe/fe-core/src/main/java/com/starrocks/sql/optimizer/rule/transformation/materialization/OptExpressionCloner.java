...
/**
 * TODO: Cloner is used to clone OptExpression without changing original column ref ids.
 */
    ...
    static class OptExpressionCloneVisitor extends OptExpressionVisitor<OptExpression, Void> {
        ...
        public OptExpression visitLogicalTableScan(OptExpression optExpression, Void context) {
            ...
            for (Map.Entry<ColumnRefOperator, Column> entry : columnRefOperatorColumnMap.entrySet()) {
                columnRefColumnMapBuilder.put(entry.getKey(), entry.getValue());
            }
            ...
            for (Map.Entry<Column, ColumnRefOperator> entry : columnMetaToColRefMap.entrySet()) {
                columnMetaToColRefMapBuilder.put(entry.getKey(), entry.getValue());
            }
        ...
        public OptExpression visitLogicalProject(OptExpression optExpression, Void context) {
            ...
            Map<ColumnRefOperator, ScalarOperator> newColumnRefMap = Maps.newHashMap(projectOperator.getColumnRefMap());
        ...
        public OptExpression visitLogicalAggregate(OptExpression optExpression, Void context) {
            ...
            // group by keys
            List<ColumnRefOperator> newGroupKeys = Lists.newArrayList(aggregationOperator.getGroupingKeys());
            aggregationBuilder.setGroupingKeys(newGroupKeys);
            // aggregations
            Map<ColumnRefOperator, CallOperator> newAggregates = Maps.newHashMap(aggregationOperator.getAggregations());
            ...
            if (partitionColumns != null) {
                List<ColumnRefOperator> newPartitionColumns = Lists.newArrayList(partitionColumns);
        ...
        public OptExpression visitLogicalWindow(OptExpression optExpression, Void context) {
            ...
            // partitions
            List<ScalarOperator> newPartitions = Lists.newArrayList(windowOperator.getPartitionExpressions());
            ...
            // window call
            Map<ColumnRefOperator, CallOperator> newWindowCalls = Maps.newHashMap(windowOperator.getWindowCall());
        ...
        public OptExpression visitLogicalTopN(OptExpression optExpression, Void context) {
            ...
            if (topNOperator.getPartitionByColumns() != null) {
                List<ColumnRefOperator> newPartitionBys = Lists.newArrayList(topNOperator.getPartitionByColumns());
        ...
        public OptExpression visitLogicalValues(OptExpression optExpression, Void context) {
            ...
            // column refs
            List<ColumnRefOperator> newColRefs = Lists.newArrayList(valuesOperator.getColumnRefSet());
        ...
        public OptExpression visitLogicalTableFunction(OptExpression optExpression, Void context) {
            ...
            // fnResultColRef
            List<ColumnRefOperator> newFnResultColRefs = Lists.newArrayList(tableFunctionOperator.getFnResultColRefs());
            opBuilder.setFnResultColRefs(newFnResultColRefs);

            // outerColRef
            List<ColumnRefOperator> newOuterColRefs = Lists.newArrayList(tableFunctionOperator.getOuterColRefs());
            ...
            List<Pair<ColumnRefOperator, ScalarOperator>> newFnParamColumnProject =
                    Lists.newArrayList(tableFunctionOperator.getFnParamColumnProject());
        ...
        public OptExpression visitLogicalRepeat(OptExpression optExpression, Void context) {
            ...
            // fnResultColRef
            List<ColumnRefOperator> newOutputGroupings = Lists.newArrayList(repeatOperator.getOutputGrouping());
            ...
            for (List<ColumnRefOperator> repeatColumnRefs : repeatOperator.getRepeatColumnRef()) {
                List<ColumnRefOperator> newRepeatColumnRefs = Lists.newArrayList(repeatColumnRefs);
        ...
        public OptExpression visitLogicalCTEConsume(OptExpression optExpression, Void context) {
            ...
            Map<ColumnRefOperator, ColumnRefOperator> newCteOutputColumnRefMap =
                    Maps.newHashMap(cteConsumeOperator.getCteOutputColumnRefMap());
