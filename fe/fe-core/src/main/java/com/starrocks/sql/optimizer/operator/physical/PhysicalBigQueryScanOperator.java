...
public class PhysicalBigQueryScanOperator extends PhysicalScanOperator {
    private ScanOperatorPredicates predicates;

    public PhysicalBigQueryScanOperator(LogicalBigQueryScanOperator scanOperator) {
        super(OperatorType.PHYSICAL_BIGQUERY_SCAN, scanOperator);
    ...
    public <R, C> R accept(OperatorVisitor<R, C> visitor, C context) {
        return visitor.visitPhysicalBigQueryScan(this, context);
    }

    @Override
    public <R, C> R accept(OptExpressionVisitor<R, C> visitor, OptExpression optExpression, C context) {
        return visitor.visitPhysicalBigQueryScan(optExpression, context);
    }
