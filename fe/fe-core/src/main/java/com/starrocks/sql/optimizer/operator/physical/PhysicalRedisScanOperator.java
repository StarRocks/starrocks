...
public class PhysicalRedisScanOperator extends PhysicalScanOperator {

    private ScanOperatorPredicates predicates;

    protected PhysicalRedisScanOperator(OperatorType type) {
        super(type);
    }

    public PhysicalRedisScanOperator(LogicalRedisScanOperator scan) {
        super(OperatorType.PHYSICAL_REDIS_SCAN, scan);
    ...
    public <R, C> R accept(OperatorVisitor<R, C> visitor, C context) {
        return visitor.visitPhysicalRedisScan(this, context);
    }

    @Override
    public <R, C> R accept(OptExpressionVisitor<R, C> visitor, OptExpression optExpression, C context) {
        return visitor.visitPhysicalRedisScan(optExpression, context);
    }
