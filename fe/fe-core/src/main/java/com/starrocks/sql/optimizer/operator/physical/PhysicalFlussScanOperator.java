...
public class PhysicalFlussScanOperator extends PhysicalScanOperator {
    ...
    public <R, C> R accept(OperatorVisitor<R, C> visitor, C context) {
        return visitor.visitPhysicalFlussScan(this, context);
    }

    @Override
    public <R, C> R accept(OptExpressionVisitor<R, C> visitor, OptExpression optExpression, C context) {
        return visitor.visitPhysicalFlussScan(optExpression, context);
    }
