 ...
 */
public class PushDownAsofjoinConditionToChildProject extends TransformationRule {
    public PushDownAsofjoinConditionToChildProject() {
        super(RuleType.TF_PUSH_DOWN_ASOF_JOIN_CONDITION_TO_CHILD_PROJECT,
    ...
    public List<OptExpression> transform(OptExpression input, OptimizerContext context) {
        ...
        // After commutation, lhs/rhs should each belong to exactly one side; if not, treat as invalid and no-op
