...
public class ShowNodesStmt extends ShowStmt {
    private static final ShowResultSetMetaData META_DATA =
            ShowResultSetMetaData.builder()
                    .addColumn("WarehouseName")
                    .addColumn("CNGroupId")
                    .addColumn("WorkerGroupId")
                    .addColumn("NodeId")
                    .addColumn("WorkerId")
                    .addColumn("IP")
                    .addColumn("HeartbeatPort")
                    .addColumn("BePort")
                    .addColumn("HttpPort")
                    .addColumn("BrpcPort")
                    .addColumn("StarletPort")
                    .addColumn("LastStartTime")
                    .addColumn("LastUpdateMs")
                    .addColumn("Alive")
                    .addColumn("ErrMsg")
                    .addColumn("Version")
                    .addColumn("NumRunningQueries")
                    .addColumn("CpuCores")
                    .addColumn("MemUsedPct")
                    .addColumn("CpuUsedPct")
                    .build();
