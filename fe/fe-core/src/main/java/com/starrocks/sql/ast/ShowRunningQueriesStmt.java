...
public class ShowRunningQueriesStmt extends ShowStmt {
    private static final List<Pair<Column, Function<LogicalSlot, String>>> META_DATA = ImmutableList.of(
            ...
            Pair.create(new Column("PlanMemCosts", ScalarType.createVarchar(64)),
                    slot -> Long.toString(slot.getPlanMemCosts())),
            Pair.create(new Column("SkipTimes", ScalarType.createVarchar(64)),
                    slot -> Integer.toString(slot.getSkipTimes())),
