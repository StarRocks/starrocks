...
public class RewriteToVectorPlanRule extends TransformationRule {
    ...
    private OptExpression rewriteOptByDistanceColumn(LogicalTopNOperator topNOp,
        ...
        Column distanceColumn = new Column(distanceColumnName, StandardTypes.FLOAT);
        scanOp.getTable().addColumn(distanceColumn);

        ColumnRefOperator distanceColRef = context.getColumnRefFactory().create(distanceColumnName, StandardTypes.FLOAT, false);
