...
/**
 * Compressed Values operator that stores raw constant data instead of parsed expressions.
 * This dramatically reduces serialization overhead for large constant lists.
 */
public class LogicalCompressedValuesOperator extends LogicalOperator {
    ...
    public LogicalCompressedValuesOperator(List<ColumnRefOperator> columnRefSet, 
                                         Type valueType,
                                         String rawConstantList, 
                                         int constantCount) {
        super(OperatorType.LOGICAL_COMPRESSED_VALUES);
    ...
    public <R, C> R accept(OperatorVisitor<R, C> visitor, C context) {
        return visitor.visitLogicalCompressedValues(this, context);
    }

    @Override
    public <R, C> R accept(OptExpressionVisitor<R, C> visitor, OptExpression optExpression, C context) {
        return visitor.visitLogicalCompressedValues(optExpression, context);
    }
    ...
    public boolean equals(Object o) {
        ...
        LogicalCompressedValuesOperator that = (LogicalCompressedValuesOperator) o;
    ...
    public String toString() {
        return String.format("CompressedValues{type=%s, count=%d, sample=%s}", 
                           valueType, constantCount, 
                           rawConstantList.length() > 50 ? 
