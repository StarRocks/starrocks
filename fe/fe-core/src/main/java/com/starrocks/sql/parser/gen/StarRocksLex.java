// Generated from /Users/lishuming/work/sr_dev/fe/fe-core/src/main/java/com/starrocks/sql/parser/StarRocksLex.g4 by ANTLR 4.10.1
...
public class StarRocksLex extends Lexer {
	...
	public static final int
		...
		COSTS=55, COUNT=56, CREATE=57, CROSS=58, CUBE=59, CURRENT=60, CURRENT_TIMESTAMP=61, 
		CURRENT_USER=62, DATA=63, DATABASE=64, DATABASES=65, DATE=66, DATETIME=67, 
		DAY=68, DECIMAL=69, DECIMALV2=70, DECIMAL32=71, DECIMAL64=72, DECIMAL128=73, 
		DECOMMISSION=74, DEFAULT=75, DELETE=76, DENSE_RANK=77, NTILE=78, DESC=79, 
		DESCRIBE=80, DISTINCT=81, DISTRIBUTED=82, DISTRIBUTION=83, DOUBLE=84, 
		DROP=85, DUAL=86, DUPLICATE=87, DYNAMIC=88, ELSE=89, END=90, ENGINE=91, 
		ENGINES=92, ERRORS=93, EVENTS=94, EXCEPT=95, EXECUTE=96, EXISTS=97, EXPLAIN=98, 
		EXPORT=99, EXTERNAL=100, EXTRACT=101, EVERY=102, FALSE=103, FILE=104, 
		FILTER=105, FIRST=106, FIRST_VALUE=107, FLOAT=108, FLOOR=109, FN=110, 
		FOLLOWING=111, FOLLOWER=112, FOR=113, FORCE=114, FORMAT=115, FREE=116, 
		FROM=117, FRONTEND=118, FRONTENDS=119, FULL=120, FUNCTION=121, FUNCTIONS=122, 
		GLOBAL=123, GRANT=124, GRANTS=125, GROUP=126, GROUPS=127, GROUPING=128, 
		GROUPING_ID=129, HASH=130, HAVING=131, HELP=132, HISTOGRAM=133, HLL=134, 
		HLL_UNION=135, HOST=136, HOUR=137, HUB=138, IDENTIFIED=139, IF=140, IMPERSONATE=141, 
		IGNORE=142, IN=143, INDEX=144, INDEXES=145, INFILE=146, INSTALL=147, INNER=148, 
		INSERT=149, INT=150, INCREMENTAL=151, INTEGER=152, INTERMEDIATE=153, INTERSECT=154, 
		INTERVAL=155, INTO=156, OVERWRITE=157, IS=158, ISOLATION=159, JOB=160, 
		JOIN=161, JSON=162, KEY=163, KEYS=164, KILL=165, LABEL=166, LAG=167, LARGEINT=168, 
		LAST=169, LAST_VALUE=170, LATERAL=171, LEAD=172, LEFT=173, LESS=174, LEVEL=175, 
		LIKE=176, LIMIT=177, LIST=178, LOAD=179, LOCAL=180, LOCATION=181, LOGICAL=182, 
		MANUAL=183, MATERIALIZED=184, MAX=185, MAXVALUE=186, MERGE=187, MIN=188, 
		MINUTE=189, MINUS=190, META=191, MOD=192, MODE=193, MODIFY=194, MONTH=195, 
		NAME=196, NAMES=197, NEGATIVE=198, NO=199, NODE=200, NODES=201, NOT=202, 
		NULL=203, NULLS=204, OBSERVER=205, OFFSET=206, ON=207, ONLY=208, OPEN=209, 
		OPTIMIZER=210, OPTION=211, OR=212, ORDER=213, OUTER=214, OUTFILE=215, 
		OVER=216, PARTITION=217, PARTITIONS=218, PASSWORD=219, PATH=220, PAUSE=221, 
		PERCENTILE=222, PERCENTILE_UNION=223, PLUGIN=224, PLUGINS=225, PRECEDING=226, 
		PRIMARY=227, PROC=228, PROCEDURE=229, PROCESSLIST=230, PROPERTIES=231, 
		PROPERTY=232, QUALIFY=233, QUARTER=234, QUERY=235, QUOTA=236, RANDOM=237, 
		RANGE=238, RANK=239, READ=240, RECOVER=241, REFRESH=242, REGEXP=243, RELEASE=244, 
		RENAME=245, REPAIR=246, REPEATABLE=247, REPLACE=248, REPLACE_IF_NOT_NULL=249, 
		REPLICA=250, REPOSITORY=251, REPOSITORIES=252, RESOURCE=253, RESOURCES=254, 
		RESTORE=255, RESUME=256, RETURNS=257, REVOKE=258, REVERT=259, RIGHT=260, 
		RLIKE=261, ROLE=262, ROLES=263, ROLLBACK=264, ROLLUP=265, ROUTINE=266, 
		ROW=267, ROWS=268, ROW_NUMBER=269, SAMPLE=270, SCHEMA=271, SCHEMAS=272, 
		SECOND=273, SELECT=274, SEMI=275, SERIALIZABLE=276, SESSION=277, SET=278, 
		SETS=279, SET_VAR=280, SIGNED=281, SHOW=282, SMALLINT=283, SNAPSHOT=284, 
		SQLBLACKLIST=285, START=286, STATS=287, STATUS=288, STOP=289, STORAGE=290, 
		STREAM=291, STRING=292, SUBMIT=293, SUM=294, SYNC=295, SYSTEM=296, SWAP=297, 
		STRUCT=298, TABLE=299, TABLES=300, TABLET=301, TASK=302, TEMPORARY=303, 
		TERMINATED=304, THAN=305, THEN=306, TIME=307, TIMESTAMP=308, TIMESTAMPADD=309, 
		TIMESTAMPDIFF=310, TINYINT=311, TRANSACTION=312, TO=313, TRACE=314, TRIGGERS=315, 
		TRUE=316, TRUNCATE=317, TYPE=318, TYPES=319, UNBOUNDED=320, UNCOMMITTED=321, 
		UNION=322, UNIQUE=323, UNINSTALL=324, UNSIGNED=325, UPDATE=326, USE=327, 
		USER=328, USING=329, VALUE=330, VALUES=331, VARCHAR=332, VARIABLES=333, 
		VERBOSE=334, VIEW=335, WARNINGS=336, WEEK=337, WHEN=338, WHERE=339, WHITELIST=340, 
		WITH=341, WORK=342, WRITE=343, YEAR=344, EQ=345, NEQ=346, LT=347, LTE=348, 
		GT=349, GTE=350, EQ_FOR_NULL=351, PLUS_SYMBOL=352, MINUS_SYMBOL=353, ASTERISK_SYMBOL=354, 
		SLASH_SYMBOL=355, PERCENT_SYMBOL=356, LOGICAL_OR=357, LOGICAL_AND=358, 
		LOGICAL_NOT=359, INT_DIV=360, BITAND=361, BITOR=362, BITXOR=363, BITNOT=364, 
		ARROW=365, AT=366, INTEGER_VALUE=367, DECIMAL_VALUE=368, DOUBLE_VALUE=369, 
		SINGLE_QUOTED_TEXT=370, DOUBLE_QUOTED_TEXT=371, LETTER_IDENTIFIER=372, 
		DIGIT_IDENTIFIER=373, QUOTED_IDENTIFIER=374, BACKQUOTED_IDENTIFIER=375, 
		SIMPLE_COMMENT=376, BRACKETED_COMMENT=377, SEMICOLON=378, DOTDOTDOT=379, 
		WS=380;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"PROCEDURE", "PROCESSLIST", "PROPERTIES", "PROPERTY", "QUALIFY", "QUARTER", 
			"QUERY", "QUOTA", "RANDOM", "RANGE", "RANK", "READ", "RECOVER", "REFRESH", 
			...
			"SUM", "SYNC", "SYSTEM", "SWAP", "STRUCT", "TABLE", "TABLES", "TABLET", 
			"TASK", "TEMPORARY", "TERMINATED", "THAN", "THEN", "TIME", "TIMESTAMP", 
			...
			"DOUBLE_VALUE", "SINGLE_QUOTED_TEXT", "DOUBLE_QUOTED_TEXT", "LETTER_IDENTIFIER", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'QUERY'", "'QUOTA'", "'RANDOM'", "'RANGE'", "'RANK'", "'READ'", "'RECOVER'", 
			"'REFRESH'", "'REGEXP'", "'RELEASE'", "'RENAME'", "'REPAIR'", "'REPEATABLE'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CROSS", "CUBE", "CURRENT", "CURRENT_TIMESTAMP", "CURRENT_USER", "DATA", 
			...
			"INT", "INCREMENTAL", "INTEGER", "INTERMEDIATE", "INTERSECT", "INTERVAL", 
			"INTO", "OVERWRITE", "IS", "ISOLATION", "JOB", "JOIN", "JSON", "KEY", 
			"KEYS", "KILL", "LABEL", "LAG", "LARGEINT", "LAST", "LAST_VALUE", "LATERAL", 
			"LEAD", "LEFT", "LESS", "LEVEL", "LIKE", "LIMIT", "LIST", "LOAD", "LOCAL", 
			"LOCATION", "LOGICAL", "MANUAL", "MATERIALIZED", "MAX", "MAXVALUE", "MERGE", 
			"MIN", "MINUTE", "MINUS", "META", "MOD", "MODE", "MODIFY", "MONTH", "NAME", 
			"NAMES", "NEGATIVE", "NO", "NODE", "NODES", "NOT", "NULL", "NULLS", "OBSERVER", 
			"OFFSET", "ON", "ONLY", "OPEN", "OPTIMIZER", "OPTION", "OR", "ORDER", 
