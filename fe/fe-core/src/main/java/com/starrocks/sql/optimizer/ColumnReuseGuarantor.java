 ...
 */
public class ColumnReuseGuarantor {

    public static void handleColumnReuse(OptExpression optExpression) {
        optExpression.getOp().accept(new Visitor(), optExpression, null);
    }

    private static final class Visitor extends OptExpressionVisitor<Void, Void> {

        public static void wrapReusedColumnRefOperator(Map<ColumnRefOperator, ScalarOperator> projectMap) {
            if (projectMap == null) {
                return;
            }
        ...
        public Void visit(OptExpression optExpression, Void context) {
            ...
            if (projection != null) {
                wrapReusedColumnRefOperator(projection.getColumnRefMap());
                wrapReusedColumnRefOperator(projection.getCommonSubOperatorMap());
            }
        ...
        public Void visitLogicalProject(OptExpression optExpression, Void context) {
            ...
            wrapReusedColumnRefOperator(op.getColumnRefMap());
