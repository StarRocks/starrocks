...
public class Group {
    ...
    private final Map<GroupExpression, Statistics> extraStatistics;
    ...
    public Group(int groupId) {
        ...
        isExplored = false;
        extraStatistics = Maps.newHashMap();
    }
    ...
    public void setGroupExpressionStatistics(GroupExpression groupExpression, Statistics statistics) {
        if (!extraStatistics.containsKey(groupExpression)) {
            extraStatistics.put(groupExpression, statistics);
        }
    }

    public Map<GroupExpression, Statistics> getGroupExpressionStatistics() {
        return extraStatistics;
    }

    public Statistics getStatisticsForGroupExpression(GroupExpression groupExpression) {
        return extraStatistics.get(groupExpression);
    }
