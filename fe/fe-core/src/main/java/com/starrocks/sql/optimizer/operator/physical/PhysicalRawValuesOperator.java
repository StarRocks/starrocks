...
public class PhysicalRawValuesOperator extends PhysicalOperator {
    ...
    public PhysicalRawValuesOperator(List<ColumnRefOperator> columnRefSet, 
                                          ...
                                          int constantCount) {
        super(OperatorType.PHYSICAL_RAW_VALUES);
    ...
    public <R, C> R accept(OperatorVisitor<R, C> visitor, C context) {
        return visitor.visitPhysicalRawValues(this, context);
    }

    @Override
    public <R, C> R accept(OptExpressionVisitor<R, C> visitor, OptExpression optExpression, C context) {
        return visitor.visitPhysicalRawValues(optExpression, context);
    }
    ...
    public String toString() {
        return String.format("PhysicalRawValues{constantType=%s, count=%d, sample=%s}",
                constantType, constantCount,
                rawConstantList.length() > 50 ? rawConstantList.substring(0, 47) + "..." : rawConstantList);
    }
}
