        ...
        for (Map.Entry<ColumnRefOperator, Column> entries : operator.getColRefToColumnMetaMap().entrySet()) {
            ...
            switch (columnName) {
                ...
                case "spec_id":
                    ...
                    agg = new CallOperator("any_value", StandardTypes.INT, Lists.newArrayList(columnRefOperator), fun);
                    break;
                case "record_count":
                ...
                case "equality_delete_file_count":
                    ...
                    agg = new CallOperator("sum", StandardTypes.BIGINT, Lists.newArrayList(columnRefOperator), fun);
                    break;
                case "last_updated_at":
                    fun = ExprUtils.getBuiltinFunction("max", argTypes, Function.CompareMode.IS_IDENTICAL);
                    agg = new CallOperator("max", StandardTypes.DATETIME, Lists.newArrayList(columnRefOperator), fun);
                    break;
                default:
