...
public class PrivilegeChecker {
    ...
    private PrivilegeChecker() {
        this.systemAccessControl = new PrivilegeActionsEPack();
        this.privilegeCheckerVisitor = new PrivilegeCheckerVisitorEPack(this.systemAccessControl);
    }
    ...
    public static void checkAnyActionOnFunction(UserIdentity currentUser, Set<Long> roleIds, long databaseId,
                                                long functionSig) {
                ...
                try {
                    ...
                    if (CatalogMgr.isInternalCatalog(catalogName)) {
                        try {
                            ...
                            try {
                                getInstance().systemAccessControl.checkAnyActionOnMaterializedView(userIdentity,
                                        roleIds,
                                        new TableName("*", "*"));
    ...
    public static void checkAnyActionOnWarehouse(UserIdentity currentUser, Set<Long> roleIds, String name) {
        ((SystemAccessControlEPack) getInstance().systemAccessControl).checkAnyActionOnWarehouse(currentUser, roleIds, name);
    }
}
