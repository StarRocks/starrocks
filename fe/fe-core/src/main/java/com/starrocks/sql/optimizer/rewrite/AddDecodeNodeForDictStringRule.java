...
public class AddDecodeNodeForDictStringRule implements PhysicalOperatorTreeRewriteRule {
    ...
    private static class DecodeVisitor extends OptExpressionVisitor<OptExpression, DecodeContext> {
        ...
        private boolean projectionNeedDecode(OptExpression optExpression, DecodeContext context,
            ...
            java.util.function.Function<Map<ColumnRefOperator, ScalarOperator>, Boolean> addAllRefs = operatorMap -> {
                ...
                for (ScalarOperator operator : operatorMap.values()) {
            ...
            if (addAllRefs.apply(projection.getColumnRefMap())) {
                return true;
            }

            if (addAllRefs.apply(projection.getCommonSubOperatorMap())) {
                return true;
            }
