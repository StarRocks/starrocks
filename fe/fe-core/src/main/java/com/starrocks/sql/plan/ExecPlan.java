...
public class ExecPlan {
    ...
    public ExecPlan() {
        ...
        aiProviderBindings = AIProviderBindings.EMPTY;
    }
    ...
    public ExecPlan(ConnectContext connectContext, List<String> colNames,
        ...
        this(connectContext, colNames, physicalPlan, outputColumns, isShortCircuit, AIProviderBindings.EMPTY);
    }
    ...
    public AIProviderBindings getAIProviderBindings() {
    ...
    Map<String, AIModelConfigs.ModelConfig> getOrCreateAIModelConfigs(Collection<Expr> expressions) {
        ...
        for (Expr expression : expressions) {
            ...
            AIModelConfigs.ModelConfig config = aiModelConfigs.computeIfAbsent(id, key -> {
                ...
                return aiProviderBindings.getRequiredConfig(name);
            });
