...
public class DeriveRangeJoinPredicateRule extends TransformationRule {
    ...
    public List<OptExpression> transform(OptExpression input, OptimizerContext context) {
        ...
        for (ColumnRefSet refs : columnToRange.keySet()) {
            ...
            ScalarOperator lower = new ConstantOperator(columnStatistic.getMinString(), StandardTypes.STRING);
            ScalarOperator upper = new ConstantOperator(columnStatistic.getMaxString(), StandardTypes.STRING);
