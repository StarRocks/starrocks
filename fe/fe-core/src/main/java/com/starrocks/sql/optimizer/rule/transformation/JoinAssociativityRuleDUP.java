 ...
 *  A     B               B      C
 * */
public class JoinAssociativityRuleDUP extends TransformationRule {
    private JoinAssociativityRuleDUP() {
    ...
    private static final JoinAssociativityRuleDUP instance = new JoinAssociativityRuleDUP();

    public static JoinAssociativityRuleDUP getInstance() {
        return instance;
    }
