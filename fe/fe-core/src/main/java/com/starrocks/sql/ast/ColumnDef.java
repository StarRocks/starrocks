    ...
    public static class DefaultValueDef {
        ...
        public DefaultValueDef(boolean isSet, boolean hasArgs, Expr expr) {
            ...
            if (expr != null) {
                ...
                this.expr = NullLiteral.create(StandardTypes.VARCHAR);
            }
        }

        private static final String ZERO = new String(new byte[] {0});
        // no default value
        public static DefaultValueDef NOT_SET = new DefaultValueDef(false, NullLiteral.create(StandardTypes.VARCHAR));
        // default null
        public static DefaultValueDef NULL_DEFAULT_VALUE = new DefaultValueDef(true, NullLiteral.create(StandardTypes.VARCHAR));
