...
public class CreateDbStmt extends DdlStmt {
    ...
    public CreateDbStmt(boolean ifNotExists, String dbName) {
        this(ifNotExists, "", dbName, Maps.newConcurrentMap(), NodePosition.ZERO);
    }
    ...
    public CreateDbStmt(boolean ifNotExists, String catalogName,
                        String dbName, Map<String, String> properties, NodePosition pos) {
        super(pos);
