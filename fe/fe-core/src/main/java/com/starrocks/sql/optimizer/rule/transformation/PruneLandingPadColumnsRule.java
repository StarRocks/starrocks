...
public class PruneLandingPadColumnsRule extends TransformationRule {

    public PruneLandingPadColumnsRule() {
        super(RuleType.TF_PRUNE_LANDING_PAD_COLUMNS, Pattern.create(OperatorType.LOGICAL_LANDING_PAD, OperatorType.PATTERN_LEAF));
    }

    @Override
    public List<OptExpression> transform(OptExpression input, OptimizerContext context) {
        LogicalLandingPadOperator landingPadOperator = (LogicalLandingPadOperator) input.getOp();
        ...
        landingPadOperator.getColumnRefMap().forEach(((columnRefOperator, operator) -> {
        ...
        return Lists.newArrayList(OptExpression.create(new LogicalLandingPadOperator(landingPadOperator.getPlan(), newMap), input.getInputs()));
    }
}
