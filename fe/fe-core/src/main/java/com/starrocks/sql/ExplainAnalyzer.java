...
public class ExplainAnalyzer {
    ...
    public static String analyze(ProfilingExecPlan plan, RuntimeProfile profile)
        ...
        List<Integer> planNodeIds = new ArrayList<>();
        ExplainAnalyzer analyzer = new ExplainAnalyzer(plan, profile, planNodeIds, false);
    ...
    private String getQueryProgress() throws StarRocksException {
        try {
