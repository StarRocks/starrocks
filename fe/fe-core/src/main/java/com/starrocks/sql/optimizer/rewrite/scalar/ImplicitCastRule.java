    ...
    public ScalarOperator visitBinaryPredicate(BinaryPredicateOperator predicate,
        ...
        if (rightChild.isVariable() && leftChild.isConstantRef()) {
            ...
            if (op.isPresent()) {
                ...
                return predicate;
            } else if ((leftChild.getType().isDateType()||leftChild.getType().isIpType()) && Type.canCastTo(leftChild.getType(), rightChild.getType())) {
            ...
            if (op.isPresent()) {
                ...
                return predicate;
            } else if ((leftChild.getType().isDateType()||leftChild.getType().isIpType()) && Type.canCastTo(rightChild.getType(), leftChild.getType())) {
                // For like MySQL, convert to date type as much as possible
