...
public class DeletePlanner {
    ...
    public ExecPlan plan(DeleteStmt deleteStatement, ConnectContext session) {
        return plan(deleteStatement, session, AIProviderBindings.EMPTY);
    }

    public ExecPlan plan(DeleteStmt deleteStatement, ConnectContext session, AIProviderBindings aiProviderBindings) {
        ...
        return planDelete(deleteStatement, session, aiProviderBindings);
    }

    /**
     * Main method to plan delete operations for different table types
     */
    private ExecPlan planDelete(DeleteStmt deleteStatement, ConnectContext session, AIProviderBindings aiProviderBindings) {
    ...
    private ExecPlan createDeletePlan(
            ...
            List<String> colNames,
                                      com.starrocks.catalog.Table table, AIProviderBindings aiProviderBindings) {
        ...
        try {
            ...
            ExecPlan execPlan = PlanFragmentBuilder.createPhysicalPlan(optimizedPlan, session,
                    ...
                    colNames, TResultSinkType.MYSQL_PROTOCAL, false, false, aiProviderBindings);
