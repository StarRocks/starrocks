...
public enum RuleType {
    ...
    TF_CHANGES_PARTITION_PRUNE,
    TF_CHANGES_DISTRIBUTION_PRUNE,
    ...
    TF_PUSH_DOWN_PREDICATE_AI_PROJECT,
    ...
    TF_PUSH_DOWN_AGG_TO_JDBC_SCAN,
    TF_PUSH_DOWN_PROJECT_TO_JDBC_SCAN,
    TF_PUSH_DOWN_TOPN_TO_JDBC_SCAN,
    ...
    TF_IVM_DELTA_OLAP_SCAN,
    TF_IVM_DELTA_FILTER,
    TF_IVM_DELTA_PROJECT,
    TF_IVM_DELTA_JOIN,
    TF_IVM_DELTA_AGGREGATE,
    TF_IVM_DELTA_RETRACTABLE_AGGREGATE,
    TF_IVM_DELTA_UNION,
    TF_IVM_VERSION_ICEBERG_SCAN,
    TF_IVM_VERSION_OLAP_SCAN,
