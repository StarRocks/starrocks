...
public class DelComputeNodeBlackListStmt extends StatementBase {
    private final List<Long> computeNodeIds;

    public DelComputeNodeBlackListStmt(NodePosition pos, List<Long> computeNodeIds) {
        super(pos);
