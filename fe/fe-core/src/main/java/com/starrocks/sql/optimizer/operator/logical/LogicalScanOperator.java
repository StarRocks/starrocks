...
public abstract class LogicalScanOperator extends LogicalOperator {
    ...
    public LogicalScanOperator(
        ...
        ImmutableMap.Builder<Column, ColumnRefOperator> builder = ImmutableMap.builder();
        for (Map.Entry<ColumnRefOperator, Column> entry : colRefToColumnMetaMap.entrySet()) {
            builder.put(entry.getValue(), entry.getKey());
        }
        this.columnMetaToColRefMap = builder.build();
    ...
    public String toString() {
        return "LogicalScanOperator" + " {" +
                "table='" + table.getId() + '\'' +
                ", outputColumns='" + columnMetaToColRefMap.keySet() + '\'' +
                '}';
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), table.getId(), outputColumns, colRefToColumnMetaMap);
    }
}
