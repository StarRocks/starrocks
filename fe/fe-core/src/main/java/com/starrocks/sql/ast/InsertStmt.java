...
public class InsertStmt extends DmlStmt {
    ...
    private PartitionRef targetPartitionRef;
    ...
    // set by InsertAnalyzer after validating the "enable_push_down_schema" INSERT property.
    ...
    public InsertStmt(TableRef tableRef, PartitionRef targetPartitionNames, String label, List<String> cols,
        ...
        this.targetPartitionRef = targetPartitionNames;
        this.label = label;
    ...
    public InsertStmt(TableRef tableRef, QueryStatement queryStatement) {
    ...
    public InsertStmt(Map<String, String> tableFunctionProperties, QueryStatement queryStatement, NodePosition pos) {
        super(pos);
        this.tableRef = new TableRef(QualifiedName.of(Lists.newArrayList("table_function_catalog",
                "table_function_db", "table_function_table")), null, pos);
        this.targetColumnNames = null;
        this.targetPartitionRef = null;
        this.queryStatement = queryStatement;
    ...
    public InsertStmt(QueryStatement queryStatement, NodePosition pos) {
        super(pos);
        this.tableRef = new TableRef(QualifiedName.of(Lists.newArrayList("black_hole_catalog",
                "black_hole_db", "black_hole_table")), null, pos);
        this.targetColumnNames = null;
        this.targetPartitionRef = null;
        this.queryStatement = queryStatement;
        this.tableFunctionAsTargetTable = false;
    ...
    public void setEnablePushDownSchema(boolean enablePushDownSchema) {
        this.enablePushDownSchema = enablePushDownSchema;
    }
    ...
    public PartitionRef getTargetPartitionNames() {
        return targetPartitionRef;
    }

    public boolean isSpecifyPartitionNames() {
        return targetPartitionRef != null && !targetPartitionRef.isKeyPartitionNames();
    }
    ...
    public void setTargetPartitionNames(PartitionRef targetPartitionNames) {
        this.targetPartitionRef = targetPartitionNames;
    }
