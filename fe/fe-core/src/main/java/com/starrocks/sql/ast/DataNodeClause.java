...
public class DataNodeClause extends AlterClause {
    protected List<String> hostPorts;

    protected List<Pair<String, Integer>> hostPortPairs;

    protected DataNodeClause(List<String> hostPorts, NodePosition pos) {
    ...
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
        return visitor.visitDataNodeClause(this, context);
    }
}
