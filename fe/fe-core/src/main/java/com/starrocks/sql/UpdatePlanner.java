...
public class UpdatePlanner {
    ...
    public ExecPlan plan(UpdateStmt updateStmt, ConnectContext session) {
        return plan(updateStmt, session, AIProviderBindings.EMPTY);
    }

    public ExecPlan plan(UpdateStmt updateStmt, ConnectContext session, AIProviderBindings aiProviderBindings) {
        ...
        return createUpdatePlan(updateStmt, session, optExprBuilder.getRoot(), columnRefFactory,
                outputColumns, colNames, targetTable, requiredProperty, aiProviderBindings);
    }
    ...
    private ExecPlan createUpdatePlan(UpdateStmt updateStmt, ConnectContext session,
        ...
        try {
            ...
            ExecPlan execPlan = PlanFragmentBuilder.createPhysicalPlan(optimizedPlan, session,
                    outputColumns, columnRefFactory, colNames, TResultSinkType.MYSQL_PROTOCAL, false, false, aiProviderBindings);
