...
public class CancelExternalCooldownAnalyzer {

    public static void analyzeCancelExternalCooldownStmt(
            CancelExternalCooldownStmt cancelExternalCooldownStmt, ConnectContext session) {
