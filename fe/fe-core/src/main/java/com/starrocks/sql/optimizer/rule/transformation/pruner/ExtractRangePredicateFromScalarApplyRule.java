...
public class ExtractRangePredicateFromScalarApplyRule extends TransformationRule {
    ...
    public List<OptExpression> transform(OptExpression input, OptimizerContext context) {
        ...
        Function fn =
                ExprUtils.getBuiltinFunction(FunctionSet.HOURS_ADD, new Type[] {DateType.DATETIME, IntegerType.INT},
                        Function.CompareMode.IS_IDENTICAL);
        ScalarOperator prevDay = new CallOperator(FunctionSet.HOURS_ADD, DateType.DATETIME,
                List.of(constOp, ConstantOperator.createInt(-26)), fn);
        ScalarOperator nextDay = new CallOperator(FunctionSet.HOURS_ADD, DateType.DATETIME,
                List.of(constOp, ConstantOperator.createInt(26)), fn);
