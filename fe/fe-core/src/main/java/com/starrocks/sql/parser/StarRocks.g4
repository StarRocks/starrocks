...
temporalClause
    ...
    | FOR SYSTEM_TIME ALL
    | VERSION AS OF version=(INTEGER_VALUE | SINGLE_QUOTED_TEXT | DOUBLE_QUOTED_TEXT)
    | TIMESTAMP AS OF timestamp=(SINGLE_QUOTED_TEXT | DOUBLE_QUOTED_TEXT)
    ;
...
nonReserved
    ...
    | TRIGGERS | VERSION | TRUNCATE | TYPE | TYPES
