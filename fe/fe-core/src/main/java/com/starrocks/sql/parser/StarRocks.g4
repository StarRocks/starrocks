...
nonReserved
    : ACTIVE | AFTER | ARRAY_AGG| AGGREGATE | ASYNC | AUTHORS | AVG | ADMIN
    ...
    | RESOURCE | RESOURCES | RESTORE | RESUME | RETURNS | REVERT | REWRITE | ROLE | ROLES | ROLLUP | ROLLBACK | ROUTINE
    | SAMPLE | SCHEDULER | SECOND | SEPARATOR | SERIALIZABLE | SESSION | SETS | SIGNED | SNAPSHOT | SQLBLACKLIST | START | SUM | STATUS | STOP
