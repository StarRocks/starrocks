...
alterMaterializedViewStatement
    : ALTER MATERIALIZED VIEW mvName=qualifiedName (
        ...
        swapTableClause )
    | ALTER MATERIALIZED VIEW mvName=qualifiedName statusDesc (WITH RETAIN_VERSION_MAP)?
    ;
...
nonReserved
    ...
    | NAME | NAMES | NEGATIVE | NO | NODE | NODES | NONE | NULLS | NUMBER | NUMERIC | RETAIN_VERSION_MAP
