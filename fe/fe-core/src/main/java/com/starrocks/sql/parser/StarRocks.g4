...
privilegeType
    ...
    | CREATE (
        ...
        | MASKING POLICY | ROW ACCESS POLICY | STORAGE VOLUME | WAREHOUSE | FAILOVER GROUP | PIPE )
...
nonReserved
    ...
    | MASKING | MANUAL | MAP | MAPPING | MAPPINGS | MATCH | MATERIALIZED | MAX | MEMBER | MEMBERS | META | MIN | MINUTE | MINUTES | MODE | MODIFY | MONTH | MERGE | MINUS | MULTI_COLUMNS
