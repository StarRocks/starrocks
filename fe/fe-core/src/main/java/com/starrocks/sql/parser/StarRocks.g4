...
privilegeType
    ...
    | CREATE (
        ...
        | MASKING POLICY | ROW ACCESS POLICY | STORAGE VOLUME | WAREHOUSE | PIPE )
...
privObjectType
    : CATALOG | DATABASE | MATERIALIZED VIEW | MASKING POLICY | ROW ACCESS POLICY | RESOURCE | RESOURCE GROUP
        | STORAGE VOLUME | SYSTEM | TABLE| VIEW | WAREHOUSE | PIPE
    ;
...
nonReserved
    ...
    | MASKING | MANUAL | MAP | MAPPING | MAPPINGS | MATCH | MATERIALIZED | MAX | MEMBER | MEMBERS | META | MIN | MINUTE | MINUTES | MODE | MODIFY | MONTH | MERGE | MINUS
