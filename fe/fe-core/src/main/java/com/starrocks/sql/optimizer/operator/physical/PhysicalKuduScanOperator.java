...
public class PhysicalKuduScanOperator extends PhysicalScanOperator {
    private ScanOperatorPredicates predicates;

    public PhysicalKuduScanOperator(LogicalKuduScanOperator scan) {
        super(OperatorType.PHYSICAL_KUDU_SCAN, scan);
    ...
    public <R, C> R accept(OperatorVisitor<R, C> visitor, C context) {
        return visitor.visitPhysicalKuduScan(this, context);
    }

    @Override
    public <R, C> R accept(OptExpressionVisitor<R, C> visitor, OptExpression optExpression, C context) {
        return visitor.visitPhysicalKuduScan(optExpression, context);
    }
