...
public interface ConnectorMetadata {
    ...
    /**
     * 1. Get the remote file information from hdfs or s3 for hive/hudi/deltalake/file table
     * 2. Get file scan task for iceberg metadata
     * @param table
     * @param partitionKeys selected columns
     * @param snapshotId selected snapshot id
     * @param predicate to filter metadata
