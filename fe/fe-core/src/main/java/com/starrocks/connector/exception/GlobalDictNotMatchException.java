...
public class GlobalDictNotMatchException extends RuntimeException {
    ...
    public GlobalDictNotMatchException(String formatString, Object... args) {
        super(format(formatString, args));
    }

    public GlobalDictNotMatchException(String message, Throwable cause) {
        super(message, cause);
    }
