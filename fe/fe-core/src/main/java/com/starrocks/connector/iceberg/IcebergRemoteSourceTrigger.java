    ...
    public synchronized void trigger() {
        ...
        if (eqDeleteFiles.isEmpty()) {
            ...
            if (!needToCheckEqualityIds) {
                ...
                // but a data file may correspanding to many eq delete files. and these eq delete files may not have the same
                // equality ids, we should fill in all the correspongding queue.
