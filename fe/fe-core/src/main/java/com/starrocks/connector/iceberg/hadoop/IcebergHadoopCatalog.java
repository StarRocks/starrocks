...
public class IcebergHadoopCatalog implements IcebergCatalog {
    ...
    public IcebergHadoopCatalog(String name, Configuration conf, Map<String, String> properties) {
        ...
        // A hadoop catalog is a directory tree: loading it opens the warehouse file system, and every
        // method below is a listing or a metadata.json read against it.
        BlockingCallValidator.validateNotUnderLock(IcebergCatalogType.HADOOP_CATALOG.transportTag(), name);
