...
public class IcebergMetaSplit implements RemoteMetaSplit {
    public static final String PLACE_HOLDER_FILE = "place_holder_file";
    public static final long PLACE_HOLDER_FILE_LENGTH = 1L;
    public static final String PLACE_HOLDER_FILE_PATH = "place_holder_file_path";
    ...
    public static IcebergMetaSplit placeholderSplit() {
        return new IcebergMetaSplit(PLACE_HOLDER_FILE, PLACE_HOLDER_FILE_LENGTH, PLACE_HOLDER_FILE_PATH);
    }

    public static boolean onlySingleSplit(MetadataTableType tableType) {
