...
public class ConnectorFactory {
    ...
    public static CatalogConnector createConnector(ConnectorContext context) throws StarRocksConnectorException {
        ...
        try {
            ...
            TableMetaConnector metaConnector = new TableMetaConnector(context.getCatalogName());
            return new CatalogConnector(connector, informationSchemaConnector, metaConnector);
