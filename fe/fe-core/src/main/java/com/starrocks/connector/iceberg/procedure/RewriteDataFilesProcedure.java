...
public class RewriteDataFilesProcedure extends IcebergTableProcedure {
    ...
    private RewriteDataFilesProcedure() {
        super(
                PROCEDURE_NAME,
                Arrays.asList(
                        new NamedArgument(REWRITE_ALL, StandardTypes.BOOLEAN, false),
                        new NamedArgument(MIN_FILE_SIZE_BYTES, StandardTypes.BIGINT, false),
                        new NamedArgument(BATCH_SIZE, StandardTypes.BIGINT, false),
                        new NamedArgument(BATCH_PARALLELISM, StandardTypes.BIGINT, false)
                ),
