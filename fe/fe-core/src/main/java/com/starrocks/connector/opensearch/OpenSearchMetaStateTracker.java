...
/**
 * It is responsible for this class to schedule all network request sent to remote OpenSearch Cluster
 * Request sequence
 * 1. GET /
 ...
 */
public class OpenSearchMetaStateTracker {

    private List<SearchPhase> builtinSearchPhase = new LinkedList<>();
    private SearchContext searchContext;

    public OpenSearchMetaStateTracker(OpenSearchRestClient client, EsTable esTable) {
