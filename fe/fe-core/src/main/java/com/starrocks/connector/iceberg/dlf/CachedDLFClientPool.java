...
package com.starrocks.connector.iceberg.dlf;
...
public class CachedDLFClientPool implements ClientPool<IMetaStoreClient, TException> {
    ...
    public CachedDLFClientPool(Configuration conf, Map<String, String> properties) {
        this.conf = conf;
    ...
    DLFClientPool clientPool() {
        return clientPoolCache.get(metastoreUri, k -> new DLFClientPool(clientPoolSize, conf));
    }
