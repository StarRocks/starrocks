...
public class IcebergFileBasedStatisticProvider implements IcebergStatisticProvider {
    private static final Logger LOG = LogManager.getLogger(IcebergFileBasedStatisticProvider.class);
    public IcebergFileBasedStatisticProvider() {
    }
