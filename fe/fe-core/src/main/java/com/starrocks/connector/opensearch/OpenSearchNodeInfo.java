 ...
 */
public class OpenSearchNodeInfo {
    ...
    public OpenSearchNodeInfo(String id, Map<String, Object> map) throws StarRocksConnectorException {
        this.id = id;
    ...
    public OpenSearchNodeInfo(String id, String seed) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        OpenSearchNodeInfo nodeInfo = (OpenSearchNodeInfo) o;
