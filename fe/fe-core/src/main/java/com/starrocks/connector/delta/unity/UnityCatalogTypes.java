...
public final class UnityCatalogTypes {
    ...
    /**
     * Subset of the response from {@code GET /api/2.1/unity-catalog/metastore_summary}. The full
     * payload carries the metastore name, default catalog, owner, etc.; only the {@code region}
     * field is consumed by StarRocks (to stamp on AWS-vended credentials).
     */
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class MetastoreSummary {
        @JsonProperty("region")
