...
// This class represents the information that needs to be persisted for each external table.
public class ConnectorTableInfo {
    ...
    public void addPersistentInfo(ConnectorTableInfo tableInfo) {
    ...
    public void removePersistentInfo(ConnectorTableInfo tableInfo) {
    ...
    public Set<MvId> getRelatedMaterializedViews() {
        return this.relatedMaterializedViews;
    }
