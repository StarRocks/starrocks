...
public class IcebergStatisticsProvider {
    private static final Logger LOG = LogManager.getLogger(IcebergStatisticsProvider.class);

    public IcebergStatisticsProvider() {
    }
    ...
    public Statistics getTableStatistics(IcebergTable icebergTable, ScalarOperator predicate,
        ...
        Table nativeTable = icebergTable.getIcebergTable();
    ...
    private IcebergFileStats generateIcebergFileStats(IcebergTable icebergTable, ScalarOperator icebergPredicate) {
        Optional<Snapshot> snapshot = Optional.ofNullable(icebergTable.getIcebergTable().currentSnapshot());
