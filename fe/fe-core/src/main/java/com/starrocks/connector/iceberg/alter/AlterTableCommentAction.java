...
public class AlterTableCommentAction implements AlterTableAction {

    @Override
    public void execute(Transaction transaction, AlterClause clause) {
        Preconditions.checkArgument(clause instanceof AlterTableCommentClause, "alter clause instance is not correct.");
