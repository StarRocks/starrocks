...
public class ColumnRenameAction implements AlterTableAction {

    @Override
    public void execute(Transaction transaction, AlterClause clause) {

        UpdateSchema updateSchema = transaction.updateSchema();
        Preconditions.checkArgument(clause instanceof ColumnRenameClause, "alter clause instance is not correct.");
