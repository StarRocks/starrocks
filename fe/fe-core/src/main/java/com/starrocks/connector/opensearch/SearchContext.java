...
public class SearchContext {
    ...
    public void version(OpenSearchMajorVersion version) {
        this.version = version;
    }

    public OpenSearchMajorVersion version() {
        return version;
    }

    public void partitions(OpenSearchShardPartitions shardPartitions) {
        this.shardPartitions = shardPartitions;
    }

    public OpenSearchShardPartitions partitions() {
        return shardPartitions;
    }

    // this will be refactor soon
    public OpenSearchTablePartitions tablePartitions() throws Exception {
        return OpenSearchTablePartitions.fromShardPartitions(table, shardPartitions);
    }
