...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/rpc/DataNodeServiceProxy.java
...
public class DataNodeServiceClient {
    ...
    public Future<PExecPlanFragmentResult> execPlanFragmentAsync(
        ...
        try {
            final PDataNodeService service = BrpcProxy.getDataNodeService(address);
    ...
    public Future<PFetchDataResult> fetchDataAsync(TNetworkAddress address, PFetchDataRequest request) throws RpcException {
        try {
            PDataNodeService service = BrpcProxy.getDataNodeService(address);
