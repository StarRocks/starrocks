...
public interface PDataNodeService {
    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "exec_plan_fragment",
    ...
    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "exec_batch_plan_fragments",
            attachmentHandler = ThriftClientAttachmentHandler.class, onceTalkTimeout = 60000)
    Future<PExecBatchPlanFragmentsResult> execBatchPlanFragmentsAsync(PExecBatchPlanFragmentsRequest request);

    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "cancel_plan_fragment",
    ...
    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "fetch_data",
    ...
    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "trigger_profile_report",
    ...
    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "collect_query_statistics",
            attachmentHandler = ThriftClientAttachmentHandler.class, onceTalkTimeout = 10000)
    Future<PCollectQueryStatisticsResult> collectQueryStatistics(PCollectQueryStatisticsRequest request);

    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "get_info", onceTalkTimeout = 10000)
    Future<PProxyResult> getInfo(PProxyRequest request);

    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "get_pulsar_info", onceTalkTimeout = 10000)
    Future<PPulsarProxyResult> getPulsarInfo(PPulsarProxyRequest request);

    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "submit_mv_maintenance_task", onceTalkTimeout = 60000,
    ...
    @ProtobufRPC(serviceName = "PDataNodeService", methodName = "execute_command", onceTalkTimeout = 60000,
            attachmentHandler = ThriftClientAttachmentHandler.class)
