...
public class Checkpoint extends MasterDaemon {
    ...
    protected void runAfterCatalogReady() {
        ...
        catalog = GlobalStateMgr.getCurrentState();
        ...
        List<Frontend> allFrontends = GlobalStateMgr.getServingCatalog().getNodeMgr().getFrontends(null);
        int successPushed = 0;
        ...
        if (!allFrontends.isEmpty()) {
            ...
            for (Frontend fe : allFrontends) {
                ...
                if (host.equals(GlobalStateMgr.getServingCatalog().getNodeMgr().getMasterIp())) {
                    // skip master itself
                    continue;
                }
