...
public class TabletInvertedIndex implements MemoryTrackable {
    ...
    public void addReplica(long tabletId, Replica replica) {
        ...
        CopyOnWriteArrayList<Replica> replicas = tabletToReplicaList.computeIfAbsent(tabletId, k -> new CopyOnWriteArrayList<>());
        replicas.add(replica);

        Set<Long> tabletIds = backendToTabletIdList.computeIfAbsent(replica.getBackendId(), k -> ConcurrentHashMap.newKeySet());
