...
public class SystemId {
    ...
    public static final long FE_THREADS_ID = 43L;

    public static final long TEMP_TABLES_ID = 44L;

    public static final long KEYWORDS_ID = 45L;

    public static final long APPLICABLE_ROLES_ID = 46L;
