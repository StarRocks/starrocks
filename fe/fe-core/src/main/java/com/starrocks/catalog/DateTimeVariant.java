...
public class DateTimeVariant extends Variant {
    ...
    public DateTimeVariant(Type type, String value) {
        this(type, DateUtils.parseStrictDateTime(value).toInstant(ZoneOffset.UTC));
    }

    public DateTimeVariant(Type type, Instant value) {
        super(type);
    ...
    public int compareTo(Variant other) {
        Preconditions.checkArgument(other instanceof DateTimeVariant, other);
        DateTimeVariant otherDateTime = (DateTimeVariant) other;
    ...
    public boolean equals(Object object) {
        ...
        if (object == null || !(object instanceof DateTimeVariant)) {
            return false;
        }
        DateTimeVariant other = (DateTimeVariant) object;
