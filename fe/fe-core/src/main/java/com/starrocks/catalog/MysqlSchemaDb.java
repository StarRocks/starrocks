...
public class MysqlSchemaDb extends Database {
    public static final String DATABASE_NAME = "mysql";

    public MysqlSchemaDb() {
        super(SystemId.MYSQL_SCHEMA_DB_ID, DATABASE_NAME);
        initTables();
    }
    ...
    private void initTables() {
        for (Table table : SchemaTable.MYSQL_TABLE_MAP.values()) {
