...
public class PaimonTable extends Table {
    ...
    public boolean isDataEvolutionEnabled() {
        return paimonNativeTable instanceof DataTable
                && ((DataTable) paimonNativeTable).coreOptions().dataEvolutionEnabled();
    }
    ...
    public TTableDescriptor toThrift(List<DescriptorTable.ReferencedPartitionInfo> partitions) {
        ...
        tPaimonTable.setPaimon_data_evolution_enabled(isDataEvolutionEnabled());
        ...
        if (paimonNativeTable instanceof FileStoreTable) {
            ...
            tPaimonTable.setPaimon_branch(fileStoreTable.options()
                    .getOrDefault(CoreOptions.BRANCH.key(), CoreOptions.BRANCH.defaultValue()));
            try {
