    ...
    public static SystemTable create() {
        return new SystemTable(SystemId.PARTITIONS_META_ID,
                ...
                builder()
                        ...
                        .column("VERSION_TXN_TYPE", TypeFactory.createVarcharType(NAME_CHAR_LEN))
                        ...
                        .column("PARTITION_VALUE", TypeFactory.createVarcharType(NAME_CHAR_LEN))
                        .column("DISTRIBUTION_KEY", TypeFactory.createVarcharType(NAME_CHAR_LEN))
                        .column("BUCKETS", IntegerType.INT)
                        .column("REPLICATION_NUM", IntegerType.INT)
                        .column("STORAGE_MEDIUM", TypeFactory.createVarcharType(NAME_CHAR_LEN))
