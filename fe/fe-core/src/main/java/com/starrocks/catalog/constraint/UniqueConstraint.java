...
public class UniqueConstraint extends Constraint {
    ...
    public List<String> getUniqueColumnNames(Table selfTable) {
        Table targetTable;
        // Catalog/db both null is a self-reference auto-generated by
        // OlapTable.getUniqueConstraints for PK/UK tables — resolve against selfTable.
        if (selfTable.isMaterializedView() && catalogName != null && dbName != null) {
