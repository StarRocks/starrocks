...
//    public static final String COUNT_SLOTH = "count_sloth";
...
//            addBuiltin(AggregateFunction.createBuiltin(FunctionSet.COUNT_SLOTH,
//                    Lists.newArrayList(t), Type.BOOLEAN, Type.BIGINT, false, true, true));
