...
public class FunctionSet {
    ...
    public static final String JSON_QUERY_MANY_FROM_STRING = "json_query_many_from_string";
    public static final String JSON_QUERY_FROM_STRING = "json_query_from_string";
