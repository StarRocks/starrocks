...
public class FunctionSet {
    ...
    private void initAggregateBuiltins() {
        ...
        // VarcharType.VARCHAR must before all other type, so bitmap_agg(varchar) can convert to bitmap_agg(bigint)
        ...
        // DateType.DATE must before Type.DATATIME, because DATE could be considered as DATETIME.
