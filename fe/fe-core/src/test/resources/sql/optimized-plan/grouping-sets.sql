...
[result]
AGGREGATE ([GLOBAL] aggregate [{4: count=multi_distinct_count(4: count), 5: count=multi_distinct_count(5: count)}] group by [[]] having [null]
    EXCHANGE GATHER
        AGGREGATE ([LOCAL] aggregate [{4: count=multi_distinct_count(1: v1), 5: count=multi_distinct_count(2: v2)}] group by [[]] having [null]
            SCAN (columns[1: v1, 2: v2] predicate[null])
[end]
...
[result]
AGGREGATE ([GLOBAL] aggregate [{4: count=multi_distinct_count(4: count), 6: sum=multi_distinct_sum(6: sum), 7: multi_distinct_count=multi_distinct_count(7: multi_distinct_count), 8: multi_distinct_sum=multi_distinct_sum(8: multi_distinct_sum)}] group by [[]] having [null]
    EXCHANGE GATHER
        AGGREGATE ([LOCAL] aggregate [{4: count=multi_distinct_count(1: v1), 6: sum=multi_distinct_sum(3: v3), 7: multi_distinct_count=multi_distinct_count(2: v2), 8: multi_distinct_sum=multi_distinct_sum(2: v2)}] group by [[]] having [null]
...
[result]
AGGREGATE ([GLOBAL] aggregate [{4: count=multi_distinct_count(4: count), 5: count=multi_distinct_count(5: count), 7: sum=multi_distinct_sum(7: sum), 11: multi_distinct_sum=multi_distinct_sum(11: multi_distinct_sum)}] group by [[]] having [null]
    EXCHANGE GATHER
        AGGREGATE ([LOCAL] aggregate [{4: count=multi_distinct_count(1: v1), 5: count=multi_distinct_count(2: v2), 7: sum=multi_distinct_sum(3: v3), 11: multi_distinct_sum=multi_distinct_sum(2: v2)}] group by [[]] having [null]
            SCAN (columns[1: v1, 2: v2, 3: v3] predicate[null])
[end]
...
[result]
AGGREGATE ([GLOBAL] aggregate [{4: count=multi_distinct_count(4: count), 5: count=multi_distinct_count(5: count)}] group by [[3: v3]] having [null]
    EXCHANGE SHUFFLE[3]
        AGGREGATE ([LOCAL] aggregate [{4: count=multi_distinct_count(1: v1), 5: count=multi_distinct_count(2: v2)}] group by [[3: v3]] having [null]
            SCAN (columns[1: v1, 2: v2, 3: v3] predicate[null])
[end]
...
TOP-N (order by [[6: sum ASC NULLS FIRST]])
    TOP-N (order by [[6: sum ASC NULLS FIRST]])
        AGGREGATE ([GLOBAL] aggregate [{4: count=multi_distinct_count(4: count), 6: sum=multi_distinct_sum(6: sum), 7: multi_distinct_count=multi_distinct_count(7: multi_distinct_count), 8: multi_distinct_sum=multi_distinct_sum(8: multi_distinct_sum)}] group by [[]] having [divide(cast(8: multi_distinct_sum as double), cast(7: multi_distinct_count as double)) > 0.0]
            EXCHANGE GATHER
                AGGREGATE ([LOCAL] aggregate [{4: count=multi_distinct_count(1: v1), 6: sum=multi_distinct_sum(2: v2), 7: multi_distinct_count=multi_distinct_count(3: v3), 8: multi_distinct_sum=multi_distinct_sum(3: v3)}] group by [[]] having [null]
                    SCAN (columns[1: v1, 2: v2, 3: v3] predicate[null])
[end]
...
[result]
AGGREGATE ([GLOBAL] aggregate [{4: count=multi_distinct_count(4: count), 6: sum=multi_distinct_sum(6: sum)}] group by [[]] having [null]
    EXCHANGE GATHER
        AGGREGATE ([LOCAL] aggregate [{4: count=multi_distinct_count(1: v1), 6: sum=multi_distinct_sum(1: v1)}] group by [[]] having [null]
            SCAN (columns[1: v1] predicate[null])
[end]
