...
[result]
AGGREGATE ([GLOBAL] aggregate [{}] group by [[4: expr, 5: expr, 6: GROUPING_ID]] having [null]
    EXCHANGE SHUFFLE[4, 5, 6]
        AGGREGATE ([LOCAL] aggregate [{}] group by [[4: expr, 5: expr, 6: GROUPING_ID]] having [null]
            REPEAT [[], [4: expr], [4: expr, 5: expr]]
                UNION
                    VALUES (1)
                    VALUES (2)
[end]
