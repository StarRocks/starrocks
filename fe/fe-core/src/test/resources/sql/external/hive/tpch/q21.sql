...
|    |  equal join conjunct: [8: l_orderkey, INT, true] = [54: l_orderkey, INT, true]
...
|    |  cardinality: 12000746
|    |  column statistics:
|    |  * s_name-->[-Infinity, Infinity, 0.0, 25.0, 40000.0] ESTIMATE
|    |  * l_orderkey-->[1.0, 6.0E8, 0.0, 8.0, 1.2000746039241958E7] ESTIMATE
|    |  * l_suppkey-->[1.0, 1000000.0, 0.0, 4.0, 40000.0] ESTIMATE
|    |
|    17:HASH JOIN
|    |  join op: LEFT SEMI JOIN (PARTITIONED)
|    |  equal join conjunct: [8: l_orderkey, INT, true] = [37: l_orderkey, INT, true]
