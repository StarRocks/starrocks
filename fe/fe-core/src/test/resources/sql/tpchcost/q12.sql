...
TABLE: lineitem
PREAGGREGATION: ON
PREDICATES: 23: L_RECEIPTDATE < '1998-01-01', 23: L_RECEIPTDATE >= '1997-01-01', 25: L_SHIPMODE IN ('REG AIR', 'MAIL'), 22: L_COMMITDATE < 23: L_RECEIPTDATE, 21: L_SHIPDATE < 22: L_COMMITDATE
partitions=1/1
rollup: lineitem
tabletRatio=20/20
