...
* S_NAME-->[-Infinity, Infinity, 0.0, 25.0, 10000.0] ESTIMATE
* S_ADDRESS-->[-Infinity, Infinity, 0.0, 40.0, 10000.0] ESTIMATE
* PS_SUPPKEY-->[1.0, 10000.0, 0.0, 8.0, 10000.0] ESTIMATE
...
|  cardinality: 15611881188
|  column statistics:
|  * PS_PARTKEY-->[1.0, 200000.0, 0.0, 8.0, 200000.0] ESTIMATE
|  * PS_SUPPKEY-->[1.0, 10000.0, 0.0, 8.0, 10000.0] ESTIMATE
|  * PS_AVAILQTY-->[1.0, 9999.0, 0.0, 4.0, 9999.0] ESTIMATE
|  * L_PARTKEY-->[1.0, 200000.0, 0.0, 8.0, 200000.0] ESTIMATE
...
|  * PS_SUPPKEY-->[1.0, 10000.0, 0.0, 8.0, 10000.0] ESTIMATE
|  * PS_AVAILQTY-->[1.0, 9999.0, 0.0, 4.0, 9999.0] ESTIMATE
|  * P_PARTKEY-->[1.0, 200000.0, 0.0, 8.0, 200000.0] ESTIMATE
|
|----8:EXCHANGE
|       cardinality: 5000000
|
...
column statistics:
* P_PARTKEY-->[1.0, 200000.0, 0.0, 8.0, 200000.0] ESTIMATE
* P_NAME-->[-Infinity, Infinity, 0.0, 55.0, 199997.0] ESTIMATE
