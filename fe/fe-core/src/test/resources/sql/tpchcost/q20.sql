...
|  equal join conjunct: [1: S_SUPPKEY, INT, false] = [15: PS_SUPPKEY, INT, false]
|  build runtime filters:
|  - filter_id = 4, build_expr = (15: PS_SUPPKEY), remote = false
|  output columns: 2, 3
|  cardinality: 40000
|  column statistics:
|  * S_SUPPKEY-->[1.0, 1000000.0, 0.0, 4.0, 40000.0] ESTIMATE
...
|  build runtime filters:
|  - filter_id = 0, build_expr = (9: N_NATIONKEY), remote = false
...
- filter_id = 4, probe_expr = (1: S_SUPPKEY)
column statistics:
...
OutPut Partition: BUCKET_SHUFFLE_HASH_PARTITIONED: 15: PS_SUPPKEY
...
|  build runtime filters:
|  - filter_id = 2, build_expr = (14: PS_PARTKEY), remote = true
|  - filter_id = 3, build_expr = (15: PS_SUPPKEY), remote = false
|  output columns: 15
|  cardinality: 39029703
|  column statistics:
...
cardinality: 86732673
probe runtime filters:
- filter_id = 2, probe_expr = (32: L_PARTKEY)
- filter_id = 3, probe_expr = (33: L_SUPPKEY)
...
|  build runtime filters:
|  - filter_id = 1, build_expr = (20: P_PARTKEY), remote = false
...
probe runtime filters:
- filter_id = 1, probe_expr = (14: PS_PARTKEY)
column statistics:
