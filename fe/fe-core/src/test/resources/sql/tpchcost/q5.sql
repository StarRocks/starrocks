...
|  column statistics:
|  * L_ORDERKEY-->[1.0, 6000000.0, 0.0, 8.0, 1500000.0] ESTIMATE
|  * L_SUPPKEY-->[1.0, 10000.0, 0.0, 4.0, 10000.0] ESTIMATE
|  * L_EXTENDEDPRICE-->[901.0, 104949.5, 0.0, 8.0, 932377.0] ESTIMATE
|  * L_DISCOUNT-->[0.0, 0.1, 0.0, 8.0, 11.0] ESTIMATE
|  * S_SUPPKEY-->[1.0, 10000.0, 0.0, 4.0, 10000.0] ESTIMATE
|  * S_NATIONKEY-->[0.0, 24.0, 0.0, 4.0, 5.0] ESTIMATE
|  * N_NAME-->[-Infinity, Infinity, 0.0, 25.0, 5.0] ESTIMATE
|
|----11:EXCHANGE
...
|  cardinality: 2276507277
|  column statistics:
|  * C_CUSTKEY-->[1.0, 149999.0, 0.0, 8.0, 99996.0] ESTIMATE
|  * C_NATIONKEY-->[0.0, 24.0, 0.0, 4.0, 25.0] ESTIMATE
|  * O_ORDERKEY-->[1.0, 6000000.0, 0.0, 8.0, 1500000.0] ESTIMATE
...
cardinality: 22765073
probe runtime filters:
- filter_id = 3, probe_expr = (11: O_CUSTKEY)
column statistics:
* O_ORDERKEY-->[1.0, 6000000.0, 0.0, 8.0, 1500000.0] ESTIMATE
* O_CUSTKEY-->[1.0, 149999.0, 0.0, 8.0, 99996.0] ESTIMATE
...
cardinality: 15000000
column statistics:
* C_CUSTKEY-->[1.0, 150000.0, 0.0, 8.0, 150000.0] ESTIMATE
* C_NATIONKEY-->[0.0, 24.0, 0.0, 4.0, 25.0] ESTIMATE
