...
TABLE: part
PREAGGREGATION: ON
PREDICATES: 23: P_SIZE <= 15, 21: P_BRAND IN ('Brand#45', 'Brand#11', 'Brand#21'), 24: P_CONTAINER IN ('SM CASE', 'SM BOX', 'SM PACK', 'SM PKG', 'MED BAG', 'MED BOX', 'MED PKG', 'MED PACK', 'LG CASE', 'LG BOX', 'LG PACK', 'LG PKG'), 23: P_SIZE >= 1
partitions=1/1
rollup: part
tabletRatio=10/10
cardinality=5714286
...
TABLE: lineitem
PREAGGREGATION: ON
PREDICATES: 14: L_SHIPINSTRUCT = 'DELIVER IN PERSON', 15: L_SHIPMODE IN ('AIR', 'AIR REG'), 5: L_QUANTITY <= 35.0, 5: L_QUANTITY >= 5.0
partitions=1/1
rollup: lineitem
tabletRatio=20/20
