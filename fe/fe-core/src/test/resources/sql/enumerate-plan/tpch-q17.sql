...
[plan-1]
AGGREGATE ([GLOBAL] aggregate [{48: sum(6: L_EXTENDEDPRICE)=sum(6: L_EXTENDEDPRICE)}] group by [[]] having [null]
    EXCHANGE GATHER
        INNER JOIN (join-predicate [18: P_PARTKEY = 29: L_PARTKEY AND 5: L_QUANTITY < multiply(0.2, 45: avg(32: L_QUANTITY))] post-join-predicate [null])
            ...
            EXCHANGE SHUFFLE[29]
                AGGREGATE ([GLOBAL] aggregate [{45: avg(32: L_QUANTITY)=avg(32: L_QUANTITY)}] group by [[29: L_PARTKEY]] having [null]
                    EXCHANGE SHUFFLE[29]
