                        ...
                        FETCH (columns[[24: L_QUANTITY]])
                            INNER JOIN (join-predicate [10: O_ORDERKEY = 20: L_ORDERKEY] post-join-predicate [null])
                                FETCH (columns[[11: O_CUSTKEY,13: O_TOTALPRICE,14: O_ORDERDATE]])
                                    ...
                                    LookUp
                                EXCHANGE SHUFFLE[20]
                                    SCAN (columns[20: L_ORDERKEY, 59: ROW_ID] predicate[null])
                            LookUp
                LookUp
[end]
