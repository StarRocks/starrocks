...
PLAN FRAGMENT 2(F06)
  ...
  INSTANCES
    INSTANCE(4-F06#0)
      DESTINATIONS: 1-F12#0,2-F12#1,3-F12#2
      BE: 10001
      SCAN RANGES
...
PLAN FRAGMENT 3(F09)
  ...
  INSTANCES
    INSTANCE(7-F09#0)
      DESTINATIONS: 4-F06#0,5-F06#1,6-F06#2
      BE: 10001
      SCAN RANGES
        17:OlapScanNode
...
PLAN FRAGMENT 6(F03)
  ...
  INSTANCES
    INSTANCE(16-F03#0)
      DESTINATIONS: 13-F00#0,14-F00#1,15-F00#2
      BE: 10001
      SCAN RANGES
        6:OlapScanNode
          1. partitionID=2488,tabletID=2491
...
PLAN FRAGMENT 7(F01)
  ...
  INSTANCES
    INSTANCE(19-F01#0)
      DESTINATIONS: 15-F00#2,13-F00#0,14-F00#1,15-F00#2,13-F00#0,14-F00#1,15-F00#2,13-F00#0,14-F00#1,15-F00#2,13-F00#0,14-F00#1,15-F00#2,13-F00#0,14-F00#1,15-F00#2,13-F00#0,14-F00#1
      BE: 10001
      SCAN RANGES
        2:OlapScanNode
          1. partitionID=2448,tabletID=2451
...
PLAN FRAGMENT 2
 OUTPUT EXPRS:
  ...
  STREAM DATA SINK
    EXCHANGE ID: 21
    HASH_PARTITIONED: 36: L_ORDERKEY, 54: o_orderdate, 63: p_name
...
PLAN FRAGMENT 5
 OUTPUT EXPRS:
  ...
  STREAM DATA SINK
    EXCHANGE ID: 10
    HASH_PARTITIONED: 1: L_ORDERKEY, 19: o_orderdate, 28: p_name
