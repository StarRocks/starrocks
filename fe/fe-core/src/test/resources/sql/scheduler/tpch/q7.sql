...
PLAN FRAGMENT 10(F01)
  ...
  INSTANCES
    INSTANCE(24-F01#0)
      DESTINATIONS
        21-F00#0,22-F00#1,23-F00#2,21-F00#0,22-F00#1,23-F00#2,21-F00#0,22-F00#1,23-F00#2,21-F00#0
        22-F00#1,23-F00#2,21-F00#0,22-F00#1,23-F00#2,21-F00#0,22-F00#1,23-F00#2,21-F00#0,22-F00#1
      BE: 10001
      SCAN RANGES
        1:OlapScanNode
