...
PLAN FRAGMENT 3(F01)
  ...
  INSTANCES
    INSTANCE(7-F01#0)
      DESTINATIONS: 4-F00#0,5-F00#1,6-F00#2,4-F00#0,5-F00#1,6-F00#2,4-F00#0,5-F00#1,6-F00#2,4-F00#0,5-F00#1,6-F00#2,4-F00#0,5-F00#1,6-F00#2,4-F00#0,5-F00#1,6-F00#2,4-F00#0,5-F00#1
      BE: 10001
      SCAN RANGES
        3:OlapScanNode
