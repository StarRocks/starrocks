...
PLAN FRAGMENT 4(F02)
  ...
  INSTANCES
    INSTANCE(8-F02#0)
      DESTINATIONS
        5-F01#0,6-F01#1,7-F01#2,5-F01#0,6-F01#1,7-F01#2,5-F01#0,6-F01#1,7-F01#2,5-F01#0
        6-F01#1,7-F01#2,5-F01#0,6-F01#1,7-F01#2,5-F01#0,6-F01#1,7-F01#2,5-F01#0,6-F01#1
      BE: 10001
      SCAN RANGES
        3:OlapScanNode
