...
PLAN FRAGMENT 3
 OUTPUT EXPRS:
  ...
  1:OlapScanNode
     TABLE: lineitem
     PREAGGREGATION: ON
     PREDICATES: 24: L_SHIPMODE IN ('MAIL', 'SHIP'), 21: L_COMMITDATE < 22: L_RECEIPTDATE, 20: L_SHIPDATE < 21: L_COMMITDATE, 22: L_RECEIPTDATE >= '1994-01-01', 22: L_RECEIPTDATE <= '1994-12-31', 21: L_COMMITDATE < '1994-12-31', 20: L_SHIPDATE < '1994-12-31'
     partitions=1/1
     rollup: lineitem
     tabletRatio=20/20
