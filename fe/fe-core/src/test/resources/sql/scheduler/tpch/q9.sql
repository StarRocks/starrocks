...
PLAN FRAGMENT 10(F01)
  ...
  INSTANCES
    INSTANCE(26-F01#0)
      DESTINATIONS
        25-F00#2,23-F00#0,24-F00#1,25-F00#2,23-F00#0,24-F00#1,25-F00#2,23-F00#0,24-F00#1,25-F00#2
        23-F00#0,24-F00#1,25-F00#2,23-F00#0,24-F00#1,25-F00#2,23-F00#0,24-F00#1
      BE: 10001
      SCAN RANGES
        1:OlapScanNode
