  ...
  INSTANCES
    INSTANCE(4-F01#0)
      DESTINATIONS
        ...
        1-F00#0,2-F00#1,3-F00#2,1-F00#0,2-F00#1,3-F00#2,1-F00#0,2-F00#1,3-F00#2,1-F00#0
        2-F00#1,3-F00#2,1-F00#0,2-F00#1
      BE: 10001
      SCAN RANGES
        BUCKET SEQUENCES
          16,1,4,7,10,13
...
PLAN FRAGMENT 3(F04)
  ...
  INSTANCES
    INSTANCE(7-F04#0)
      DESTINATIONS
        6-F01#2,4-F01#0,5-F01#1,6-F01#2,4-F01#0,5-F01#1,6-F01#2,4-F01#0,5-F01#1,6-F01#2
        4-F01#0,5-F01#1,6-F01#2,4-F01#0,5-F01#1,6-F01#2,4-F01#0,5-F01#1
      BE: 10001
      SCAN RANGES
        8:OlapScanNode
