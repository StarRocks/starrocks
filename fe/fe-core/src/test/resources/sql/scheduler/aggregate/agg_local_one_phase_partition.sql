  ...
  INSTANCES
    INSTANCE(1-F00#0)
      ...
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 16:2,1:0,4:1,7:2,10:0,13:1
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1056
            2. partitionID=1045,tabletID=1128
    ...
    INSTANCE(2-F00#1)
      ...
      DOP: 3
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 17:2,2:0,5:1,8:2,11:0,14:1
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1058
            2. partitionID=1045,tabletID=1130
    ...
    INSTANCE(3-F00#2)
      ...
      DOP: 3
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 0:0,3:1,6:2,9:0,12:1,15:2
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1054
            2. partitionID=1045,tabletID=1126
...
PLAN FRAGMENT 1(F00)
  ...
  INSTANCES
    INSTANCE(1-F00#0)
      ...
      DOP: 2
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 16:1,1:0,4:1,7:0,10:1,13:0
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1056
            2. partitionID=1045,tabletID=1128
    ...
    INSTANCE(2-F00#1)
      ...
      DOP: 2
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 17:1,2:0,5:1,8:0,11:1,14:0
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1058
            2. partitionID=1045,tabletID=1130
    ...
    INSTANCE(3-F00#2)
      ...
      DOP: 2
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 0:0,3:1,6:0,9:1,12:0,15:1
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1054
            2. partitionID=1045,tabletID=1126
...
PLAN FRAGMENT 1(F00)
  ...
  INSTANCES
    INSTANCE(1-F00#0)
      ...
      DOP: 1
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 16:0,1:0,4:0,7:0,10:0,13:0
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1056
            2. partitionID=1045,tabletID=1128
    ...
    INSTANCE(2-F00#1)
      ...
      DOP: 1
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 17:0,2:0,5:0,8:0,11:0,14:0
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1058
            2. partitionID=1045,tabletID=1130
    ...
    INSTANCE(3-F00#2)
      ...
      DOP: 1
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 0:0,3:0,6:0,9:0,12:0,15:0
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1054
            2. partitionID=1045,tabletID=1126
...
PLAN FRAGMENT 1(F00)
  ...
  INSTANCES
    INSTANCE(1-F00#0)
      ...
      DOP: 6
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 16:5,1:0,4:1,7:2,10:3,13:4
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1056
            2. partitionID=1045,tabletID=1128
    ...
    INSTANCE(2-F00#1)
      ...
      DOP: 6
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 17:5,2:0,5:1,8:2,11:3,14:4
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1058
            2. partitionID=1045,tabletID=1130
    ...
    INSTANCE(3-F00#2)
      ...
      DOP: 6
      SCAN RANGES (per driver sequence)
        BUCKET SEQUENCE TO DRIVER SEQUENCE: 0:0,3:1,6:2,9:3,12:4,15:5
        0:OlapScanNode
          DriverSequence#0
            1. partitionID=1044,tabletID=1054
            2. partitionID=1045,tabletID=1126
