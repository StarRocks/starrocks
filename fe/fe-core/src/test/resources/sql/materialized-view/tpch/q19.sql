...
<<<<<<< HEAD
            SCAN (mv[lineitem_mv] columns[95: l_quantity, 99: l_shipinstruct, 100: l_shipmode, 108: p_brand, 109: p_container, 111: p_size, 116: l_saleprice] predicate[99: l_shipinstruct = DELIVER IN PERSON AND 111: p_size >= 1 AND 108: p_brand = Brand#45 AND 109: p_container IN (SM CASE, SM BOX, SM PACK, SM PKG) AND 95: l_quantity >= 5 AND 95: l_quantity <= 15 AND 111: p_size <= 5 OR 108: p_brand = Brand#11 AND 109: p_container IN (MED BAG, MED BOX, MED PKG, MED PACK) AND 95: l_quantity >= 15 AND 95: l_quantity <= 25 AND 111: p_size <= 10 OR 108: p_brand = Brand#21 AND 109: p_container IN (LG CASE, LG BOX, LG PACK, LG PKG) AND 95: l_quantity >= 25 AND 95: l_quantity <= 35 AND 111: p_size <= 15 AND 100: l_shipmode IN (AIR, AIR REG)])
=======
