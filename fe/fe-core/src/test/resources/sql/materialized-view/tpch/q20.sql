        ...
        LEFT SEMI JOIN (join-predicate [1: s_suppkey = 13: ps_suppkey] post-join-predicate [null])
            ...
            EXCHANGE SHUFFLE[13]
                INNER JOIN (join-predicate [12: ps_partkey = 30: l_partkey AND 13: ps_suppkey = 31: l_suppkey AND cast(14: ps_availqty as decimal128(38, 3)) > multiply(0.5, 43: sum)] post-join-predicate [null])
                    ...
                    EXCHANGE SHUFFLE[30]
                        AGGREGATE ([GLOBAL] aggregate [{149: sum=sum(149: sum)}] group by [[114: l_partkey, 112: l_suppkey]] having [null]
                            EXCHANGE SHUFFLE[114, 112]
                                AGGREGATE ([LOCAL] aggregate [{149: sum=sum(115: sum_qty)}] group by [[114: l_partkey, 112: l_suppkey]] having [null]
                                    SCAN (mv[lineitem_agg_mv2] columns[112: l_suppkey, 113: l_shipdate, 114: l_partkey, 115: sum_qty] predicate[113: l_shipdate >= 1993-01-01 AND 113: l_shipdate < 1994-01-01])
[end]
