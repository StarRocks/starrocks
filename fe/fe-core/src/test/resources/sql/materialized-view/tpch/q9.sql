...
TOP-N (order by [[48: n_name ASC NULLS FIRST, 51: year DESC NULLS LAST]])
    TOP-N (order by [[48: n_name ASC NULLS FIRST, 51: year DESC NULLS LAST]])
        AGGREGATE ([GLOBAL] aggregate [{340: sum=sum(340: sum)}] group by [[56: n_name1, 55: o_orderyear]] having [null]
            EXCHANGE SHUFFLE[56, 55]
                AGGREGATE ([LOCAL] aggregate [{340: sum=sum(57: sum_amount)}] group by [[56: n_name1, 55: o_orderyear]] having [null]
