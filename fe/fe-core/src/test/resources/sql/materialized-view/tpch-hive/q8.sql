        ...
        AGGREGATE ([GLOBAL] aggregate [{65: sum=sum(65: sum), 64: sum=sum(64: sum)}] group by [[61: year]] having [null]
            EXCHANGE SHUFFLE[61]
                AGGREGATE ([LOCAL] aggregate [{65: sum=sum(62: expr), 64: sum=sum(63: case)}] group by [[61: year]] having [null]
                    SCAN (mv[lineitem_mv] columns[128: o_orderdate, 137: p_type, 141: l_saleprice, 144: o_orderyear, 145: n_name1, 150: r_name2] predicate[128: o_orderdate >= 1995-01-01 AND 128: o_orderdate <= 1996-12-31 AND 150: r_name2 = MIDDLE EAST AND 137: p_type = ECONOMY ANODIZED STEEL])
[end]
