                ...
                RIGHT ANTI JOIN (join-predicate [20: o_custkey = 1: c_custkey] post-join-predicate [null])
                    ...
                    EXCHANGE SHUFFLE[1]
                        INNER JOIN (join-predicate [cast(6: c_acctbal as decimal128(38, 8)) > 17: avg] post-join-predicate [null])
                            ...
                            EXCHANGE BROADCAST
                                ASSERT LE 1
                                    AGGREGATE ([GLOBAL] aggregate [{17: avg=avg(17: avg)}] group by [[]] having [null]
                                        EXCHANGE GATHER
                                            AGGREGATE ([LOCAL] aggregate [{17: avg=avg(14: c_acctbal)}] group by [[]] having [null]
                                                SCAN (columns{13,14,93} predicate[14: c_acctbal > 0.00 AND substring(13: c_phone, 1, 2) IN (21, 28, 24, 32, 35, 34, 37)])
[end]
