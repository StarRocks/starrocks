        ...
        AGGREGATE ([GLOBAL] aggregate [{28: sum=sum(28: sum), 29: sum=sum(29: sum)}] group by [[24: l_shipmode]] having [null]
            EXCHANGE SHUFFLE[24]
                AGGREGATE ([LOCAL] aggregate [{28: sum=sum(26: case), 29: sum=sum(27: case)}] group by [[24: l_shipmode]] having [null]
                    PREDICATE 53: l_commitdate < 59: l_receiptdate AND 53: l_commitdate > 61: l_shipdate
                        SCAN (mv[lineitem_mv] columns[53: l_commitdate, 59: l_receiptdate, 61: l_shipdate, 63: l_shipmode, 67: o_orderpriority] predicate[59: l_receiptdate >= 1997-01-01 AND 59: l_receiptdate < 1998-01-01 AND 63: l_shipmode IN (MAIL, REG AIR)])
[end]
