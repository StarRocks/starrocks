...
AGGREGATE ([GLOBAL] aggregate [{36: sum=sum(36: sum)}] group by [[]] having [null]
    EXCHANGE GATHER
        AGGREGATE ([LOCAL] aggregate [{36: sum=sum(multiply(cast(46: LO_EXTENDEDPRICE as bigint(20)), cast(48: LO_DISCOUNT as bigint(20))))}] group by [[]] having [null]
            SCAN (columns[45: LO_QUANTITY, 46: LO_EXTENDEDPRICE, 48: LO_DISCOUNT, 79: d_yearmonthnum] predicate[79: d_yearmonthnum = 199401 AND 45: LO_QUANTITY <= 35 AND 45: LO_QUANTITY >= 26 AND 48: LO_DISCOUNT <= 6 AND 48: LO_DISCOUNT >= 4])
[end]
