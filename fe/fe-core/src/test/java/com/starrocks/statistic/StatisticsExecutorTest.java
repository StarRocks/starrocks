            ...
            public List<TStatisticData> executeStatisticDQL(ConnectContext context, String sql) {
                Assert.assertEquals(
                        "SELECT cast(6 as INT), column_name, sum(row_count), cast(sum(data_size) as bigint), " +
                                ...
                                "cast(min(cast(min as int(11))) as string) FROM external_column_statistics " +
                                "WHERE table_uuid = \"hive0.partitioned_db.t1.0\" and column_name = \"c1\" " +
                                ...
                                "WHERE table_uuid = \"hive0.partitioned_db.t1.0\" and column_name = \"c2\" " +
