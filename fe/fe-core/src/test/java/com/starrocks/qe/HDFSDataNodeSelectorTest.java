...
public class HDFSDataNodeSelectorTest {
    ...
    public void testHdfsScanNodeHashRing() throws Exception {
        ...
        Map<TNetworkAddress, Long> addressToDataNodeId = new HashMap<>();
        Set<Long> usedDataNodeIDs = new HashSet<>();
        List<ComputeNode> computeNodes = createComputeNodes(hostNumber);

        HDFSDataNodeSelector selector =
                new HDFSDataNodeSelector(hdfsScanNode, locations, assignment, addressToDataNodeId, usedDataNodeIDs,
