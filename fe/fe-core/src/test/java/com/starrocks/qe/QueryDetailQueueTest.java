...
public class QueryDetailQueueTest extends PlanTestBase {
    ...
    public void testQueryDetailQueue() {
        ...
        startQueryDetail.setscanPartitions("\"[{catalogName:default_catalog,databaseName:testDb,tableName:table1,partitionIds:[table1]}]\"");
        ...
        String queryDetailString = "[{\"eventTime\":" + startQueryDetail.getEventTime() + ","
                ...
                + "\"user\":\"root\","
                + "\"scanRows\":100,"
                + "\"scanPartitions\":\"[{catalogName:default_catalog,databaseName:testDb,tableName:table1,partitionIds:[table1]}]\","
                + "\"scanBytes\":10001,"
                + "\"returnRows\":1,"
                + "\"cpuCostNs\":1002,"
                + "\"memCostBytes\":100003,"
