...
public class CoordinatorTest extends PlanTestBase {
    ...
    public void testStreamAgg() throws Exception {
        ...
        SlotDescriptor groupBySlot = new SlotDescriptor(new SlotId(4), "groupBy", StandardTypes.INT, false);
        SlotDescriptor aggFuncSlot = new SlotDescriptor(new SlotId(5), "aggFunc", StandardTypes.INT, false);
