...
public class JoinTest extends SchedulerTestBase {
    ...
    public void testCancelAtJoining() throws Exception {
        ...
        DefaultScheduler scheduler = startScheduling(sql);
    ...
    public void testBackendBecomeDeadAtJoining() throws Exception {
        ...
        Assert.assertEquals(TStatusCode.INTERNAL_ERROR, scheduler.getStatus().getErrorCode());
    }
    ...
    public void testReportFailedExecutionAtJoining() throws Exception {
        ...
        executionDAG.getExecutionIndexesInJob().forEach(indexInJob -> {
        ...
        Assert.assertEquals(JobStateType.FAILED, scheduler.getState());
    }
    ...
    public void testJoinFinishSuccessfully() throws Exception {
        ...
        Assert.assertEquals(JobStateType.FINISHED, scheduler.getState());
