...
class PlanTuningAnalyzerTest extends DistributedEnvPlanTestBase {
    ...
    // A runtime filter probe drops groups before HAVING and books them separately, so those count
    // towards the cardinality too: 200M/7 would fire, the real 10M groups read 20 and must not.
    @Test
