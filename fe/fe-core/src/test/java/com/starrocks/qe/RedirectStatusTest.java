...
import com.starrocks.sql.ast.warehouse.cngroup.CnGroupStmtBase;
...
public class RedirectStatusTest {
    ...
    public void testBeginStmt() {
        ...
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testExecuteStmt() {
        ...
        Assertions.assertNull(stmt.getRedirectStatus());
    }
    ...
    @Test
    public void testDdlStmtRedirectStatus() {
        // DdlStmt is abstract, but we can test a simple concrete implementation
        class TestDdlStmt extends DdlStmt {
            public TestDdlStmt() {
        ...
        TestDdlStmt stmt = new TestDdlStmt();
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }

    @Test
    public void testDmlStmtRedirectStatus() {
        // DmlStmt is abstract, but we can test a simple concrete implementation
        class TestDmlStmt extends DmlStmt {
            public TestDmlStmt() {
                super(NodePosition.ZERO);
            }
        ...
        TestDmlStmt stmt = new TestDmlStmt();
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }

    @Test
    public void testShowStmtRedirectStatus() {
        // ShowStmt is abstract, but we can test a simple concrete implementation
        class TestShowStmt extends ShowStmt {
            public TestShowStmt() {
                super(NodePosition.ZERO);
            }
        ...
        TestShowStmt stmt = new TestShowStmt();
        Assertions.assertEquals(RedirectStatus.NO_FORWARD, stmt.getRedirectStatus());
    }

    @Test
    public void testPlanAdvisorStmtRedirectStatus() {
        // PlanAdvisorStmt is abstract, but we can test a simple concrete implementation
        class TestPlanAdvisorStmt extends PlanAdvisorStmt {
            public TestPlanAdvisorStmt() {
                super(NodePosition.ZERO);
            }
        ...
        TestPlanAdvisorStmt stmt = new TestPlanAdvisorStmt();
        Assertions.assertEquals(RedirectStatus.NO_FORWARD, stmt.getRedirectStatus());
    }
    ...
    @Test
    public void testImportColumnsStmt() {
        ImportColumnsStmt stmt = new ImportColumnsStmt(java.util.Collections.emptyList());
        Assertions.assertNull(stmt.getRedirectStatus());
    }

    @Test
    public void testImportWhereStmt() {
        ImportWhereStmt stmt = new ImportWhereStmt(null);
        Assertions.assertNull(stmt.getRedirectStatus());
    }
    ...
    public void testCreateTableAsSelectStmt() {
        ...
        CreateTableAsSelectStmt stmt =
                new CreateTableAsSelectStmt(createTableStmt, java.util.Collections.emptyList(), queryStatement);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }

    @Test
    public void testUpdateFailPointStatusStatement() {
        UpdateFailPointStatusStatement stmt =
                new UpdateFailPointStatusStatement("test_point", true, java.util.Collections.emptyList(), NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.NO_FORWARD, stmt.getRedirectStatus());
    }
    ...
    public void testShowTabletStmt() {
        ...
        RedirectStatus status = stmt.getRedirectStatus();
    ...
    public void testAnalyzeStmt() {
        AnalyzeStmt stmt =
                new AnalyzeStmt(null, java.util.Collections.emptyList(), null, java.util.Collections.emptyMap(), false, false,
    ...
    public void testCreateMaterializedViewStmt() {
        ...
        CreateMaterializedViewStmt stmt =
                new CreateMaterializedViewStmt(tableName, queryStatement, java.util.Collections.emptyMap());
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testCreateUserStmt() {
        CreateUserStmt stmt = new CreateUserStmt(null, false, null, null, null, java.util.Collections.emptyList(),
    ...
    public void testRevokePrivilegeStmt() {
        RevokePrivilegeStmt stmt =
                new RevokePrivilegeStmt(null, null, new GrantRevokeClause(new UserIdentity("", ""), ""), null, null);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testAlterUserStmt() {
        AlterUserStmt stmt = new AlterUserStmt(null, false, null, null, null, null, NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testBackupStmt() {
        BackupStmt stmt =
                new BackupStmt(null, "test_snapshot", null, null, null, null, false, null, java.util.Collections.emptyMap(),
                        NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testCreateFunctionStmt() {
        CreateFunctionStmt stmt =
                new CreateFunctionStmt("", null, null, null, java.util.Collections.emptyMap(), null, false, false,
                        NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testCreateResourceStmt() {
        CreateResourceStmt stmt =
                new CreateResourceStmt(true, "test_resource", java.util.Collections.emptyMap(), NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }

    @Test
    public void testCreateResourceGroupStmt() {
        CreateResourceGroupStmt stmt = new CreateResourceGroupStmt("test_group", false, false, java.util.Collections.emptyList(),
    ...
    public void testRestoreStmt() {
        RestoreStmt stmt =
                new RestoreStmt(null, "test_snapshot", null, null, null, null, false, null, java.util.Collections.emptyMap(),
                        NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testCreateTableLikeStmt() {
        CreateTableLikeStmt stmt =
                new CreateTableLikeStmt(false, null, null, null, null, java.util.Collections.emptyMap(), NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }

    @Test
    public void testCreateTemporaryTableStmt() {
        CreateTemporaryTableStmt stmt =
                new CreateTemporaryTableStmt(false, false, null, java.util.Collections.emptyList(), null, null, null, null, null,
                        null, java.util.Collections.emptyMap(), java.util.Collections.emptyMap(), null,
    ...
    public void testCreateTemporaryTableLikeStmt() {
        CreateTemporaryTableLikeStmt stmt =
                new CreateTemporaryTableLikeStmt(false, null, null, null, null, java.util.Collections.emptyMap(),
                        NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testRefreshMaterializedViewStatement() {
        RefreshMaterializedViewStatement stmt =
                new RefreshMaterializedViewStatement(null, null, false, false, null, NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testCreateDataCacheRuleStmt() {
        CreateDataCacheRuleStmt stmt =
                new CreateDataCacheRuleStmt(null, null, 1, java.util.Collections.emptyMap(), NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testDataCacheSelectStatement() {
        ...
        class TestDataCacheSelectStatement extends DataCacheSelectStatement {
            public TestDataCacheSelectStatement() {
                super(null, java.util.Collections.emptyMap(), NodePosition.ZERO);
            }

            @Override
            public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
                return null; // Override to avoid NPE in constructor
            }
        }

        // Test the redirect status directly - DataCacheSelectStatement extends DdlStmt
        // and doesn't override getRedirectStatus, so it should return FORWARD_WITH_SYNC
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, RedirectStatus.FORWARD_WITH_SYNC);
    }
    ...
    public void testAdminSetConfigStmt() {
        AdminSetConfigStmt stmt =
                new AdminSetConfigStmt(AdminSetConfigStmt.ConfigType.FRONTEND, new Property("", ""), false, NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_NO_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testShowRoutineLoadStmt() {
        ShowRoutineLoadStmt stmt =
                new ShowRoutineLoadStmt(null, false, null, java.util.Collections.emptyList(), null, NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_NO_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testGrantPrivilegeStmt() {
        GrantPrivilegeStmt stmt =
                new GrantPrivilegeStmt(null, null, new GrantRevokeClause(new UserIdentity("", ""), ""), null, false);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testCreatePipeStmt() {
        CreatePipeStmt stmt =
                new CreatePipeStmt(false, false, null, 1, null, java.util.Collections.emptyMap(), NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testBaseCreateAlterUserStmt() {
        ...
        CreateUserStmt stmt =
                new CreateUserStmt(null, false, null, null, null, java.util.Collections.emptyList(),
                        java.util.Collections.emptyMap(),
                        NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    @Test
    public void testCnGroupStmtBase() {
        // CnGroupStmtBase is abstract, testing through a concrete subclass if available
        // For now, we'll test its default behavior through a simple implementation
        class TestCnGroupStmt extends CnGroupStmtBase {
            public TestCnGroupStmt() {
                super("test", "group", NodePosition.ZERO);
            }
        ...
        TestCnGroupStmt stmt = new TestCnGroupStmt();
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testAlterStorageVolumeStmtCoverage() {
        AlterStorageVolumeStmt stmt =
                new AlterStorageVolumeStmt("test_volume", java.util.Collections.emptyMap(), null, NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
    ...
    public void testCreateDictionaryStmtCoverage() {
        CreateDictionaryStmt stmt =
                new CreateDictionaryStmt("test_dict", null, java.util.Collections.emptyList(), java.util.Collections.emptyList(),
                        java.util.Collections.emptyMap(), NodePosition.ZERO);
        Assertions.assertEquals(RedirectStatus.FORWARD_WITH_SYNC, stmt.getRedirectStatus());
    }
