...
public class SessionVariableTest {
    ...
    public void testPaimonNativeReaderOptions() {
        ...
        Assertions.assertEquals(64, options.getPaimon_datacache_remote_read_buffer_block_count());
        ...
        sessionVariable.setPaimonDataCacheRemoteReadBufferBlockCount(32);
        ...
        Assertions.assertEquals(32, options.getPaimon_datacache_remote_read_buffer_block_count());
    ...
    public void testPaimonIoOptionValidation() throws DdlException {
        ...
        Assertions.assertThrows(DdlException.class, () -> VariableVarConverters.convert(
                SessionVariable.PAIMON_DATACACHE_REMOTE_READ_BUFFER_BLOCK_COUNT, "0"));
        Assertions.assertThrows(DdlException.class, () -> VariableVarConverters.convert(
                SessionVariable.PAIMON_DATACACHE_REMOTE_READ_BUFFER_BLOCK_COUNT, "257"));
        Assertions.assertThrows(DdlException.class, () -> VariableVarConverters.convert(
