...
public class SimpleSchedulerTest {
    ...
    public void testGetHostWithBackendId() {
        ...
        DataNode dataNodeA = new DataNode(0, "addressA", 0);
        dataNodeA.updateOnce(0, 0, 0);
        DataNode dataNodeB = new DataNode(1, "addressB", 0);
        dataNodeB.updateOnce(0, 0, 0);
        DataNode dataNodeC = new DataNode(2, "addressC", 0);
        dataNodeC.updateOnce(0, 0, 0);

        Map<Long, DataNode> threeBackends = Maps.newHashMap();
        threeBackends.put((long) 0, dataNodeA);
        threeBackends.put((long) 1, dataNodeB);
        threeBackends.put((long) 2, dataNodeC);
    ...
    public void testBlackList() {
        ...
        dataNodeC.updateOnce(0, 0, 0);
        Map<Long, DataNode> threeBackends = Maps.newHashMap();
        threeBackends.put((long) 100, dataNodeA);
        threeBackends.put((long) 101, dataNodeB);
        threeBackends.put((long) 102, dataNodeC);
        ImmutableMap<Long, DataNode> immutableThreeBackends = ImmutableMap.copyOf(threeBackends);
    ...
    public void testNoAliveBackend() {
        ImmutableMap.Builder<Long, DataNode> builder = ImmutableMap.builder();
        for (int i = 0; i < 6; i++) {
            DataNode dataNode = new DataNode(i, "address" + i, 0);
            dataNode.setAlive(false);
            builder.put(dataNode.getId(), dataNode);
        }
