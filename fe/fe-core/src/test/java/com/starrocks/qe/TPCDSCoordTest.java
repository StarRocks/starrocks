...
public class TPCDSCoordTest extends TPCDSPlanTestBase {
    ...
    public void testQuery20() throws Exception {
        ...
        CoordinatorPrepare.FragmentExecParams params = coord.getFragmentExecParamsMap().get(topFragmentId);
    ...
    public void testSubQueryExtractedFromQ5() throws Exception {
        ...
        for (CoordinatorPrepare.FragmentExecParams params : coord.getFragmentExecParamsMap().values()) {
