...
public class StmtExecutorTest {
    ...
    public void testExecTimeoutWithTableQueryTimeout() throws Exception {
        ...
        // Test 12: Cover the try-catch around isSessionQueryTimeoutOverridden() (covers line 620-621)
        {
            ConnectContext testCtx = UtFrameUtils.createDefaultCtx();
            testCtx.setDatabase(dbName);
            ...
            // Mock isSessionQueryTimeoutOverridden() to throw, so StmtExecutor falls back to sessionTimeoutOverridden=false
