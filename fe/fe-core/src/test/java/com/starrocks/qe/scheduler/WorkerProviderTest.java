...
public class WorkerProviderTest {
    ...
    private static <C extends ComputeNode> ImmutableMap<Long, C> genWorkers(long startId, long endId, Supplier<C> factory) {
    ...
    public void testCaptureAvailableWorkers() {
        ...
        for (Integer numUsedComputeNodes : numUsedComputeNodesList) {
            ...
            workerProvider =
                    WorkerProvider.captureAvailableWorkers(GlobalStateMgr.getCurrentSystemInfo(), true, numUsedComputeNodes);
    ...
    public void testCaptureAvailableWorkersForSharedData() {
        ...
        try {
            ...
            for (Integer numUsedComputeNodes : numUsedComputeNodesList) {
                ...
                workerProvider =
                        WorkerProvider.captureAvailableWorkers(GlobalStateMgr.getCurrentSystemInfo(), false, numUsedComputeNodes);
    ...
    private static <C extends ComputeNode> void testChooseNextWorkerHelper(WorkerProvider workerProvider, Map<Long, C> id2Worker)
    ...
    public void testChooseNextWorker() throws UserException {
        ...
        workerProvider = new WorkerProvider(id2Backend, id2ComputeNode, availableId2Backend, availableId2ComputeNode, true);
        ...
        workerProvider = new WorkerProvider(id2Backend, id2ComputeNode, availableId2Backend, availableId2ComputeNode, false);
        testChooseNextWorkerHelper(workerProvider, availableId2Backend);
