...
public class ExternalCooldownPartitionSelectorTest {
    ...
    public void testSinglePartitionTable() {
        ...
        List<Partition> partitions1 = selector1.getSatisfiedPartitions(-1);
        ...
        List<Partition> partitions2 = selector2.getSatisfiedPartitions(-1);
    ...
    public void testReloadSatisfiedPartitions() throws Exception {
        ...
        selector.reloadSatisfiedPartitions();
        Assert.assertTrue(selector.isTableSatisfied());
        List<Partition> satisfiedPartitions = selector.getSatisfiedPartitions(-1);
        Assert.assertEquals(2, satisfiedPartitions.size());
        List<Partition> satisfiedPartitionsLimited = selector.getSatisfiedPartitions(1);
    ...
    @Test
    public void testNonPartitionTableWithIcebergPartitioned() throws Exception {
    ...
    public void testGetPartitionsInRange() {
        ...
        List<Partition> satisfiedPartitions1 = selector1.getSatisfiedPartitions(-1);
