...
public class BackupHandlerDropSnapshotTest {
    ...
    public void testDropSnapshotRepositoryNotFound() throws DdlException {
        ...
        Assertions.assertThrows(DdlException.class, () -> backupHandler.dropSnapshot(stmt));
    }
    ...
    public void testDropSnapshotMultipleSnapshotsPartialSuccess() throws DdlException {
        ...
        try {
            backupHandler.dropSnapshot(stmt);
            Assertions.fail("Expected DdlException for partial failures");
        } catch (DdlException e) {
            // Test lines 608-611: Exception thrown when some deletions fail
            Assertions.assertTrue(e.getMessage().contains("Failed to drop 1 out of 3 snapshots"));
        }
    }
    ...
    public void testDropSnapshotLockingAndUnlocking() throws DdlException {
        ...
        Assertions.assertTrue(lockCalled[0], "Lock should be called at method entry");
        Assertions.assertTrue(unlockCalled[0], "Unlock should be called in finally block");
    }
    ...
    public void testDropSnapshotSpecificLinesCoverage() throws DdlException {
        ...
        try {
            ...
            Assertions.assertTrue(e.getMessage().contains("Failed to drop 1 out of 2 snapshots"),
