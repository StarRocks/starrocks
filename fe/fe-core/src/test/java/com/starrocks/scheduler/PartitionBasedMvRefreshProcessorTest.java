...
public class PartitionBasedMvRefreshProcessorTest {
    ...
    public void testAutoPartitionRefreshWithPartitionedHiveTableJoinInternalTable() throws Exception {
        ...
        taskRun.initStatus(UUIDUtil.genUUID().toString(), System.currentTimeMillis());
        taskRun.executeTaskRun();
<<<<<<< HEAD:fe/fe-core/src/test/java/com/starrocks/scheduler/PartitionBasedMaterializedViewRefreshProcessorTest.java
        PartitionBasedMaterializedViewRefreshProcessor processor = (PartitionBasedMaterializedViewRefreshProcessor)
=======
        PartitionBasedMvRefreshProcessor processor = (PartitionBasedMvRefreshProcessor)
>>>>>>> branch-2.5:fe/fe-core/src/test/java/com/starrocks/scheduler/PartitionBasedMvRefreshProcessorTest.java
                taskRun.getProcessor();
