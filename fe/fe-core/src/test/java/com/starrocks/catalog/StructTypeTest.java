...
public class StructTypeTest {
    ...
    public void testTypeMatch() {
        ...
        Assertions.assertTrue(AnyStructType.ANY_STRUCT.matchesType(AnyElementType.ANY_ELEMENT));
        StructType structType = new StructType(Lists.newArrayList(IntegerType.BIGINT, FloatType.DOUBLE));
        Assertions.assertTrue(AnyStructType.ANY_STRUCT.matchesType(structType));
    }
    ...
    public void testStructEquals() {
        ...
        StructType originType = new StructType(Lists.newArrayList(IntegerType.INT, VarcharType.VARCHAR));
        StructType comparedType = new StructType(Lists.newArrayList(IntegerType.INT, VarcharType.VARCHAR));
        Assertions.assertEquals(originType, comparedType);
        Assertions.assertEquals(comparedType, originType);

        comparedType = new StructType(Lists.newArrayList(VarcharType.VARCHAR, IntegerType.INT));
        ...
        StructField tmpField1 = new StructField("hello", IntegerType.INT);
        StructField tmpField2 = new StructField("world", VarcharType.VARCHAR);
        comparedType = new StructType(Lists.newArrayList(tmpField1, tmpField2));
        Assertions.assertNotEquals(originType, comparedType);
        Assertions.assertNotEquals(comparedType, originType);

        // test equals() for named struct & named struct
        StructField tmpField3 = new StructField("hello", IntegerType.INT);
        StructField tmpField4 = new StructField("world", VarcharType.VARCHAR);
        ...
        tmpField3 = new StructField("hello123", IntegerType.INT);
        comparedType = new StructType(Lists.newArrayList(tmpField3, tmpField4));
        Assertions.assertNotEquals(originType, comparedType);
        Assertions.assertNotEquals(comparedType, originType);
    }
    ...
    public void testStructMatchType() throws Exception {
        ...
        StructType diffName = new StructType(Lists.newArrayList(
                new StructField("st", IntegerType.INT),
