...
public class GlobalStateMgrTestUtil {
    ...
    public static void createEsTable(Database db) throws DdlException {
        ...
        Column userId = new Column("userId", StandardTypes.VARCHAR);
        columns.add(userId);
        columns.add(new Column("time", StandardTypes.BIGINT));
        columns.add(new Column("type", StandardTypes.VARCHAR));
