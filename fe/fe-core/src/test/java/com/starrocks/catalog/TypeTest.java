...
public class TypeTest {
    ...
    public void testMysqlDataType() {
        Object[][] testCases = new Object[][] {
                ...
                {new StructType(Lists.newArrayList(new StructField("col1", Type.INT))), "struct"},
        };
    ...
    public void testMysqlColumnType() {
        Object[][] testCases = new Object[][] {
                ...
                {new StructType(Lists.newArrayList(new StructField("col1", Type.INT))), "struct<col1 int(11)>"},
        };
