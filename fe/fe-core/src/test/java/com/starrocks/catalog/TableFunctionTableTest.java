...
public class TableFunctionTableTest {
    ...
    public void testNormal() {
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(new Column("col_int", StandardTypes.INT), schema.get(0));
            Assertions.assertEquals(new Column("col_string", StandardTypes.VARCHAR), schema.get(1));
