...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/test/java/org/apache/doris/catalog/DataNodeTest.java
...
public class DataNodeTest {
    ...
    public void testSerialization() throws Exception {
        ...
        Assert.assertEquals("DataNode [id=1, host=a, heartbeatPort=1, alive=true]", back1.toString());
    ...
    @Test
    public void testGetDataNodeStorageTypeCnt() {

        int backendStorageTypeCnt;
        DataNode backend = new DataNode(100L, "192.168.1.1", 9050);
        backendStorageTypeCnt = backend.getAvailableDataNodeStorageTypeCnt();
