...
public class ListPartitionInfoTest {
    ...
    public void testMultiListPartition(@Injectable OlapTable dstTable) throws StarRocksException {
        ...
        ListPartitionInfo listPartitionInfo = new ListPartitionInfo(PartitionType.LIST,
                Lists.newArrayList(new Column("dt", StandardTypes.STRING), new Column("province", StandardTypes.STRING)));
        ...
        idToColumn.put(ColumnId.create("dt"), new Column("dt", StandardTypes.STRING));
    ...
    public OlapTable findTableForSingleListPartition() {
        ...
        List<Column> baseSchema =
                Lists.newArrayList(new Column("id", StandardTypes.BIGINT),
                        new Column("province", StandardTypes.BIGINT));
    ...
    public OlapTable findTableForMultiListPartition() {
        ...
        String tableName = "testTbl";
        List<Column> baseSchema =
                Lists.newArrayList(new Column("id", StandardTypes.BIGINT), new Column("province", StandardTypes.BIGINT),
                        new Column("dt", StandardTypes.DATE));
