...
public class StorageMediumInferTest {
    ...
    public void testCreateTable() throws Exception {
        ...
        OlapTable tbl1 = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "tbl1");
        List<Partition> partitionList1 = Lists.newArrayList(tbl1.getPartitions());
        DataProperty dataProperty1 =
                globalStateMgr.getStarRocksMetadata().getDataPropertyIncludeRecycleBin(tbl1.getPartitionInfo(),
        ...
        createTable(sql);
        OlapTable tbl2 = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "tbl2");
        List<Partition> partitionList2 = Lists.newArrayList(tbl2.getPartitions());
        DataProperty dataProperty2 =
                globalStateMgr.getStarRocksMetadata().getDataPropertyIncludeRecycleBin(tbl2.getPartitionInfo(),
        ...
        createTable("create table test.tbl3(key1 int, key2 varchar(10)) \n" +
                "distributed by hash(key1) buckets 10 properties('replication_num' = '1');");
        OlapTable tbl3 = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "tbl3");
        ...
        createTable("create table test.tbl4(key1 int, key2 varchar(10)) \n" +
                "distributed by hash(key1) buckets 10 properties('replication_num' = '1');");
        OlapTable tbl4 = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "tbl4");
        List<Partition> partitionList4 = Lists.newArrayList(tbl4.getPartitions());
        DataProperty dataProperty4 =
                globalStateMgr.getStarRocksMetadata().getDataPropertyIncludeRecycleBin(tbl4.getPartitionInfo(),
    ...
    public void testAlterTableAddPartition() throws Exception {
        ...
        OlapTable tbl2 = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "tblp2");
        List<Partition> partitionList2 = Lists.newArrayList(tbl2.getPartitions());
