...
public class ReplaceLakePartitionTest {
    ...
    LakeTable buildLakeTableWithTempPartition(PartitionType partitionType) {
        ...
        if (partitionType == PartitionType.UNPARTITIONED) {
            ...
            partitionInfo = new ListPartitionInfo(PartitionType.LIST, Lists.newArrayList(new Column("c0", StandardTypes.BIGINT)));
            ...
            partitionInfo = new RangePartitionInfo(Lists.newArrayList(new Column("c0", StandardTypes.BIGINT)));
        ...
        LakeTable table = new LakeTable(
                tableId, "t0",
                Lists.newArrayList(new Column("c0", StandardTypes.BIGINT)),
