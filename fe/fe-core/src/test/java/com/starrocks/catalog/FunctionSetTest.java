...
public class FunctionSetTest {
    ...
    public void testGetLagFunction() {
        ...
        Function lagDesc1 = new Function(new FunctionName("lag"), argTypes1, ScalarType.INVALID, false);
        ...
        Function lagDesc2 = new Function(new FunctionName("lag"), argTypes2, ScalarType.INVALID, false);
