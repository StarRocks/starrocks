...
public class PhysicalPartitionTest {
    ...
    public void testGsonPostProcess() throws IOException {
        ...
        PhysicalPartition physicalPartition = new PhysicalPartition(partitionId, "p1", parentId, baseIndex);
    ...
    public void testCreateRollupMaterializedIndexOperations() {
        ...
        PhysicalPartition partition = new PhysicalPartition(partitionId, "p1", parentId, baseIndex);
    ...
    public void testMultiVersionMaterializedIndexOperations() {
        ...
        PhysicalPartition partition = new PhysicalPartition(partitionId, "p1", parentId, baseIndex1);
