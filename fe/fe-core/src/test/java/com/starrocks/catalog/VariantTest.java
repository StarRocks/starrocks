...
public class VariantTest {
    ...
    // ==================== DateTimeVariant Tests ====================

    @Test
    public void testDateTimeVariantFromString() {
        DateTimeVariant v1 = new DateTimeVariant(DateType.DATETIME, "2024-01-15T10:30:00");
    ...
    public void testDateTimeVariantFromInstant() {
        ...
        DateTimeVariant v1 = new DateTimeVariant(DateType.DATETIME, instant);
    ...
    public void testDateTimeVariantCompareTo() {
        DateTimeVariant v1 = new DateTimeVariant(DateType.DATETIME, "2024-01-15T10:30:00");
        DateTimeVariant v2 = new DateTimeVariant(DateType.DATETIME, "2024-01-15T10:30:01");
        DateTimeVariant v3 = new DateTimeVariant(DateType.DATETIME, "2024-01-15T10:30:00");
    ...
    public void testDateTimeVariantWithNanos() {
        ...
        DateTimeVariant v1 = new DateTimeVariant(DateType.DATETIME, instant1);
        DateTimeVariant v2 = new DateTimeVariant(DateType.DATETIME, instant2);
    ...
    public void testVariantOfDateTime() {
        ...
        Assertions.assertTrue(v1 instanceof DateTimeVariant);

        Variant v2 = Variant.of(DateType.DATE, "2024-01-15T00:00:00");
        Assertions.assertTrue(v2 instanceof DateTimeVariant);
    }
    ...
    // ==================== DateTimeVariant equals() and hashCode() Tests ====================

    @Test
    public void testDateTimeVariantEqualsReflexive() {
        DateTimeVariant v = new DateTimeVariant(DateType.DATETIME, "2024-01-15T10:30:00");
        Assertions.assertTrue(v.equals(v));
    }
    ...
    public void testDateTimeVariantEqualsSymmetric() {
        DateTimeVariant v1 = new DateTimeVariant(DateType.DATETIME, "2024-01-15T10:30:00");
        DateTimeVariant v2 = new DateTimeVariant(DateType.DATETIME, "2024-01-15T10:30:00");
        Assertions.assertTrue(v1.equals(v2));
        Assertions.assertTrue(v2.equals(v1));
    }
    ...
    public void testDateTimeVariantEqualsSameValue() {
        Instant instant = Instant.parse("2024-01-15T10:30:00Z");
        DateTimeVariant v1 = new DateTimeVariant(DateType.DATETIME, instant);
        DateTimeVariant v2 = new DateTimeVariant(DateType.DATETIME, instant);
        Assertions.assertTrue(v1.equals(v2));
    }
    ...
    public void testDateTimeVariantEqualsWithNanos() {
        ...
        DateTimeVariant v1 = new DateTimeVariant(DateType.DATETIME, instant1);
        DateTimeVariant v2 = new DateTimeVariant(DateType.DATETIME, instant2);
        DateTimeVariant v3 = new DateTimeVariant(DateType.DATETIME, instant3);
