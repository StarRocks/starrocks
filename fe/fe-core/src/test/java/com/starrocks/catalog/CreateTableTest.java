...
public class CreateTableTest {
    ...
    public void testNormal() throws DdlException {
        ...
        OlapTable tbl6 = (OlapTable) MetadataMgr.getTable(db.getFullName(), "tbl6");
        Assert.assertTrue(tbl6.getColumn("k1").isKey());
        Assert.assertTrue(tbl6.getColumn("k2").isKey());
        Assert.assertTrue(tbl6.getColumn("k3").isKey());

        OlapTable tbl7 = (OlapTable) MetadataMgr.getTable(db.getFullName(), "tbl7");
    ...
    public void testCreateTableWithLocation() throws Exception {
        ...
        for (int i = 0; i < tableLocationProps.length; i++) {
            ...
            if (expectedAnalyzedProp == null) {
                ...
                createTable(createTableSql);
                table = (OlapTable) MetadataMgr.getTable(testDb.getFullName(), "test_location_prop_" + i);
    ...
    public void testCreateTableWithBinlogProperties() {
        ...
        Database db = MetadataMgr.getDb("test");
        OlapTable table =
                (OlapTable) MetadataMgr.getTable(db.getFullName(), "binlog_table");
    ...
    public void testCreateTableWithConstraint() {
        ...
        Database db = MetadataMgr.getDb("test");
        OlapTable table =
                (OlapTable) MetadataMgr.getTable(db.getFullName(), "parent_table1");
        ...
        OlapTable table2 =
                (OlapTable) MetadataMgr.getTable(db.getFullName(), "parent_table2");
