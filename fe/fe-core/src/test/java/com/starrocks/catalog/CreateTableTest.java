...
public class CreateTableTest {
    ...
    public void testCreatePartitionByExprTable() {
        ...
        ExceptionChecker.expectThrowsWithMsg(AnalysisException.class,
                "Getting analyzing error from line 5, column 24 to line 5, column 41. Detail message: " +
                        "Unsupported partition expression substr for column day type DATETIME, Cause: " +
                        "The first parameter of substr must be a VARCHAR.",
                () -> createTable(
        ...
        ExceptionChecker.expectThrowsWithMsg(AnalysisException.class,
                "Getting analyzing error from line 5, column 24 to line 5, column 49. Detail message: " +
                        "Unsupported partition expression substr for column bill_code type VARCHAR(200), Cause: " +
                        "The second parameter of substr must be a INT.",
                () -> createTable(
        ...
        ExceptionChecker.expectThrowsWithMsg(AnalysisException.class,
                "Getting analyzing error from line 5, column 24 to line 5, column 49. Detail message: " +
                        "Unsupported partition expression substr for column bill_code type VARCHAR(200), Cause: " +
                        "The third parameter of substr must be a INT.",
                () -> createTable(
