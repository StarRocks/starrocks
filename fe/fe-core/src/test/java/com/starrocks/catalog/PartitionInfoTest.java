    ...
    public void testAddDropPartitionPartitionInfo() throws AnalysisException {
        { // ListPartitionInfo
            ListPartitionInfo info =
                    new ListPartitionInfo(PartitionType.LIST, Lists.newArrayList(new Column("c0", StandardTypes.BIGINT)));
        ...
        { // RangePartitionInfo
            RangePartitionInfo info = new RangePartitionInfo(Lists.newArrayList(new Column("c0", StandardTypes.BIGINT)));
