...
public class JDBCResourceTest {
    ...
    public void testSerialization() throws Exception {
        ...
        Assert.assertEquals(jdbcResourceRead.getProperty("hosts"), "host1,host2");
        ...
        Assert.assertEquals(jdbcResourceRead.getProperty("jdbc_type"), "jdbc_type");
