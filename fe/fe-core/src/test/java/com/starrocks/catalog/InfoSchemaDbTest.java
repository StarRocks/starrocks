...
public class InfoSchemaDbTest {
    ...
    public void testShowFunctionsWithPriv() throws Exception {
        ...
        Type[] arg = new Type[1];
        arg[0] = StandardTypes.INT;
        Function function = ScalarFunction.createUdf(new FunctionName("db", "MY_UDF_JSON_GET"), arg, StandardTypes.INT,
        ...
        new Expectations(metadataMgr) {
            {
                ...
                result = HiveTable.builder().setHiveTableName("tbl")
                        .setFullSchema(Lists.newArrayList(new Column("v1", StandardTypes.INT))).build();
                minTimes = 0;
            }
        };
