...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/test/java/org/apache/doris/rewrite/FEFunctionsTest.java
...
public class FEFunctionsTest {
    ...
    @Test
    public void curDateTest() throws AnalysisException {
        Assert.assertEquals(0, FEFunctions.curDate().getHour());
        Assert.assertEquals(0, FEFunctions.curDate().getMinute());
        Assert.assertEquals(0, FEFunctions.curDate().getSecond());
    }
    ...
    public void dateParseTest() {
        try {
            Assert.assertEquals("2013-05-10",
                    FEFunctions.dateParse(new StringLiteral("2013,05,10"), new StringLiteral("%Y,%m,%d"))
                            .getStringValue());
            Assert.assertEquals("2013-05-17 00:35:10", FEFunctions
                    .dateParse(new StringLiteral("2013-05-17 12:35:10"), new StringLiteral("%Y-%m-%d %h:%i:%s"))
                    .getStringValue());
            Assert.assertEquals("2013-05-17 00:35:10", FEFunctions
                    .dateParse(new StringLiteral("2013-05-17 00:35:10"), new StringLiteral("%Y-%m-%d %H:%i:%s"))
                    .getStringValue());
            Assert.assertEquals("2013-05-17 00:35:10", FEFunctions
                    .dateParse(new StringLiteral("2013-05-17 12:35:10 AM"), new StringLiteral("%Y-%m-%d %h:%i:%s %p"))
                    .getStringValue());
            Assert.assertEquals("2013-05-17 12:35:10", FEFunctions
                    .dateParse(new StringLiteral("2013-05-17 12:35:10 PM"), new StringLiteral("%Y-%m-%d %h:%i:%s %p"))
                    .getStringValue());
            Assert.assertEquals("2013-05-17 23:35:10", FEFunctions
                    .dateParse(new StringLiteral("abc 2013-05-17 fff 23:35:10 xyz"),
                            new StringLiteral("abc %Y-%m-%d fff %H:%i:%s xyz")).getStringValue());
            Assert.assertEquals("2016-01-28 23:45:46", FEFunctions
                    .dateParse(new StringLiteral("28-JAN-16 11.45.46 PM"), new StringLiteral("%d-%b-%y %l.%i.%s %p"))
                    .getStringValue());
            Assert.assertEquals("2019-05-09",
                    FEFunctions.dateParse(new StringLiteral("2019/May/9"), new StringLiteral("%Y/%b/%d"))
                            .getStringValue());
            Assert.assertEquals("2019-05-09",
    ...
    public void addBigIntTest() throws AnalysisException {
        LargeIntLiteral actualResult = FEFunctions
                .addBigInt(new LargeIntLiteral("170141183460469231731687303715884105727"),
    ...
    public void subtractBigIntTest() throws AnalysisException {
        LargeIntLiteral actualResult = FEFunctions
                .subtractBigInt(new LargeIntLiteral("170141183460469231731687303715884105727"),
                        new LargeIntLiteral("170141183460469231731687303715884105728"));
        LargeIntLiteral expectedResult = new LargeIntLiteral("-1");
        Assert.assertEquals(expectedResult, actualResult);
    ...
    public void multiplyBigIntTest() throws AnalysisException {
        LargeIntLiteral actualResult = FEFunctions
                .multiplyBigInt(new LargeIntLiteral("-170141183460469231731687303715884105727"),
    ...
    @Test
    public void testMod() throws AnalysisException {
        IntLiteral int1 = new IntLiteral(1);
        IntLiteral int2 = new IntLiteral(100);
        Assert.assertEquals(1, Objects.requireNonNull(FEFunctions.modInt(int1, int2)).getLongValue());

        IntLiteral int3 = new IntLiteral(0);
        Assert.assertNull(FEFunctions.modInt(int1, int3));

        DecimalLiteral decimal1 = new DecimalLiteral(new BigDecimal(2.0));
        DecimalLiteral decimal2 = new DecimalLiteral(new BigDecimal(6.0));
        Assert.assertEquals(2, Objects.requireNonNull(FEFunctions.modDecimal(decimal1, decimal2)).getLongValue());

        LargeIntLiteral actualResult = FEFunctions.modLargeInt(new LargeIntLiteral("5"), new LargeIntLiteral("10"));
        LargeIntLiteral expectedResult = new LargeIntLiteral("5");
