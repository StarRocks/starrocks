...
public class CreateTableWithPartitionTest {
    ...
    public void testCreateTablePartitionLessThan() throws Exception {
        ...
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p20140103 VALUES LESS THEN ('2014-01-03')"));
    }
    ...
    public void testCreateTablePartitionNormal() throws Exception {
        ...
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20140102 VALUES [('2014-01-01'), ('2014-01-02'))"));
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20140103 VALUES [('2014-01-02'), ('2014-01-03'))"));
    }
    ...
    public void testCreateTableBatchPartitionDay() throws Exception {
        ...
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20140102 VALUES [('2014-01-02'), ('2014-01-03'))"));
        Assert.assertTrue(
    ...
    public void testCreateTableBatchPartition5Day() throws Exception {
        ...
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20140106 VALUES [('2014-01-06'), ('2014-01-11'))"));
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20140111 VALUES [('2014-01-11'), ('2014-01-16'))"));
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20140116 VALUES [('2014-01-16'), ('2014-01-21'))"));
    ...
    public void testCreateTableBatchPartitionYear() throws Exception {
        ...
        Assert.assertFalse(partitionDesc.toSql().contains("PARTITION p2021 VALUES [('2021-01-01'), ('2022-01-01'))"));
    ...
    public void testCreateTableBatchPartitionWeekThroughYear2023() throws Exception {
        ...
        CreateTableStmt createTableStmt = (CreateTableStmt) UtFrameUtils.parseStmtWithNewParser(createTableSql, ctx);
        PartitionDesc partitionDesc = createTableStmt.getPartitionDesc();
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p2022_53 VALUES [('2022-12-26'), ('2023-01-02'))"));
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p2023_01 VALUES [('2023-01-02'), ('2023-01-09'))"));
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p2023_02 VALUES [('2023-01-09'), ('2023-01-16'))"));
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p2023_03 VALUES [('2023-01-16'), ('2023-01-23'))"));
    }
    ...
    public void testCreateTableBatchPartitionWeekThroughYear2023Week4() throws Exception {
        ...
        CreateTableStmt createTableStmt = (CreateTableStmt) UtFrameUtils.parseStmtWithNewParser(createTableSql, ctx);
        PartitionDesc partitionDesc = createTableStmt.getPartitionDesc();
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p2022_53 VALUES [('2022-12-29'), ('2023-01-05'))"));
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p2023_01 VALUES [('2023-01-05'), ('2023-01-12'))"));
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p2023_02 VALUES [('2023-01-12'), ('2023-01-19'))"));
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p2023_03 VALUES [('2023-01-19'), ('2023-01-26'))"));
    }
    ...
    public void testCreateTableBatchPartitionNumber() throws Exception {
        ...
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p3 VALUES [('3'), ('4'))"));
        Assert.assertFalse(partitionDesc.toSql().contains("PARTITION p4 VALUES [('4'), ('5'))"));
    ...
    public void testCreateTableBatchPartitionMul() throws Exception {
        ...
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p2015 VALUES [('2015-01-01'), ('2016-01-01'))"));
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20200429 VALUES [('2020-04-29'), ('2020-04-30'))"));
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20200430 VALUES [('2020-04-30'), ('2020-05-01'))"));
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20200501 VALUES [('2020-05-01'), ('2020-05-02'))"));
        Assert.assertTrue(
                partitionDesc.toSql().contains("PARTITION p20200502 VALUES [('2020-05-02'), ('2020-05-03'))"));
    }
    ...
    public void testCreateTableBatchPartitionWithDateTimeType() throws Exception {
        ...
        Assert.assertFalse(partitionDesc.toSql()
    ...
    public void testCreateTableBatchPartitionWithDateKeyType() throws Exception {
        ...
        Assert.assertTrue(partitionDesc.toSql().contains("PARTITION p20140103 VALUES [('20140103'), ('20140104'))"));
