...
public class RefreshMaterializedViewStatementTest {
    ...
    public void testRefreshMaterializedView() throws Exception {
        ...
        Table table = GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "table_name_tmp_1");
        Assert.assertNotNull(table);
        Table t2 = GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "mv1");
