...
public class CreateRoutineLoadStmtTest {
    ...
    public void testParser() {
        String sql = "CREATE ROUTINE LOAD testdb.routine_name ON table1\n"
                ...
                + "\"confluent.schema_registry.url\" = \"https://user:password@confluent.west.us\",\n"
    ...
    public void testToString() {
        ...
        "FROM KAFKA ( \"kafka_broker_list\" = \"kafkahost1:9092,kafkahost2:9092\", \"confluent.schema_registry.url\" = \"https://user:password@confluent.west.us\", \"kafka_topic\" = \"topictest\" )", AstToStringBuilder.toString(stmt));
    }
