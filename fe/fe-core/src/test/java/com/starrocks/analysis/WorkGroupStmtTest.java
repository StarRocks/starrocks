...
public class WorkGroupStmtTest {
    ...
    private static final String runningDir = "fe/mocked/WorkGroupStmtTest/" + UUID.randomUUID() + "/";
    private static StarRocksAssert starRocksAssert;
    private final String createRg1Sql = "create resource_group rg1\n" +
            "to\n" +
            ...
            "    'type' = 'normal'\n" +
            ");";
    private final String createRg2Sql = "create resource_group rg2\n" +
            "to\n" +
            ...
            "    'type' = 'realtime'\n" +
            ");";
    private final String createRg3Sql = "create resource_group rg3\n" +
            "to\n" +
            ...
            "    'type' = 'normal'\n" +
            ");";
    private final String createRg4Sql = "create resource_group rg4\n" +
            "to\n" +
