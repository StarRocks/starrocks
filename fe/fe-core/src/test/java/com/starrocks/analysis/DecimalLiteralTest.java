...
public class DecimalLiteralTest {
    ...
    public void testDealWithSingularDecimalLiteralNormal() throws AnalysisException {
        ...
        Assertions.assertEquals(decimalLiteral.getType(), ScalarType.createDecimalV3Type(PrimitiveType.DECIMAL128, 38, 8));
        Assertions.assertEquals(decimalLiteral.getStringValue(), "123456789012345678901234567890.12345679");

        decimalLiteral = new DecimalLiteral(new BigDecimal("12345678901234567890.12345678901234567890"));
        Assertions.assertEquals(decimalLiteral.getType(), ScalarType.createDecimalV3Type(PrimitiveType.DECIMAL128, 38, 18));
        Assertions.assertEquals(decimalLiteral.getStringValue(), "12345678901234567890.123456789012345679");
