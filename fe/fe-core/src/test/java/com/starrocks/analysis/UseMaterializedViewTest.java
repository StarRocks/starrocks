...
public class UseMaterializedViewTest {
    ...
    public void testDropMaterializedView() {
        ...
        try {
            Database database = starRocksAssert.getCtx().getGlobalStateMgr().getMetastore().getDb("test");
            Assert.assertTrue(database != null);
            Table table = GlobalStateMgr.getCurrentState().getMetastore().getTable(database.getFullName(), "mv_to_drop");
            Assert.assertTrue(table != null);
            MaterializedView materializedView = (MaterializedView) table;
            long baseTableId = materializedView.getBaseTableInfos().iterator().next().getTableId();
            OlapTable baseTable = ((OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(database.getId(), baseTableId));
            ...
            table = GlobalStateMgr.getCurrentState().getMetastore().getTable(database.getFullName(), "mv_to_drop");
            Assert.assertTrue(table == null);
