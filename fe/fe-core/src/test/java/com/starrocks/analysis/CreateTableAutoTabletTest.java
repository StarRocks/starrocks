...
public class CreateTableAutoTabletTest {
    ...
    public void testAutoTabletWithoutPartition() throws Exception {
        ...
        Database db = GlobalStateMgr.getCurrentState().getMetastore().getDb("db_for_auto_tablets");
        if (db == null) {
            return;
        }
        OlapTable table = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "test_table1");
        if (table == null) {
            return;
        }
    ...
    public void test1AutoTabletWithPartition() throws Exception {
        ...
        OlapTable table = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "test_table2");
        if (table == null) {
            return;
        }
    ...
    public void test1AutoTabletWithDynamicPartition() throws Exception {
        ...
        OlapTable table = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "test_auto_tablets_of_dynamic_partition");
        if (table == null) {
            return;
        }
    ...
    public void test1AutoTabletWithModifyDynamicPartitionProperty() throws Exception {
        ...
        OlapTable table = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "test_modify_dynamic_partition_property");
        if (table == null) {
            return;
        }
    ...
    public void test1AutoTabletWithColocate() throws Exception {
        ...
        OlapTable table = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "colocate_partition");
        if (table == null) {
            return;
        }
