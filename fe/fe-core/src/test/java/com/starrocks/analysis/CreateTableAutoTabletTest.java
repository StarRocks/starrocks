...
public class CreateTableAutoTabletTest {
    ...
    public void test1AutoTabletWithPartition() throws Exception {
        ...
        OlapTable table = (OlapTable) MetadataMgr.getTable(db.getFullName(), "test_table2");
        if (table == null) {
            return;
        }
    ...
    public void test1AutoTabletWithDynamicPartition() throws Exception {
        ...
        OlapTable table = (OlapTable) MetadataMgr.getTable(db.getFullName(), "test_auto_tablets_of_dynamic_partition");
        if (table == null) {
            return;
        }
    ...
    public void test1AutoTabletWithModifyDynamicPartitionProperty() throws Exception {
        ...
        OlapTable table = (OlapTable) MetadataMgr.getTable(db.getFullName(), "test_modify_dynamic_partition_property");
        if (table == null) {
            return;
        }
    ...
    public void test1AutoTabletWithColocate() throws Exception {
        ...
        OlapTable table = (OlapTable) MetadataMgr.getTable(db.getFullName(), "colocate_partition");
        if (table == null) {
            return;
        }
