...
public class CreateMaterializedViewTest {
    ...
    public void testFullCreateMultiTables() throws Exception {
        ...
        try {
            StatementBase statementBase = UtFrameUtils.parseStmtWithNewParser(sql, connectContext);
            currentState.getStarRocksMeta().createMaterializedView((CreateMaterializedViewStatement) statementBase);
    ...
    public void testCreateColocateMvToExitGroup() throws Exception {
        ...
        try {
            StatementBase statementBase = UtFrameUtils.parseStmtWithNewParser(sql, connectContext);
            currentState.getStarRocksMeta().createMaterializedView((CreateMaterializedViewStmt) statementBase);
    ...
    private void assertCreateFailWithException(String sql, String msg) {
        ...
        try {
            currentState.getStarRocksMeta().createMaterializedView(stmt);
            Assert.fail();
        } catch (Exception e) {
            Assert.assertTrue(e.getMessage().contains(msg));
        }
    ...
    MaterializedView getMaterializedViewChecked(String sql) {
        try {
            ...
            currentState.getStarRocksMeta().createMaterializedView(createMaterializedViewStatement);
