...
public class ModifyDataNodeAddressClauseTest {
    ...
    public void testCreateClause() {
        ModifyDataNodeAddressClause clause1 = new ModifyDataNodeAddressClause("originalHost-test", "sandbox");
    ...
    public void testNormal() throws AnalysisException {
        ModifyDataNodeAddressClause clause = new ModifyDataNodeAddressClause("", "");
