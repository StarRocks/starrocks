    ...
    public void testDropPipeTaskProtected() throws Exception {
        ...
        try {
            ...
            assertEquals("Can not drop task generated by pipe. " +
                    "You can use DROP PIPE to drop the pipe, which will delete the related task automatically, " +
                    "or use DROP TASK ... FORCE to force delete this task.", e.getMessage());
            ...
            assertEquals("Can not drop task generated by pipe. " +
                    "You can use DROP PIPE to drop the pipe, which will delete the related task automatically, " +
                    "or use DROP TASK ... FORCE to force delete this task.", e2.getMessage());
