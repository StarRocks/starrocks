...
public class DateLiteralNewTest {
    ...
    public void testFromString() throws AnalysisException {
        DateLiteral dateLiteral = new DateLiteral("2022-12-12 16:20:17.123456", StandardTypes.DATETIME);
        ...
        dateLiteral = new DateLiteral("2023-03-29 01:01:01.12", StandardTypes.DATETIME);
        ...
        dateLiteral = new DateLiteral("2023-03-29 01:01:01.1234", StandardTypes.DATETIME);
    ...
    public void invalidDate() {
        ...
        for (String c : testDateCases) {
            Assertions.assertThrows(AnalysisException.class, () -> new DateLiteral(c, StandardTypes.DATE));
        }
        ...
        for (String c : testDatetimeCases) {
            Assertions.assertThrows(AnalysisException.class, () -> new DateLiteral(c, StandardTypes.DATETIME));
        }
    }
