    ...
    public void testMVAggregate() throws Exception {
        {
            ...
            CreateMaterializedViewStmt stmt =
                    (CreateMaterializedViewStmt) UtFrameUtils.parseStmtWithNewParser(sql, starRocksAssert.getCtx());
            Assertions.assertEquals(StandardTypes.BIGINT, stmt.getMVColumnItemList().get(1).getType());
        }
        ...
        }
        {
            ...
            CreateMaterializedViewStmt stmt =
                    (CreateMaterializedViewStmt) UtFrameUtils.parseStmtWithNewParser(sql, starRocksAssert.getCtx());
            Assertions.assertEquals(StandardTypes.DOUBLE, stmt.getMVColumnItemList().get(1).getType());
        }
    }
