...
public class ModifyBackendAddressClauseTest {
    ...
    public void testGetDiscardedHost() throws AnalysisException {
        ...
        ModifyBackendAddressClause clause = new ModifyBackendAddressClause("originalHost:1000", "testHost:1000");
    ...
    public void testGetNewlyEffectiveHost() throws AnalysisException {
        ...
        ModifyBackendAddressClause clause = new ModifyBackendAddressClause("testHost:1000", "newHost:1000");
        clause.analyze(analyzer);
