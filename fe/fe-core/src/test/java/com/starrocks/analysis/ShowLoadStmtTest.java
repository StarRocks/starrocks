...
public class ShowLoadStmtTest {
    ...
    public void testNormal() throws Exception {
        ...
        Assertions.assertEquals("State", metaData.getColumn(2));
        Assertions.assertEquals("Progress", metaData.getColumn(3));
        Assertions.assertEquals("Type", metaData.getColumn(4));
        Assertions.assertEquals("Priority", metaData.getColumn(5));
        Assertions.assertEquals("ScanRows", metaData.getColumn(6));
        Assertions.assertEquals("FilteredRows", metaData.getColumn(7));
        Assertions.assertEquals("UnselectedRows", metaData.getColumn(8));
        Assertions.assertEquals("SinkRows", metaData.getColumn(9));
        Assertions.assertEquals("EtlInfo", metaData.getColumn(10));
        Assertions.assertEquals("TaskInfo", metaData.getColumn(11));
        Assertions.assertEquals("ErrorMsg", metaData.getColumn(12));
        Assertions.assertEquals("CreateTime", metaData.getColumn(13));
        Assertions.assertEquals("EtlStartTime", metaData.getColumn(14));
        Assertions.assertEquals("EtlFinishTime", metaData.getColumn(15));
        Assertions.assertEquals("LoadStartTime", metaData.getColumn(16));
        Assertions.assertEquals("LoadFinishTime", metaData.getColumn(17));
        Assertions.assertEquals("TrackingSQL", metaData.getColumn(18));
        Assertions.assertEquals("JobDetails", metaData.getColumn(19));
        Assertions.assertEquals("Warehouse", metaData.getColumn(20));
    }
