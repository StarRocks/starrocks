...
public class ShowLoadStmtTest {
    ...
    public void testInvalidWhere() {
        AnalyzeTestUtil.getStarRocksAssert().useDatabase("test");
        analyzeFail("SHOW LOAD WHERE STATE = 'RUNNING'", "Where clause should looks like: LABEL = \"your_load_label\", or LABEL LIKE \"matcher\",  or STATE = \"PENDING|ETL|LOADING|FINISHED|CANCELLED\",  or compound predicate with operator AND");
    }
