...
public class ShowMaterializedViewTest {
    ...
    public void testNormal() throws Exception {
        ...
        ShowMaterializedViewStmt stmt = new ShowMaterializedViewStmt("", null, null);
        ...
        stmt = new ShowMaterializedViewStmt("abc", "bcd", null);
        com.starrocks.sql.analyzer.Analyzer.analyze(stmt, ctx);
    ...
    public void testNoDb() throws Exception {
        ctx = UtFrameUtils.createDefaultCtx();
        ShowMaterializedViewStmt stmt = new ShowMaterializedViewStmt("", "", null);
        com.starrocks.sql.analyzer.Analyzer.analyze(stmt, ctx);
