...
public class CompactionJobTest {
    ...
    public void testGetResult() {
        ...
        PhysicalPartition partition = new PhysicalPartitionImpl(0, "", 1, null);
    ...
    public void testBuildTabletCommitInfo() {
        ...
        Table table = new Table(Table.TableType.CLOUD_NATIVE);
        PhysicalPartition partition = new PhysicalPartitionImpl(0, "", 1, null);
        CompactionJob job = new CompactionJob(db, table, partition, 10010, false, "warehouse");
        assertDoesNotThrow(() -> {
    ...
    public void testGetExecutionProfile() {
        ...
        Table table = new Table(Table.TableType.CLOUD_NATIVE);
        PhysicalPartition partition = new PhysicalPartitionImpl(0, "", 1, null);
        CompactionJob job = new CompactionJob(db, table, partition, 10010, true, "warehouse");
