...
public class DatabaseTransactionGraphTest {
    private void expectNextBatch(DatabaseTransactionGraph graph, List<Long> expected) {
    ...
    public void testSimple() {
        DatabaseTransactionGraph graph = new DatabaseTransactionGraph();
