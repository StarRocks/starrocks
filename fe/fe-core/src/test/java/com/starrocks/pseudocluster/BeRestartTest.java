...
public class BeRestartTest {
    ...
    public void testBeRestart() throws Exception {
        ...
        final PseudoDataNode be10001 = cluster.getDataNode(10001);
        final PseudoDataNode be10002 = cluster.getDataNode(10002);
        final PseudoDataNode be10003 = cluster.getDataNode(10003);
