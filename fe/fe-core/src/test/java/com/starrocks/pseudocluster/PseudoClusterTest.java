...
public class PseudoClusterTest {
    ...
    public void testCreateTabletAndInsert() throws Exception {
        ...
        try {
            ...
            stmt.execute(
                    "create table test ( pk bigint NOT NULL, v0 string not null, v1 int not null ) primary KEY (pk) DISTRIBUTED BY HASH(pk) BUCKETS 7 PROPERTIES(\"replication_num\" = \"3\", \"storage_medium\" = \"SSD\")");
