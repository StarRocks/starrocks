...
public class MaterializedViewTextBasedRewriteTPCHTest extends MaterializedViewTestBase {
    ...
    public static void beforeClass() throws Exception {
        ...
        OlapTable t4 = (OlapTable) globalStateMgr.getMetastore().getDb(MATERIALIZED_DB_NAME).getTable("customer");
        setTableStatistics(t4, 150000 * scale);
        OlapTable t7 = (OlapTable) globalStateMgr.getMetastore().getDb(MATERIALIZED_DB_NAME).getTable("lineitem");
