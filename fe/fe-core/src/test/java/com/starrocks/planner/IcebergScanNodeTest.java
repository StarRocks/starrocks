...
public class IcebergScanNodeTest {
    ...
    void executeShouldRunNormallyWhenPreparedStateAndTasksExist() throws Exception {
        ...
        new MockUp<IcebergRewriteStmt>() {
            @Mock
            public void $init(InsertStmt base, boolean rewriteAll, boolean writeRowLineage, boolean hasPartitionFilter) {
                //do nothing
            }
        };

        IcebergRewriteDataJob job = new IcebergRewriteDataJob(
                "insert into t select * from t", "insert into t select * from t", false, false, 0L, 10L, 1L, false,
                context, alter);
    ...
    void executeShouldSetErrorAndReturnWhenExecutorThrows() throws Exception {
        ...
        new mockit.MockUp<IcebergRewriteStmt>() {
            @mockit.Mock
            public void $init(InsertStmt base, boolean rewriteAll, boolean writeRowLineage, boolean hasPartitionFilter) { /* no-op */ }
        };
        ...
        IcebergRewriteDataJob job = new IcebergRewriteDataJob(
                "insert into t select 1", "insert into t select 1", false, false, 0L, 10L, 1L, false, context, alter);
