...
public class OlapTableSinkTest2 {
    ...
    public void testCreateLocationException() {
        ...
        Database db = GlobalStateMgr.getCurrentState().getMetastore().getDb("db2");
        OlapTable olapTable = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getTable(db.getFullName(), "tbl1");
