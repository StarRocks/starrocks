...
public class MaterializedViewTest extends MaterializedViewTestBase {
    ...
    public static void beforeClass() throws Exception {
        ...
        OlapTable t7 = (OlapTable) globalStateMgr.getMetastore().getDb(MATERIALIZED_DB_NAME).getTable("emps");
    ...
    public void testJoinWithToBitmapRewrite() throws Exception {
        try {
            ...
            OlapTable t4 = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getDb(MATERIALIZED_DB_NAME)
