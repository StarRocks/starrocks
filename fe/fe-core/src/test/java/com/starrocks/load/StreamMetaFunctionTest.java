...
public class StreamMetaFunctionTest {
    ...
    public void testValidateSourceMatch() {
        ...
        Assertions.assertThrows(DdlException.class,
                () -> Load.validateStreamMetaFunctions(kafkaOffset, "PULSAR", "json"));
        Assertions.assertDoesNotThrow(() -> Load.validateStreamMetaFunctions(kafkaOffset, "KAFKA", "json"));
        ...
        Assertions.assertThrows(DdlException.class,
                () -> Load.validateStreamMetaFunctions(pulsarMid, "KAFKA", "json"));
    }
    ...
    public void testValidateFormat() {
        ...
        Assertions.assertThrows(DdlException.class, () -> Load.validateStreamMetaFunctions(descs, "KAFKA", ""));
        Assertions.assertDoesNotThrow(() -> Load.validateStreamMetaFunctions(descs, "KAFKA", "json"));
        Assertions.assertDoesNotThrow(() -> Load.validateStreamMetaFunctions(descs, "KAFKA", "avro"));
    }
    ...
    public void testValidateAvroRejectedForPulsar() {
        ...
        Assertions.assertThrows(DdlException.class,
                () -> Load.validateStreamMetaFunctions(descs, "PULSAR", "avro"));
        Assertions.assertDoesNotThrow(() -> Load.validateStreamMetaFunctions(descs, "PULSAR", "json"));
    }
    ...
    public void testValidateArityAndKey() {
        ...
        Assertions.assertThrows(DdlException.class, () -> Load.validateStreamMetaFunctions(noArg, "KAFKA", "json"));

        List<ImportColumnDesc> nonLiteral =
                Lists.newArrayList(new ImportColumnDesc("c", call("kafka_header", new SlotRef(null, "x"))));
        Assertions.assertThrows(DdlException.class, () -> Load.validateStreamMetaFunctions(nonLiteral, "KAFKA", "json"));

        List<ImportColumnDesc> ok =
                Lists.newArrayList(new ImportColumnDesc("c", call("kafka_header", new StringLiteral("trace-id"))));
        Assertions.assertDoesNotThrow(() -> Load.validateStreamMetaFunctions(ok, "KAFKA", "json"));
        ...
        Assertions.assertThrows(DdlException.class, () -> Load.validateStreamMetaFunctions(extraArg, "KAFKA", "json"));
    }
