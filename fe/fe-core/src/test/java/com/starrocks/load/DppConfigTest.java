...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/test/java/org/apache/doris/load/DppConfigTest.java
...
public class DppConfigTest {
    ...
    public void testNormal(@Mocked GlobalStateMgr globalStateMgr) throws LoadException {
        ...
        Assert.assertEquals(String.format("/user/starrocks2/%d/applications/%s", clusterId, FeConstants.dpp_version),
                dppConfig.getApplicationsPath());
        Assert.assertEquals(String.format("/user/starrocks2/%d/output", clusterId), dppConfig.getOutputPath());
