...
public class ExportJobTest {
    ...
    public void initProfile_createsProfileWithCorrectSummaryInfo(@Mocked GlobalStateMgr state,
        ...
        Assert.assertNotNull(summaryProfile);
        Assert.assertEquals("12345", summaryProfile.getInfoString(ProfileManager.QUERY_ID));
        Assert.assertEquals("Query", summaryProfile.getInfoString(ProfileManager.QUERY_TYPE));
        Assert.assertEquals("EXPORTING", summaryProfile.getInfoString(ProfileManager.QUERY_STATE));
        Assert.assertEquals("default_warehouse", summaryProfile.getInfoString(ProfileManager.WAREHOUSE_CNGROUP));
    }
}
