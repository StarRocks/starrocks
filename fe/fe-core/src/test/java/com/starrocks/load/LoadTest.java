...
public class LoadTest {
    ...
    public void testInitColumnsPathColumns() throws StarRocksException {
        // columns
        String c0Name = "c0";
        columns.add(new Column(c0Name, StandardTypes.INT, true, null, true, null, ""));
        columnExprs.add(new ImportColumnDesc(c0Name, null));

        String c1Name = "c1";
        columns.add(new Column(c1Name, StandardTypes.INT, true, null, true, null, ""));
        ...
        Assertions.assertTrue(c1SlotDesc.getColumn().getType().equals(StandardTypes.VARCHAR));
    }
    ...
    public void testInitColumnsColumnInSchemaAndExprArgs() throws StarRocksException {
        ...
        String c2Name = "c2";
        columns.add(new Column(c2Name, StandardTypes.BITMAP, false, AggregateType.BITMAP_UNION, true, null, ""));
        columnExprs.add(new ImportColumnDesc(c2Name, null));

        String c3Name = "c3";
        columns.add(new Column(c3Name, StandardTypes.VARCHAR, false, AggregateType.REPLACE, true, null, ""));
        columnExprs.add(new ImportColumnDesc(c3Name, null));
        String c31Name = "c31";
        columns.add(new Column(c31Name, StandardTypes.INT, true, AggregateType.SUM, true, null, ""));
        ...
        Expr mapping3 = new ArithmeticExpr(ArithmeticExpr.Operator.ADD, new SlotRef(null, c3Name),
                new IntLiteral(1, StandardTypes.INT));
        ...
        Assertions.assertTrue(c2SlotDesc.getColumn().getType().equals(StandardTypes.VARCHAR));
        SlotDescriptor c3SlotDesc = slotDescByName.get(c3Name);
        Assertions.assertTrue(c3SlotDesc.getColumn().getType().equals(StandardTypes.VARCHAR));
    }
    ...
    public void testLambda() throws Exception {
        ...
        columns.add(new Column(c0Name, StandardTypes.INT, true, null, true, null, ""));
        String c1Name = "c1";
        columns.add(new Column(c1Name, StandardTypes.STRING, false, null, true, null, ""));
        String c2Name = "c2";
        columns.add(new Column(c2Name, StandardTypes.STRING, false, null, true, null, ""));
        String c3Name = "c3";
        columns.add(new Column(c3Name, StandardTypes.STRING, false, null, true, null, ""));
    ...
    public void testNowPrecision() throws Exception {
        ...
        columns.add(new Column(c0Name, StandardTypes.INT, true, null, true, null, ""));
        String c1Name = "c1";
        columns.add(new Column(c1Name, StandardTypes.DATETIME, false, null, true, null, ""));
        String c2Name = "c2";
        columns.add(new Column(c2Name, StandardTypes.DATETIME, false, null, true, null, ""));
        new Expectations() {
            {
                table.getBaseSchema();
                result = columns;
