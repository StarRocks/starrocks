...
public class SparkLoadPendingTaskTest {
    ...
    public void testExecuteTask(@Injectable SparkLoadJob sparkLoadJob,
        ...
        columns.add(new Column("c1", StandardTypes.BIGINT, true, null, false, null, ""));
    ...
    public void testRangePartitionHashDistribution(@Injectable SparkLoadJob sparkLoadJob,
        ...
        List<Column> columns = Lists.newArrayList();
        columns.add(new Column("c1", StandardTypes.INT, true, null, false, null, ""));
        columns.add(new Column("c2", TypeFactory.createVarcharType(10), true, null, false, null, ""));
        columns.add(new Column("c3", StandardTypes.INT, false, AggregateType.SUM, false, null, ""));
