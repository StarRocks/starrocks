...
public class MergeTabletJobTest {
    ...
    public void testMergeTabletJobFactoryWithTabletGroups() throws Exception {
        ...
        List<Tablet> orderedTablets = getOrderedTablets(oldIndex);
    ...
    private List<Tablet> getOrderedTablets(MaterializedIndex index) {
        return new ArrayList<>(index.getTablets());
    }
}
