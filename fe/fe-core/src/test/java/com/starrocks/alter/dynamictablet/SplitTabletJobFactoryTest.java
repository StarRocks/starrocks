...
public class SplitTabletJobFactoryTest {
    ...
    public void testCreateDynamicTabletJob() throws Exception {
...

        {
            ...
            Assertions.assertNotNull(materializedIndex.getDynamicTablets());

            Assertions.assertThrows(StarRocksException.class, () -> factory.createDynamicTabletJob());

            ((SplitTabletJob) dynamicTabletJob).clearDynamicTablets();

            ((SplitTabletJob) factory.createDynamicTabletJob()).clearDynamicTablets();
        }
    }
}
