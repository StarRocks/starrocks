...
public class LakeTableAsyncFastSchemaChangeJobTest {
    ...
    private static LakeTable createTable(ConnectContext connectContext, String sql) throws Exception {
        ...
        Database db = GlobalStateMgr.getCurrentState().getMetastore().getDb(createTableStmt.getDbName());
        LakeTable table = (LakeTable) GlobalStateMgr.getCurrentState().getMetastore()
    ...
    public void testReplay() throws Exception {
        Database db = GlobalStateMgr.getCurrentState().getMetastore().getDb(DB_NAME);
