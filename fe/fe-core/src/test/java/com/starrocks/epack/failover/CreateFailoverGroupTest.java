...
public class CreateFailoverGroupTest {
    ...
    public void testCreatePrimaryFailoverGroup() throws Exception {
        ...
        DDLStmtExecutorEPack.execute(stmt1, starRocksAssert.getCtx());
        ...
        DDLStmtExecutorEPack.execute(stmt2, starRocksAssert.getCtx());
    ...
    public void testCreateSecondaryFailoverGroup() throws Exception {
        ...
        DDLStmtExecutorEPack.execute(stmt, starRocksAssert.getCtx());
