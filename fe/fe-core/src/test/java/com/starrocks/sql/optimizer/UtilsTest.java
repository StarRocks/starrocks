...
public class UtilsTest {
    ...
    public void unknownStats() {
        ...
        OptExpression opt = new OptExpression(new LogicalOlapScanOperator(t0, null, columnRefMap, null, -1, null));
        ...
        Catalog.getCurrentStatisticStorage().addColumnStatistic(t0, "v3",
                new ColumnStatistic(1, 1, 0, 1, 1));
        opt = new OptExpression(new LogicalOlapScanOperator(t0, null, columnRefMap, null, -1, null));
