...
public class TPCDS1TRuntimeFilterTest extends TPCDS1TTestBase {
    ...
    public void testRuntimeFilterWaitMs(String name) throws Exception {
        String plan = getVerboseExplain(getSql(name));
        Assertions.assertTrue(plan.contains("xwait = "), () -> extractRuntimeFilter(plan));
    }
    ...
    private static Stream<Arguments> waitCases() {
        Arguments[] list = new Arguments[] {
                //                Arguments.of("query01"),
                //                Arguments.of("query02"),
                //                Arguments.of("query03"),
                //                Arguments.of("query04"),
                Arguments.of("query05"),
                //                Arguments.of("query06"),
                //                Arguments.of("query07"),
                //                Arguments.of("query08"),
                //                Arguments.of("query09"),
                Arguments.of("query10"),
                //                Arguments.of("query11"),
                //                Arguments.of("query12"),
                Arguments.of("query13"),
                //                Arguments.of("query14-1"),
                //                Arguments.of("query14-2"),
                //                Arguments.of("query15"),
                Arguments.of("query16"),
                //                Arguments.of("query17"),
                //                Arguments.of("query18"),
                //                Arguments.of("query19"),
                //                Arguments.of("query20"),
                //                Arguments.of("query21"),
                //                Arguments.of("query22"),
                Arguments.of("query23-1"),
                Arguments.of("query23-2"),
                //                Arguments.of("query24-1"),
                //                Arguments.of("query24-2"),
                Arguments.of("query25"),
                //                Arguments.of("query26"),
                //                Arguments.of("query27"),
                //                Arguments.of("query28"),
                //                Arguments.of("query29"),
                //                Arguments.of("query30"),
                //                Arguments.of("query31"),
                Arguments.of("query32"),
                //                Arguments.of("query33"),
                //                Arguments.of("query34"),
                Arguments.of("query35"),
                //                Arguments.of("query36"),
                //                Arguments.of("query37"),
                //                Arguments.of("query38"),
                //                Arguments.of("query39-1"),
                //                Arguments.of("query39-2"),
                //                Arguments.of("query39-1-2"),
                //                Arguments.of("query39-2-2"),
                //                Arguments.of("query40"),
                //                Arguments.of("query41"),
                //                Arguments.of("query42"),
                //                Arguments.of("query43"),
                //                Arguments.of("query44"),
                //                Arguments.of("query45"),
                //                Arguments.of("query46"),
                //                Arguments.of("query47"),
                //                Arguments.of("query48"),
                //                Arguments.of("query49"),
                //                Arguments.of("query50"),
                //                Arguments.of("query51"),
                //                Arguments.of("query52"),
                //                Arguments.of("query53"),
                Arguments.of("query54"),
                //                Arguments.of("query55"),
                //                Arguments.of("query56"),
                //                Arguments.of("query57"),
                //                Arguments.of("query58"),
                //                Arguments.of("query59"),
                //                Arguments.of("query60"),
                //                Arguments.of("query61"),
                //                Arguments.of("query62"),
                //                Arguments.of("query63"),
                Arguments.of("query64"),
                Arguments.of("query64-2"),
                Arguments.of("query65"),
                //                Arguments.of("query66"),
                //                Arguments.of("query67"),
                //                Arguments.of("query68"),
                Arguments.of("query69"),
                //                Arguments.of("query70"),
                //                Arguments.of("query71"),
                //                Arguments.of("query72"),
                //                Arguments.of("query73"),
                //                Arguments.of("query74"),
                //                Arguments.of("query75"),
                //                Arguments.of("query76"),
                //                Arguments.of("query77"),
                //                Arguments.of("query78"),
                //                Arguments.of("query79"),
                Arguments.of("query80"),
                //                Arguments.of("query81"),
                //                Arguments.of("query82"),
                //                Arguments.of("query83"),
                //                Arguments.of("query84"),
                Arguments.of("query85"),
                //                Arguments.of("query86"),
                //                Arguments.of("query87"),
                //                Arguments.of("query88"),
                //                Arguments.of("query89"),
                //                Arguments.of("query90"),
                Arguments.of("query91"),
                Arguments.of("query92"),
                //                Arguments.of("query93"),
                Arguments.of("query94"),
                Arguments.of("query95"),
                //                Arguments.of("query96"),
                //                Arguments.of("query97"),
                //                Arguments.of("query98"),
                //                Arguments.of("query99"),
        };
