...
=======
        assertContains(plan, "  3:Decode\n" +
                ...
                "  |  limit: 10");
        ;
>>>>>>> 3fadd4127 ([Bugfix] keep the aggregate expr order when rewrite aggregate operator (#7657)):fe/fe-core/src/test/java/com/starrocks/sql/plan/LowCardinalityTest.java
    }
