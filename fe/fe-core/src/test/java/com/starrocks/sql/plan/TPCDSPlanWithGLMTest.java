...
public class TPCDSPlanWithGLMTest extends TPCDSPlanTestBase {
    private static final Logger LOG = LogManager.getLogger(TPCDSPlanWithGLMTest.class);
    ...
    public static void beforeClass() throws Exception {
        ...
        LOG.info("current db " + connectContext.getDatabase());
    ...
    private static Stream<Arguments> tpcdsSource() {
        ...
        for (Map.Entry<String, String> entry : getAllSQL().entrySet()) {
