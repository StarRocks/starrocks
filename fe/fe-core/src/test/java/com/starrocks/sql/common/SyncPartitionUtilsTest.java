...
public class SyncPartitionUtilsTest extends StarRocksTestBase {
    ...
    public static void beforeClass() throws Exception {
        ...
        partitionColumn = new Column("k1", StandardTypes.DATETIME);
    }
    ...
    public void testMappingRangeRollupWithMaxValue() throws AnalysisException {
        String maxValueDate =
                new DateLiteral(StandardTypes.DATE, true).toLocalDateTime().format(DateTimeFormatter.ISO_DATE_TIME);
        // minute
    ...
    private DateLiteral plusDay(DateLiteral dateLiteral, int diff) {
        try {
            ...
            return new DateLiteral(date, StandardTypes.DATE);
        } catch (Exception e) {
            Assertions.fail();
            return null;
        }
    ...
    public void transferRangeHandlesMinValue() throws AnalysisException {
        final DateLiteral minValue = DateLiteral.createMinValue(StandardTypes.DATE);
    ...
    public void transferRangeHandlesMaxValue() throws AnalysisException {
        final DateLiteral maxValue = DateLiteral.createMaxValue(StandardTypes.DATE);
