...
public class HistogramStatisticsTest {
    ...
    public void testColumnToConstant() {
        ColumnRefOperator columnRefOperator = new ColumnRefOperator(0, StandardTypes.BIGINT, "v1", true);
    ...
    public void testColumnToColumn() {
        ColumnRefOperator leftColumnRefOperator = new ColumnRefOperator(0, StandardTypes.BIGINT, "v1", true);
        ...
        ColumnRefOperator rightColumnRefOperator = new ColumnRefOperator(1, StandardTypes.BIGINT, "v2", true);
    ...
    public void testNotHitBucketInHist() {
        ...
        Optional<Histogram> notExist = BinaryPredicateStatisticCalculator.updateHistWithGreaterThan(columnStatistic,
                Optional.of(new ConstantOperator(400, StandardTypes.BIGINT)), true);
        ...
        notExist = BinaryPredicateStatisticCalculator.updateHistWithLessThan(columnStatistic,
                Optional.of(new ConstantOperator(-1, StandardTypes.BIGINT)), true);
        Assertions.assertFalse(notExist.isPresent());
        ...
        Optional<Histogram> exist = BinaryPredicateStatisticCalculator.updateHistWithGreaterThan(columnStatistic,
                Optional.of(new ConstantOperator(18, StandardTypes.BIGINT)), true);
        ...
        exist = BinaryPredicateStatisticCalculator.updateHistWithLessThan(columnStatistic,
                Optional.of(new ConstantOperator(3, StandardTypes.BIGINT)), true);
        Assertions.assertEquals(exist.get().getBuckets().size(), 1);
    ...
    public void testUpdateHistWithEqual() {
        ...
        Optional<Histogram> notExist = BinaryPredicateStatisticCalculator.updateHistWithEqual(columnStatistic,
                Optional.of(new ConstantOperator(12, StandardTypes.BIGINT)));
        Assertions.assertFalse(notExist.isPresent());
        ...
        Optional<Histogram> exist = BinaryPredicateStatisticCalculator.updateHistWithEqual(columnStatistic,
                Optional.of(new ConstantOperator(22, StandardTypes.BIGINT)));
        ...
        exist = BinaryPredicateStatisticCalculator.updateHistWithEqual(columnStatistic,
                Optional.of(new ConstantOperator(2, StandardTypes.BIGINT)));
        Assertions.assertTrue(exist.isPresent());
        Assertions.assertEquals(exist.get().getBuckets().size(), 0);
    ...
    public void testHitMCV() {
        ...
        ColumnRefOperator columnRefOperator = new ColumnRefOperator(0, StandardTypes.BOOLEAN, "b1", true);
        ...
        columnRefOperator = new ColumnRefOperator(0, StandardTypes.BOOLEAN, "b1", true);
    ...
    public void testUpdateHistWithJoin() {
        ...
        Optional<Histogram> notExist = BinaryPredicateStatisticCalculator.updateHistWithJoin(
                columnStatisticLeft, StandardTypes.BIGINT, columnStatisticRight, StandardTypes.BIGINT);
        ...
        exist = BinaryPredicateStatisticCalculator.updateHistWithJoin(columnStatisticLeft, StandardTypes.BIGINT,
                columnStatisticRight, StandardTypes.BIGINT);
        Assertions.assertTrue(exist.isPresent());
