...
public class AnalyzeSnapshotTest {
    ...
    public void testShowSnapshot() throws DdlException {
        ...
        String sql = "SHOW SNAPSHOT ON `repo` WHERE SNAPSHOT = \"backup1\" AND TIMESTAMP = \"2018-05-05-15-34-26\";";
        analyzeSuccess(sql);
        analyzeFail("SHOW SNAPSHOT ON `repo1` WHERE SNAPSHOT = \"backup1\" AND TIMESTAMP = \"2018-05-05-15-34-26\";");
