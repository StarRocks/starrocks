...
public class AggregateTest extends PlanTestBase {
    ...
    public void testSortAggWithMonotonicExpressions() throws Exception {
        ...
        try {
            ...
            // Test 3: encode_sort_key with wrong order (should not use sort agg)
