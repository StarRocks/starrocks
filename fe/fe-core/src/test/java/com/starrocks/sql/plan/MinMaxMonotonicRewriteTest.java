...
public class MinMaxMonotonicRewriteTest extends PlanTestBase {
    ...
    public void testColumnMinMaxMgrGenSql() throws Exception {
        ...
        when(regularColumn.getType()).thenReturn(StandardTypes.BIGINT);
        ...
        when(jsonColumn.getType()).thenReturn(StandardTypes.BIGINT);
        ...
        when(jsonColumn.getName()).thenReturn("json_col");
        when(jsonColumn.getType()).thenReturn(StandardTypes.VARCHAR);
