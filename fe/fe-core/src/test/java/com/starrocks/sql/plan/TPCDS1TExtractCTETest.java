...
public class TPCDS1TExtractCTETest extends TPCDS1TTestBase {
    ...
    public void testQuery09() throws Exception {
        ...
        assertContains(plan, " s 2:AGGREGATE (update serialize)\n" +
    ...
    public void testQuery88() throws Exception {
        ...
        assertContains(plan, "MultiCastDataSinks");
        assertContains(plan, "18:AGGREGATE (merge finalize)\n" +
                "  |  output: count(641: count), count(643: count), count(629: count), " +
                "count(631: count), count(633: count), count(635: count), " +
                "count(637: count), count(639: count)");
    }
