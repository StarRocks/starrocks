...
public class FineGrainedRangePredicateTest extends DistributedEnvPlanTestBase {
    ...
    void testCutDateRange1() {
        ColumnRefOperator datetimeCol = new ColumnRefOperator(1, StandardTypes.DATETIME, "datetime_col", true);
    ...
    @Test
    void testCutRange3() {
        ColumnRefOperator dateCol = new ColumnRefOperator(1, StandardTypes.DATE, "date_col", true);
