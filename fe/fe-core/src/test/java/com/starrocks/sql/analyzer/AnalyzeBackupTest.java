...
public class AnalyzeBackupTest {
    ...
    public void testBackup() {
        ...
        analyzeSuccess("BACKUP SNAPSHOT snapshot_label2 TO `repo` ON ( t0, t1 ) PROPERTIES (\"type\" = \"full\",\"timeout\" = \"3600\");");
        analyzeFail("BACKUP SNAPSHOT test.snapshot_label2 TO `repo` ON ( t0, t0 ) PROPERTIES (\"type\" = \"full\",\"timeout\" = \"3600\");");
