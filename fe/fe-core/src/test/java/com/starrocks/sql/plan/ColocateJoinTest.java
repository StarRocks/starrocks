...
//        sqls.add("select * from colocate_t0 join colocate_t1 on v1 = v5 join colocate_t2 on v5 = v7");
//        sqls.add("select * from colocate_t0 join colocate_t1 on v1 = v5 + v6 join colocate_t2 on v5 + v6 = v7");
//        sqls.add("select * from colocate_t0, colocate_t1, colocate_t2_1 where  v1 = v5 + v6 and v5 + v6 = v7");
...
//        sqls.add("select * from colocate_t0 join colocate_t1 on v1 = v5 and v1 = v4 + v6 and v1 = v4 join colocate_t2_1 on " +
//                "v4 + v6 = v7");
//        sqls.add("select * from colocate_t0 join colocate_t1 on v1 + v2 = v4 and v1 + v2 = v5 - v4 join colocate_t2_1 on " +
//                "v5 - v4 = v7 and v7 = v1");
//        sqls.add("select * from colocate_t0 join colocate_t1 on v1 + v2 = v4 - v3 and v1 = v4 + v5 join colocate_t2_1 on " +
//                "v4 + v5 = v4 and v4 + v5 = v7");
        return sqls.stream().map(e -> Arguments.of(e));
    }
