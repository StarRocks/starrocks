...
public class SingleTableRewriteBaseRuleTest {
    ...
    public void testComparator() {
        // test different group by key nums
        {
            ...
            ColumnRefOperator columnRefOperator1 = new ColumnRefOperator(1, StandardTypes.INT, "a", true);
            ColumnStatistic columnStatistic1 = new ColumnStatistic(10, 1000, 0, 4, 100);
            ColumnRefOperator columnRefOperator2 = new ColumnRefOperator(2, StandardTypes.INT, "b", true);
            ...
            ColumnRefOperator columnRefOperator3 = new ColumnRefOperator(1, StandardTypes.INT, "a", true);
            ColumnStatistic columnStatistic3 = new ColumnStatistic(10, 1000, 0, 4, 100);
            ColumnRefOperator columnRefOperator4 = new ColumnRefOperator(2, StandardTypes.INT, "b", true);
            ...
            ColumnRefOperator columnRefOperator5 = new ColumnRefOperator(1, StandardTypes.INT, "a", true);
            ColumnStatistic columnStatistic5 = new ColumnStatistic(10, 1000, 0, 4, 100);
            ColumnRefOperator columnRefOperator6 = new ColumnRefOperator(2, StandardTypes.INT, "b", true);
        ...
        // test different compute size
        {
            ...
            ColumnRefOperator columnRefOperator6 = new ColumnRefOperator(2, StandardTypes.INT, "b", true);
            ColumnStatistic columnStatistic6 = new ColumnStatistic(10, 1000, 0, 4, 100);
            ColumnRefOperator columnRefOperator7 = new ColumnRefOperator(3, StandardTypes.INT, "c", true);
