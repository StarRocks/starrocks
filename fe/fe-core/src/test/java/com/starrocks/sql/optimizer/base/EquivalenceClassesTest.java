...
public class EquivalenceClassesTest {
    ...
    public void test() {
        ...
        ColumnRefOperator columnRef1 = columnRefFactory.create("column1", StandardTypes.INT, true);
        ColumnRefOperator columnRef2 = columnRefFactory.create("column2", StandardTypes.INT, true);
        ColumnRefOperator columnRef3 = columnRefFactory.create("column3", StandardTypes.INT, true);
        ColumnRefOperator columnRef4 = columnRefFactory.create("column4", StandardTypes.INT, true);
        ...
        ColumnRefOperator columnRef5 = columnRefFactory.create("column5", StandardTypes.INT, true);
        ColumnRefOperator columnRef6 = columnRefFactory.create("column6", StandardTypes.INT, true);
        ColumnRefOperator columnRef7 = columnRefFactory.create("column7", StandardTypes.INT, true);
