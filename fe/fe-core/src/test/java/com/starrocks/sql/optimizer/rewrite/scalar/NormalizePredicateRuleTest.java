...
public class NormalizePredicateRuleTest {
    ...
    public void testRule() {
        ...
        BinaryPredicateOperator bpo = new BinaryPredicateOperator(BinaryType.EQ,
                new ColumnRefOperator(1, StandardTypes.INT, "test", true),
    ...
    public void testInPredicate() {
        ...
        InPredicateOperator inOp = new InPredicateOperator(
                ConstantOperator.createInt(1),
                new ColumnRefOperator(0, StandardTypes.INT, "col1", true)
        );
    ...
    public void testCompound2() {
        InPredicateOperator inOp = new InPredicateOperator(
                ...
                new ColumnRefOperator(0, StandardTypes.INT, "col1", false),
                new ColumnRefOperator(1, StandardTypes.INT, "col2", false),
                new ColumnRefOperator(2, StandardTypes.INT, "col3", false),
                new ColumnRefOperator(3, StandardTypes.INT, "col4", false)
        );
