...
public class ListPartitionPrunerTest {
    ...
    public void setUp() throws AnalysisException {
        ...
        dateColumn = new ColumnRefOperator(1, StandardTypes.DATE, "date_col", true);
        intColumn = new ColumnRefOperator(2, StandardTypes.INT, "int_col", true);
        ...
        intPartitionValuesMap.put(new IntLiteral(0, StandardTypes.INT), Sets.newHashSet(0L, 3L, 6L));
        intPartitionValuesMap.put(new IntLiteral(1, StandardTypes.INT), Sets.newHashSet(1L, 4L, 7L));
        intPartitionValuesMap.put(new IntLiteral(2, StandardTypes.INT), Sets.newHashSet(2L, 5L, 8L));
    ...
    public void testEmptyConjunctsOrPartitionColumns() throws AnalysisException {
        conjuncts.clear();
        Assertions.assertEquals(null, pruner.prune());
    ...
    public void testBinaryPredicate() throws AnalysisException {
        ...
        Assertions.assertEquals(Lists.newArrayList(0L, 1L, 2L), pruner.prune());
        // date_col < "2021-01-02"
        conjuncts.clear();
        ...
        conjuncts.add(new BinaryPredicateOperator(BinaryType.LE, dateColumn,
                ConstantOperator.createDate(LocalDateTime.of(2021, 1, 3, 0, 0, 0))));
        Assertions.assertEquals(Lists.newArrayList(6L, 7L, 8L), pruner.prune());
        // date_col > "2021-01-03"
        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.GT, dateColumn,
                ConstantOperator.createDate(LocalDateTime.of(2021, 1, 3, 0, 0, 0))));
        Assertions.assertEquals(Lists.newArrayList(), pruner.prune());
        // date_col <= "2020-12-31"
        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.LE, dateColumn,
        ...
        Assertions.assertEquals(Lists.newArrayList(1L, 2L, 4L, 5L, 7L, 8L), pruner.prune());
        // int_col < 0
        conjuncts.clear();
        ...
        Assertions.assertEquals(Lists.newArrayList(3L, 4L, 6L, 7L), pruner.prune());
    }
    ...
    public void testExternalTableBinaryPredicate() throws AnalysisException {
        ...
        ColumnRefOperator stringColumn = new ColumnRefOperator(1, StandardTypes.STRING, "string_col", true);
        ...
        conjuncts.clear();
        conjuncts.add(
                new BinaryPredicateOperator(BinaryType.EQ, stringColumn, ConstantOperator.createVarchar("2021-01-02")));
        Assertions.assertEquals(Lists.newArrayList(2L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(
                new BinaryPredicateOperator(BinaryType.GE, stringColumn, ConstantOperator.createVarchar("2021-01-02")));
        Assertions.assertEquals(Lists.newArrayList(2L, 3L, 4L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.LT, new CastOperator(StandardTypes.DATE, stringColumn),
                ConstantOperator.createDate(LocalDateTime.of(2021, 1, 3, 0, 0, 0))));
        Assertions.assertEquals(Lists.newArrayList(1L, 2L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.GE, new CastOperator(StandardTypes.DATE, stringColumn),
                ConstantOperator.createDate(LocalDateTime.of(2021, 1, 4, 0, 0, 0))));
        Assertions.assertEquals(Lists.newArrayList(4L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.EQ, new CastOperator(StandardTypes.DATE, stringColumn),
                ConstantOperator.createDate(LocalDateTime.of(2021, 1, 1, 0, 0, 0))));
    ...
    public void testExternalTableBinaryPredicate2() throws AnalysisException {
        ...
        Assertions.assertEquals(Lists.newArrayList(3L, 4L, 5L, 6L, 7L, 8L), pruner.prune());
        ...
        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.EQ, new CastOperator(StandardTypes.INT, stringColumn),
                ConstantOperator.createInt(1)));
        Assertions.assertEquals(Lists.newArrayList(1L, 4L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.GT, new CastOperator(StandardTypes.INT, stringColumn),
                ConstantOperator.createInt(3)));
        Assertions.assertEquals(Lists.newArrayList(5L, 6L, 7L, 8L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.LT, new CastOperator(StandardTypes.INT, stringColumn),
                ConstantOperator.createInt(3)));
        Assertions.assertEquals(Lists.newArrayList(1L, 2L, 4L), pruner.prune());
    }
    ...
    public void testExternalTableBinaryPredicate3() throws AnalysisException {
        ...
        ColumnRefOperator intColumn = new ColumnRefOperator(1, StandardTypes.INT, "int_col", true);
        ...
        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.EQ, new CastOperator(StandardTypes.STRING, intColumn),
                ConstantOperator.createVarchar("1")));
        Assertions.assertEquals(Lists.newArrayList(1L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.GT, new CastOperator(StandardTypes.STRING, intColumn),
                ConstantOperator.createVarchar("3")));
        Assertions.assertEquals(Lists.newArrayList(), pruner.prune());

        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.LT, new CastOperator(StandardTypes.STRING, intColumn),
                ConstantOperator.createVarchar("2")));
        Assertions.assertEquals(Lists.newArrayList(1L, 4L, 5L, 6L), pruner.prune());
    }

    @Test
    public void testExternalTableBinaryPredicate4() throws AnalysisException {
        // int_col=20210101   1
        // int_col=20210102   2
        // int_col=20210103   3
        // int_col=20210104   4
        ...
        ConcurrentNavigableMap<LiteralExpr, Set<Long>> intPartitionValuesMap = new ConcurrentSkipListMap<>();
        columnToPartitionValuesMap.put(intColumn, intPartitionValuesMap);
        intPartitionValuesMap.put(new IntLiteral(20210101), Sets.newHashSet(1L));
        intPartitionValuesMap.put(new IntLiteral(20210102), Sets.newHashSet(2L));
        intPartitionValuesMap.put(new IntLiteral(20210103), Sets.newHashSet(3L));
        intPartitionValuesMap.put(new IntLiteral(20210104), Sets.newHashSet(4L));
        ...
        conjuncts.add(
                new BinaryPredicateOperator(BinaryType.EQ, intColumn,
                        new CastOperator(StandardTypes.INT, ConstantOperator.createDate(
                                LocalDateTime.of(2021, 1, 2, 0, 0, 0)))));
        Assertions.assertEquals(Lists.newArrayList(2L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(
                new BinaryPredicateOperator(BinaryType.GE, intColumn,
                        new CastOperator(StandardTypes.INT, ConstantOperator.createDate(
                                LocalDateTime.of(2021, 1, 2, 0, 0, 0)))));
        Assertions.assertEquals(Lists.newArrayList(2L, 3L, 4L), pruner.prune());
        ...
        conjuncts.clear();
        conjuncts.add(
                new BinaryPredicateOperator(BinaryType.EQ, new CastOperator(StandardTypes.DOUBLE, intColumn),
                        new CastOperator(StandardTypes.DOUBLE, ConstantOperator.createDate(
                                LocalDateTime.of(2021, 1, 2, 0, 0, 0)))));
        Assertions.assertEquals(Lists.newArrayList(2L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(
                new BinaryPredicateOperator(BinaryType.GE, new CastOperator(StandardTypes.DOUBLE, intColumn),
                        new CastOperator(StandardTypes.DOUBLE, ConstantOperator.createDate(
                                LocalDateTime.of(2021, 1, 2, 0, 0, 0)))));
        Assertions.assertEquals(Lists.newArrayList(2L, 3L, 4L), pruner.prune());

        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.LT, new CastOperator(StandardTypes.DOUBLE, intColumn),
                new CastOperator(StandardTypes.DOUBLE, ConstantOperator.createDate(
                        LocalDateTime.of(2021, 1, 2, 0, 0, 0)))));
        Assertions.assertEquals(Lists.newArrayList(1L), pruner.prune());
    }
    ...
    public void testExternalTableBinaryPredicateWithException() throws AnalysisException {
        ...
        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.EQ, new CastOperator(StandardTypes.INT, stringColumn),
                new CastOperator(StandardTypes.INT, ConstantOperator.createVarchar("1.23"))));
    ...
    public void testStringCastInPredicate() throws AnalysisException {
        ...
        ListPartitionPruner pruner =
                new ListPartitionPruner(columnToPartitionValuesMap, columnToNullPartitions, conjuncts, null);
        conjuncts.clear();
        conjuncts.add(new InPredicateOperator(new CastOperator(StandardTypes.INT, stringColumn),
                ConstantOperator.createInt(2),
                ConstantOperator.createInt(3)));
        Assertions.assertEquals(2, pruner.prune().size());
    }
    ...
    public void testSpecifyPartition() throws AnalysisException {
        ...
        intColumn = new ColumnRefOperator(2, StandardTypes.INT, "int_col", true);
        ColumnRefOperator intCol1 = new ColumnRefOperator(3, StandardTypes.INT, "int_col1", true);
        ColumnRefOperator intCol2 = new ColumnRefOperator(4, StandardTypes.INT, "int_col2", true);
        ColumnRefOperator intColNotPart = new ColumnRefOperator(5, StandardTypes.INT, "int_col_not_part", true);
        ...
        intPartitionValuesMap1.put(new IntLiteral(0, StandardTypes.INT), Sets.newHashSet(0L, 1L));
        intPartitionValuesMap1.put(new IntLiteral(1, StandardTypes.INT), Sets.newHashSet(2L));
        ...
        intPartitionValuesMap2.put(new IntLiteral(10, StandardTypes.INT), Sets.newHashSet(0L, 2L));
        intPartitionValuesMap2.put(new IntLiteral(11, StandardTypes.INT), Sets.newHashSet(1L));
        ...
        Assertions.assertNotNull(prune);
        Assertions.assertEquals(prune.get(0), (Long) 2L);
    }
    ...
    public void testComplexBinaryPredicate() throws AnalysisException {
        ...
        conjuncts.add(new BinaryPredicateOperator(
                BinaryType.EQ,
                new CallOperator("add", StandardTypes.BIGINT, Lists.newArrayList(intCol1, intCol2)),
                ConstantOperator.createInt(10)));
        Assertions.assertEquals(null, pruner.prune());
        // check not eval conjuncts
        List<ScalarOperator> notEvalConjuncts = pruner.getNoEvalConjuncts();
        Assertions.assertEquals(1, notEvalConjuncts.size());
        Assertions.assertEquals(conjuncts.get(0), notEvalConjuncts.get(0));
        ...
        conjuncts.add(new BinaryPredicateOperator(
                BinaryType.EQ,
                new CallOperator("add", StandardTypes.BIGINT, Lists.newArrayList(intCol2, ConstantOperator.createInt(1))),
    ...
    public void testIsNullPredicate() throws AnalysisException {
        ...
        Assertions.assertEquals(Lists.newArrayList(9L), pruner.prune());

        // date_col is not null
        conjuncts.clear();
        conjuncts.add(new IsNullPredicateOperator(true, dateColumn));
        Assertions.assertEquals(notNullPartitions, pruner.prune());
    ...
    public void testCompoundPredicate() throws AnalysisException {
        ...
        conjuncts.add(new CompoundPredicateOperator(
                ...
                new BinaryPredicateOperator(BinaryType.EQ, intColumn,
                        ConstantOperator.createInt(2))));
        Assertions.assertEquals(Lists.newArrayList(0L, 1L, 2L, 5L, 8L), pruner.prune());
        ...
        Assertions.assertEquals(Lists.newArrayList(6L, 7L, 8L, 9L), pruner.prune());
        ...
        Assertions.assertEquals(Lists.newArrayList(0L, 1L, 2L, 3L, 6L, 9L), pruner.prune());
        ...
        Assertions.assertEquals(Lists.newArrayList(0L, 1L, 2L, 6L, 7L, 8L), pruner.prune());
    }

    @Test
    public void testGetEffectivePartitionPredicate() {
        Column dateCol = new Column("date_col", StandardTypes.DATE);
        Column intCol = new Column("int_col", StandardTypes.INT);
    ...
    public void testCastTypePredicate() throws AnalysisException {
        ...
        conjuncts.clear();
        conjuncts.add(new BinaryPredicateOperator(BinaryType.EQ,
                new CastOperator(StandardTypes.DATETIME, dateColumn),
        ...
        conjuncts.clear();
        conjuncts.add(new InPredicateOperator(new CastOperator(StandardTypes.DATETIME, dateColumn),
                ConstantOperator.createDatetime(LocalDateTime.of(2021, 1, 1, 0, 0, 0))));
        Assertions.assertEquals(Lists.newArrayList(0L, 1L, 2L), pruner.prune());
        // date_col in ("2021-01-02", "2021-01-03")
        conjuncts.clear();
        ...
        // date_col in ("2021-01-03", "2021-01-04")
        conjuncts.clear();
        conjuncts.add(new InPredicateOperator(false, Lists.newArrayList(new CastOperator(StandardTypes.DATETIME, dateColumn),
                ConstantOperator.createDatetime(LocalDateTime.of(2021, 1, 3, 0, 0, 0)),
    ...
    public void testBinaryPredicateWithEmptyPartition() throws AnalysisException {
        ColumnRefOperator operator = new ColumnRefOperator(5, StandardTypes.VARCHAR, "ds", true);
        columnToPartitionValuesMap = Maps.newHashMap();
