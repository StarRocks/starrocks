...
public class OrderByTest extends PlanTestBase {
    ...
    public void testExistOrderBy() throws Exception {
        ...
        Assert.assertTrue(planFragment.contains("  3:HASH JOIN\n" +
                ...
                "  |  equal join conjunct: 5: dept_id = 6: dept_id"));
    }
    ...
    public void testUnionOrderByDuplicateColumn() throws Exception {
        String sql = "select v1, v2, v3 from t0 union all select v4 as v1, v5 as v2, v6 as v3 from t1 order by v1, v2, v1";
        String plan = getFragmentPlan(sql);
        assertContains(plan, "order by: <slot 4> 4: v4 ASC, <slot 5> 5: v5 ASC");
    }
