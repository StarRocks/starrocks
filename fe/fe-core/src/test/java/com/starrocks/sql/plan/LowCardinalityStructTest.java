...
public class LowCardinalityStructTest extends PlanTestBase {
    ...
    public void testNamedStructTopLevel() throws Exception {
        String sql = """
                ...
                """;
        String plan = getVerboseExplain(sql);
        String expected = "5 <-> named_struct[('c1', DictDecode(6: VARCHAR_COL, [<place-holder>], " +
                "8: named_struct.c1[true]), 'c2', DictDecode(7: ARRAY_VARCHAR_COL, [<place-holder>], " +
                "8: named_struct.c2[true]), 'c3', 8: named_struct.c3[true]); args: " +
    ...
    public void testJoin() throws Exception {
        ...
        String expected = "  12:Project\n" +
                ...
                "  |  10 <-> named_struct[('col1', DictDecode(12: VARCHAR_COL2, [<place-holder>], 14: " +
                "row.col1[true])); args: VARCHAR,VARCHAR; result: struct<col1 varchar(25)>; args nullable: " +
    ...
    public void testTwoStageDecode() throws Exception {
        ...
        String expected = "  6:Decode\n" +
                ...
                "  |  output columns:\n" +
                "  |  4 <-> [4: INTEGER_COL, INT, true]\n" +
                "  |  5 <-> named_struct[('col1', DictDecode(6: VARCHAR_COL, [<place-holder>], 8: " +
                "row.col1[true])); args: VARCHAR,VARCHAR; result: struct<col1 varchar(25)>; " +
    ...
    public void testAggregation() throws Exception {
        ...
        String expected = "  3:Project\n" +
                "  |  output columns:\n" +
                "  |  6 <-> named_struct[('col1', DictDecode(7: VARCHAR_COL, [<place-holder>], 9: " +
                "any_value.col1[true]), 'col2', 9: any_value.col2[true]); args: VARCHAR,VARCHAR,VARCHAR,INT; " +
                "result: struct<col1 varchar(25), col2 int(11)>; args nullable: true; result nullable: true]\n";
        Assertions.assertTrue(plan.contains(expected), plan);
    }
    ...
    public void testAggregationGetFields() throws Exception {
        ...
        String expected = "  3:Project\n" +
                "  |  output columns:\n" +
                "  |  7 <-> DictDecode(13: VARCHAR_COL, [<place-holder>], 16: any_value.col1[true])\n" +
                "  |  8 <-> 16: any_value.col2[false]\n" +
                "  |  9 <-> DictDecode(14: ARRAY_VARCHAR_COL, [<place-holder>], 16: any_value.col3[true])\n";
        Assertions.assertTrue(plan.contains(expected), plan);
    }
    ...
    public void testJoinAggregation() throws Exception {
        ...
        String expected = "  8:Project\n" +
                "  |  output columns:\n" +
                "  |  6 <-> named_struct[('col1', DictDecode(13: VARCHAR_COL, [<place-holder>], " +
                "16: any_value.col1[true]), 'col2', 16: any_value.col2[true]); args: VARCHAR,VARCHAR,VARCHAR,INT;" +
                " result: struct<col1 varchar(25), col2 int(11)>; args nullable: true; result nullable: true]\n" +
                "  |  12 <-> named_struct[('col1', DictDecode(14: VARCHAR_COL2, [<place-holder>], " +
                "18: any_value.col1[true]), 'col2', 18: any_value.col2[true]); args: VARCHAR,VARCHAR,VARCHAR,INT;" +
                " result: struct<col1 varchar(25), col2 int(11)>; args nullable: true; result nullable: true]\n";
        Assertions.assertTrue(plan.contains(expected), plan);
    }
    ...
    public void testNoStringFieldsInStruct() throws Exception {
        ...
        Assertions.assertTrue(plan.contains("  1:Project\n" +
                ...
                "  |  6 <-> DictDecode(9: VARCHAR_COL, [upper(<place-holder>)])\n" +
                "  |  7 <-> row(4: INTEGER_COL).col1[true]\n" +
                "  |  8 <-> row(1).col1[true]"), plan);
    }
    ...
    public void testAggregatedStructAsArgument() throws Exception {
        ...
        Assertions.assertTrue(plan.contains("  3:Project\n" +
                "  |  output columns:\n" +
                "  |  7 <-> to_json[(named_struct[('col1', DictDecode(8: VARCHAR_COL, [<place-holder>], " +
                "10: any_value.col1[true]), 'col2', 10: any_value.col2[true]); args: VARCHAR,VARCHAR,VARCHAR,INT; result: " +
    ...
    public void testStructInScan() throws Exception {
        ...
        String expected = "  1:Project\n" +
                ...
                "  |  6 <-> upper[(5: STRUCT_COL.VARCHAR_FIELD[true]); args: VARCHAR; result: VARCHAR; " +
                "args nullable: true; result nullable: true]\n" +
                "  |  7 <-> DictDecode(8: VARCHAR_COL, [upper(<place-holder>)])\n";
        Assertions.assertTrue(plan.contains(expected), plan);
    }
    ...
    public void testArrayAggString4StageGetElement() throws Exception {
        ...
        Assertions.assertTrue(plan.contains("Global Dict Exprs:\n" +
                ...
                "  7:Project\n" +
                "  |  output columns:\n" +
                "  |  6 <-> DictDecode(9: array_agg, [upper(<place-holder>)], 9: array_agg[1])\n" +
                "  |  cardinality: 1\n" +
                "  |  \n" +
                "  6:AGGREGATE (merge finalize)\n" +
