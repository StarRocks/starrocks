...
public class PredicateStatisticsCalculatorTest {
    ...
    public void testDateBinaryPredicate() {
        ...
        ColumnRefOperator columnRefOperator = new ColumnRefOperator(0, StandardTypes.DATE, "id_date", true);
    ...
    public void testColumnEqualToColumn() {
        ColumnRefOperator c1 = new ColumnRefOperator(0, StandardTypes.INT, "c1", true);
        ColumnRefOperator c2 = new ColumnRefOperator(1, StandardTypes.INT, "c2", true);
    ...
    public void testNullEqStatistic() throws Exception {
        ...
        BinaryPredicateOperator binaryPredicateOperator = new BinaryPredicateOperator(
                BinaryType.EQ_FOR_NULL, c1, ConstantOperator.createNull(StandardTypes.INT));
        Statistics estimatedStatistics =
                PredicateStatisticsCalculator.statisticsCalculate(binaryPredicateOperator, statistics);
    ...
    public void testConcatExpressionCalculate() {
        ColumnRefOperator c1 = new ColumnRefOperator(0, StandardTypes.VARCHAR, "c1", true);
        ConstantOperator c2 = new ConstantOperator("-", StandardTypes.VARCHAR);
        ColumnRefOperator c3 = new ColumnRefOperator(1, StandardTypes.VARCHAR, "c3", true);
        CallOperator concat = new CallOperator("concat", StandardTypes.VARCHAR, Lists.newArrayList(c1, c2, c3));
        Statistics statistics = Statistics.builder()
    ...
    public void testEstimateInPredicateWithHistogramNumeric() {
        ColumnRefOperator columnRef = new ColumnRefOperator(1, StandardTypes.INT, "c1", true);
    ...
    public void testEstimateNotInPredicateWithHistogram() {
        ColumnRefOperator columnRef = new ColumnRefOperator(3, StandardTypes.BIGINT, "c3", true);
    ...
    public void testEstimateInPredicateWithStringType() {
        ColumnRefOperator columnRef = new ColumnRefOperator(2, StandardTypes.VARCHAR, "c2", true);
    ...
    public void testEstimateInPredicateWithBooleanType() {
        ColumnRefOperator columnRef = new ColumnRefOperator(6, StandardTypes.BOOLEAN, "c6", true);
    ...
    public void testEstimateInPredicateWithOutOfRangeConstants() {
        ColumnRefOperator columnRef = new ColumnRefOperator(7, StandardTypes.INT, "c7", true);
