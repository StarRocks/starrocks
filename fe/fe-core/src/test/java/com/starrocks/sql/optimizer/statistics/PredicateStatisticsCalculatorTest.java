    ...
    public void testEstimateNestedIfPredicate() {
        ...
        CallOperator innerIfPredicate =
                new CallOperator(FunctionSet.IF, BooleanType.BOOLEAN, List.of(
                        c1Ge30Condition, c2Eq50Predicate, c3Eq80Predicate));
        ...
        CallOperator outerIfPredicate =
                new CallOperator(FunctionSet.IF, BooleanType.BOOLEAN, List.of(c1Ge20Condition, innerIfPredicate,
                        c3Eq70Predicate));
        ...
        innerIfPredicate =
                new CallOperator(FunctionSet.IF, BooleanType.BOOLEAN, List.of(c1Ge20Condition, c3Eq80Predicate,
                        c3Eq70Predicate));
        outerIfPredicate =
                new CallOperator(FunctionSet.IF, BooleanType.BOOLEAN, List.of(c1Ge30Condition, c2Eq50Predicate,
                        innerIfPredicate));
