...
public class PrivilegeCheckerTest extends StarRocksTestBase {
    ...
    public void testDatabaseStmt() throws Exception {
        ...
        Function function = new Function(fn, Arrays.asList(StandardTypes.STRING, StandardTypes.STRING),
    ...
    public void testUseGlobalFunc() throws Exception {
        FunctionName fn = FunctionName.createFnName("my_udf_json_get");
        fn.setAsGlobalFunction();
        Function function = new Function(1, fn, Arrays.asList(StandardTypes.STRING, StandardTypes.STRING),
                StandardTypes.STRING, false);
        try {
            GlobalStateMgr.getCurrentState().getGlobalFunctionMgr().replayAddFunction(function);
        } catch (Throwable e) {
        ...
        fn.setAsGlobalFunction();
        function = new Function(2, fn, Arrays.asList(StandardTypes.STRING, StandardTypes.STRING), StandardTypes.STRING, false);
        try {
            GlobalStateMgr.getCurrentState().getGlobalFunctionMgr().replayAddFunction(function);
        } catch (Throwable e) {
            // ignore
