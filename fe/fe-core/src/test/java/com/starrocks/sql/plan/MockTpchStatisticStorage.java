...
public class MockTpchStatisticStorage implements StatisticStorage {
    ...
    private void mockTpchTableStats(ConnectContext connectContext, int scale) {
        ...
        OlapTable t1 = (OlapTable) globalStateMgr.getMetastore().getDb("test").getTable("nation");
        ...
        OlapTable t2 = (OlapTable) globalStateMgr.getMetastore().getDb("test").getTable("supplier");
        ...
        OlapTable t3 = (OlapTable) globalStateMgr.getMetastore().getDb("test").getTable("customer");
        ...
        OlapTable t4 = (OlapTable) globalStateMgr.getMetastore().getDb("test").getTable("part");
        ...
        OlapTable t5 = (OlapTable) globalStateMgr.getMetastore().getDb("test").getTable("partsupp");
        ...
        OlapTable t6 = (OlapTable) globalStateMgr.getMetastore().getDb("test").getTable("orders");
