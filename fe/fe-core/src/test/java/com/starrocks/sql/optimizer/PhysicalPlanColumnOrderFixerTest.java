...
public class PhysicalPlanColumnOrderFixerTest {
    private List<String> expectedColumnNames;
    private PhysicalPlanColumnOrderFixer fixer;

    @BeforeEach
    public void setUp() {
        expectedColumnNames = Arrays.asList("col1", "col2", "col3");
        fixer = new PhysicalPlanColumnOrderFixer(expectedColumnNames);
    }
    ...
    public void testNeedsOrderFix_WhenOrderMatches_ReturnsFalse() {
        ...
        // Execution
        boolean result = fixer.needsOrderFix(currentOrder, expectedColumnNames);
    ...
    public void testFixPhysicalValuesOperator_WhenOrderNeedsFix() {
        ...
        List<List<ScalarOperator>> rows = Arrays.asList(
                Arrays.asList(createScalarOperator("value2"),
                        createScalarOperator("value1"),
                        createScalarOperator("value3")),
                Arrays.asList(createScalarOperator("value2_2"),
                        createScalarOperator("value1_2"),
                        createScalarOperator("value3_2"))
        );
