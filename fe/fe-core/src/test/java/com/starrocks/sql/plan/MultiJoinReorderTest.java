...
public class MultiJoinReorderTest extends PlanTestBase {
    ...
    public void testLeftJoinReorderGreedy() throws Exception {
        ...
        String sql = "select v6 from t1 " +
                ...
                "on t1.v6 = a.v5";
        String planFragment = getFragmentPlan(sql);
        Assert.assertTrue(planFragment.contains("18:HASH JOIN\n" +
        ...
        Assert.assertTrue(planFragment.contains("  |----6:EXCHANGE\n" +
                ...
                "  3:OlapScanNode\n" +
                "     TABLE: t1"));
        Assert.assertTrue(planFragment.contains("  |----9:EXCHANGE\n" +
                "  |    \n" +
                "  2:Project\n" +
                "  |  <slot 16> : 1\n" +
                "  |  \n" +
                "  1:OlapScanNode\n" +
                "     TABLE: t2"));
        Assert.assertTrue(planFragment.contains("  |----12:EXCHANGE\n" +
                "  |    \n" +
                "  0:OlapScanNode\n" +
                "     TABLE: t3"));
    }
    ...
    public void testTwoJoinRootGreedy() throws Exception {
        ...
        String sql = "select * from (select t1.v5 from t1 join t3 on t3.v10 = t1.v4 join t0 join t2) b " +
                ...
                "on b.v5 = a.v5";
        String planFragment = getFragmentPlan(sql);
        Assert.assertTrue(planFragment.contains("29:HASH JOIN\n" +
                "  |  join op: INNER JOIN (BUCKET_SHUFFLE)\n" +
                "  |  colocate: false, reason: \n" +
                ...
                "  16:OlapScanNode\n" +
                "     TABLE: t3"));
        Assert.assertTrue(planFragment.contains("13:HASH JOIN\n" +
                "  |  join op: INNER JOIN (BUCKET_SHUFFLE)\n" +
                "  |  colocate: false, reason: \n" +
                "  |  equal join conjunct: 4: v10 = 1: v4\n" +
                "  |  \n" +
    ...
    public void testPruneColsWithMultiJoin() throws Exception {
        ...
        assertContains(plan, "  3:HASH JOIN\n" +
                ...
                "  |  colocate: true\n" +
                "  |  equal join conjunct: [16: v7, BIGINT, true] = [12: v7, BIGINT, true]\n" +
                "  |  build runtime filters:\n" +
                "  |  - filter_id = 0, build_expr = (12: v7), remote = false\n" +
                "  |  cardinality: 90000");
    }
}
