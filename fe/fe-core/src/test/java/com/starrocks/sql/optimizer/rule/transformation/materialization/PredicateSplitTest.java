...
public class PredicateSplitTest {
    ...
    public void testSplitPredicate() {
        ...
        ColumnRefOperator columnRef1 = columnRefFactory.create("col1", StandardTypes.INT, false);
        ColumnRefOperator columnRef2 = columnRefFactory.create("col2", StandardTypes.INT, false);
        ...
        CallOperator callOperator = new CallOperator(FunctionSet.SUM, StandardTypes.INT, arguments);
    ...
    public void testSplitPredicateWithMultiRange() {
        ColumnRefOperator a = new ColumnRefOperator(0, StandardTypes.INT, "a", false);
        ColumnRefOperator b = new ColumnRefOperator(1, StandardTypes.INT, "b", false);
        ColumnRefOperator c = new ColumnRefOperator(2, StandardTypes.INT, "c", false);
        ColumnRefOperator d = new ColumnRefOperator(3, StandardTypes.INT, "d", false);
