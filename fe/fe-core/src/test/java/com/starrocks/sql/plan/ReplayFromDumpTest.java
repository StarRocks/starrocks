...
=======
                "  |  * expr-->[3.0, 2403.0, 0.0, 8.0, 30.13572607260726] ESTIMATE\n"));
>>>>>>> 9c9d3ae925 ([Enhancement] improve cte transform performance (#35000))
...
<<<<<<< HEAD
        Assert.assertTrue(plan, plan.contains("- filter_id = 4, probe_expr = (60: mock_004)"));
        Assert.assertTrue(plan, plan.contains("- filter_id = 3, probe_expr = (60: mock_004)"));
        Assert.assertTrue(plan, plan.contains("- filter_id = 0, probe_expr = (37: mock_004)"));
