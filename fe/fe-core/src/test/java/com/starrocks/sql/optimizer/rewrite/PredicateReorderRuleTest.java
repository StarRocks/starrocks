...
public class PredicateReorderRuleTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        v2 = columnRefFactory.create("v2", StandardTypes.INT, true);
    ...
    public void testHashJoinPredicateReorder() {
        ...
        // t0.v1 + t1.v1 = 15
        CastOperator castOperatorV10 = new CastOperator(StandardTypes.BIGINT, v1);
        CastOperator castOperatorV11 = new CastOperator(StandardTypes.BIGINT, v1);
        CallOperator add0 = new CallOperator("add", StandardTypes.BIGINT, Lists.newArrayList(castOperatorV10, castOperatorV11));
        BinaryPredicateOperator intEq0 = BinaryPredicateOperator.eq(add0, constantOperatorInt0);
        // t0.v2 + t1.v2 = 150
        CastOperator castOperatorV20 = new CastOperator(StandardTypes.BIGINT, v2);
        CastOperator castOperatorV21 = new CastOperator(StandardTypes.BIGINT, v2);
        CallOperator add1 = new CallOperator("add", StandardTypes.BIGINT, Lists.newArrayList(castOperatorV20, castOperatorV21));
