...
public class PredicateReorderRuleTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        OlapTable t0 = (OlapTable) catalog.getMetastore().getDb("test").getTable("t0");
        OlapTable t1 = (OlapTable) catalog.getMetastore().getDb("test").getTable("t1");
    ...
    public void testOlapScanPredicateReorder() {
        ...
        OlapTable t0 = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getDb("test").getTable("t0");
    ...
    public void testHashJoinPredicateReorder() {
        ...
        OlapTable t0 = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getDb("test").getTable("t0");
        OlapTable t1 = (OlapTable) GlobalStateMgr.getCurrentState().getMetastore().getDb("test").getTable("t1");
