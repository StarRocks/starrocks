...
public class TPCHPlanWithGlobalLateMaterialization extends TPCHPlanWithCostTest {

    @BeforeAll
    public static void beforeClass() throws Exception {
        TPCHPlanTest.beforeClass();
    ...
    private static Stream<Arguments> tpchSource() {
        ...
        for (Map.Entry<String, String> entry : TpchSQL.getAllSQL().entrySet()) {
            cases.add(Arguments.of(entry.getKey(), entry.getValue(), "tpch-glm/" + entry.getKey()));
        }
        return cases.stream();
    }
}
