...
public class PruneHDFSScanColumnRuleTest {
    ...
    ColumnRefOperator intColumnOperator = new ColumnRefOperator(1, StandardTypes.INT, "id", true);
    ColumnRefOperator strColumnOperator = new ColumnRefOperator(2, StandardTypes.STRING, "name", true);
    ColumnRefOperator unknownColumnOperator = new ColumnRefOperator(3, StandardTypes.UNKNOWN_TYPE, "unknown", true);
    ...
    Map<ColumnRefOperator, Column> scanColumnMapWithUnknown = new HashMap<ColumnRefOperator, Column>() {
        {
            put(intColumnOperator, new Column("id", StandardTypes.INT));
            put(strColumnOperator, new Column("name", StandardTypes.STRING));
            put(unknownColumnOperator, new Column("name", StandardTypes.UNKNOWN_TYPE));
        }
    };
    ...
    public void transformIcebergWithPredicate(@Mocked IcebergTable table,
        ...
        ColumnRefSet requiredOutputColumns = new ColumnRefSet(new ArrayList<>(
                Collections.singleton(new ColumnRefOperator(1, StandardTypes.INT, "id", true))));
