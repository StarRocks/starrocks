...
public class DiskUsageSafeModeCheckerTest {

    private DiskUsageSafeModeChecker diskUsageSafeModeChecker = new DiskUsageSafeModeChecker();
    ...
    public void testSafeMode() {
        assertEquals(true, diskUsageSafeModeChecker.checkInternal());
    }
}
