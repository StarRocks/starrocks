...
public class ConfigTest {
    ...
    public void testGetConfigFromPropertyFile() throws AnalysisException, DdlException {
        PatternMatcher matcher = PatternMatcher.createMysqlPattern("tablet_schedule_slot_num_per_path", false);
    ...
    public void testConfigGetCompatibleWithOldName() throws Exception {
        ...
        Assert.assertEquals("tablet_schedule_slot_num_per_path", configs.get(0).get(0));
