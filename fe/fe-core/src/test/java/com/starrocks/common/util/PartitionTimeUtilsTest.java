...
public class PartitionTimeUtilsTest {
    ...
    public void testFormatPartitionBoundKeepsYearZero() {
        ...
        Assertions.assertEquals("0000-01-01", PartitionTimeUtils.formatPartitionBound(yearZero, DateType.DATE));
        Assertions.assertEquals("0000-01-01 00:00:00",
                PartitionTimeUtils.formatPartitionBound(yearZero, DateType.DATETIME));
    }

    @Test
    public void testFormatPartitionBound() {
        LocalDateTime time = LocalDateTime.of(2024, 3, 5, 10, 30, 15);
        Assertions.assertEquals("2024-03-05", PartitionTimeUtils.formatPartitionBound(time, DateType.DATE));
        Assertions.assertEquals("2024-03-05 10:30:15", PartitionTimeUtils.formatPartitionBound(time, DateType.DATETIME));
    }
