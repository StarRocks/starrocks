...
public class KafkaUtilTest {
    ...
    public void getOffsets_returnsCorrectOffsetsForLatest() throws StarRocksException, RpcException {
        ...
        Assert.assertEquals(Long.valueOf(300L), offsets.get(2));
    }
    ...
    public void getOffsets_returnsCorrectOffsetsForBeginning() throws StarRocksException, RpcException {
        ...
        Assert.assertEquals(3, offsets.size());
        Assert.assertEquals(Long.valueOf(0L), offsets.get(0));
        Assert.assertEquals(Long.valueOf(10L), offsets.get(1));
        Assert.assertEquals(Long.valueOf(20L), offsets.get(2));
    }
