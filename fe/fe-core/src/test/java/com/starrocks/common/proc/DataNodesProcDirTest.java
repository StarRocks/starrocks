...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/test/java/org/apache/doris/common/proc/DataNodesProcDirTest.java
        ...
        new Expectations() {
            {
                ...
                tabletInvertedIndex.getTabletNumByDataNodeId(anyLong);
                minTimes = 0;
                result = 2;
            }
        };
