...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/test/java/org/apache/doris/common/proc/DataNodeProcNodeTest.java
        ...
        new Expectations() {
            {
                ...
                tabletInvertedIndex.getTabletNumByDataNodeIdAndPathHash(anyLong, anyLong);
                minTimes = 0;
                result = 1;
            }
        };
