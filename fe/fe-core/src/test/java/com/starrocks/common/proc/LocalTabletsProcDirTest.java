...
public class LocalTabletsProcDirTest {
    ...
    public void testFetchResultWithLocalTablet(@Mocked GlobalStateMgr globalStateMgr,
        ...
        Map<Long, DataNode> idToDataNode = Maps.newHashMap();
        long backendId = 20L;
        idToDataNode.put(backendId, new DataNode(backendId, "127.0.0.1", 9050));
        idToDataNode.put(backendId, new DataNode(backendId + 1, "127.0.0.2", 9050));
        ...
        new Expectations() {
            {
                ...
                result = ImmutableMap.copyOf(idToDataNode);
            }
        };
