...
public class QueryConverterTest {
    ...
    public void testTranslateIsNullPredicate() {
        SlotRef kSlotRef = mockSlotRef("k", StandardTypes.BOOLEAN);
    ...
    public void testTranslateInPredicate() {
        SlotRef codeSlotRef = mockSlotRef("code", StandardTypes.INT);
    ...
    public void testTranslateRawQuery() {
        SlotRef serviceSlotRef = mockSlotRef("service", StandardTypes.STRING);
        // normal test
    ...
    public void testTranslateLikePredicate() {
        SlotRef name = mockSlotRef("name", StandardTypes.STRING);
    ...
    public void testTranslateRangePredicate() {
        SlotRef valueSlotRef = mockSlotRef("value", StandardTypes.INT);
    ...
    public void testTranslateCompoundPredicate() {
        SlotRef col1SlotRef = mockSlotRef("col1", StandardTypes.INT);
        IntLiteral intLiteral1 = new IntLiteral(100);
        SlotRef col2SlotRef = mockSlotRef("col2", StandardTypes.INT);
