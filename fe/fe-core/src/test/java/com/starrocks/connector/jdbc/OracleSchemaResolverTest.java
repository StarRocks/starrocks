...
public class OracleSchemaResolverTest {
    ...
    public void testGetPartitions() {
        try {
            JDBCMetadata jdbcMetadata = new JDBCMetadata(properties, "catalog", dataSource);
            JDBCTable jdbcTable = new JDBCTable(100000, "tbl1", Arrays.asList(new Column("d", StandardTypes.VARCHAR)),
                    Arrays.asList(new Column("d", StandardTypes.VARCHAR)), "test", "catalog", properties);
    ...
    public void testListPartitionColumns() {
        try {
            ...
            List<Column> partitionCols = jdbcMetadata.listPartitionColumns("test", "tbl1",
                    Arrays.asList(new Column("`d`", StandardTypes.VARCHAR)));
    ...
    public void testMysqlInvalidPartition1() {
        try {
            ...
            JDBCMetadata jdbcMetadata = new JDBCMetadata(properties, "catalog", dataSource);
            List<Column> columns = Arrays.asList(new Column("d", StandardTypes.VARCHAR));
