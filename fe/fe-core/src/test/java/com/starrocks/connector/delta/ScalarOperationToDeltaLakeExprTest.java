...
public class ScalarOperationToDeltaLakeExprTest {
    ...
    ColumnRefOperator cBoolCol = new ColumnRefOperator(1, StandardTypes.BOOLEAN, "c_bool", true, false);
    ColumnRefOperator cShortCol = new ColumnRefOperator(1, StandardTypes.SMALLINT, "c_short", true, false);
    ColumnRefOperator cIntCol = new ColumnRefOperator(1, StandardTypes.INT, "c_int", true, false);
    ColumnRefOperator cLongCol = new ColumnRefOperator(1, StandardTypes.BIGINT, "c_long", true, false);
    ColumnRefOperator cFloatCol = new ColumnRefOperator(1, StandardTypes.FLOAT, "c_float", true, false);
    ColumnRefOperator cDoubleCol = new ColumnRefOperator(1, StandardTypes.DOUBLE, "c_double", true, false);
    ColumnRefOperator cDateCol = new ColumnRefOperator(1, StandardTypes.DATE, "c_date", true, false);
    ColumnRefOperator cTimestampCol = new ColumnRefOperator(1, StandardTypes.DATETIME, "c_timestamp", true, false);
    ColumnRefOperator cTimestampNTZCol = new ColumnRefOperator(1, StandardTypes.DATETIME, "c_timestamp_ntz", true, false);
    ColumnRefOperator cCharCol = new ColumnRefOperator(1, StandardTypes.CHAR, "c_string", true, false);
    ColumnRefOperator cVarcharCol = new ColumnRefOperator(1, StandardTypes.VARCHAR, "c_string", true, false);
    ColumnRefOperator cHLLCol = new ColumnRefOperator(1, StandardTypes.VARCHAR, "c_string", true, false);
    ...
    public void testConvertConstType() {
        ...
        // hll
        value = ConstantOperator.createObject("12345", StandardTypes.HLL);
