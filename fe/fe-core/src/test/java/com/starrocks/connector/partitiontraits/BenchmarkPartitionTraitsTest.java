...
import com.starrocks.catalog.BenchmarkPartitionKey;
...
public class BenchmarkPartitionTraitsTest {

    @Test
    public void testBenchmarkPartitionTraits() {
        BenchmarkPartitionTraits traits = new BenchmarkPartitionTraits();
