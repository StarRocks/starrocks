...
public class RewriteDataFilesTest {
    ...
    void rewriteDataFilesV3ShouldIncludeRowLineageColumns(
        ...
        new MockUp<IcebergRewriteDataJob>() {
            @Mock
            public void $init(String insertSql, boolean rewriteAll, long minFileSizeBytes,
                              long batchSize, long batchParallelism, ConnectContext context,
                              AlterTableStmt alterStmt) {
                capturedSql[0] = insertSql;
            }
