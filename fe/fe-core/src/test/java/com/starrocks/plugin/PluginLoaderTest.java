...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/test/java/org/apache/doris/plugin/PluginLoaderTest.java
...
public class PluginLoaderTest {
    ...
    public void testMovePlugin() {
        PluginInfo pf =
                new PluginInfo("test-plugin", PluginType.STORAGE, "test/test", DigitalVersion.CURRENT_STARROCKS_VERSION,
    ...
    public void testDynamicLoadPlugin() {
        try {
            PluginInfo info = new PluginInfo("test", PluginType.STORAGE, "test", DigitalVersion.CURRENT_STARROCKS_VERSION,
