...
subprojects {
    ...
    ext {
        ...
        set("google-auth-library.version", "1.37.1")
    ...
    dependencies {
        ...
        constraints {
            ...
            implementation("com.google.auth:google-auth-library-oauth2-http:${project.ext["google-auth-library.version"]}")
            ...
            implementation("org.apache.iceberg:iceberg-gcp:${project.ext["iceberg.version"]}")
