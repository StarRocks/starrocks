...
adminSetAutomatedSnapshotOnStatement
    : ADMIN SET AUTOMATED CLUSTER SNAPSHOT ON (interval)? (STORAGE VOLUME svName=identifier)? properties?
    ;
...
privObjectType
    : CATALOG | DATABASE | MATERIALIZED VIEW | MASKING POLICY | ROW ACCESS POLICY | RESOURCE | RESOURCE GROUP
        | STORAGE VOLUME | SYSTEM | TABLE| VIEW | WAREHOUSE | FAILOVER GROUP | PIPE
    ;

privObjectTypePlural
    : CATALOGS | DATABASES | FUNCTIONS | GLOBAL FUNCTIONS | MATERIALIZED VIEWS
    | MASKING POLICIES | ROW ACCESS POLICIES | RESOURCES | RESOURCE GROUPS
    | STORAGE VOLUMES | TABLES | USERS | VIEWS | WAREHOUSES | FAILOVER GROUPS | PIPES
    ;
...
nonReserved
    ...
    | OBSERVER | OF | OFFSET | ON_CHANGE | ONLY | OPTIMIZER | OPEN | OPERATE | OPTION | OVERWRITE | OFF
    ...
    | TABLES | TABLET | TABLETS | TAG | TASK | TEMPORARY | TIMESTAMP | TIMESTAMPADD | TIMESTAMPDIFF | THAN | TIME | TIMES | TRANSACTION | TRANSFER | TRACE | TRANSLATE | TTL
