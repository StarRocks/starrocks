...
public class ParsingException extends RuntimeException {
    ...
    public String getMessage() {
        ...
        if (pos == null || pos.isZero()) {
            ...
            builder.append(" ");
            builder.append(ErrorMsgProxy.PARSER_ERROR_MSG.nodePositionPoint(pos.getLine(), pos.getCol()));
        } else {
            builder.append(" ");
            builder.append(ErrorMsgProxy.PARSER_ERROR_MSG.nodePositionRange(pos.getLine(), pos.getCol(),
