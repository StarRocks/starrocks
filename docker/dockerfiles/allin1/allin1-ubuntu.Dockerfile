...
<<<<<<< HEAD
#     > DOCKER_BUILDKIT=1 docker build --build-arg ARTIFACT_SOURCE=image --build-arg ARTIFACTIMAGE=ghcr.io/dengliu/starrocks/artifact-ubuntu:latest -f docker/dockerfiles/allin1/allin1-ubuntu.Dockerfile -t allin1-ubuntu:latest docker/dockerfiles/allin1
=======
...
>>>>>>> 2a0c00d5e ([Tool][Dockerfile] merge RUNs to reduce image layers (#20514))
