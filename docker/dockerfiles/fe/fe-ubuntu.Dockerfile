...
<<<<<<< HEAD:docker/dockerfiles/fe-ubuntu.Dockerfile
...
>>>>>>> 759a838ae ([Enhancement] Relocate docker runtime scripts together with Dockerfile (#18155)):docker/dockerfiles/fe/fe-ubuntu.Dockerfile
