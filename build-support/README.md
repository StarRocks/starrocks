...
- `build-support/check_repo_handbook.py`: Validate the internal `handbook/` knowledge tree, including required entrypoints, index links, active-plan metadata, and AGENTS/CLAUDE navigation links. Usage: `python3 build-support/check_repo_handbook.py`
