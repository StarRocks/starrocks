...
-- description: Comprehensive test for decimal type default values
...
-- Insert data before adding decimal columns
INSERT INTO users_basic VALUES 
    (1, 'alice'),
    (2, 'bob'),
    (3, 'charlie');

-- Add decimal columns with different defaults
...
-- Add decimal column (reads old data with new schema)
...
-- ========================================================================
-- Edge Cases: Verify different decimal precisions and scales
-- ========================================================================
